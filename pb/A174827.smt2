;; sequence(s): A174827
;; terms: 1 2 192 4976640 115579079884800 6039552457237856256000000 1499708022491968274577374576640000000000 3321055547746756031053448740122923472047308800000000000000
;; small program: loop(loop(((y - (y div 2)) * x) * y, y + y, x), x, 1)
;; fast program: loop(loop(x * y, y + y, 1) * x, x, 1) * loop(x * x, 1, loop(loop(x * y, y, x), x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (* (* (- y (div y 2)) x) y))))
