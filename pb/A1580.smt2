;; sequence(s): A1580
;; terms: 1 3 8 17 32 57 100 177 320 593 1124 2169 4240 8361 16580 32993 65792 131361 262468 524649
;; small program: (x * x) + loop(x + x, x, 1)
;; fast program: (x * x) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
