;; sequence(s): A1779
;; terms: 1 7 29 91 239 553 1163 2269 4166 7274 12174 19650 30738 46782 69498 101046 144111 201993 278707 379093
;; small program: loop(loop((loop(2 + (x + y), 2, y) * x) div y, y, 1) - x, x, 1)
;; fast program: loop(loop((((2 * ((x + x) + x)) + x) div y) + x, y, 1) - x, x, 1)
(set-logic UFNIA)
