;; sequence(s): A71953
;; terms: 4 52 292 1092 3192 7896 17304 34584 64284 112684 188188 301756 467376 702576 1028976 1472880 2065908 2845668 3856468 5150068
;; small program: loop((loop(loop(loop(x + y, y, x), y + y, x), y, 0) * y) + x, 1 + x, 0)
;; fast program: loop((loop((((1 + x) * ((2 + x) * x)) div (1 + 2)) * (1 + x), 1, y) * y) + x, 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (* (div (* (+ 1 x) (* (+ 2 x) x)) (+ 1 2)) (+ 1 x)))))
(assert (= g5 1))
