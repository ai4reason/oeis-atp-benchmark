;; sequence(s): A191006
;; terms: 1 2 6 24 144 1296 16848 320112 8963136 367488576 22049314560 1940339681280 250303818885120 47307421769287680 13104155830092687360 5320287267017631068160 3165570923875490485555200
;; small program: loop(loop2((((y * y) div (2 + x)) + x) + 1, x, y, 1, 0) * x, x, 1)
;; fast program: loop(loop(loop2(((((y * y) + y) div (x + y)) + x) + x, x, x div 2, 1 + (x mod 2), 1), 1, y) * x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (+ (div (* y y) (+ 2 x)) x) 1))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (div (+ (* y y) y) (+ x y)) x) x))))
