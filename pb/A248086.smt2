;; sequence(s): A248086
;; terms: 0 0 5 7 22 37 81 143 276 490 895 1578 2802 4894 8547 14797 25560 43919 75267 128525
;; small program: ((loop2(y, x + y, x, 2, 2) + loop(0 - x, x, 1)) * x) div 2
;; fast program: (loop(0 - x, x mod 2, x) div 2) + loop2(x + y, x, x - 1, x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (* (+ (w0 x) (v1 x)) x) 2))))
...
(assert (forall ((x Int)) (= (fast x) (+ (div (v2 x) 2) (w3 x)))))
