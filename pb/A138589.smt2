;; sequence(s): A138589
;; terms: 0 1 9 61 113 53 3337 12589 62945 118117 328441 2690781 9259601 12743573 197935593 452807053 2264035265 7025209029 35126045145 106910748989
;; small program: loop((2 * (x + x)) + x, x, 1) mod loop(x + x, x + x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) mod loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
