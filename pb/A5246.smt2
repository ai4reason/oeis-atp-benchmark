;; sequence(s): A5246
;; terms: 1 1 1 2 3 7 11 26 41 97 153 362 571 1351 2131 5042 7953 18817 29681 70226
;; small program: loop2(x + y, (2 * (x + y)) + y, x div 2, 1, x mod 2)
;; fast program: loop2((2 * (x + x)) - y, x, x div 2, 1, 1 + (2 - (x mod 2)))
(set-logic UFNIA)
