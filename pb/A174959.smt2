;; sequence(s): A174959
;; terms: 0 0 0 ~1 0 ~2 1 ~2 6 3 24 26 81 106 250 355 732 1086 2073 3158
;; small program: 1 + (loop2(x + y, x, x, 0, 1) - loop2(y + y, x, x, 1, 1))
;; fast program: (1 - loop(x + x, (x - 1) div 2, 2)) + loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ 1 (- (w0 x) (w1 x))))))
