;; sequence(s): A78865
;; terms: 1 6 45 525 6930 120120 2297295 53348295 1561650090 48522699225 1805044411170 74207381348100 3194627767035705 150451755314205345 7993567173650388330 472542797919255648585 28841405252313189586050
;; small program: loop2(loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, y, 1) - x, 1 + y, 2, 1, x) div 2
;; fast program: loop2(loop(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 1) - x, 1 + y, 2, 1, x) div 2
(set-logic UFNIA)
