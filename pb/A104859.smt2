;; sequence(s): A104859
;; terms: 1 2 5 17 72 345 1773 9525 52788 299463 1730178 10144818 60211926 361042498 2183809018 13308564682 81637319641 503667864976 3123298907641 19456221197941
;; small program: loop(loop(loop2((2 + y) * x, 1 + y, x - 1, 1, x + x) div loop(x * y, x, 1), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x - 1, x), 1, y) + x, x, 1)
(set-logic UFNIA)
