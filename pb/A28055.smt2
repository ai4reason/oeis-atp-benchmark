;; sequence(s): A28055
;; terms: 1 23 340 4130 45031 459893 4504690 42928160 401635861 3711270563 34005047440 309788905790 2811170579491 25442007146033 229842147512590 2073840099225020 18696506927851921 168462145714550303
;; small program: loop((loop(loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1) * loop((x + x) + x, x, 1), 1, y) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
