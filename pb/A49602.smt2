;; sequence(s): A49602
;; terms: 0 1 1 5 9 30 68 195 483 1309 3355 8900 23112 60813 158717 416325 1088661 2852242 7463884 19546175
;; small program: loop2(loop2(x + y, x, y, 1, 1) - x, 1 + y, x, 0, x) div 2
;; fast program: (((loop2(x + y, x, x - 1, 1, 2) - 1) + (2 * (x mod 2))) * loop2(x + y, x, x, 0, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (+ (- (w2 x) 1) (* 2 (mod x 2))) (w3 x)) 2))))
