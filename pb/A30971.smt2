;; sequence(s): A30971
;; terms: 1 3 10 43 218 1311 9183 73467 661210 6612104 72733151 872797820 11346371670 158849203381 2382738050721 38123808811545 648104749796268 11665885496332840 221651824430323976 4433036488606479534
;; small program: (loop(loop2(x * y, y, y, 1, 1 + 2) + (((2 * (y + y)) + y) * x), x, 1) * (1 + x)) div loop((2 * (x + x)) + x, x, 1)
;; fast program: (loop(loop2(x * y, y, y, 1, 1 + 2) + (((2 * (y + y)) + y) * x), x, 1) * (1 + x)) div loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (w1 x y) (* (+ (* 2 (+ y y)) y) x)))))
...
(assert (forall ((x Int)) (= (small x) (div (* (v0 x) (+ 1 x)) (v2 x)))))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (w4 x y) (* (+ (* 2 (+ y y)) y) x)))))
...
(assert (forall ((x Int)) (= (fast x) (div (* (v3 x) (+ 1 x)) (w5 x)))))
