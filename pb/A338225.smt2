;; sequence(s): A338225
;; terms: 2 11 23 66 167 443 1154 3027 7919 20738 54287 142131 372098 974171 2550407 6677058 17480759 45765227 119814914 313679523
;; small program: loop(loop2(x + y, x, 2 + (y + y), 2, 1) - x, x, 2)
;; fast program: loop(x * x, 1, loop2(x + y, x, x, 2, 1)) - loop(0 - 2, x mod 2, 2)
(set-logic UFNIA)
