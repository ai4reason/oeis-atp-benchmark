;; sequence(s): A21048
;; terms: 1 15 160 1530 14071 127605 1151470 10372560 93381541 840520395 7564945180 68085295590 612770035411 5514937460385 49634458601290 446710191850620 4020391920103681 36183527861539575 325651752496199800
;; small program: loop(loop2(((2 * (x + y)) - 1) + x, y + y, y, 1, 2) + loop((x + x) + x, 2, x), x, 1)
;; fast program: loop((loop((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) + 1) div 2, 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (- (* 2 (+ x y)) 1) x))))
