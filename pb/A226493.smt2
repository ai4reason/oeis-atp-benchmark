;; sequence(s): A226493
;; terms: 0 12 24 84 240 732 2184 6564 19680 59052 177144 531444 1594320 4782972 14348904 43046724 129140160 387420492 1162261464 3486784404
;; small program: 2 * loop2((2 * (x + y)) + y, x, x, 0, 2)
;; fast program: (1 + 2) * (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(0 - 1, x mod 2, 1))
(set-logic UFNIA)
