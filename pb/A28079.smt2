;; sequence(s): A28079
;; terms: 1 26 433 5894 71533 807002 8661241 89694638 904552165 8939508578 86964763249 835481774582 7946080247197 74954796226154 702270481591657 6542793214395326 60669652146889429 560336828250406130
;; small program: loop(loop(loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1) * loop((x + x) + x, x, 1), 1, y) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop(loop(((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
