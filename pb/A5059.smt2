;; sequence(s): A5059
;; terms: 0 1 8 49 272 1441 7448 37969 192032 966721 4853288 24325489 121804592 609554401 3049366328 15251614609 76272421952 381405156481 1907154922568 9536162033329
;; small program: loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 0, 1)
;; fast program: (loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (- (w1 x) (w4 x)) 2))))
