;; sequence(s): A135167
;; terms: 2 13 79 487 3091 20143 133939 903727 6161731 42325903 292298899 2026329967 14085955171 98111299663 684331355059 4778093404207 33385561441411 233393582449423 1632228682334419 11417969833438447
;; small program: (loop2(((2 * (x + x)) + x) + y, (2 * ((y + y) + y)) + y, x, 2, 2) - loop(x + x, x, 1)) + loop((x + x) + x, x, 1)
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) - loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (- (w3 x) (v6 x)) (w7 x)) (w8 x)))))
