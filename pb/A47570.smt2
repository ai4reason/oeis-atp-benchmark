;; sequence(s): A47570
;; terms: 2 4 5 6 7 10 12 13 14 15 18 20 21 22 23 26 28 29 30 31
;; small program: loop(compr(loop2(y, 0 - x, x div 2, 1, x mod 2), y), x, 2)
;; fast program: ((1 + ((2 * (x div (1 + (2 + 2)))) + x)) + ((x - 1) div (1 + (2 + 2)))) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ 1 (+ (* 2 (div x (+ 1 (+ 2 2)))) x)) (div (- x 1) (+ 1 (+ 2 2)))) 2))))
