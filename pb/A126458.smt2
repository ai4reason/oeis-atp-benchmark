;; sequence(s): A126458
;; terms: 1 4 21 286 8855 501942 45057474 5843355957 1029873432159 236236542585120 68292983465630781 24268885951464043344 10392619362579990298763 5276256293478688846049120
;; small program: loop2((x * y) + x, y - 1, x, 1, loop(loop(x + y, y, x), x, 2)) div loop(x * y, x, 1)
;; fast program: loop2(x * y, y - 1, x, 1, loop(loop(x + y, y, x), x, 2) + 1) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j4 x) (+ (v5 x) 1))))
...
(assert (forall ((x Int)) (= (fast x) (div (w4 x) (v7 x)))))
