;; sequence(s): A34182
;; terms: 1 5 15 39 97 237 575 1391 3361 8117 19599 47319 114241 275805 665855 1607519 3880897 9369317 22619535 54608391
;; small program: loop2(2 + ((x + x) + y), x, x, 2, 0) - 1
;; fast program: loop2((2 * ((x + x) + x)) - y, x, x div 2, loop(1 + (2 + 2), x mod 2, 1) + 2, 1) - 2
(set-logic UFNIA)
