;; sequence(s): A5123
;; terms: 2 5 9 11 12 14 17 24 29 30 32 35 39 42 44 50 51 54 56 57
;; small program: compr(((1 + loop(0 - (x + x), x, 1)) mod (1 + (2 * (x + x)))) - 2, 1 + x) div 2
;; fast program: compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (2 * (x + x)))) - 2, 1 + x) div 2
(set-logic UFNIA)
