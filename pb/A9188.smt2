;; sequence(s): A9188
;; terms: 9 12 15 16 18 20 21 24 25 27 28 30 32 33 35 36 39 40 42 44
;; small program: compr(loop((x * y) * y, x div 2, 1) mod (1 + x), 1 + x) + 1
;; fast program: compr(loop(x * y, x div 2, 1 + 2) mod (2 + x), 2 + x) + 2
(set-logic UFNIA)
