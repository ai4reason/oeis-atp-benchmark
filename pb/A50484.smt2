;; sequence(s): A50484
;; terms: 1 12 68 264 810 2112 4884 10296 20163 37180 65208 109616 177684 279072 426360 635664 927333 1326732 1865116 2580600
;; small program: loop(loop(loop(((2 * (x + x)) div y) + x, y, 1 + y) + x, y, x), x, 1) + x
;; fast program: loop(loop((loop(loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) div (2 * (2 * (2 + (2 + 2)))), 1, y) * (1 + y)) + x, y, x), x, 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (div (v6 x) (* 2 (* 2 (+ 2 (+ 2 2))))))))
(assert (= g5 1))
