;; sequence(s): A161569
;; terms: 0 2 5 9 13 17 22 28 34 40 47 55 63 71 80 89 98 107 116 126
;; small program: loop((compr(loop(x * y, x, 2) mod (2 + x), y) - y) + x, x, x)
;; fast program: loop((compr(loop(((if (((1 + loop(x + x, x div 2, 1)) mod (1 + x)) - 2) <= 0 then 1 else x) mod 2) + x, (1 + x) mod 2, x) - x, y) - y) + x, x, 2) - 2
(set-logic UFNIA)
