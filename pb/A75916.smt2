;; sequence(s): A75916
;; terms: 1 36 900 19440 390096 7511616 141134400 2611802880 47870735616 871982724096 15819463296000 286235993272320 5170077903015936 93275375604350976 1681524519443251200 30298254922942709760
;; small program: loop(2 * ((x + x) + x), x, loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1))
;; fast program: ((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
