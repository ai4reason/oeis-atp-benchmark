;; sequence(s): A3124
;; terms: 17 50 25 74 37 110 55 164 82 41 122 61 182 91 272 136 68 34 17 50
;; small program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 1 + loop(x * x, 2, 2))
;; fast program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 1 + (2 * (2 * (2 + 2))))
(set-logic UFNIA)
