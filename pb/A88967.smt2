;; sequence(s): A88967
;; terms: 2 4 8 10 14 20 22 28 32 34 38 44 50 52 58 62 64 70 74 80
;; small program: (((compr((1 + loop(x + x, x, x)) mod (1 + x), (2 + 2) + x) - 2) - 2) - 2) - 2
;; fast program: (loop(compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 2 + x) - 2, 1, 2 + x) - 2) * 2
(set-logic UFNIA)
