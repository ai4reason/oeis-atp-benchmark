;; sequence(s): A28148
;; terms: 1 31 617 10079 147609 2022447 26547529 338695423 4238709497 52353238223 640806363561 7794824571807 94411354501465 1140149916014959 13741090450747913 165378493289389631
;; small program: loop(loop2(((((y - 1) + y) * (y * y)) + x) + (2 * ((x + x) + x)), y + y, y, 1, 2) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop(x * x, 1, loop(x + x, x, 1)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
