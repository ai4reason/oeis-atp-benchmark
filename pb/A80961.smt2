;; sequence(s): A80961
;; terms: 1 9 57 321 1713 8889 45417 230001 1158753 5820009 29178777 146130081 731358993 3658920729 18300980937 91524036561 457677578433 2288560079049 11443316955897 57218134461441
;; small program: loop2((2 * ((x + x) + y)) + x, (y + y) + y, x, 1, 2)
;; fast program: loop2(x * y, y, x, 1 + 2, 1 + (2 + 2)) - loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
