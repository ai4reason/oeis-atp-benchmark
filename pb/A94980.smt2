;; sequence(s): A94980
;; terms: 1 1 3 5 9 16 28 50 87 153 269 471 825 1443 2526 4421 7737 13540 23696 41468
;; small program: loop((x div 2) div 2, x, loop((2 * ((x + x) + x)) + x, x, 1))
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) div loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
