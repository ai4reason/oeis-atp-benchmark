;; sequence(s): A192913
;; terms: 0 0 2 3 10 32 91 273 816 2420 7209 21456 63842 190008 565470 1682835 5008192 14904512 44356229 132005445
;; small program: loop2((((y * y) - y) div (x + y)) + y, x + y, x - 1, 0, 1) * loop2(x + y, x, x, 1, 0)
;; fast program: loop2((((y * y) - y) div (x + y)) + y, x + y, x - 2, if (x - 1) <= 0 then 0 else 1, 1) * loop2(x + y, x, x - 2, 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (div (- (* y y) y) (+ x y)) y))))
(assert (forall ((x Int) (y Int)) (= (g2 x y) (+ x y))))
(assert (forall ((x Int)) (= (h2 x) (- x 2))))
(assert (forall ((x Int)) (= (i2 x) (ite (<= (- x 1) 0) 0 1))))
(assert (= j2 1))
