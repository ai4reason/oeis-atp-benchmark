;; sequence(s): A140833
;; terms: 0 2 2 6 6 16 16 42 42 110 110 288 288 754 754 1974 1974 5168 5168 13530
;; small program: 2 * loop2(y, x + y, x, x mod 2, 1)
;; fast program: if x <= 0 then 0 else loop2(((x - y) + x) + x, x, (x - 1) div 2, 2, 0)
(set-logic UFNIA)
