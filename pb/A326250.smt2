;; sequence(s): A326250
;; terms: 0 0 0 3 50 982 32636 2096723
;; small program: loop((2 * ((2 * (x * y)) - x)) div (1 + y), x, 1 - 2) + loop2(x * y, y + y, x, 1, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + x) div (loop(x * y, x, 1) * (0 - 1))) + loop2(x * y, y + y, x - 1, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (w2 x) (* (v3 x) (- 0 1))) (w4 x)))))
