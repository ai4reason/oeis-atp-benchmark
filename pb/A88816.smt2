;; sequence(s): A88816
;; terms: 2 25 3123 823541 285311670609 302875106592251 827240261886336764175 1978419655660313589123977 20880467999847912034355032910565 2567686153161211134561828214731016126483467
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop2(x * y, y, x - 1, 1, x), y, 2, 1, x) - 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop2(x * y, y, x - 2, x, x), y, 2, 1, x) - 2
(set-logic UFNIA)
