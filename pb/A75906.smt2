;; sequence(s): A75906
;; terms: 1 84 4158 158760 5182947 152457228 4166544096 107883135360 2681751885813 64597295294532 1518037879508514 34979886546859800 793401360863472999 17766424516726033596 393690756719422620612
...
;; fast program: loop(loop(loop(((((((loop(loop((loop(((loop((loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div 2) div (1 + 2), 1, y) + x) + x) + x, y, 1) + ((x + x) * 2)) + x, x, 1), 1, y) + x) + x) + x) + x) + x) + x) + x, x, 1), 1, y) + (((x + x) + x) * 2), x, 1) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
