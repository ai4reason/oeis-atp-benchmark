;; sequence(s): A125137
;; terms: 5 28 3126 823544 285311670612 302875106592254 827240261886336764178 1978419655660313589123980 20880467999847912034355032910568 2567686153161211134561828214731016126483470 17069174130723235958610643029059314756044734432 10555134955777783414078330085995832946127396083370199442518
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop2(x * y, y, x - 1, 1, x), y, 2, 1, x) + 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop2(x * y, y, x - 1, 1, x), y, 2, 1, x) + 1
(set-logic UFNIA)
