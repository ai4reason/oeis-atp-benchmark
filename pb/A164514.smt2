;; sequence(s): A164514
;; terms: 1 2 3 5 6 7 8 10 11 12 13 14 15 17 18 19 20 21 22 23
;; small program: loop((x - (y div (0 - x))) div 2, x, 1) + x
;; fast program: (loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2, ((x - 2) - (if x <= 0 then 0 else 1)) div 2) + 2) + x
(set-logic UFNIA)
...
(assert (= h1 (+ 1 2)))
(assert (= i1 2))
(assert (forall ((x Int)) (= (j1 x) (div (- (- x 2) (ite (<= x 0) 0 1)) 2))))
