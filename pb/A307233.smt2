;; sequence(s): A307233
;; terms: 0 1 0 1 3 3 0 1 0 9 3 9 0 7 12 1 3 9 0 1
;; small program: loop(((1 + y) * (x * y)) + x, x, 1) mod (1 + x)
;; fast program: loop(loop(1 + ((x * x) + x), 1, y div 2) * x, x, 1) mod (1 + x)
(set-logic UFNIA)
...
(assert (= g2 1))
(assert (forall ((x Int) (y Int)) (= (h2 x y) (div y 2))))
