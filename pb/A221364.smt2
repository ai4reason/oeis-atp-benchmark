;; sequence(s): A221364
;; terms: 1 1 1 5 1 16 1 45 1 121 1 320 1 841 1 2205 1 5776 1 15125
;; small program: loop2(x + y, x, if (x mod 2) <= 0 then 1 else x, 1, 2) - 2
;; fast program: loop2(loop2(x + y, x, y, 1, 2) - 2, 0, x mod 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h0 x) (ite (<= (mod x 2) 0) 1 x))))
(assert (= i0 1))
(assert (= j0 2))
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (- (w2 x y) 2))))
(assert (= g1 0))
