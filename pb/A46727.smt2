;; sequence(s): A46727
;; terms: 0 3 21 119 697 4059 23661 137903 803761 4684659 27304197 159140519 927538921 5406093003 31509019101 183648021599 1070379110497 6238626641379 36361380737781 211929657785303
;; small program: loop(loop(loop2((x + x) + y, x, y + y, 0, 2) - x, y, 1), x, x)
;; fast program: ((if x <= 0 then 1 else (loop2((2 * ((x + x) + x)) - y, x, x - 1, 1 + (2 + (2 + 2)), 1) + 2)) div 2) - (x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (div (ite (<= x 0) 1 (+ (w3 x) 2)) 2) (mod x 2)))))
