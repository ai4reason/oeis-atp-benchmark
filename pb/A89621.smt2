;; sequence(s): A89621
;; terms: 3 19 86 263 636 1309 2418 4115 6584 10029 14672 20773 28602 38459 50672 65589 83580 105037 130388 160071
;; small program: (compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + x) + 1) + loop(x * x, 2, 1 + x)
;; fast program: (compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + x) + 1) + loop(x * x, 2, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (v3 x) 1) (v6 x)))))
