;; sequence(s): A26311
;; terms: 0 1 2 6 7 8 13 14 15 19 20 21 25 26 27 31 32 33 34 38
;; small program: loop(compr(((((((((2 * (x + x)) - 1) div loop(1 + (x + x), 2, 2)) + 1) + x) div 2) + 1) + x) mod 2, y), x, 2) - 2
;; fast program: loop(compr(((((((((2 * (x + x)) - 1) div (1 + (2 + (2 * (2 + 2))))) + 1) + x) div 2) + 1) + x) mod 2, y), x, 2) - 2
(set-logic UFNIA)
