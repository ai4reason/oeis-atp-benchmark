;; sequence(s): A135799
;; terms: 1 0 0 4 5 48 252 1832 14625 132080 1323168 14576076 175108661 2278429216 31920719820 479088848976 7669098865441 130426934203296 2348478878321248 44633950190867220
;; small program: loop(loop((x * y) + loop(0 - x, y, 1), y - 1, 1) - x, x, 1) * (1 + x)
;; fast program: loop(loop(loop(0 - 1, x mod 2, 1) + (x * y), y - 1, 1) - x, x, 1) * (1 + x)
(set-logic UFNIA)
