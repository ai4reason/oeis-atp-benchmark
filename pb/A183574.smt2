;; sequence(s): A183574
;; terms: 3 4 5 7 8 9 11 12 13 14 15 17 18 19 20 21 23 24 25 26
;; small program: loop(2 + ((1 + y) div x), (x + 2) + x, 2) + x
;; fast program: ((loop((loop(loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x div 2) + x, 2, x) - x, 1, x div 2) + 2) + x, 2, x) + x) div 2) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ 2 (div (+ 1 y) x)))))
