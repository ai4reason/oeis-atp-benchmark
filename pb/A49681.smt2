;; sequence(s): A49681
;; terms: 0 1 2 7 20 56 152 407 1080 2851 7502 19702 51680 135461 354902 929567 2434320 6374236 16689752 43697227
;; small program: (loop2(y - x, x, x + x, 2, 1) - loop2(y, x + y, x, 2, 1)) div 2
;; fast program: ((if x <= 0 then 1 else loop2(((x - y) + x) + x, x, x - 1, 1 + 2, 2)) - loop2(x + y, x, x - 1, 1, 2)) div 2
(set-logic UFNIA)
