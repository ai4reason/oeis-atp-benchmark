;; sequence(s): A193832
;; terms: 1 2 3 3 3 4 4 5 5 5 5 5 6 6 6 7 7 7 7 7
;; small program: loop(((1 + y) div loop2(x + y, y - 1, (1 + x) div 2, 1, x)) + x, x, 1)
;; fast program: ((((loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 1 + 2, x div (1 + 2)) + x, 1 + 2, x) - 1) - x) * 2) + 1) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (* (- (- (v2 x) 1) x) 2) 1) (+ 1 2)))))
