;; sequence(s): A97786
;; terms: 1 7 31 113 374 1178 3618 10974 33087 99481 298729 896551 2690108 8070884 24213332 72640812 217923405 653771355 1961315395 5883947725
;; small program: loop((loop(loop(x + y, y, x), 1 + y, x) + x) + x, x, 1)
;; fast program: loop(((loop((((x * x) * x) - x) div (2 + (2 + 2)), 1, 2 + y) + x) + x) + x, x, 1)
(set-logic UFNIA)
