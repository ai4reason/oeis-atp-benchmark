;; sequence(s): A280113
;; terms: 1 1711 2467531 3558178261 5130890585101 7398740665537651 10668978908814707911 15384660187770143270281 22184669321785637781037561 31990277777354701910112892951 46129958370276158368745010598051 66519367979660443013028395169496861
;; small program: ((loop(x * x, 1, loop2((2 * ((x + x) + x)) + y, x, x + x, 1 + 2, 1)) div 2) div 2) div 2
;; fast program: loop(x * x, 1, loop2((2 * ((x + x) + x)) + y, x, x + x, 1 + 2, 1)) div (2 * (2 + 2))
(set-logic UFNIA)
