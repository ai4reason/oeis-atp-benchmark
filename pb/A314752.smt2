;; sequence(s): A314752
;; terms: 1 5 9 13 19 23 27 31 37 41 45 50 55 59 63 69 73 77 81 87
;; small program: loop((((((if x <= 0 then 1 else x) - 1) div (1 + (2 + (2 * (2 + 2))))) + x) + 1) + (x div loop(1 + (x + x), 2, 2)), 1, (x + x) + x) + x
;; fast program: loop((((((if x <= 0 then 1 else x) - 1) div (1 + (2 + (2 * (2 + 2))))) + x) + 1) + (x div (1 + (2 + (2 * (2 + 2))))), 1, (x + x) + x) + x
(set-logic UFNIA)
