;; sequence(s): A177727
;; terms: 1 3 30 180 1300 8736 60333 412335 2829310 19384200 132882696 910735488 6242420665 42785803515 293259265950 2010026277756 13776931957468 94428478367520 647222466507045 4436128656563175
;; small program: loop2(loop2(x + y, x, y, 1, 0) * x, 1 + y, 1 + 2, loop2(x + y, x, x, 1, 0), x) div 2
;; fast program: (((((loop(x * x, 1, loop2(x + y, x, x, 1, 1)) - (x mod 2)) - (x mod 2)) + 1) * loop2(x + y, x, x, 1, 1)) div 2) * loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (* (+ (- (- (v3 x) (mod x 2)) (mod x 2)) 1) (w5 x)) 2) (w6 x)))))
