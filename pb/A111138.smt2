;; sequence(s): A111138
;; terms: 0 0 1 1 2 4 4 5 7 10 10 11 13 16 20 20 21 23 26 30
;; small program: loop(loop(x - (if (y - x) <= 0 then y else 0), y, y) + x, x, 0)
;; fast program: loop(loop(loop(x - (if (y - x) <= 0 then y else 0), x - (x div 2), x), 1, y) + x, x, 0)
(set-logic UFNIA)
