;; sequence(s): A5722
;; terms: 1 4 16 36 100 144 256 324 484 784 900 1296 1600 1764 2116 2704 3364 3600 4356 4900
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) * x) + x, y, 2, 1, x)
;; fast program: loop2(compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * (x * x), x, 2, 1, x) div 2
(set-logic UFNIA)
