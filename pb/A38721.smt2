;; sequence(s): A38721
;; terms: 2 18 110 570 2702 12138 52670 223290 931502 3842058 15718430 63928410 258885902 1045076778 4208939390 16921719930 67944897902 272553908298 1092539107550 4377127901850
;; small program: loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * 2
;; fast program: loop(loop((x * x) + x, 1, loop(x + x, x, 1)) - loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))), 1, 2 + x)
(set-logic UFNIA)
