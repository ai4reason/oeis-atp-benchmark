;; sequence(s): A235136
;; terms: 1 1 3 5 21 45 231 585 3465 9945 65835 208845 1514205 5221125 40883535 151412625 1267389585 4996616625 44358635475 184874815125
;; small program: loop(loop((2 * (x * y)) - x, y, 1) div x, x, 1)
;; fast program: loop2((2 * (x * y)) - x, y - 2, x div 2, 1, x)
(set-logic UFNIA)
