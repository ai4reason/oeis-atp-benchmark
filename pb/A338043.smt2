;; sequence(s): A338043
;; terms: 2 3 10 7 22 15 38 27 58 43 82 63 110 87 142 115 178 147 218 183
;; small program: (loop((y * y) - x, x, (x div 2) + x) + x) + 2
;; fast program: (((loop(2 + (2 + (2 + x)), 1 - (x mod 2), x) * x) + 1) div 2) + 2
(set-logic UFNIA)
