;; sequence(s): A110523
;; terms: 1 0 ~3 3 6 ~15 ~3 48 ~39 ~105 222 93 ~759 480 1797 ~3237 ~2154 11865 ~5403 ~30192
;; small program: loop2((y + y) + y, 0 - (x + y), x, 1, 0)
;; fast program: loop(0 - x, x mod 2, loop2(x - y, (x + x) + x, x, 1, 1))
(set-logic UFNIA)
