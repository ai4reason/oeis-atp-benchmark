;; sequence(s): A221719
;; terms: 0 2 6 15 34 74 157 328 678 1391 2838 5766 11677 23588 47554 95719 192426 386450 775485 1555152
;; small program: loop(1 + (x + x), x, 2) - loop2(x + y, x, x, 2, 1)
;; fast program: (((1 + 2) * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - 1) - loop2(x + y, x, x, 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (* (+ 1 2) (v2 x)) 1) (w5 x)))))
