;; sequence(s): A99198
;; terms: 0 7 197 8018 556014 59740609 9174170011 1904975488436 513771331467372 174548332364311563 72920994844093191553 36737130036755448717350 21961934137099746053158010 15369599839081193169161637861
;; small program: (loop(loop(((x + y) * y) + x, y, 1) + x, x + x, 0) div 2) - x
;; fast program: loop(loop((loop(1 + (x * y), x - 1, 1) * x) - x, 1, y) + x, (x + 1) + x, 1) div 2
(set-logic UFNIA)
