...
(assert (forall ((x Int)) (= (f2 x) (mod (+ (ite (<= (- (mod (+ 1 (w3 x)) (+ 1 x)) 2) 0) 1 0) x) 2))))
(assert (forall ((x Int)) (= (g2 x) (mod x 2))))
(assert (forall ((x Int)) (= (h2 x) (+ 1 x))))
(assert (forall ((x Int) (y Int)) (= (u2 x y) (ite (<= x 0) y (f2 (u2 (- x 1) y))))))
(assert (forall ((x Int)) (= (v2 x) (u2 (g2 x) (h2 x)))))
(assert (forall ((x Int)) (= (f1 x) (mod (mod (+ (v2 x) x) 2) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (f5 x) (mod (- (mod (- (mod (+ (mod (ite (<= (- (mod (+ 1 (w6 x)) (+ 1 x)) 2) 0) 1 2) 2) 1) (+ 1 2)) 1) (+ 1 2)) 1) (+ 1 x)))))
