;; sequence(s): A64686
;; terms: 0 2 7 23 73 227 697 2123 6433 19427 58537 176123 529393 1590227 4774777 14332523 43013953 129074627 387289417 1161999323
;; small program: loop2(((x + x) + x) + y, y + y, x, 1, 1) div 2
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x - 1, 1)
(set-logic UFNIA)
