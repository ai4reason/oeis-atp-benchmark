;; sequence(s): A287451
;; terms: 0 1 2 2 0 1 1 2 0 1 2 0 0 1 2 2 0 1 2 0
;; small program: loop2(y - x, y div (1 + 2), 1 + (2 + 2), 0, x) mod (1 + 2)
;; fast program: loop2(y - x, y div (1 + 2), 2 + 2, x, x div (1 + 2)) mod (1 + 2)
(set-logic UFNIA)
