;; sequence(s): A200312
;; terms: 1 1 8 35 266 1680 12804 93093 726440 5635058 45063668 362121760 2955642508 24284658100 201428123040 1680921310635 14119413718770 119205791509200 1011387051005100 8617021562542470
;; small program: loop(2 * ((x - (x div y)) + x), x, loop2(((x + y) + y) + y, x, x, 1, 0)) div (1 + x)
;; fast program: (loop(2 * ((x - (x div y)) + x), x, 1) div (1 + x)) * loop2(((x + y) + y) + y, x, x - 1, 1, 1)
(set-logic UFNIA)
