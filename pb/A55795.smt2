;; sequence(s): A55795
;; terms: 0 1 3 7 15 30 56 98 162 255 385 561 793 1092 1470 1940 2516 3213 4047 5035
;; small program: loop(loop(loop(x + y, y - 2, x), y, x) + y, x, 0)
;; fast program: loop((((x * x) - x) div (2 + (2 + 2))) + x, 1, ((x * x) - x) div 2) + x
(set-logic UFNIA)
