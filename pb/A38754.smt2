;; sequence(s): A38754
;; terms: 1 2 3 6 9 18 27 54 81 162 243 486 729 1458 2187 4374 6561 13122 19683 39366
;; small program: loop2(y, (x + x) + x, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, 1 + (x mod 2), 1 + 2)
(set-logic UFNIA)
