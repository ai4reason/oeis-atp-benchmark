;; sequence(s): A137492
;; terms: 268435456 22876792454961 37252902984619140625 459986536544739960976801 144209936106499234037676064081 15502932802662396215269535105521 28351092476867700887730107366063041
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop((x * x) * x, 1 + 2, x), y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop((x * x) * x, 2, (x * x) * x), y, 2, 1, x)
(set-logic UFNIA)
