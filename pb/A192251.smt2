;; sequence(s): A192251
;; terms: 0 2 8 48 258 1518 8910 53526 323796 1976876 12138456 74921904 464320368 2887660168 18011618368 112633305568 705899650498 4432668783838 27882818399038 175661366346838
;; small program: loop(loop(loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x, 0, 1)), 1, y) + x, x, 0)
;; fast program: loop(loop(loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x - 2, 1, 1)), 1, y) + x, x, 0)
(set-logic UFNIA)
