;; sequence(s): A28243
;; terms: 0 0 2 12 50 180 602 1932 6050 18660 57002 173052 523250 1577940 4750202 14283372 42915650 128878020 386896202 1161212892
;; small program: 1 - loop2(((x - y) + x) + x, y + y, x, 1, 2)
;; fast program: 1 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x, 2))
(set-logic UFNIA)
