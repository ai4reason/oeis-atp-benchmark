...
(assert (forall ((x Int)) (= (f1 x) (* (mod (+ (+ (v2 x) 1) x) 2) (+ 1 x)))))
(assert (= g1 2))
...
(assert (forall ((x Int)) (= (small x) (mod (+ (mod (- (v0 x) x) (+ 1 x)) 1) 2))))
...
(assert (forall ((x Int)) (= (f5 x) (* (mod (+ (+ (v6 x) 1) x) 2) (+ 1 x)))))
(assert (= g5 2))
...
(assert (forall ((x Int)) (= (fast x) (mod (+ (mod (- (v4 x) x) (+ 1 x)) 1) 2))))
