;; sequence(s): A5099
;; terms: 1 2 3 5 6 8 11 12 15 17 18 20 21 26 27 32 33 35 38 41
;; small program: (compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x) div 2) + 1
;; fast program: (compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) div 2) + 1
(set-logic UFNIA)
