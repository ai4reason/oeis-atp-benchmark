;; sequence(s): A124669
;; terms: 4 13 33 75 141 219 321 435 665 897 1145 1515 1761 2019 2489 3125 3597 4085 4755 5181
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, 1 + y, 2, 1, x) - 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 2, 1, x) - 2
(set-logic UFNIA)
