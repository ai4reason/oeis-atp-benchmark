;; sequence(s): A317251
;; terms: 2 6 1680 108972864000 137047310902965380295426048000000 5507245320567889066989296412116383715402149139520190633628554443368693760000000000000
;; small program: loop2((2 + y) * x, 1 + y, loop((x + x) + y, x, 0), 1, x) * 2
;; fast program: loop(loop2(x * y, 1 + y, x - 1, 2, 1 + x) * loop(x * y, x, 1), 1, loop(x + x, x, 1)) div loop((1 + y) * x, x, 1)
(set-logic UFNIA)
