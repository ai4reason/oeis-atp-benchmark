;; sequence(s): A70712
;; terms: 0 1 4 17 16 5 6 28 2 10 20 13 24 22 19 23 8 12 9 7
;; small program: loop2((x * x) * y, x, 2, x, x) mod ((2 * loop(x * x, 2, 2)) - 1)
...
(assert (= v1 (u1 g1 h1)))
(assert (forall ((x Int)) (= (small x) (mod (w0 x) (- (* 2 v1) 1)))))
