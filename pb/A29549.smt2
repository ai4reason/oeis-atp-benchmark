;; sequence(s): A29549
;; terms: 0 6 210 7140 242556 8239770 279909630 9508687656 323015470680 10973017315470 372759573255306 12662852473364940 430164224521152660 14612920781245825506 496409142337836914550 16863297918705209269200
;; small program: (loop(x * x, 1, loop2((x + x) + y, x, x + x, 1, 0)) div 2) div 2
;; fast program: loop(x * x, 1, loop2((2 * ((x + x) + x)) - y, x, x - 1, (if x <= 0 then 0 else (2 + 2)) + 1, 1)) div (2 + 2)
(set-logic UFNIA)
