;; sequence(s): A202768
;; terms: 1 1 3 120 151200 10973491200 73004442255360000 64942882916646518784000000 10615517921765466641283416064000000000 419534029722194863260820186269027926016000000000000 5103425917047830280023316797736216735574814664897331200000000000000
;; small program: loop(loop(x * y, (y - 1) + y, x) div y, x, 1)
;; fast program: loop(loop(loop(x * y, x + x, 1 + (x + x)) div (1 + x), 1, y) * x, x - 1, 1)
(set-logic UFNIA)
