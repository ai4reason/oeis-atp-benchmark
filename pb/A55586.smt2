;; sequence(s): A55586
;; terms: 1 10 59 268 1037 3598 11535 34832 100369 278546 749587 1966100 5046293 12714006 31522839 77070360 186122265 444596250 1051721755 2466250780
;; small program: loop(loop(loop(2 * ((((x + x) + x) div y) + x), y, 1) + x, y, x), x, 1) + x
;; fast program: (((loop(loop(loop(x + x, x, 1) * loop(loop(x + y, y, x), x, x), 1, y) + x, x, 1) + x) * 2) - 1) - x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* 2 (+ (div (+ (+ x x) x) y) x)))))
