;; sequence(s): A37165
;; terms: 1 7 23 59 119 191 287 395 615 839 1079 1439 1679 1931 2391 3015 3479 3959 4619 5039
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x, 1 + y, 2, 1, x) - 1
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x, 1 + y, 2, 1, x) - 1
(set-logic UFNIA)
