;; sequence(s): A90946
;; terms: 0 2 5 6 8 9 10 12 13 14 15 16 17 19 20 21 22 23 24 25
;; small program: loop(loop(((1 + y) div loop2(x + y, x, x, 1, 2)) + x, x, 1) + y, x, x)
;; fast program: loop((loop((y div loop2(x + y, x, x, 1 + 2, 1)) + x, 1 + x, 0) + 1) + y, x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (+ (v4 x) 1) y))))
