;; sequence(s): A8880
;; terms: 33 100 50 25 76 38 19 58 29 88 44 22 11 34 17 52 26 13 40 20
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + (2 * loop(x * x, 2, 2)))
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + (2 * (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
