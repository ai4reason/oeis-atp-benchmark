;; sequence(s): A140429
;; terms: 0 1 3 9 27 81 243 729 2187 6561 19683 59049 177147 531441 1594323 4782969 14348907 43046721 129140163 387420489
;; small program: loop2(y, (y + y) + y, x, 0, 1)
;; fast program: if x <= 0 then 0 else loop2(x * y, y, (x - 1) div 2, loop(1, x mod 2, 1 + 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
