;; sequence(s): A28123
;; terms: 1 29 545 8485 119481 1586589 20323345 254479445 3140238761 38383465549 466251023745 5640435145605 68049758226841 819519225638909 9857637166837745 118479045968342965 1423248497110019721
;; small program: loop(loop2(((((y - 1) + y) * (y * y)) + x) + (2 * (x + x)), y + y, y, 1, 2) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) + 1) * loop(x * x, 1, loop(x + x, x - 1, 2))) div 2, 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (div (* (+ (w5 x) 1) (v6 x)) 2))))
(assert (= g4 1))
