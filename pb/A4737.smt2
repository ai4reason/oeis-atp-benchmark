;; sequence(s): A4737
;; terms: 1 1 2 1 1 2 3 2 1 1 2 3 4 3 2 1 1 2 3 4
;; small program: loop((((loop(((y div x) div x) + x, x, 1) + x) mod 2) + y) - x, x + x, 1) - x
;; fast program: loop((((loop((y div (x * x)) + x, x, 1) + x) mod 2) + y) - x, x + x, 1) - x
(set-logic UFNIA)
