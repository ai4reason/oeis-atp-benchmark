;; sequence(s): A33967
;; terms: 1 22 11 232 116 58 29 610 305 6406 3203 67264 33632 16816 8408 4204 2102 1051 22072 11036
;; small program: loop(loop(2 + (loop((x * x) + x, 2, 2) * x), x mod 2, x) div 2, x, 1)
;; fast program: loop(loop(2 + (loop((x * x) + x, 1, 2 + (2 + 2)) * x), x mod 2, x) div 2, x, 1)
(set-logic UFNIA)
