;; sequence(s): A53187
;; terms: 0 1 1 4 4 4 4 9 9 9 9 9 9 16 16 16 16 16 16 16
;; small program: (x + x) - loop((if x <= 0 then 1 else y) - x, x + x, x)
;; fast program: loop2(loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x), 1, y) * x, y, 2, 1, (x - 1) div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (- (ite (<= x 0) 1 y) x))))
