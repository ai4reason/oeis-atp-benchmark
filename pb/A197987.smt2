;; sequence(s): A197987
;; terms: 4 27 625 16807 1771561 62748517 6975757441 322687697779 41426511213649 12200509765705829 787662783788549761 243569224216081305397 37929227194915558802161 3177070365797955661914307 566977372488557307219621121 205442259656281392806087233013
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2 + x, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * x, y, 2 + x, 1, x)
(set-logic UFNIA)
