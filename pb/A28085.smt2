;; sequence(s): A28085
;; terms: 1 30 585 9450 137781 1888110 24862545 318755250 4012058061 49847787990 613622150505 7503229474650 91300979746341 1106997911204670 13386607046238465 161563913916523650
;; small program: loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, y, 1, 2) + x, x, 1) * loop((x + x) + x, x, 1)
;; fast program: loop(((loop(loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div (2 + (2 + 2)), 1, y) + x) + x) + x, x, 1) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (div (v5 x) (+ 2 (+ 2 2))))))
(assert (= g4 1))
