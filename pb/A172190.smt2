;; sequence(s): A172190
;; terms: 16 54 250 686 2662 4394 9826 13718 24334 48778 59582 101306 137842 159014 207646 297754 410758 453962 601526 715822
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + 2, 1, x) * 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((x * x) * x), 0, 2, 1, x)
(set-logic UFNIA)
