;; sequence(s): A46325
;; terms: 510510 4849845 37182145 215656441 955049953 3212440751 10131543907 25626846353 63392725189 146078888479 297194980009 584803025179 1058967640189 1833822011059 3113232716449 5232880523393 8194888366823
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, 1 + y, 1 + (2 + (2 + 2)), 1, x)
