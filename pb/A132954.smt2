;; sequence(s): A132954
;; terms: 1 2 4 ~1 ~2 ~4 1 2 4 ~1 ~2 ~4 1 2 4 ~1 ~2 ~4 1 2
;; small program: loop2(((y - x) * y) div x, 0 - y, x, 1, 2)
;; fast program: loop(0 - (x + x), x mod (1 + 2), 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (div (* (- y x) y) x))))
