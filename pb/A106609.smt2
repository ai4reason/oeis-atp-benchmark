;; sequence(s): A106609
;; terms: 0 1 1 3 1 5 3 7 1 9 5 11 3 13 7 15 2 17 9 19
;; small program: loop(x div (2 - (x mod 2)), 1 + 2, x)
;; fast program: loop(loop(loop(x div 2, 1 - (x mod 2), x), 2, x div 2), 1 - (x mod 2), x)
(set-logic UFNIA)
