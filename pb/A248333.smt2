;; sequence(s): A248333
;; terms: 0 0 0 0 1 1 2 2 3 4 4 5 6 6 7 8 9 9 10 11
;; small program: loop(loop((y * y) div ((y - x) + y), x, 0), 2, x)
;; fast program: loop((loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, (x - 1) div 2) * (0 - 1)) + x, 2, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (div (* y y) (+ (- y x) y)))))
