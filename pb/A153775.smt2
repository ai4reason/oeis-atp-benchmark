;; sequence(s): A153775
;; terms: 1 2 3 5 6 8 9 14 15 17 18 23 24 26 27 41 42 44 45 50
;; small program: loop(compr(loop(if (1 - (x mod (1 + 2))) <= 0 then (x div (1 + 2)) else x, x, x), y), x, 0) + 1
;; fast program: (compr(loop(x div loop(1 + 2, x mod 2, 1), loop(1 + (x + x), 2, 2), x), 1 + x) div 2) + 1
(set-logic UFNIA)
