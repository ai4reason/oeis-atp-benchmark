;; sequence(s): A329320
;; terms: 0 1 1 1 1 2 1 2 1 2 2 2 1 2 2 2 1 2 2 2
;; small program: loop2((loop(x div 2, x, y) mod 2) + x, y div 2, x, 0, x)
;; fast program: loop2(((y div (2 - (x mod 2))) mod 2) + x, y div 2, 1 + (2 + (2 + 2)), 1, x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (mod (div y (- 2 (mod x 2))) 2) x))))
