;; sequence(s): A145996
;; terms: 0 1 2 4 243
;; small program: (loop(loop(loop(x * y, x, y) div x, x, y), x, 1) - 1) + x
;; fast program: loop2(loop2(x * y, y, y - 1, 1, 1 + 2) * (x + y), x, x - 2, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (* (w4 x y) (+ x y)))))
