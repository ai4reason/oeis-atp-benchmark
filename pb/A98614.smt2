;; sequence(s): A98614
;; terms: 1 1 4 15 70 336 1716 9009 48620 267410 1494844 8465184 48466796 280073300 1631408400 9568812015 56466198990 335002137360 1997007404700 11955535480350
;; small program: loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x, 1, 0)) div (1 + x)
;; fast program: loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x - 1, 1, 1)) div (1 + x)
(set-logic UFNIA)
