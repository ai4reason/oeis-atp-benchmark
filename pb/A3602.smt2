;; sequence(s): A3602-A351090
;; terms: 1 1 2 1 3 2 4 1 5 3 6 2 7 4 8 1 9 5 10 3
;; small program: 1 + (loop(x div (1 + (x mod 2)), x, x) div 2)
;; fast program: loop(loop(loop(loop(loop(loop(loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, x div 2), x mod 2, x) div 2, x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2) + 1
(set-logic UFNIA)
