;; sequence(s): A5159-A151383
;; terms: 1 3 18 135 1134 10206 96228 938223 9382230 95698746 991787004 10413763542 110546105292 1184422556700 12791763612360 139110429284415 1522031755700070 16742349312700770 185047018719324300 2054021907784499730
;; small program: loop((loop(2 - ((2 + y) * x), 2, y) * x) div (1 + y), x, 1)
;; fast program: (loop(2 * ((x - (x div y)) + x), x, 1) div (1 + x)) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
