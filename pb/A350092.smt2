;; sequence(s): A350092
;; terms: 1 2 4 9 20 42 90 191 405 857 1816 3848 8150 17263 36564 77445 164031 347423 735855 1558567
;; small program: loop2(x + y, x, ((x - 1) + x) + x, 1, 2) div loop(x + x, x, 1)
;; fast program: loop2((2 * (x + x)) + y, x, x - 1, if x <= 0 then 1 else 2, 1) div loop(x + x, x - 1, 1)
(set-logic UFNIA)
