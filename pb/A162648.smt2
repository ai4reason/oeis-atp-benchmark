;; sequence(s): A162648
;; terms: 0 4 6 8 12 16 20 22 24 28 30 32 36 38 40 44 48 52 54 56
;; small program: compr(loop(if (x mod 2) <= 0 then ((x div 2) - x) else x, x, x), 1 + x) - 2
;; fast program: (compr((loop(loop((if (x mod 2) <= 0 then 2 else x) div 2, 1 + (2 * (2 + 2)), x), 2, x) + 1) mod 2, x) - 2) + 1
(set-logic UFNIA)
