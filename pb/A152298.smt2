;; sequence(s): A152298
;; terms: 0 1 1 13 10 121 91 1093 820 9841 7381 88573 66430 797161 597871 7174453 5380840 64570081 48427561 581130733
;; small program: loop2((y + y) + y, (x + y) + y, x, 1, x mod 2) div 2
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div loop(2 * (2 + x), 1 - (x mod 2), 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (w1 x) (v3 x)))))
