;; sequence(s): A299335
;; terms: 1 5 17 45 103 211 399 707 1190 1918 2982 4494 6594 9450 13266 18282 24783 33099 43615 56771
;; small program: loop(loop(loop(loop(loop(x + y, y div 2, x), y, x), y, x), 2 + y, x), x, 1)
;; fast program: loop(loop(loop(((2 * ((x + x) + x)) div y) + x, y, 1) - x, y, 1) - x, x, 1)
(set-logic UFNIA)
