;; sequence(s): A84922
;; terms: 4 8 20 28 48 60 88 140 160 228 280 308 368 468 580 620 748 840 888 1040
;; small program: (loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + y) * x) + 2, y, 2, 1, x) div (1 + 2)) div 2
;; fast program: (loop(loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x), 1, 2 + x) div 2) div (1 + 2)
(set-logic UFNIA)
