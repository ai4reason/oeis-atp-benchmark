;; sequence(s): A266846
;; terms: 1 6 20 104 336 1696 5440 27264 87296 436736 1397760 6989824 22368256 111845376 357908480 1789558784 5726601216 28633071616 91625881600 458129670144
;; small program: loop(x + x, x, loop2(1 + (y + y), x + x, x, 1, 1))
;; fast program: loop(x + x, x, loop2(1 + (x * y), y, x div 2, loop(1 + 2, x mod 2, 1), 2 + 2))
(set-logic UFNIA)
