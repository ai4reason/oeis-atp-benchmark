;; sequence(s): A97038
;; terms: 0 1 1 5 7 21 35 85 155 341 651 1365 2667 5461 10795 21845 43435 87381 174251 349525
;; small program: loop2((x + y) + y, x, x, 1, 0) - loop2(y + y, x, x, 1, 0)
;; fast program: (((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)) * 2) + 1) - loop(x + x, x div 2, 1 - (x mod 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h5 x) (- 1 (mod x 2)))))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int)) (= (v5 x) (u5 (g5 x) (h5 x)))))
(assert (forall ((x Int)) (= (fast x) (- (+ (* (div (v2 x) (+ 1 2)) 2) 1) (v5 x)))))
