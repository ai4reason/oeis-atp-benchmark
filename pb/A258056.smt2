;; sequence(s): A258056
;; terms: 75 226 113 340 170 85 256 128 64 32 16 8 4 2 1 4 2 1 4 2
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + loop(2 + ((x * x) + x), 2, 2))
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, (1 + 2) * loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
