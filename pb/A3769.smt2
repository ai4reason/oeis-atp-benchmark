;; sequence(s): A3769
;; terms: 3 16 75 361 1728 8281 39675 190096 910803 4363921 20908800 100180081 479991603 2299777936 11018898075 52794712441 252954664128 1211978608201 5806938376875 27822713276176
;; small program: loop(loop2(((2 * (x + x)) - y) + x, x, y, 1, 1) - x, 1 + x, 1)
;; fast program: loop((((loop2(((2 * (x + x)) - y) + x, x, x - 1, (if x <= 0 then 0 else (1 + 2)) + 2, 2) div (1 + (2 + (2 + 2)))) * 2) + 1) + (x mod 2), 1, 2 + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (+ (+ (* (div (w3 x) (+ 1 (+ 2 (+ 2 2)))) 2) 1) (mod x 2)))))
(assert (= g2 1))
