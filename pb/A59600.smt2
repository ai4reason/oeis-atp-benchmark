;; sequence(s): A59600
;; terms: 1 14 85 344 1086 2892 6798 14520 28743 53482 94523 159952 260780 411672 631788 945744 1384701 1987590 2802481 3888104
;; small program: loop(loop(loop(loop(loop(((y * y) - y) + x, y + y, x), y, x), y, x), 1 + y, x), x, 2) div 2
;; fast program: loop(loop(loop(((2 * (2 * (x + x))) div y) + x, x + x, 1) div (1 + (x + x)), 1, y) - x, x, 1)
(set-logic UFNIA)
