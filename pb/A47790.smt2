;; sequence(s): A47790
;; terms: 0 0 0 1 6 24 81 250 732 2073 5742 15664 42273 113202 301428 799273 2112774 5571816 14668209 38563882
;; small program: 1 + (loop2(x + y, x, x + x, 0, 1) - loop(x + x, x, 1))
;; fast program: (loop2(((x - y) + x) + x, x, x - 2, if (x - 1) <= 0 then x else (1 + 2), 1) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) + 1
(set-logic UFNIA)
