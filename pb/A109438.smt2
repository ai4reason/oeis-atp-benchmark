;; sequence(s): A109438
;; terms: 1 5 18 68 253 945 3526 13160 49113 183293 684058 2552940 9527701 35557865 132703758 495257168 1848324913 6898042485 25743845026 96077337620
;; small program: loop(loop2((2 * (x + x)) + y, 0 - x, y, 1, 2) - x, x, 1)
;; fast program: (1 + loop2((2 * (x + x)) - y, x, x, 1 + (2 + (2 + 2)), 0 - 1)) div (2 + (2 + 2))
(set-logic UFNIA)
