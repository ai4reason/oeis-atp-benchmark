;; sequence(s): A192861
;; terms: 1 3 5 7 9 11 13 15 19 21 23 25 27 29 31 33 37 39 41 43
;; small program: (compr(loop(loop(if ((1 + loop(x + x, x, x)) mod (1 + x)) <= 0 then (1 + x) else 2, 1, y) * x, 1 + x, 1) mod (1 + x), x) * 2) + 1
