;; sequence(s): A181149
;; terms: 14 39 155 399 1463 2379 5219 7239 12719 25259 30783 52059 70643 81399 106079 151739 208919 230763 305319 363023
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + 2) * x, y, 2, 1, x) - 1
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1) + x, y, 1 + 2, 1, x) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (* (+ (* (v1 x y) x) 2) x))))
