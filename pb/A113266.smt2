;; sequence(s): A113266
;; terms: 1 ~6 92 ~1623 31991 ~673903 14855765 ~338444182 7905221248 ~188294015986 4556160266218 ~111682969647780 2767470863606632 ~69211374967753668 1744655539982525892 ~44282217426880817943 1130756774785983371727
;; small program: loop(loop((loop(2 * ((x - (x div y)) + x), x, 1) div (1 + x)) * loop2(x * y, y, x, 1, 1 - (2 * (2 + 2))), 1, y) + x, x, 1)
...
(assert (forall ((x Int)) (= (f1 x) (* (div (v2 x) (+ 1 x)) (w3 x)))))
(assert (= g1 1))
