;; sequence(s): A67602
;; terms: 0 2 7 17 58 209 316 1580 3526 4508 22540 112700 209206 1046030 447181 11801843 30311401 108510284 155130931 775654655
;; small program: loop((2 * (x + x)) + x, x, 1) mod loop((x + x) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) mod loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
