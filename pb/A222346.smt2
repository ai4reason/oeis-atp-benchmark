;; sequence(s): A222346
;; terms: 8 33 124 460 1714 6433 24308 92376 352714 1352076
;; small program: (loop(2 * ((x - (x div y)) + x), 1 + (2 + x), 1) div 2) - 2
;; fast program: loop(loop2(x * y, 1 + y, x, 1, 2 + x) div loop(x * y, x - 1, x), 1, 2 + x) - 2
(set-logic UFNIA)
