;; sequence(s): A46648
;; terms: 1 2 7 30 143 728 3876 21318 120175 690690 4032015 23841480 142498692
;; small program: loop2((2 + y) * x, 1 + y, x, 1, x + x) div loop((x * y) + x, x, 1)
;; fast program: loop2(x * y, 1 + y, x - 1, if x <= 0 then 1 else 2, 1 + (2 + (x + x))) div loop(x * y, x, 1)
(set-logic UFNIA)
