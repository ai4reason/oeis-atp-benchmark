;; sequence(s): A122069
;; terms: 1 3 18 81 405 1944 9477 45927 223074 1082565 5255361 25509168 123825753 601059771 2917611090 14162371209 68745613437 333698181192 1619805064509 7862698824255
;; small program: loop((x + x) + x, x, loop2(x + y, x, x, 1, 0))
;; fast program: loop2(x + y, x, x - 1, 1, 1) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
