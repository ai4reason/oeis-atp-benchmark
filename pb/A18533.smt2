;; sequence(s): A18533
;; terms: 1 3 5 9 13 15 39 45 65 117 195 585
;; small program: loop(compr(loop((2 + (x div y)) * x, 2 + 2, 1) mod (1 + x), y), x, 0) + 1
;; fast program: (compr(loop((1 + (x * x)) * (1 + x), 1, 2 * (2 + 2)) mod (1 + (x + x)), x) * 2) + 1
(set-logic UFNIA)
