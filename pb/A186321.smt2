...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (div (* 2 (+ x y)) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (small x) (+ (+ (+ (div (+ (div (div (w0 x) 2) (+ 1 2)) x) 2) x) x) 2))))
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (div (+ (div (+ (+ 1 x) (div (+ 2 x) (+ 1 (+ 2 (+ 2 2))))) (+ 1 (+ 2 (+ 2 2)))) x) 2) x) x) 2))))
