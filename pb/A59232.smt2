;; sequence(s): A59232
;; terms: 1 3 30 205891132094649000000000000000000000000000004
;; small program: loop(((loop2(x * y, y, x - 2, 1, x) * (x * x)) + 1) + y, x, 1)
;; fast program: loop((loop2(x * y, y, x - (x div 2), 1, x) * loop2(x * y, y, x div 2, 1, x)) + (1 + y), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (+ (* (w1 x) (* x x)) 1) y))))
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (* (w3 x) (w4 x)) (+ 1 y)))))
