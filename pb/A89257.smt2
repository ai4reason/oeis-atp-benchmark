;; sequence(s): A89257
;; terms: 4 6 8 12 14 18 24 26 32 36 38 42 44 54 56 66 68 72 78 84
;; small program: (compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x) + 1) + 2
;; fast program: (compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) + 1) + 2
(set-logic UFNIA)
