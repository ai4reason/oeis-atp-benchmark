;; sequence(s): A182555
;; terms: 1 2 5 12 29 68 158 360 813 1812 4010 8792 19170 41512 89500 191952 410237 873140 1853042 3919608
;; small program: loop((loop(loop(x + x, x, 1) - loop((x * y) div (y - (y div 2)), x, 1), 1, y - 1) + x) + x, x, 1)
;; fast program: loop((loop(loop(x + x, x, 1) - loop((x * y) div (y - (y div 2)), x, 1), 1, y) + x) + x, x - 1, if x <= 0 then 1 else 2)
(set-logic UFNIA)
