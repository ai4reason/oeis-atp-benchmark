;; sequence(s): A28848
;; terms: 0 0 25 0 2641 0
;; small program: loop2((x * y) + x, y, (x + x) + x, 1, x) mod loop2(x * (y + y), y, x, 1, 2 + 2)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + x)) mod loop((x * x) * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
