;; sequence(s): A3046
;; terms: 1 1 2 10 140 5880 776160 332972640 476150875200 2315045555222400 38883505145515430400 2285805733484270091494400 475475022233529990271933132800 353230394017289429773019124357120000 944693494975599542562153266945656012800000
;; small program: loop(loop(2 * ((x - (x div y)) + x), y, x) div (1 + y), x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 2, (1 + 2) + x) div loop(x * y, x, 1), 1, y) * x, x - 1, 1)
(set-logic UFNIA)
