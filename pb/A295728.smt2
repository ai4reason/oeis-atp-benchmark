;; sequence(s): A295728
;; terms: 1 ~1 1 1 4 7 15 26 49 83 148 247 427 706 1197 1967 3292 5387 8935 14578
;; small program: loop2(y, x + y, x, 1 + 2, 2) - loop2(x + y, x - y, x, 2, 1)
;; fast program: loop2(y, x + y, x, 1 + 2, 2) - loop(x + x, x div 2, 2 + (x mod 2))
(set-logic UFNIA)
