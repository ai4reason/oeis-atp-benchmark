;; sequence(s): A180617
;; terms: 12 24 48 96 168 252 360 480 720 960 1216 1596 1848 2112 2592 3240 3720 4216 4896 5328
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + 2) * x, 1 + y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 2) * x, 1 + y, 2, 1, x)
(set-logic UFNIA)
