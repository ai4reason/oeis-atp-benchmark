;; sequence(s): A92352
;; terms: 1 2 3 9 15 21 36 51 66 94 122 150 195 240 285 351 417 483 574 665
;; small program: loop(loop(1 + ((2 * (y + y)) + x), y div (1 + 2), 1) + x, x, 1)
;; fast program: loop(loop(loop2(((y div (1 + 2)) + x) * x, y, 2, 1, x), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (* (+ (div y (+ 1 2)) x) x))))
