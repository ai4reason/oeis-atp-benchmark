;; sequence(s): A234016
;; terms: 0 0 1 1 1 2 3 3 3 4 4 4 5 6 7 7 7 8 8 8
;; small program: (1 - loop((y div loop2(x + y, y div 2, x, 0, x)) + x, x, 1)) + x
;; fast program: (1 - loop((y div loop2(x + y, y div 2, 1 + (2 + 2), x, x div 2)) + x, x, 1)) + x
(set-logic UFNIA)
