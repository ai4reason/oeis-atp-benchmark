;; sequence(s): A316322
;; terms: 2 11 36 85 184 327 548 833 1224 1775 2426 3277 4302 5463 6826 8469 10416 12551 15030 17799
;; small program: loop(loop((compr((1 + loop(x + x, x, x)) mod (1 + x), x) + 1) * (1 + (x + x)), 1, y) + x, x, 2)
;; fast program: loop(loop(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, x) * 2) + 1) * (1 + (x + x)), 1, y) + x, x, 2)
(set-logic UFNIA)
