;; sequence(s): A175657
;; terms: 1 4 8 18 38 80 166 342 700 1426 2894 5856 11822 23822 47932 96330 193414 388048 778070 1559334
;; small program: loop(x + x, x, 1 + 2) - loop2(x + y, x, x, 2, 0)
;; fast program: ((1 + 2) * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - loop2(x + y, x, x - 1, 2, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (+ 1 2) (v2 x)) (w5 x)))))
