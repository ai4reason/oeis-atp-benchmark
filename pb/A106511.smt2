;; sequence(s): A106511
;; terms: 1 0 0 0 1 ~2 3 ~4 6 ~10 17 ~28 45 ~72 116 ~188 305 ~494 799 ~1292
;; small program: loop((x mod 2) + loop2(y - x, x, y, 1, 1), x, 2) div 2
;; fast program: ((loop2(y - x, x, x - 1, 0, 1) - (x mod (1 + 2))) div 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (- (w2 x) (mod x (+ 1 2))) 2) 1))))
