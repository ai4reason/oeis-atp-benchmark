;; sequence(s): A186350
;; terms: 1 3 5 7 8 10 11 12 14 15 16 18 19 20 22 23 24 25 27 28
;; small program: loop(loop(x + y, x, y) div x, x + x, 1) + x
;; fast program: loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + (x div (2 + (2 + 2))), x + x) + x
(set-logic UFNIA)
...
(assert (= h2 (+ 1 2)))
(assert (forall ((x Int)) (= (i2 x) (+ 2 (div x (+ 2 (+ 2 2)))))))
