;; sequence(s): A87447
;; terms: 1 1 4 10 24 56 128 288 640 1408 3072 6656 14336 30720 65536 139264 294912 622592 1310720 2752512
;; small program: loop(x + x, x - 1, 2 + x) div 2
;; fast program: loop(x + x, x - 2, loop(1, 2 - x, 2 + x))
(set-logic UFNIA)
