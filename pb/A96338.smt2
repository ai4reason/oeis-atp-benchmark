;; sequence(s): A96338
;; terms: 0 1 2 6 10 20 30 50 70 105 140 196 252 336 420 540 660 825 990 1210
;; small program: loop(loop(loop(x + y, y, x), y - (y div 2), x), x, 0)
;; fast program: (loop(loop(x + y, 1 + y, x), x div 2, 1) * loop2(1 + y, x, x, 0, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g1 x y) (- y (div y 2)))))
