;; sequence(s): A56326
;; terms: 0 1 2 5 9 19 35 71 135 271 527 1055 2079 4159 8255 16511 32895 65791 131327 262655
;; small program: ((loop(x + x, x, 1) + loop2(y + y, x, x, 1, 1)) div 2) - 1
;; fast program: loop(x div 2, 1 - (x mod 2), loop((x * x) + x, 1, loop(x + x, x div 2, 1))) - 1
(set-logic UFNIA)
