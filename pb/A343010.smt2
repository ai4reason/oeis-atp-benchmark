;; sequence(s): A343010
;; terms: 0 1 3 20 52 357 935 6408 16776 114985 301035 2063324 5401852 37024845 96932303 664383888 1739379600 11921885137 31211900499 213929548580
;; small program: loop(loop2(x + y, x, x, 0, 1) * loop2(x + y, x, x, 1, 0), 1, (x + x) - (x div 2)) div 2
;; fast program: loop(loop2(x + y, x, x - 1, 1, 1) * loop2(x + y, x, x - 2, 1, 1), 1, (x + x) - (x div 2)) div 2
(set-logic UFNIA)
...
(assert (= g3 1))
(assert (forall ((x Int)) (= (h3 x) (- (+ x x) (div x 2)))))
