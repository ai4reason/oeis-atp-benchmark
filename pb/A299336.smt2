;; sequence(s): A299336
;; terms: 1 3 10 22 49 91 168 280 462 714 1092 1596 2310 3234 4488 6072 8151 10725 14014 18018
;; small program: loop(loop(loop(loop(loop(x + y, y, x), y, x), y div 2, x), 2 + y, x), x, 1)
;; fast program: loop(loop(loop(((2 * (x + x)) div y) + x, y div 2, 1) + x, y, 1) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (+ (div (* 2 (+ x x)) y) x))))
