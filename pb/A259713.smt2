;; sequence(s): A259713
;; terms: 1 8 10 26 46 98 190 386 766 1538 3070 6146 12286 24578 49150 98306 196606 393218 786430 1572866
;; small program: loop2(y + y, x + y, x, 1, 2 + 2)
;; fast program: loop(2 * (2 + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)) * (1 + 2)) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h1 x) (* (v2 x) (+ 1 2)))))
