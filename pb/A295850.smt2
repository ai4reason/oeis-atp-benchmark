;; sequence(s): A295850
;; terms: 0 0 2 1 7 6 21 23 60 75 167 226 457 651 1236 1823 3315 5010 8837 13591
;; small program: loop2(x + y, x, x, 1, 2) - loop2(x + y, x - y, x, 1, 2)
;; fast program: loop2(x + y, x, x, 1, 2) - loop(x + x, x div 2, loop(1 + 2, x mod 2, 1))
(set-logic UFNIA)
