;; sequence(s): A269429
;; terms: 0 ~1 8 ~22 48 ~87 144 ~220 320 ~445 600 ~786 1008 ~1267 1568 ~1912 2304 ~2745 3240 ~3790
;; small program: loop(1 - x, x, ((2 + x) * x) * x) div 2
;; fast program: loop(1 - x, x mod 2, ((2 + x) * x) * x) div 2
(set-logic UFNIA)
