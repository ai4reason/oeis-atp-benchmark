;; sequence(s): A184
;; terms: 2 22 164 1030 5868 31388 160648 795846 3845020 18211380 84876152 390331292 1775032504 7995075960 35715205136 158401506118 698102372988 3059470021316 13341467466520 57918065919924
;; small program: loop(loop(((((loop(2 * (((x div y) + x) + x), y, 1) div (1 + y)) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1) * 2
;; fast program: loop((((loop(loop((loop(2 * (((x div y) + x) + x), y, 1) div (1 + y)) + (2 * (x + x)), x, 1), 1, y) + x) + x) + x) + x, x, 1) * 2
(set-logic UFNIA)
