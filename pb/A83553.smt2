;; sequence(s): A83553
;; terms: 2 8 24 60 120 192 288 396 616 840 1080 1440 1680 1932 2392 3016 3480 3960 4620 5040
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x, 1 + y, 2, 1, x)
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x, 1 + y, 2, 1, x)
(set-logic UFNIA)
