;; sequence(s): A275202
;; terms: 2 3 5 6 8 10 11 12 14 16 18 20 21 22 23 24 26 28 30 32
;; small program: loop(loop(1 + (loop(y, x - 2, x) div 2), x, y) + x, x, 2)
;; fast program: loop(loop((loop(x div loop(1, 2 + (2 - x), 2), 1 + (2 + 2), x) + 1) mod 2, 1, y) + x, x, 2) + x
(set-logic UFNIA)
