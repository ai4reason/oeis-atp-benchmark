;; sequence(s): A56122
;; terms: 1 17 125 605 2255 7007 19019 46475 104390 218790 432718 814606 1469650 2554930 4299130 7027834 11195503 17425375 26558675 39714675
;; small program: loop(loop((loop(2 + (x + y), 2, y) * x) div y, y, 1 + y) + x, x, 1)
;; fast program: loop(loop((((2 * ((x + x) + x)) + x) div y) + x, y, 1 + y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (h4 x y) (+ 1 y))))
