;; sequence(s): A169606
;; terms: 2 3 4 5 8 9 10 11 14 15 16 17 20 21 26 27 28 29 34 35
;; small program: compr(loop((loop(x * y, x, 2) - 1) mod (2 + x), 2, x) - 1, 2 + x)
;; fast program: (loop((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, 2 + x) - 1) - x, 1, x div 2) * 2) + x
(set-logic UFNIA)
