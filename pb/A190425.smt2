;; sequence(s): A190425
;; terms: 1 2 12 60 700 3780 51744 288288 4247100 24066900 369881512 2118412296 33466634656 193076738400 3109838832000 18037065225600 294718130342460 1716299700229620 28355714001615000 165657066009435000
;; small program: ((loop2(x * y, 1 + y, x - 1, 1, 1 + (x div 2)) div loop(x * y, x - 1, 1)) * loop2(x * y, 1 + y, x, 1, 1 + x)) div loop(x * y, x, 1)
;; fast program: (((loop2(x * y, 1 + y, x - 1, 1, 1 + (x div 2)) div loop(x * y, x - 1, 1)) * loop2(x * y, 1 + y, x - 1, 1, 2 + x)) div loop(x * y, x, 1)) * (1 + x)
(set-logic UFNIA)
...
(assert (= i0 1))
(assert (forall ((x Int)) (= (j0 x) (+ 1 (div x 2)))))
...
(assert (= i4 1))
(assert (forall ((x Int)) (= (j4 x) (+ 1 (div x 2)))))
...
(assert (forall ((x Int)) (= (fast x) (* (div (* (div (w4 x) (v5 x)) (w6 x)) (v7 x)) (+ 1 x)))))
