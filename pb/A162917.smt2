;; sequence(s): A162917
;; terms: 1 2 6 7 8 9 15 16 17 18 19 20 28 29 30 31 32 33 34 35
;; small program: compr(loop2(loop(x + y, x, y) div x, y, x, 1, x) mod 2, x)
;; fast program: loop2(loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x), 1, y) * x, y, 2, 1, x div 2) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (w3 x) x))))
