;; sequence(s): A249154
;; terms: 0 2 3 8 5 12 14 24 9 20 22 36 26 42 45 64 17 36 38 60
;; small program: (1 + x) * (loop2(x - y, y div 2, x, x, x) + x)
;; fast program: (1 + x) * loop2(x - y, y div 2, 2 + (2 + 2), x, x div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (+ 1 x) (+ (w0 x) x)))))
