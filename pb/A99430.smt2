;; sequence(s): A99430
;; terms: 1 0 4 6 16 30 64 126 256 510 1024 2046 4096 8190 16384 32766 65536 131070 262144 524286
;; small program: loop(x + x, x, 1) - (2 * (x mod 2))
;; fast program: loop((x - 2) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
