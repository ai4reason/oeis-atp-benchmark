;; sequence(s): A83336
;; terms: 3 3 9 12 33 45 123 168 459 627 1713 2340 6393 8733 23859 32592 89043 121635 332313 453948
;; small program: loop2(2 * (x + y), x, x, 1 + 2, 0) div loop2(y + y, x, x, 1, 1)
;; fast program: loop2((2 * (x + x)) - y, x, x div 2, 1, 1 - (x mod 2)) * (1 + 2)
(set-logic UFNIA)
