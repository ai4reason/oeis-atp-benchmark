;; sequence(s): A344
;; terms: 1 5 20 75 275 1001 3640 13260 48450 177650 653752 2414425 8947575 33266625 124062000 463991880 1739969550 6541168950 24647883000 93078189750
;; small program: (loop((2 + (2 + y)) * x, x + x, 1) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + (2 + 2))
;; fast program: (loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + (2 + 2)) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (div (v0 x) (v1 x)) (w2 x)))))
