;; sequence(s): A18621
;; terms: 1 3 13 19 39 57 247 741
;; small program: loop(compr(loop(((2 + x) * x) + (x div 2), 2, 2 + 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + (2 + loop(((x * x) * x) + x, 1, 1 + (2 * (2 + 2))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
