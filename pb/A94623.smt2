;; sequence(s): A94623
;; terms: 0 1 11 21 121 221 1221 2221 12221 22221 122221 222221 1222221 2222221 12222221 22222221 122222221 222222221 1222222221 2222222221
;; small program: 1 - loop2(2 * ((2 * (y + y)) + y), x - 2, x, 1, 0)
;; fast program: loop2(2 + (x * y), y, x div 2, 1 + (x mod 2), 2 + (2 * (2 + 2))) - 1
(set-logic UFNIA)
