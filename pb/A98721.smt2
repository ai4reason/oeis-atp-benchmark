;; sequence(s): A98721
;; terms: 1 1 6 100 3375 194481 17210368 2176782336 373669453125 83733937890625 23762680013799936 8335775831236199424 3543686674874777831491 1795856326022129150390625 1069932053790720000000000000
;; small program: loop2((x * y) + x, y, x - 1, 1, loop(x + y, x, x))
;; fast program: (loop2(x * y, y, x - 1, 1, 2 + x) * loop2(x * y, y, x - 1, 1, 1 + x)) div loop(x + x, x - 1, 1)
(set-logic UFNIA)
