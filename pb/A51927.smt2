;; sequence(s): A51927
;; terms: 3 1 7 13 35 81 199 477 1155 2785 6727 16237 39203 94641 228487 551613 1331715 3215041 7761799 18738637
;; small program: loop(0 - x, x, 1) + loop2(y, (x + y) + y, x, 2, 2)
;; fast program: 1 + loop(x - 2, x mod 2, loop2((x + x) + y, x, x - 1, 2, 2))
(set-logic UFNIA)
