;; sequence(s): A110528
;; terms: 1 10 37 162 681 2890 12237 51842 219601 930250 3940597 16692642 70711161 299537290 1268860317 5374978562 22768774561 96450076810 408569081797 1730726404002
;; small program: loop2((2 * (x + x)) + y, x, x, 2, 1) - loop(0 - x, x, 1)
;; fast program: loop2((2 * (x + x)) + y, x, x, 2, 1) - loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
