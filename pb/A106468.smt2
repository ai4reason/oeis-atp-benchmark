;; sequence(s): A106468
;; terms: 1 1 1 1 0 1 1 1 1 1 0 0 1 0 1 0 0 1 1 1
;; small program: ((loop((((loop(((loop(2 + (y div x), x + x, 2) mod 2) + x) + y, 2, x) + x) mod 2) + 1) + x, 2, x) - x) div 2) mod 2
;; fast program: (((loop((((loop((((loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2 + 2, x - 1) + 1) mod 2) + 1) + x, 2, x) + x) mod 2) + 2) + x, 2, x) - x) + 1) div 2) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ 2 (div y x)))))
(assert (forall ((x Int)) (= (g2 x) (+ x x))))
(assert (= h2 2))
(assert (forall ((x Int) (y Int)) (= (u2 x y) (ite (<= x 0) y (f2 (u2 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v2 x) (u2 (g2 x) h2))))
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (+ (mod (v2 x) 2) x) y))))
(assert (= g1 2))
...
(assert (forall ((x Int)) (= (small x) (mod (div (- (v0 x) x) 2) 2))))
...
(assert (forall ((x Int) (y Int)) (= (v6 x y) (u6 (g6 x) (h6 x y)))))
(assert (forall ((x Int) (y Int)) (= (f5 x y) (div (v6 x y) (+ 2 x)))))
(assert (forall ((x Int) (y Int)) (= (g5 x y) y)))
(assert (= h5 (+ 1 2)))
(assert (= i5 (+ 2 2)))
(assert (forall ((x Int)) (= (j5 x) (- x 1))))
...
(assert (forall ((x Int)) (= (f4 x) (+ (+ (mod (+ (w5 x) 1) 2) 1) x))))
(assert (= g4 2))
(assert (forall ((x Int)) (= (h4 x) x)))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int)) (= (v4 x) (u4 g4 (h4 x)))))
(assert (forall ((x Int)) (= (f3 x) (+ (+ (mod (+ (v4 x) x) 2) 2) x))))
(assert (= g3 2))
(assert (forall ((x Int)) (= (h3 x) x)))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 g3 (h3 x)))))
(assert (forall ((x Int)) (= (fast x) (- (div (+ (- (v3 x) x) 1) 2) 2))))
