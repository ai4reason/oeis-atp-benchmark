;; sequence(s): A26532
;; terms: 1 3 6 18 36 108 216 648 1296 3888 7776 23328 46656 139968 279936 839808 1679616 5038848 10077696 30233088
;; small program: loop((2 + (y mod 2)) * x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 2 + (2 + 2))
(set-logic UFNIA)
