;; sequence(s): A71556
;; terms: 8 78 1002 17018 323324 7436430 215656442 6685349672 247357937828 10141675450908 436092044389002 20496326086283048 1086305282573001492 64092011671807087970 3909612711980232366110 261944051702675568529304
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + y) * x) + x, 1 + x, 1) + 1
;; fast program: loop(loop((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, 2 + x) * 2) + 1, 1, y) * x, 1 + x, 1) + 1
(set-logic UFNIA)
