;; sequence(s): A94024
;; terms: 1 1 1 3 1 7 1 15 1 31 1 63 1 127 1 255 1 511 1 1023
;; small program: loop(loop2(y + y, x, y, 1, 1) - x, x, 1)
;; fast program: loop2(loop(x + x, y div 2, 2) - x, 0, x mod 2, 1, x)
(set-logic UFNIA)
...
(assert (= g2 0))
(assert (forall ((x Int)) (= (h2 x) (mod x 2))))
(assert (= i2 1))
