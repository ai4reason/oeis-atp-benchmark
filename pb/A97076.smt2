;; sequence(s): A97076
;; terms: 0 1 1 4 8 21 49 120 288 697 1681 4060 9800 23661 57121 137904 332928 803761 1940449 4684660
;; small program: loop(loop2((x + x) + y, x, y, 0, 1) - x, x, 0)
;; fast program: (loop2((x + x) + y, x, x - 1, 1, 1) div 2) + (x mod 2)
(set-logic UFNIA)
