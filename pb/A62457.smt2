;; sequence(s): A62457
;; terms: 2 9 125 2401 161051 4826809 410338673 16983563041 1801152661463 420707233300201 25408476896404831 6582952005840035281 925103102315013629321 73885357344138503765449
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + x, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + 1) * x, y, 1 + x, 1, 1 + x)
(set-logic UFNIA)
