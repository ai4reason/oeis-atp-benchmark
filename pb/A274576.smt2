;; sequence(s): A274576
;; terms: 0 0 0 0 1 0 1 0 2 1 2 0 3 1 3 0 4 2 4 1
;; small program: (loop(x div (1 + (x mod 2)), x, x) div 2) div 2
;; fast program: loop(loop(loop(loop(loop(1, x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2) div 2
(set-logic UFNIA)
