;; sequence(s): A174120
;; terms: 1 2 2 1 1 8 36 115 307 738 1662 3589 7541 15564 31752 64295 129575 260358 522178 1046105
;; small program: loop(x + x, x, 2) - loop((y * y) + x, x, 1)
;; fast program: (2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - loop((y * y) + x, x, 1)
(set-logic UFNIA)
