;; sequence(s): A85741
;; terms: 1 1 9 216 10000 759375 85766121 13492928512 2821109907456 756680642578125 253295162119140625 103510234140112521216 50714860157241037295616 29345269354638035222576971
;; small program: loop2(loop(x + y, y, 0) * x, y, x, 1, x)
;; fast program: loop2(loop2(x * y, y, y - 2, 1, x) * (x * x), x - 1, 1, if (x * x) <= 0 then 1 else (((x * x) + x) div 2), x)
(set-logic UFNIA)
...
(assert (= h2 1))
(assert (forall ((x Int)) (= (i2 x) (ite (<= (* x x) 0) 1 (div (+ (* x x) x) 2)))))
