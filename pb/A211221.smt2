;; sequence(s): A211221
;; terms: 1 3 4 9 12 27 36 81 108 243 324 729 972 2187 2916 6561 8748 19683 26244 59049
;; small program: loop2(1 + ((y mod x) + y), x + y, x, 1, 2)
;; fast program: if x <= 0 then 1 else loop2(x * y, y, (x - 1) div 2, loop(1 + 2, x mod 2, 2 + 2), 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ 1 (+ (mod y x) y)))))
