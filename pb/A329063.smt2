;; sequence(s): A329063
;; terms: 1 2 4 28 304888344611713860501504000028
;; small program: loop(loop(x * y, x, 1) + x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x, 1, 1 + x) * loop(x * y, x, 1), 1, x div 2) + x, x, 1)
(set-logic UFNIA)
