;; sequence(s): A186302
;; terms: 3 11 15 23 35 39 51 63 75 83 95 99 111 119 131 135 155 179 183 191
;; small program: compr(((loop(x + x, x, x mod 2) - 1) mod (1 + (x + x))) * (1 + x), 1 + x)
;; fast program: compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) + x) mod (1 + (x + x)), x mod 2, x), 1 + x)
(set-logic UFNIA)
