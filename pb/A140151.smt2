;; sequence(s): A140151
;; terms: 1 33 42 1066 1091 8867 8916 41684 41765 141765 141886 390718 390887 928711 928936 1977512 1977801 3867369 3867730 7067730
;; small program: loop(loop(loop2((x * y) + x, y, 2 + ((1 + 2) * (x mod 2)), 1, x), 1, y) + x, x, 1)
;; fast program: loop(loop(loop(x * x, x mod 2, loop(x * x, x mod 2, 1 + x)) * (1 + x), 1, y) + x, x, 1)
(set-logic UFNIA)
