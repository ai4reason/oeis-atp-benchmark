;; sequence(s): A162852
;; terms: 3 ~1 9 ~3 27 ~9 81 ~27 243 ~81 729 ~243 2187 ~729 6561 ~2187 19683 ~6561 59049 ~19683
;; small program: loop2((y - x) + y, x + y, x, 1 + 2, 1)
;; fast program: loop2(x * y, y, x div 2, 1 + loop(0 - 2, x mod 2, 2), 1 + 2)
(set-logic UFNIA)
