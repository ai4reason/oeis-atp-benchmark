;; sequence(s): A270059
;; terms: 1 1 3 3 3 4 4 5 5 6 6 7 7 8 8 9 9 10 10 11
;; small program: loop(loop(2 + y, y - x, x), x, 1)
;; fast program: ((loop(loop2(y, x - x, x, 1, 2), 1 + (2 - x), 1) + x) div 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (+ (v2 x) x) 2) 1))))
