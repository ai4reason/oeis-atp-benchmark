;; sequence(s): A236428
;; terms: 1 1 5 11 31 79 209 545 1429 3739 9791 25631 67105 175681 459941 1204139 3152479 8253295 21607409 56568929
;; small program: loop(loop2(x + y, x, y + y, 0, 2) - x, x, 1)
;; fast program: ((loop2(((x - y) + x) + x, x, x - 1, 2 + 2, 1) div (1 + (2 + 2))) * 2) + 1
(set-logic UFNIA)
