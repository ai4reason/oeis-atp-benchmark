;; sequence(s): A257273
;; terms: 2 5 14 44 152 560 2144 8384 33152 131840 525824 2100224 8394752 33566720 134242304 536920064 2147581952 8590131200 34360131584 137439739904
;; small program: loop2(((y * y) + x) + x, y + y, x, 2, 1)
;; fast program: loop(((2 + x) * x) + x, 1, loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) div 2
(set-logic UFNIA)
