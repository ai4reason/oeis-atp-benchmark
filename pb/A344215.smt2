;; sequence(s): A344215
;; terms: 0 0 2 15 76 325 1266 4655 16472 56745 191710 638275 2101188 6855485 22205834 71498775 229058224 730680145 2322163638 7356008555
;; small program: loop2(((x + x) + x) + y, y + y, x - 1, 0, x)
;; fast program: (loop2(x * y, y, (x - 1) div 2, loop(1, x mod 2, 1 + 2), 1 + (2 * (2 + 2))) - loop(x + x, x - 1, 1)) * x
(set-logic UFNIA)
