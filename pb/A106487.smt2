;; sequence(s): A106487
;; terms: 1 1 1 2 1 2 2 3 1 2 2 3 2 3 3 4 1 2 2 3
;; small program: loop2(x - y, y div 2, 2 + (2 + 2), if x <= 0 then 1 else x, x) + x
;; fast program: if x <= 0 then 1 else loop2(x - y, y div 2, 1 + (2 + 2), x, x div 2)
(set-logic UFNIA)
...
(assert (= h0 (+ 2 (+ 2 2))))
(assert (forall ((x Int)) (= (i0 x) (ite (<= x 0) 1 x))))
