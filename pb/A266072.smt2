;; sequence(s): A266072
;; terms: 1 1 1 5 1 9 1 13 1 17 1 21 1 25 1 29 1 33 1 37
;; small program: 1 + (x - loop(2 - x, x, x))
;; fast program: loop2((y - 1) + y, 0, x mod 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (- y 1) y))))
(assert (= g1 0))
