;; sequence(s): A179753
;; terms: 1 0 3 2 1 0 5 4 3 2 1 0 7 6 5 4 3 2 1 0
;; small program: (loop((x * x) + x, 1, loop(((y - x) div (x * x)) + x, x, 1)) - x) - 1
;; fast program: ((loop((1 - loop(x - (if x <= 0 then 0 else (1 + y)), x, x)) + x, 1, x div 2) * 2) - 1) - x
(set-logic UFNIA)
