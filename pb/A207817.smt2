;; sequence(s): A207817
;; terms: 1 12 840 92400 12612600 1955457504 329820499008 59064793444800 11062343605599000 2145275226626532000 427760079188506384320 87255985739923260973440 18139177035549431752363200 3831766983249199488516960000 820623729024838763928509760000
;; small program: loop2(loop(2 * ((x - (x div y)) + x), y, x) * x, y + y, 2, 1, x) div (1 + x)
;; fast program: ((((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 2 + x)) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 1 + ((x + x) + x))) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (div (* (div (w2 x) (v3 x)) (w4 x)) (v5 x)) (w6 x)) (v7 x)))))
