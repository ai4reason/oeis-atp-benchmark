;; sequence(s): A81625
;; terms: 1 7 41 223 1169 6007 30521 154063 774689 3886567 19472201 97479103 487749809 2439811927 12202248281 61020807343 305132734529 1525749766087 7629007110761 38145810394783
;; small program: loop2(((2 * (x + x)) + x) + y, (y + y) + y, x, 1, 2)
;; fast program: loop2(x * y, y, x, 2, 1 + (2 + 2)) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
