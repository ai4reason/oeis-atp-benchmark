;; sequence(s): A19628
;; terms: 1 23 369 5143 66977 841575 10367953 126315191 1529146113 18443562247 221980457777 2668373663319 32052757927009 384859080003239 4619891122628241 55449769683406327 665474773978915265
;; small program: loop((loop2(loop((2 + y) * x, 2, x) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
