;; sequence(s): A176423
;; terms: 3 6 9 10 12 14 15 16 18 20 21 22 24 25 26 27 28 30 32 33
...
(assert (forall ((x Int)) (= (f0 x) (mod (div (v1 x) (+ 2 2)) (+ 2 x)))))
...
(assert (forall ((x Int)) (= (f2 x) (mod (div (v3 x) (+ 2 2)) (+ 2 x)))))
