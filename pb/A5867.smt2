;; sequence(s): A5867
;; terms: 1 1 2 8 48 480 5760 92160 1658880 36495360 1021870080 30656102400 1103619686400 44144787456000 1854081073152000 85287729364992000 4434961926979584000 257227791764815872000 15433667505888952320000
;; small program: loop(compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x, x, 1)
;; fast program: loop(compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * x, x - 1, 1) * loop(x + x, x - 1, 1)
(set-logic UFNIA)
