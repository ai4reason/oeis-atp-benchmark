;; sequence(s): A69486
;; terms: 12 30 70 154 286 442 646 874 1334 1798 2294 3034 3526 4042 4982 6254 7198 8174 9514 10366
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, 1 + y, 2, 2, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + 1) * x, 1 + y, 2, 2, 1 + x)
(set-logic UFNIA)
