;; sequence(s): A78052
;; terms: 1 ~2 0 2 2 ~6 ~2 10 6 ~22 ~10 42 22 ~86 ~42 170 86 ~342 ~170 682
;; small program: loop(loop2(0 - y, x + x, y, 1, 1) - x, x, 1)
;; fast program: loop2(y + y, 1 - x, x, 1, 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
