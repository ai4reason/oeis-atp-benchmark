;; sequence(s): A238420
;; terms: 0 4 9 40 120 390 1176 3536 10395 30260 87120 248844 705744 1989820 5581485 15586720 43356936 120187026 332134440 915304520
;; small program: loop(loop2(x + y, x, y + y, 1, 0) - x, x, 0) * (1 + x)
;; fast program: (loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1)) - loop(0 - x, x mod 2, 1)) * (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- (v2 x) (v4 x)) (+ 1 x)))))
