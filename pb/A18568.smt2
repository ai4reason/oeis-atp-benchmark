;; sequence(s): A18568
;; terms: 1 3 5 15 43 129 215 645
;; small program: loop(compr(loop((2 + (2 + ((x * x) * x))) * x, 2, 1) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(((1 + 2) * (loop((x * x) * x, 1, 2 + (2 + 2)) - 1)) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
