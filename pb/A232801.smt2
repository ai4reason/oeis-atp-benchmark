;; sequence(s): A232801
;; terms: 0 1 1 3 4 9 13 27 40 81 121 243 364 729 1093 2187 3280 6561 9841 19683
;; small program: loop2(y, (x + x) + x, x, 1, 2) div 2
;; fast program: loop(x div 2, 1 - (x mod 2), loop2(x * y, y, x div 2, 1, 1 + 2))
(set-logic UFNIA)
