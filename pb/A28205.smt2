;; sequence(s): A28205
;; terms: 1 33 688 11598 172879 2380371 31036006 389148576 4740682837 56509956789 662486064604 7666900074834 87835709417275 998290939845687 11274360941128882 126686827598516772 1417790522653118593
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop(loop(loop((((loop2(x * y, y, x, 1, 1 + (2 + (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))) div 2) - loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) div 2, 1, 2 + x) div 2, 1, y) + (2 * ((x + x) + x)), x, 1)
(set-logic UFNIA)
