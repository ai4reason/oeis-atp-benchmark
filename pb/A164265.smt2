;; sequence(s): A164265
;; terms: 4 7 19 28 64 91 199 280 604 847 1819 2548 5464 7651 16399 22960 49204 68887 147619 206668
;; small program: loop2((y + y) + y, 1 + x, 1 + x, 2, 2) - 2
;; fast program: ((1 + 2) * loop2(1 + (x * y), y, x div 2, 2 + (x mod 2), 1 + 2)) - 2
(set-logic UFNIA)
