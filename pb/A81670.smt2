;; sequence(s): A81670
;; terms: 1 4 14 46 150 494 1652 5618 19430 68302 243804 882578 3235596 11994922 44899568 169466426 644127110 2462746382 9462555788 36507525266
;; small program: (loop((x + x) + x, x, 1) - 1) + loop(2 * ((x - (x div y)) + x), x, 1)
;; fast program: (loop(2 * ((x - (x div y)) + x), x, 1) - 1) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
