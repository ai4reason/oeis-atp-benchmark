;; sequence(s): A179893
;; terms: 3 6 9 15 18 24 27 33 42 45 54 60 63 69 78 87 90 99 105 108
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) div 2) * (1 + 2)
;; fast program: compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x) * (1 + 2)
(set-logic UFNIA)
