;; sequence(s): A297470
;; terms: 1 2 9 18 225 450 11025 22050 893025 1786050 108056025 216112050 18261468225 36522936450 4108830350625 8217660701250 1187451971330625 2374903942661250 428670161650355625 857340323300711250
;; small program: loop2((x * y) * y, 2 + y, x div 2, 1 + (x mod 2), 1 + 2)
;; fast program: loop2((y * y) * x, 2 + y, x div 2, 1 + (x mod 2), 1 + 2)
(set-logic UFNIA)
