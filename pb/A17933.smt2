;; sequence(s): A17933
;; terms: 1 18 225 2430 24381 234738 2205225 20404710 186995061 1703091258 15448694625 139763668590 1262226050541 11386154248578 102632111782425 924629361662070 8327306431726821 74979611075290698
;; small program: loop((x + x) + x, x, loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1))
;; fast program: ((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
