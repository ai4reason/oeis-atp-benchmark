;; sequence(s): A228698
;; terms: 7 23 119 839 9239 120119 2042039 38798759 892371479 25878772919 802241960519 29682952539239 1217001054108839 52331045326680119 2459559130353965639 130356633908760178919 7691041400616850556279 469153525437627883933079 31433286204321068223516359 2231763320506795843869661559
;; small program: ((loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, x, 2) * 2) * 2) - 1
;; fast program: loop(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x, 2 * (2 + 2)) - 1
(set-logic UFNIA)
