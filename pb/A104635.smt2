;; sequence(s): A104635
;; terms: 1 3 5 9 11 15 21 23 29 33 35 39 41 51 53 63 65 69 75 81
;; small program: compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x)
;; fast program: compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x)
(set-logic UFNIA)
