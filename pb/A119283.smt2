;; sequence(s): A119283
;; terms: 0 ~1 0 ~4 5 ~20 44 ~125 316 ~840 2185 ~5736 15000 ~39289 102840 ~269260 704909 ~1845500 4831556 ~12649205
;; small program: loop(loop(loop2(x + y, x, x, 1, 0) * loop2(y - x, x, x, 1, 1), 1, y) + x, x, 0) - x
;; fast program: loop(loop(loop(0 - x, x mod 2, loop(x * x, 1, loop2(x + y, x, x - 2, 1, 1))), 1, y) + x, x, 0)
(set-logic UFNIA)
