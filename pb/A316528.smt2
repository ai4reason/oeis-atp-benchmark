;; sequence(s): A316528
;; terms: 1 4 10 24 54 118 252 530 1102 2272 4654 9486 19260 38986 78726 158672 319318 641830 1288828 2586018
;; small program: loop((x + x) + loop2(x + y, x, y, 0, 2), x, 1)
;; fast program: ((1 + (2 + 2)) * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - loop2(x + y, x, x, 2 + 2, 2)
(set-logic UFNIA)
