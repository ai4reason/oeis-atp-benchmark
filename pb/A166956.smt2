;; sequence(s): A166956
;; terms: 0 ~1 3 5 15 29 63 125 255 509 1023 2045 4095 8189 16383 32765 65535 131069 262143 524285
;; small program: loop2(y, (x + x) + y, x, 2, 1) - 2
;; fast program: loop((x - 2) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1
(set-logic UFNIA)
