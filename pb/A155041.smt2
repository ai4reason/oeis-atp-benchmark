;; sequence(s): A155041
;; terms: 1 1 2 0 1 ~1 2 0 3 ~1 2 ~2 3 ~1 4 ~2 3 ~3 4 ~2
;; small program: loop(loop2(1 + (((y mod 2) + x) - y), x, y, 1, 0) - x, x, 1)
;; fast program: ((((loop(x div 2, x mod 2, 2 + x) - 1) div (1 + 2)) * 2) + 1) - (x div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (+ (* (div (- (v2 x) 1) (+ 1 2)) 2) 1) (div x 2)))))
