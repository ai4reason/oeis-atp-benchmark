;; sequence(s): A5056
;; terms: 1 4 12 34 96 274 792 2314 6816 20194 60072 179194 535536 1602514 4799352 14381674 43112256 129271234 387682632 1162785754
;; small program: loop2(((x - y) + x) + x, y + y, x, 2, 1) - 1
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (v1 x) 1) (w4 x)))))
