;; sequence(s): A27973
;; terms: 1 4 9 21 46 99 209 436 901 1849 3774 7671 15541 31404 63329 127501 256366 514939 1033449 2072676
;; small program: loop((x + loop2(y, x + y, y - 1, 2, 1)) + x, x, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - loop2(x + y, x, x, 1 + 2, 1)
(set-logic UFNIA)
