;; sequence(s): A41337
;; terms: 1 2 53 108 2861 5830 154441 314712 8336953 16988618 450041021 917070660 24293878181 49504827022 1311419380753 2672343588528 70792352682481 144257048953490 3821475625473221 7787208299899932
;; small program: loop2(((if (x mod 2) <= 0 then loop(1 + (x * x), 2, 2) else 2) * x) + y, x, x, 1, 0)
