;; sequence(s): A18091
;; terms: 1 23 370 5150 66451 819413 9810340 115087100 1330524901 15216894803 172615989910 1945847389850 21827965327351 243920416546193 2717439768299080 30200674142257400 334986945826585801
;; small program: loop(((loop(loop((x + x) + x, y + y, 1) + (loop((2 + y) * x, 2, x) - x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(((1 + 2) * (x * x)) - x, 1, loop2(x * y, y, x, 1, 1 + 2)) div 2, 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f6 x) (- (* (+ 1 2) (* x x)) x))))
(assert (= g6 1))
