;; sequence(s): A235536
;; terms: 1 4 140 7084 420732 27343888 1882933364 134993766600 9969937491420 753310723010608 57956002331347120 4524678117939182220 357557785658996609700 28545588568201512137904 2298872717007844035521848 186533392975795702301759056
;; small program: loop(loop2(x * y, y - 1, x - 1, 1, 2 * (x + x)) div loop(x * y, x, 1), 1, x + x)
;; fast program: loop(loop2(x * y, 1 + y, x - 1, 1, 2 + ((x + x) + x)) div loop(x * y, x, 1), 1, x + x)
(set-logic UFNIA)
...
(assert (= i4 1))
(assert (forall ((x Int)) (= (j4 x) (+ 2 (+ (+ x x) x)))))
