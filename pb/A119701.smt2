;; sequence(s): A119701
;; terms: 0 2 12 120 840 6300 44352 312312 2162160 14877720 101615800 690617928 4672781568 31503417400 211735414800 1419325308000 9492261518880 63355075266780 422102693073600 2807792411008200
;; small program: loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x, 0, x))
;; fast program: loop(2 * (((x div y) + x) + x), x - 1, if x <= 0 then 0 else loop2(x + y, x, x - 2, 2, 2))
(set-logic UFNIA)
