;; sequence(s): A302930
;; terms: 0 0 0 0 0 1 1 2 2 3 3 4 4 5 6 6 7 8 8 9
;; small program: loop(loop(y div (x - 2), x + x, 0) + x, 2, x)
;; fast program: loop((loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x div (2 + 2)) * (0 - 1)) + x, 2 + 2, x) + 1
(set-logic UFNIA)
