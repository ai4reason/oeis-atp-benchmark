;; sequence(s): A46994
;; terms: 1 3 8 17 38 78 164 332 680 1368 2768 5552 11168 22368 44864 89792 179840 359808 720128 1440512
;; small program: loop((loop((loop2(y, x + x, x, 2, 1) + 1) div 2, 1, y) + x) + x, x, 1)
;; fast program: loop((loop((loop(x + x, x div 2, loop(1, x mod 2, 2)) + 1) div 2, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
