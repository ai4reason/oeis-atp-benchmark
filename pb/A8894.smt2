;; sequence(s): A8894
;; terms: 36 18 9 26 13 38 19 56 28 14 7 20 10 5 14 7 20 10 5 14
;; small program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, loop(2 + (x * x), 2, 2) - 2)
;; fast program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, loop(x * x, 1, 2 + (2 + 2)))
(set-logic UFNIA)
