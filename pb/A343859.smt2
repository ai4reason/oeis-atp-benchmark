;; sequence(s): A343859
;; terms: 2 7 14 25 38 55 74 97 126 157 194 235 278 325 378 437 498 565 636 709
;; small program: loop(compr((1 + loop(2 * x, x, x)) mod (1 + x), y) + x, 1 + x, x)
;; fast program: (loop(compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, 1 + y) + x, x, 1) * 2) + x
(set-logic UFNIA)
