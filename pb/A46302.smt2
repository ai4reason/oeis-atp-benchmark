;; sequence(s): A46302
;; terms: 210 1155 5005 17017 46189 96577 215441 392863 765049 1363783 2022161 3065857 4391633 6319667 8965109 12780049 17120443 21182921 27433619 33984931
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, 1 + y, 2 + 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 2 + 2, 1, x)
(set-logic UFNIA)
