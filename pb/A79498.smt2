;; sequence(s): A79498
;; terms: 0 5 7 11 13 15 19 21 26 29 31 33 37 39 44 45 50 52 55 57
;; small program: loop(compr(loop2(x + y, y div (1 + 2), x, 0, x) mod (1 + 2), y), x, 0)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (mod (w3 x) (+ 1 2)) x) x) x))))
