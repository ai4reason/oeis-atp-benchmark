;; sequence(s): A53486
;; terms: 1 4 17 78 393 2208 13977 100026 806769 7280604 72865089 801693126 9620848953 125072630712 1751021612937 26265338542962 420245459734113 7144172944620084 128595113390582001 2443307155583319486
;; small program: loop((x * y) + loop((x + x) + x, y, 1), x, 1)
;; fast program: (loop((x * y) + loop2(x * y, y, y, 1, 1 + 2), x - 1, 1) * x) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
