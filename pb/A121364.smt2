;; sequence(s): A121364
;; terms: 0 0 1 2 3 6 10 18 29 50 81 136 220 364 589 966 1563 2550 4126 6710
;; small program: loop2(x + y, x, x, 1, 0) - loop2(x + y, x, x div 2, 1, 0)
;; fast program: loop2(x + y, x, x - 1, 1, 1) - loop2(x + y, x, (x div 2) - 1, 1, 1)
(set-logic UFNIA)
