;; sequence(s): A67994
;; terms: 1 0 ~2 0 12 0 ~120 0 1680 0 ~30240 0 665280 0 ~17297280 0 518918400 0 ~17643225600 0
;; small program: loop2(0 - (x * y), y - 1, x div 2, 1 - (x mod 2), x)
;; fast program: loop2(x * y, 1 + y, x div 2, 1 - (x mod 2), 0 - x)
(set-logic UFNIA)
