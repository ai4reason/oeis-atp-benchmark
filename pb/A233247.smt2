;; sequence(s): A233247
;; terms: 1 1 1 4 9 16 36 81 169 361 784 1681 3600 7744 16641 35721 76729 164836 354025 760384
;; small program: loop2(loop2(((y * y) + x) div (x + y), x + y, y, 1, 1) * x, y, 2, 1, x)
;; fast program: loop2(loop(loop2(((y * y) div (1 + x)) + x, x, x - 2, 2, 2) - 1, 1, y) * x, y, 2, 1, x)
(set-logic UFNIA)
