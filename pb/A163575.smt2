;; sequence(s): A163575
;; terms: 0 1 0 1 2 3 0 1 4 5 2 3 6 7 0 1 8 9 4 5
;; small program: loop(x div (1 + (x mod 2)), x, x div 2) + (x mod 2)
;; fast program: ((loop(loop(loop(loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, x div 2), x mod 2, x) div 2, x mod 2, x div 2), x mod 2, x div 2) - x, 1, x div 2) + x) * 2) - x
(set-logic UFNIA)
