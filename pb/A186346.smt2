;; sequence(s): A186346
;; terms: 3 5 7 9 11 12 14 15 17 18 20 21 23 24 25 27 28 29 31 32
;; small program: (1 + loop((y div (x div 2)) + (x div 2), x + x, 2)) + x
;; fast program: loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 1 + 2, x div (2 + 2)) + x, 2 + 2, x) - 1
(set-logic UFNIA)
