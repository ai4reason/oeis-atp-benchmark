;; sequence(s): A112032
;; terms: 4 1 8 2 16 4 32 8 64 16 128 32 256 64 512 128 1024 256 2048 512
;; small program: loop2(y, x + x, x, 2 + 2, 1)
;; fast program: loop(x + x, x div 2, loop(1, x mod 2, 2 + 2))
(set-logic UFNIA)
