;; sequence(s): A66983
;; terms: 1 1 1 3 3 7 9 17 25 43 67 111 177 289 465 755 1219 1975 3193 5169
;; small program: loop(loop2(x + y, x, y, 0, 2) - x, x, 1)
;; fast program: loop(2 + x, x mod 2, loop2(y, x + y, x, 2, 0)) - 1
(set-logic UFNIA)
