;; sequence(s): A55844
;; terms: 1 14 95 440 1595 4862 13013 31460 70070 145860 286858 537472 965770 1673140 2806870 4576264 7272991 11296450 17185025 25654200
;; small program: loop(loop(loop(loop((loop(((2 * (x + x)) div y) + x, y - 1, 1) * y) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop((loop(((2 * (x + x)) div y) + x, y - 1, 1) * y) + x, y, x), y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (div (* 2 (+ x x)) y) x))))
...
(assert (forall ((x Int) (y Int)) (= (f9 x y) (+ (div (* 2 (+ x x)) y) x))))
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ (* (v9 x y) y) x))))
