;; sequence(s): A1117
;; terms: 1 0 0 6 36 150 540 1806 5796 18150 55980 171006 519156 1569750 4733820 14250606 42850116 128746950 386634060 1160688606
;; small program: loop2((x - 2) + y, 2 * ((y - x) + y), x, 1, 1)
;; fast program: ((1 - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) * (1 + 2)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (- 1 (v1 x)) (+ 1 2)) (w4 x)))))
