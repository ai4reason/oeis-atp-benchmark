;; sequence(s): A1316
;; terms: 1 2 2 4 2 4 4 8 2 4 4 8 4 8 8 16 2 4 4 8
;; small program: loop2(((y mod 2) * x) + x, y div 2, x, 1, x)
;; fast program: loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), 1 + (x mod 2), x div 2)
(set-logic UFNIA)
