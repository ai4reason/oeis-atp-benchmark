;; sequence(s): A279245
;; terms: 1 2 4 6 12 20 40 64 128 208 416 672 1344 2176 4352 7040 14080 22784 45568 73728
;; small program: loop2(2 * (x + y), x + x, x div 2, 1 + (x mod 2), 1)
;; fast program: loop(x + x, x div 2, 1) * loop2(x + y, x, (x - 1) div 2, if x <= 0 then 1 else 2, 1)
(set-logic UFNIA)
