;; sequence(s): A265802
;; terms: 1 11 19 59 145 389 1009 2651 6931 18155 47521 124421 325729 852779 2232595 5845019 15302449 40062341 104884561 274591355
;; small program: loop(loop2(x + y, x, y + y, 2 + (2 + 2), 0) - x, x, 1)
;; fast program: ((((1 + 2) * loop(x * x, 1, loop2(x + y, x, x, 1, 2))) div (1 + (2 + 2))) * 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (div (* (+ 1 2) (v2 x)) (+ 1 (+ 2 2))) 2) 1))))
