;; sequence(s): A66440
;; terms: 0 1 0 1 4 3 2 1 0 1 9 9 9 11 9 1 9 9 9 1
;; small program: loop((x + x) + x, 2 + (x + x), 1) mod (1 + x)
;; fast program: loop(x * x, 1, (1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) mod (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h1 x) (* (+ 1 2) (w2 x)))))
