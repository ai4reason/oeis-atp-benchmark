;; sequence(s): A112553
;; terms: 1 1 ~1 ~2 0 2 1 ~1 ~1 0 0 0 1 1 ~1 ~2 0 2 1 ~1
;; small program: loop2(y, 0 - x, x, 0, 1) + loop2(x - y, x, x, 1, 1)
;; fast program: (loop2(x - y, x, x mod (2 + (2 + 2)), 1, 1) - loop(y, x mod (2 + 2), 2)) + 2
(set-logic UFNIA)
