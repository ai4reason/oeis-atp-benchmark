;; sequence(s): A265722
;; terms: 1 0 1 4 1 8 1 12 1 16 1 20 1 24 1 28 1 32 1 36
;; small program: x - loop(1 - x, x, x - 1)
;; fast program: loop2((y - 2) + y, 0, x mod 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (- y 2) y))))
(assert (= g1 0))
