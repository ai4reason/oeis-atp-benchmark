;; sequence(s): A102485
;; terms: 1 7 29 103 341 1087 3389 10423 31781 96367 291149 877543 2640821 7938847 23849309 71613463 214971461 645176527 1936053869 5809210183
;; small program: loop2((2 * (x + y)) + x, y + y, x, 1, 2)
;; fast program: ((1 + (2 + 2)) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (+ 1 (+ 2 2)) (w1 x)) (v3 x)))))
