;; sequence(s): A74532
;; terms: 3 11 45 197 897 4181 19785 94637 456417 2215781 10815225 53024477 260921937 1287820181 6371967465 31591352717 156882923457 780119453381 3883417004505 19348364759357
;; small program: loop2((y * y) + y, y + y, x, 2, 2) + loop((2 * (x + x)) + x, x, 1)
;; fast program: loop((x * x) + x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
