;; sequence(s): A163942
;; terms: 1 14 121 834 5037 27918 145777 728858 3526933 16640262 76952793 350167122 1572467389 6984206846 30735634369 134202204426 582040933605 2509672804470 10766469841705 45982221941570
;; small program: loop(((loop(loop2(((2 * (y * y)) - y) + x, y + y, y, 1, 2) + (2 * (x + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(((loop(loop(loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div (2 + (2 + 2)), 1, y) + (2 * (x + x)), y, 1) + x) + x) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (w2 x y) (* 2 (+ x x))))))
