;; sequence(s): A28180
;; terms: 1 29 530 7810 101451 1213359 13695340 148146020 1551618101 15847349089 158652680550 1562885008230 15193886293951 146104406183219 1392173613916160 13163974362722440 123666997751585001
;; small program: loop((loop((loop(loop((x + x) + x, y + y, 1) + (2 * (2 * (x + x))), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop(loop((((loop2(x * y, y, x, 1, 1 + (2 + 2)) + loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) div 2) - loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) div 2, 1, 2 + x) div 2, 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (v3 x y) (* 2 (* 2 (+ x x)))))))
