;; sequence(s): A157462
;; terms: 1 15 900 13500 810000 12150000 729000000 10935000000 656100000000 9841500000000 590490000000000 8857350000000000 531441000000000000 7971615000000000000 478296900000000000000 7174453500000000000000
;; small program: loop(loop((2 + (2 + y)) * x, 2, x), x, 1) div (1 + (x mod 2))
;; fast program: loop(x * x, 1, loop(x + x, x div 2, 1)) * loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)
(set-logic UFNIA)
