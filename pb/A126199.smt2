;; sequence(s): A126199
;; terms: 11 23 47 95 167 251 359 479 719 959 1215 1595 1847 2111 2591 3239 3719 4215 4895 5327
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + 2) * x, 1 + y, 2, 1, x) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 2) * x, 1 + y, 2, 1, x) - 1
(set-logic UFNIA)
