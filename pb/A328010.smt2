;; sequence(s): A328010
;; terms: 17 86 43 216 108 54 27 136 68 34 17 86 43 216 108 54 27 136 68 34
;; small program: loop(loop(2 + (2 * ((2 * (x + x)) + x)), x mod 2, x) div 2, x, 1 + loop(x * x, 2, 2))
;; fast program: loop(loop(2 + (2 * ((2 * (x + x)) + x)), x mod 2, x) div 2, x, 1 + (2 * (2 * (2 + 2))))
(set-logic UFNIA)
