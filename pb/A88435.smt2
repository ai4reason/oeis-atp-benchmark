;; sequence(s): A88435
;; terms: 3 2 2 1 2 3 2 1 3 2 1 2 2 3 2 1 3 2 2 1
;; small program: (((loop(((loop(x div (1 + (x mod 2)), x, x) div 2) + 1) mod 2, 1, x div 2) + x) mod 2) - ((x div 2) mod 2)) + 2
;; fast program: (((loop((loop(loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, x div 2), x mod 2, x) div 2, x mod 2, x div 2) + 1) mod 2, 1, x div 2) + x) mod 2) - ((x div 2) mod 2)) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (- (mod (+ (v0 x) x) 2) (mod (div x 2) 2)) 2))))
...
(assert (forall ((x Int)) (= (fast x) (+ (- (mod (+ (v2 x) x) 2) (mod (div x 2) 2)) 2))))
