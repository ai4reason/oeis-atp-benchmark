;; sequence(s): A74550
;; terms: 3 15 89 603 4433 34035 266969 2115723 16849313 134499555 1074849449 8594306043 68736785393 549824517075 4398319729529 35185460179563 281479314724673 2251817122694595 18014467616379209 144115464116024283
;; small program: loop((x + x) + x, x, 1) + loop(x + x, x + x, loop((x - 1) + x, x, 2))
;; fast program: loop((1 + x) * (x * x), 1, loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
