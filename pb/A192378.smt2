;; sequence(s): A192378
;; terms: 0 1 2 10 34 131 484 1812 6756 25221 94118 351262 1310918 4892423 18258760 68142632 254311752 949104393 3542105802 13219318834
;; small program: loop(loop(loop2(y, (2 * (y + y)) - x, y, 0, 1) - x, y, 0) - x, x, 0)
;; fast program: loop(loop((1 + loop2((2 * (x + x)) - y, x, x - 1, (if x <= 0 then 0 else (1 + 2)) + 2, 1)) div (2 + (2 + 2)), 1, y) - x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (div (+ 1 (w5 x)) (+ 2 (+ 2 2))))))
(assert (= g4 1))
