;; sequence(s): A138616
;; terms: 0 1 1 7 1 7 17 119 193 327 753 1175 2081 6375 3665 9271 32129 28295 66993 206807
;; small program: loop((2 * ((x + x) + x)) + x, x, 1) mod loop(x + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) mod loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
