;; sequence(s): A109534
;; terms: 1 2 4 5 9 6 12 9 17 10 20 13 25 14 28 17 33 18 36 21
;; small program: loop(loop(0 - x, y, x - 1) + y, x, 1) + x
;; fast program: x + loop2(y, 1 + x, (x - 1) mod (2 + 2), 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (mod (- x 1) (+ 2 2)))))
(assert (= i2 1))
