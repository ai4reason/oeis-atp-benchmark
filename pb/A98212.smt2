;; sequence(s): A98212
;; terms: 5 25 149 865 5045 29401 171365 998785 5821349 33929305 197754485 1152597601 6717831125 39154389145 228208503749 1330096633345 7752371296325 45184131144601 263352415571285 1534930362283105
;; small program: loop2(1 + y, (x + y) + y, 2 + (x + x), 2, 1) - (x mod 2)
;; fast program: ((((loop(x * x, 1, loop2((x + x) + y, x, x - 1, if x <= 0 then 1 else 2, 1)) * (1 + 2)) div 2) * 2) * 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (* (div (* (v1 x) (+ 1 2)) 2) 2) 2) 1))))
