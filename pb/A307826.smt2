;; sequence(s): A307826
;; terms: 1 1 4 24 240 2880 46080 829440 18247680 510935040 15328051200 551809843200 22072393728000 927040536576000 42643864682496000 2217480963489792000 128613895882407936000 7716833752944476160000 509311027694335426560000
;; small program: loop(compr((1 + loop((x + x) + x, x, x)) mod (1 + x), y) * x, x, 1)
;; fast program: loop(compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * x, x, 1) * loop(x + x, x - 1, 1)
(set-logic UFNIA)
