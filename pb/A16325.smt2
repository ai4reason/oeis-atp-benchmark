;; sequence(s): A16325
;; terms: 1 23 377 5395 71841 915243 11317657 136994195 1631936081 19201296763 223714264137 2585856904995 29694425953921 339138685491083 3855525540397817 43660780944367795 492768590388029361
;; small program: loop((loop2((2 * ((2 * (x + x)) + x)) + y, y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + (2 + 2), 1 + (2 + 2)) div 2) * loop(x + x, x - 1, 1), 1, y) + x) + ((((x + x) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (* (div (w5 x) 2) (v6 x)))))
(assert (= g4 1))
(assert (forall ((x Int) (y Int)) (= (h4 x y) y)))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int) (y Int)) (= (v4 x y) (u4 g4 (h4 x y)))))
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (+ (v4 x y) x) (* (+ (* (+ x x) 2) x) 2)))))
