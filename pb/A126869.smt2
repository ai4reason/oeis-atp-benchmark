;; sequence(s): A126869
;; terms: 1 0 2 0 6 0 20 0 70 0 252 0 924 0 3432 0 12870 0 48620 0
;; small program: loop((x * y) div (y - (y div 2)), x, 1 - (x mod 2))
;; fast program: loop(loop(2 * ((x - (x div y)) + x), x div 2, 1) + x, 1 - (x mod 2), x) - x
(set-logic UFNIA)
