;; sequence(s): A203778
;; terms: 2 ~48 40320 ~159667200 1743565824000 ~40548366802944000 1723467782592331776000 ~120987438337981690675200000 13052124847901464790040576000000 ~2050227771108362089219573678080000000 449688758403823707201064412255354880000000
;; small program: loop(x * y, 2 * (x + x), 2) div loop(0 - (x * y), x, 1)
;; fast program: loop2(x * y, 1 + y, (x + x) + x, 1, 1 + x) * loop(0 - x, x, 2)
(set-logic UFNIA)
