;; sequence(s): A18420
;; terms: 1 2 11 17 22 34 187 374
;; small program: loop(compr((loop(2 * ((2 * (2 * (2 + x))) + x), 2, 2) - 2) mod (1 + x), y), x, 0) + 1
;; fast program: (compr(loop((1 + (2 + (2 * (2 + 2)))) * (1 + x), 2, 2) mod (1 + x), x) + 1) div loop(1, 2, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (v3 x) 1) (v5 x)))))
