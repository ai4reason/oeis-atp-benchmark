;; sequence(s): A45720
;; terms: 1 9 57 312 1578 7599 35401 161052 719790 3173090 13836426 59803104 256596276 1094249019 4642178601 19605872724 82483419846 345839048094 1445715336366 6027524015664
;; small program: loop(loop(loop2((2 + (2 + y)) * x, 1 + y, x, 1, x) div loop(x * y, x, 1), 1, y) + (2 * (x + x)), x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x, 1, 2 + (2 + x)) div loop(x * y, x, 1), 1, y) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
