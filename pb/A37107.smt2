;; sequence(s): A37107
;; terms: 3 58 29 552 276 138 69 1312 656 328 164 82 41 780 390 195 3706 1853 35208 17604
;; small program: loop(loop(2 + (loop(2 + (x * x), 2, 2) * x), x mod 2, x) div 2, x, 1 + 2)
;; fast program: loop(loop(2 + ((2 + loop(x * x, 1, 2 + (2 + 2))) * x), x mod 2, x) div 2, x, 1 + 2)
(set-logic UFNIA)
