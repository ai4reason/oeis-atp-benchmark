;; sequence(s): A90993
;; terms: 8 14 24 42 72 126 216 378 648 1134 1944 3402 5832 10206 17496 30618 52488 91854 157464 275562
;; small program: 2 * loop2(x + y, (x - y) + x, x, 2 + 2, 1 + 2)
;; fast program: 2 * loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 2) + 2, 1 + 2)
(set-logic UFNIA)
