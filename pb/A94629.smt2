;; sequence(s): A94629
;; terms: 2 11 20 110 200 1100 2000 11000 20000 110000 200000 1100000 2000000 11000000 20000000 110000000 200000000 1100000000 2000000000 11000000000
;; small program: loop2(loop((x + x) + x, 2, y) + x, x - y, x, 2, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 * (2 + 2))), x mod 2, 2), 2 + (2 * (2 + 2)))
(set-logic UFNIA)
