;; sequence(s): A78358
;; terms: 1 3 4 5 7 8 9 10 11 13 14 15 16 17 18 19 21 22 23 24
;; small program: loop(((y div x) div x) + x, x, 1) + x
;; fast program: loop2(loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2, (x - 2) div 2) + (2 + y), x, 2, x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (w2 x) (+ 2 y)))))
