;; sequence(s): A90989
;; terms: 4 6 8 12 16 24 32 48 64 96 128 192 256 384 512 768 1024 1536 2048 3072
;; small program: 2 + loop2(2 + (y + y), x, x, 2, 1)
;; fast program: 2 * loop(x + x, x div 2, 2 + (x mod 2))
(set-logic UFNIA)
