;; sequence(s): A52208
;; terms: 0 1 12 175 2448 34481 485100 6826079 96049728 1351523425 19017374892 267594778639 3765344259600 52982414452241 745519146496332 10490250465629375 147609025664755968 2077016609773544641 29225841562491165900 411238798484657629039
;; small program: loop2(loop2((x + x) + y, x, y, 1, 0) - x, 2 + y, x, 0, x) div 2
;; fast program: loop(x * x, 1, loop2((x + x) + y, x, x, 0, 1)) * loop2(y, (x + y) + y, x, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g4 x y) (+ (+ x y) y))))
