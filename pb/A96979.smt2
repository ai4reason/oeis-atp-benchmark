;; sequence(s): A96979
;; terms: 0 1 6 36 210 1225 7140 41616 242556 1413721 8239770 48024900 279909630 1631432881 9508687656 55420693056 323015470680 1882672131025 10973017315470 63955431761796
;; small program: (loop(x * x, 1, loop2((x + x) + y, x, x, 1, 0)) div 2) div 2
;; fast program: loop(x * x, 1, loop2((x + x) + y, x, x - 1, if x <= 0 then 0 else 2, 1)) div (2 + 2)
(set-logic UFNIA)
