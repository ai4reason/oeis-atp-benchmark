;; sequence(s): A74558
;; terms: 3 18 122 882 6578 49818 380522 2922882 22548578 174591018 1356276122 10567438482 82561295378 646646418618 5076274366922 39931947947682 314707950326978 2484430456812618 19642812494812922 155514084423490482
;; small program: loop2(((2 * ((x + x) + x)) + ((y * y) * y)) + x, y + y, x, 2, 1) + loop((x + x) + x, x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
