;; sequence(s): A4119
;; terms: 1 4 7 13 25 49 97 193 385 769 1537 3073 6145 12289 24577 49153 98305 196609 393217 786433
;; small program: 1 + loop2(y, y + y, x, 0, 1 + 2)
;; fast program: (loop(x div 2, 1 - (x mod 2), loop(x * x, 1, loop(x + x, x div 2, 1))) * (1 + 2)) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (v1 x) (+ 1 2)) 1))))
