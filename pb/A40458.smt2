...
(assert (forall ((x Int)) (= (small x) (div (- (* (- (* (+ (* (- (v0 x) (mod x 2)) 2) 1) (ite (<= x 0) 1 2)) (mod x 2)) (+ 1 (+ 2 2))) 2) (+ 1 2)))))
(assert (= f1 (+ 2 (+ 2 2))))
(assert (forall ((x Int)) (= (g1 x) (- 1 (mod x (+ 2 2))))))
(assert (= h1 1))
(assert (forall ((x Int) (y Int)) (= (u1 x y) (ite (<= x 0) y f1))))
(assert (forall ((x Int)) (= (v1 x) (u1 (g1 x) h1))))
(assert (forall ((x Int)) (= (fast x) (div (- (* (- (* (+ (* (- (v1 x) (mod x 2)) 2) 1) (ite (<= x 0) 1 2)) (mod x 2)) (+ 1 (+ 2 2))) 2) (+ 1 2)))))
