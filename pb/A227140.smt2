;; sequence(s): A227140
;; terms: 0 1 1 3 1 5 3 7 1 9 5 11 3 13 7 15 1 17 9 19
;; small program: loop(x div (2 - (x mod 2)), 1 + (2 + 2), x)
;; fast program: loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, (x - 2) div 2), 1 - (x mod 2), x)
(set-logic UFNIA)
