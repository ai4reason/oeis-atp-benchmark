;; sequence(s): A139741
;; terms: 0 8 112 1304 14560 160808 1770832 19484984 214352320 2357928008 25937365552 285311493464 3138427845280 34522710549608 379749828800272 4177248155066744 45949729820525440 505447028370153608 5559917313104810992 61159090447252284824
;; small program: loop(loop((2 + y) * x, 2, x) - x, x, 1) - loop((x + x) + x, x, 1)
;; fast program: loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
