;; sequence(s): A138402
;; terms: 12 72 600 2352 14520 28392 83232 129960 279312 706440 922560 1872792 2824080 3416952 4877472 7887672 12113880 13842120 20146632 25406640
;; small program: loop2((loop(loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2, 1, x), 1, y) * x) - 1, y, 2, 1, x) + 1
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x), 1, y) * (x - 1), y, 2, 2, x)
(set-logic UFNIA)
