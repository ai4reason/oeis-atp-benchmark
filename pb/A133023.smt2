;; sequence(s): A133023
;; terms: 1 3 23 29 69 87 667 2001
;; small program: loop(compr((1 + loop((1 + (2 + 2)) * (x * x), 2, 2)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + (2 * loop((x * x) * x, 1, 2 + (2 * (2 + 2))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
