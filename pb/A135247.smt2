;; sequence(s): A135247
;; terms: 0 0 1 3 11 33 103 309 935 2805 8431 25293 75911 227733 683263 2049789 6149495 18448485 55345711 166037133
;; small program: loop(((x + loop2(y + y, x, y, 1, 0)) + x) + x, x, 0) div 2
;; fast program: loop(((loop(loop(loop(x + x, (x - 1) div 2, 1) + x, 1 - (x mod 2), x) - x, 1, y) + x) + x) + x, x, 0)
(set-logic UFNIA)
