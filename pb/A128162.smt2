;; sequence(s): A128162
;; terms: 0 0 1 0 3 1 3 9 31 34 37 81 137 347 487 690 355 1369 2001 1926
;; small program: loop((x + x) + x, 1 + x, 1) mod loop2(x + y, x, x, 1, 0)
;; fast program: ((1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) mod loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (* (+ 1 2) (w2 x)) (w4 x)))))
