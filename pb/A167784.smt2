;; sequence(s): A167784
;; terms: 1 0 4 2 16 14 64 74 256 350 1024 1562 4096 6734 16384 28394 65536 117950 262144 484922
;; small program: loop(x + x, x, 1) - loop2(y, (x + x) + x, x, 0, 2)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x * y, y, x div 2, loop(2, x mod 2, 0), 1 + 2)
(set-logic UFNIA)
