;; sequence(s): A46324
;; terms: 30030 255255 1616615 7436429 30808063 86822723 247110827 595973171 1348781387 2756205443 5037203051 9586934839 15805487167 25828479029 42647023513 66238993967 98733594781 138896412997 202652143553
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, 1 + y, 2 + (2 + 2), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 2 + (2 + 2), 1, x)
(set-logic UFNIA)
