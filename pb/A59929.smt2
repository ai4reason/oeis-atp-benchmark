;; sequence(s): A59929
;; terms: 0 2 3 10 24 65 168 442 1155 3026 7920 20737 54288 142130 372099 974170 2550408 6677057 17480760 45765226
;; small program: loop(loop2(x + y, x, y + y, 1, 0) - x, x, 0)
;; fast program: loop(2 + x, x mod 2, loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1))) - 1
(set-logic UFNIA)
