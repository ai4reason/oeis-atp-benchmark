;; sequence(s): A154383
;; terms: 1 0 4 2 16 8 64 32 256 128 1024 512 4096 2048 16384 8192 65536 32768 262144 131072
;; small program: loop2(y, 2 * (x + x), x, 2, 1) div 2
;; fast program: loop(x div 2, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
