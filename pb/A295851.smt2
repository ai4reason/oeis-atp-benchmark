;; sequence(s): A295851
;; terms: 0 ~1 2 1 9 10 31 41 96 137 281 418 795 1213 2200 3413 5997 9410 16175 25585
;; small program: loop2(2 + (x + y), x, x, 1, 0) - loop2(2 + y, x + x, x, 1, 2)
;; fast program: loop2(x + y, x, x, 1 + 2, 2) - loop(x + x, x - (x div 2), 1 + 2)
(set-logic UFNIA)
