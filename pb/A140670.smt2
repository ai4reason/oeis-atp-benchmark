;; sequence(s): A140670
;; terms: 1 1 1 3 1 1 1 7 1 1 1 3 1 1 1 15 1 1 1 3
;; small program: loop2(1 + (y mod (x + x)), y, x, 1, x) - (x mod 2)
;; fast program: (loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 2) + x, x mod 2, x) - x) + 1
(set-logic UFNIA)
