;; sequence(s): A126456
;; terms: 1 5 55 1330 58905 4187106 437353560 63140314380 12049276177620 2938311614386005 891655291709643461 329600203128234828790 145830232567505064233200 76102715775896720790887700
;; small program: loop2(x * y, y - 1, x, 1, loop(loop(x + y, 1 + y, x), x, 2)) div loop(x * y, x, 1)
;; fast program: loop2(x * y, y - 1, x, 1, 1 + loop((((x + x) + x) div y) + x, x, 1)) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j4 x) (+ 1 (v5 x)))))
