;; sequence(s): A157459
;; terms: 0 72 23256 7488432 2411251920 776415629880 250003421569512 80500325329753056 25920854752758914592 8346434730063040745640 2687526062225546361181560 865375045601895865259716752 278648077157748243067267612656 89723815469749332371794911558552
;; small program: loop(loop2(y, (2 * (y + y)) + x, 2 * (y + y), 0, 1) + x, x, 0)
;; fast program: loop(x * x, 1, loop2((2 * ((2 * (2 * (x + x))) + x)) - y, x, x, 1, 1)) div (2 + 2)
(set-logic UFNIA)
