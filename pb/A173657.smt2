;; sequence(s): A173657
;; terms: 4 7 15 37 99 277 795 2317 6819 20197 60075 179197 535539 1602517 4799355 14381677 43112259 129271237 387682635 1162785757
;; small program: 2 + loop2(((x - y) + x) + x, y + y, x, 2, 1)
;; fast program: 2 + (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
