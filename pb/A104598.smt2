;; sequence(s): A104598
;; terms: 1 10 68 394 2092 10516 50920 239962 1107836 5033020 22572376 100168260 440604088 1923626344 8344694224 35998921978 154546983580 660652406572 2813422792696 11940478362796
;; small program: loop(loop((((loop((2 * ((2 * (x * y)) - x)) div (1 + y), y, 2) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop((((loop(loop2(x * y, 1 + y, x - 1, 2, 2 + x) div loop(x * y, x, 1), 1, y) + x) + x) + x) + x, y, 1) + ((x + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (v4 x y) (* (+ x x) 2)))))
