;; sequence(s): A55796
;; terms: 1 5 16 42 98 210 420 792 1419 2431 4004 6370 9828 14756 21624 31008 43605 60249 81928 109802
;; small program: loop(loop(loop(loop(loop(x + y, y - 2, x), y, x) + y, y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop((loop((x * x) + x, 1, 2 + (((x * x) + x) div 2)) div (2 + (2 + 2))) + x, 1, y) + x, y, x), x, 1) + x
(set-logic UFNIA)
