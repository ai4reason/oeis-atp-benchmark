;; sequence(s): A175965
;; terms: 1 2 4 7 12 19 30 43 60 79 102 131 162 199 240 283 330 383 442 503
;; small program: loop(compr((2 - loop(x + x, x, 2)) mod (1 + x), y - 1) + x, x, 1) + x
;; fast program: loop(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + x, x - 1, 1) + x
(set-logic UFNIA)
