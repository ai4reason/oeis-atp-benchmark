;; sequence(s): A127223
;; terms: 1 1 12 60480 871782912000 129260083694424883200000 516657398319307246483332566876160000000 120690846038545150966716699071685590652292228448256000000000
;; small program: loop(x * y, x * x, 1) div loop(x * y, x, 1)
;; fast program: loop(loop(loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + (x * x)) * (1 + x), 1, y) * x, x - 1, 1)
(set-logic UFNIA)
