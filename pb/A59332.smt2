;; sequence(s): A59332
;; terms: 1 1 2 24 3456 9953280 859963392000 3120635156889600000 634153008009974906880000000 9278496603801318870491332608000000000 12218100099725239100847669366019325952000000000000 1769792823810713244721831122736499011207487815680000000000000000
;; small program: loop(loop((x * y) * y, y, x) div y, x, 1)
;; fast program: loop(x * x, 1, loop(loop(x * y, y, 1) * x, x - 1, 1)) * loop(x * y, x, 1)
(set-logic UFNIA)
