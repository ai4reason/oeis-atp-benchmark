;; sequence(s): A130236
;; terms: 0 1 4 8 13 18 24 30 36 43 50 57 64 71 79 87 95 103 111 119
;; small program: loop(loop((y div loop2(x + y, x, x, 1, 0)) + x, y, 1) + x, x - 1, x)
;; fast program: ((loop(loop((y div loop2(x + y, x, x, 1, 1)) + x, y, 1) + x, x - 1, x) + 1) + x) - (if x <= 0 then 1 else 2)
(set-logic UFNIA)
