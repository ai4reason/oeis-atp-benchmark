;; sequence(s): A14437
;; terms: 1 1 3 5 13 21 55 89 233 377 987 1597 4181 6765 17711 28657 75025 121393 317811 514229
;; small program: loop2(x + y, x, (x div 2) + x, 1, 0)
;; fast program: loop2((2 * (x + x)) + y, x, x div 2, 1, 1 - loop(0, x mod 2, 2))
(set-logic UFNIA)
