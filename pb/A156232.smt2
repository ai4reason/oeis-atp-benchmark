;; sequence(s): A156232
;; terms: 0 4 4 16 24 64 112 256 480 1024 1984 4096 8064 16384 32512 65536 130560 262144 523264 1048576
;; small program: loop(x + x, x, 2) - loop2(y + y, x, x, 2, 0)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2) - loop(0, x mod 2, 1))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h3 x) (- (v4 x) (v5 x)))))
