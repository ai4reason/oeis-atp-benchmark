;; sequence(s): A27266
;; terms: 1 6 18 72 180 648 1512 5184 11664 38880 85536 279936 606528 1959552 4199040 13436928 28553472 90699264 191476224 604661760
;; small program: loop((2 + (y mod 2)) * x, x, 1 + x)
;; fast program: loop((x + x) + x, x mod 2, loop2(x * y, y, x div 2, 1 + x, 2 + (2 + 2)))
(set-logic UFNIA)
