;; sequence(s): A16276
;; terms: 1 12 103 786 5713 40656 286651 2012862 14109205 98822460 691932319 4844053578 33909961177 237374494824 1661635779907 11631493440534 81420583092829 569944468808148 3989612443394215
;; small program: loop(((loop2(((2 * ((x + x) + x)) + x) + y, y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: (loop(loop2((x + x) + y, (2 * ((y + y) + y)) + y, x, 1, 1) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))), 1, 2 + x) div 2) div 2
(set-logic UFNIA)
