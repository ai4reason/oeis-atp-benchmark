;; sequence(s): A277598
;; terms: 2 7 12 17 20 22 27 32 37 42 47 52 57 62 67 70 72 77 82 87
;; small program: compr((((loop(x div loop(1, x mod (2 + (2 * (2 + 2))), ((2 + 2) * 2) + 2), x div (2 + 2), x) mod (1 + (2 + 2))) - 1) - 1) mod (1 + x), 1 + x)
;; fast program: compr(((((loop(x div loop(1, x mod (2 + (2 * (2 + 2))), 2 + (2 * (2 + 2))), x div (2 + (2 * (2 + (2 + 2)))), x) mod (1 + (2 + 2))) - 1) mod (1 + 2)) + 1) mod 2, x)
(set-logic UFNIA)
(declare-fun f2 () Int)
