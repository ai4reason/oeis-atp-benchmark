;; sequence(s): A212748
;; terms: 1 4 17 20 53 56 117 120 217 220 361 364 557 560 813 816 1137 1140 1537 1540
;; small program: loop2(loop(x + y, 1 + y, x), 1 + y, x, 1, 2 - (x mod 2))
;; fast program: loop2(2 + ((y * y) + x), 2 + y, x div 2, loop(1 + (2 + 2), x mod 2, 1), 2 + 2) - x
(set-logic UFNIA)
