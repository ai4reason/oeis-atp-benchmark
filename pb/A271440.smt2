;; sequence(s): A271440
;; terms: 2 7 56 743 30746 773527 49783736 1837403019 160181560802 29532404308019 1666577516860962 360777399719461393 45691067858241526814 3477439299142731351087 518913689466371066697746 147680787468230866751370317 43490064769447225534580532962
;; small program: loop2(((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + 1) + x, y, x, 2, x)
;; fast program: loop2((loop((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, x) * 2) + 1, 1, y) * x) + 1, y, x, 2, x)
(set-logic UFNIA)
