;; sequence(s): A292410
;; terms: 0 1 9 17 17 57 41 97 33 105 185 17 113 217 329 449 65 201 345 497
;; small program: loop(2 + (x mod y), 2 * ((x * x) + x), 1) - 1
;; fast program: loop2(((((1 + loop((x mod y) + y, x div (2 + 2), 0)) * (if (x - 1) <= 0 then 1 else 2)) * (if x <= 0 then 1 else 2)) - x) - x, 1, 2, (x * x) + x, 2)
(set-logic UFNIA)
