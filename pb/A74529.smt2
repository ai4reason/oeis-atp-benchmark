;; sequence(s): A74529
;; terms: 3 12 62 378 2498 17082 118442 825858 5771618 40373802 282535322 1977505938 13841822738 96890612922 678227872202 4747575891618 33232973681858 232630643258442 1628413985593082 11398896348158898
;; small program: loop2(((x - y) + x) + x, y + y, x, 2, 1) + loop((2 * ((x + x) + x)) + x, x, 1)
;; fast program: (loop(x + x, x, 1) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
