;; sequence(s): A113753
;; terms: 2 4 6 9 14 18 25 32 44 63 86 126 185 276 424 663 1046 1658 2651 4252
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), x) + 1) + loop2(x + y, x, x - 1, 1, 0)
;; fast program: ((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, x) * 2) + 1) + loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
