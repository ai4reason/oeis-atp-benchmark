;; sequence(s): A159918
;; terms: 0 1 1 2 1 3 2 3 1 3 3 5 2 4 3 4 1 3 3 5
;; small program: loop2((y mod 2) + x, y div 2, x + x, 0, x * x)
;; fast program: loop2(x - y, y div 2, x, x * x, (x * x) div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j1 x) (div (* x x) 2))))
