;; sequence(s): A45530
;; terms: 1 23 310 3195 27866 216566 1546028 10338515 65635570 399429602 2346750900 13384232030 74417751940 404759481420 2159510136408 11327603405955 58528412321250 298354368109930 1502525977613540
;; small program: loop(loop((((loop((((loop((((loop(((((loop(2 * (((x div y) + x) + x), y, 1) div (1 + y)) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop((((loop((((loop((((loop((((loop(loop2(x * y, 1 + y, x, 1, 2 + x) div loop(x * y, x, 1), 1, y) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (* 2 (+ (+ (div x y) x) x)))))
