;; sequence(s): A234933
;; terms: 0 0 0 0 2 8 24 62 148 336 738 1584 3344 6974 14412 29576 60370 122712 248616 502398
;; small program: (2 - loop2(x + y, x, x, 2, 2)) mod loop(x + x, x, 1)
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x + y, x, x, 2, 2)) + (if x <= 0 then 1 else 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (mod (- 2 (w0 x)) (v1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (- (v2 x) (w5 x)) (ite (<= x 0) 1 2)))))
