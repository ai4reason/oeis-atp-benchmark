;; sequence(s): A108754
;; terms: 1 1 1 1 3 5 9 13 19 29 39 53 69 85 103 125 151 177 207 239
;; small program: loop((loop(compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, x) - x, 1, y) * 2) + x, x, 1)
;; fast program: (((loop(compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) + x, x, 0) * 2) - x) + 1) - (x * x)
(set-logic UFNIA)
