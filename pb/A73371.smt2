;; sequence(s): A73371
;; terms: 1 2 7 16 41 94 219 492 1101 2426 5311 11528 24881 53398 114083 242724 514581 1087410 2291335 4815680
;; small program: loop(loop(loop(x + x, y, 1 + y) - x, y, 1) - x, x, 1)
;; fast program: loop((loop2(y - (x mod 2), (x + x) + y, y, 1, 1) + x) + x, x, 1)
(set-logic UFNIA)
