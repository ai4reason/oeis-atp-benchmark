;; sequence(s): A91024
;; terms: 0 1 2 7 19 56 160 462 1329 3828 11021 31735 91376 263108 757588 2181389 6281058 18085587 52075371 149945056
;; small program: loop(loop2(((((x * y) div (x + y)) + x) + x) + y, x + y, y, 0, 1) - x, x, 0)
;; fast program: loop(loop2(((((x * y) div (x + y)) + x) + x) + y, x + y, y - 1, 1, 1) - x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (+ (+ (div (* x y) (+ x y)) x) x) y))))
