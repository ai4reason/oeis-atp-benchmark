;; sequence(s): A136326
;; terms: 1 2 4 9 17 37 69 149 277 597 1109 2389 4437 9557 17749 38229 70997 152917 283989 611669
;; small program: loop2(1 + y, (((x mod y) + x) + x) + x, x, 1, 1)
;; fast program: (loop2(((2 + y) * x) + y, 2, x div 2, loop(1 + 2, x mod 2, 1), 1 + 2) + 1) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (+ (+ (+ (mod x y) x) x) x))))
