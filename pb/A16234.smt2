;; sequence(s): A16234
;; terms: 1 15 166 1650 15631 144585 1320796 11984820 108351661 977606355 8810664226 79357013190 714518294491 6432190529325 57897344158456 521114244398760 4690218934452121 42212924084385495
;; small program: loop((loop(1 + loop((x + x) + x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: (((loop(((loop2(x * y, y, x, 1, 1 + (2 * (2 + 2))) div 2) - loop2(x * y, y, x, 1, 1 + (2 + 2))) div 2, 1, 2 + x) div 2) div 2) div 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (div (- (div (w4 x) 2) (w5 x)) 2))))
(assert (= g3 1))
(assert (forall ((x Int)) (= (h3 x) (+ 2 x))))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 g3 (h3 x)))))
(assert (forall ((x Int)) (= (fast x) (+ (div (div (div (v3 x) 2) 2) 2) 1))))
