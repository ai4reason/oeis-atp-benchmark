;; sequence(s): A92387
;; terms: 5 9 20 49 125 324 845 2209 5780 15129 39605 103684 271445 710649 1860500 4870849 12752045 33385284 87403805 228826129
;; small program: 2 + loop2(x + y, x, 1 + (x + x), 1, 2)
;; fast program: loop(x * x, 1, loop2(x + y, x, x, 1, 2)) + loop(0, x mod 2, 2 + 2)
(set-logic UFNIA)
