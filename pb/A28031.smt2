;; sequence(s): A28031
;; terms: 1 24 385 5280 67441 833064 10129825 122282160 1471249681 17675304504 212209212865 2547054594240 30567440844721 366823482358344 4401953808801505 52823810060045520 633887559543412561
;; small program: loop(((loop((loop2(loop((2 + y) * x, 2, x) + (y * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x * x, 1, loop(x + x, x, 1)), 1, y) + x) + x) + x, y, 1) + ((x + x) * 2)) + x, x, 1)
(set-logic UFNIA)
