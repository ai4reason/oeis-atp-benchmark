;; sequence(s): A242278
;; terms: 0 6 18 72 216 702 2106 6480 19440 58806 176418 530712 1592136 4780782 14342346 43040160 129120480 387400806 1162202418 3486725352
;; small program: loop(((loop2((y + y) + y, x, y, 0, 2) + x) + x) + x, x, 0)
;; fast program: (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + 2) - 1) * loop2(x * y, y, x div 2, 1 + 2, 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- (w2 x) 1) (w4 x)))))
