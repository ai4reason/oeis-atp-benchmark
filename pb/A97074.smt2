;; sequence(s): A97074
;; terms: 1 1 5 9 21 41 85 169 341 681 1365 2729 5461 10921 21845 43689 87381 174761 349525 699049
;; small program: loop2((x + y) + y, x, x, 2, 0) - 1
;; fast program: loop(((x - 1) - 2) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (+ (- (- x 1) 2) x))))
