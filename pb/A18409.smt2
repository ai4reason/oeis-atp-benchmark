;; sequence(s): A18409
;; terms: 1 2 3 6 59 118 177 354
;; small program: loop(compr(loop((2 * (x * x)) + y, 2 + 2, 1) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 + loop((2 + ((x * x) + x)) * (x * x), 1, 2 + 2)) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
