;; sequence(s): A160385
;; terms: 0 1 1 1 1 2 2 2 1 2 2 2 1 2 2 2 1 2 2 2
;; small program: loop(loop2((((y div 2) + y) div 2) + x, (y div 2) div 2, x, 0, x) - x, 2, x)
;; fast program: loop(loop2((((y div 2) + y) div 2) + x, y div (2 + 2), x, 0, x) - x, 2, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (div (+ (div y 2) y) 2) x))))
