;; sequence(s): A94997
;; terms: 1 1 1 1 2 2 3 4 4 6 7 9 11 13 16 20 24 30 37 45
;; small program: loop(loop((2 + y) * x, 2, x) - x, x, 1) div loop((x + x) + x, x + x, 1)
;; fast program: (loop2(x * y, y, x - 1, 1, 1 + (2 + (2 * (2 + 2)))) * (if x <= 0 then 1 else (1 + (2 + (2 * (2 + 2)))))) div loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
