;; sequence(s): A288795
;; terms: 11 41 143 497 1751 6281 22943 85217 321191 1225721 4725743 18371537 71891831 282784361 1116788543 4424107457 17567289671 69881738201 278364691343 1109971980977
;; small program: loop((x + x) + x, 2 + x, 1) + loop(2 + (x + x), x + x, 2)
;; fast program: (((1 + 2) * loop2(x * y, y, x div 2, loop(1 + (2 * (2 + 2)), x mod 2, 1 + 2), 1 + (2 * (2 + 2)))) + loop(x * x, 1, loop(x + x, x, 2))) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (+ (* (+ 1 2) (w2 x)) (v4 x)) 2))))
