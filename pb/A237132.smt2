;; sequence(s): A237132
;; terms: 3 4 5 9 12 23 31 60 81 157 212 411 555 1076 1453 2817 3804 7375 9959 19308
;; small program: loop2(x + y, x, x, 2, 1) + loop2(y - x, x, x, 1, 2)
;; fast program: loop2(y - x, x, (x mod 2) + x, 1 + 2, (x mod 2) + 1)
(set-logic UFNIA)
...
(assert (= i2 (+ 1 2)))
(assert (forall ((x Int)) (= (j2 x) (+ (mod x 2) 1))))
