;; sequence(s): A159765
;; terms: 1 2 4 5 8 10 16 20 25 32 40 50 64 80 100 125 160 200 250 320
;; small program: compr(loop((loop(x * x, 2, x) * x) * x, 1, 2 + (2 * (2 + 2))) mod (1 + x), x) + 1
;; fast program: loop2(compr(loop((x * x) * x, 1, loop(x * x, 1, 2 + (2 * (2 + 2)))) mod (1 + x), y) + x, 0, x, 1, x)
(set-logic UFNIA)
