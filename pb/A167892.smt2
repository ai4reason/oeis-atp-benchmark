;; sequence(s): A167892
;; terms: 1 5 30 226 1990 19414 203455 2248355 25887399 307993015 3763786811 47032778955 598933188955 7751562502555 101741582076580 1351906409905480 18159677984049580 246298405721739580 3369517588450715680 46457194476711692080
;; small program: loop(loop2(loop((((1 + 2) * (x * y)) div (2 + y)) + x, y, x), y, 2, 1, y) + x, x, 1)
;; fast program: loop(loop((loop(x * x, 1, loop(2 * ((x - (x div y)) + x), x, 1)) div (1 + x)) div (1 + x), 1, y) + x, 1 + x, 0)
(set-logic UFNIA)
