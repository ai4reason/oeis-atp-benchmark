;; sequence(s): A26534
;; terms: 1 4 10 28 64 172 388 1036 2332 6220 13996 37324 83980 223948 503884 1343692 3023308 8062156 18139852 48372940
;; small program: loop2((2 * (2 + y)) + y, x + x, x, 1, 0)
;; fast program: loop2((x * y) - 1, y, x div 2, loop(1 + (2 + 2), x mod 2, 2), 2 + (2 + 2)) - 1
(set-logic UFNIA)
