;; sequence(s): A133529
;; terms: 38 83 195 339 579 819 1179 1731 2331 3171 4011 4899 5739 6867 8499 10011 11691 13251 14859 16611
;; small program: loop2(loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
(set-logic UFNIA)
