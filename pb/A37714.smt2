...
(assert (forall ((x Int)) (= (f2 x) (mod (+ 1 (+ x x)) (+ 1 (+ 2 2))))))
...
(assert (forall ((x Int)) (= (f3 x) (div (- (* (+ 1 (+ 2 (* 2 (+ 2 2)))) (w4 x)) 1) (+ 1 (* 2 (* 2 (+ 2 (* 2 (+ 2 2))))))))))
(assert (= g3 1))
(assert (forall ((x Int)) (= (h3 x) (+ 2 x))))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 g3 (h3 x)))))
(assert (forall ((x Int)) (= (fast x) (div (div (div (+ (div (div (v3 x) 2) (+ 1 2)) 2) 2) 2) 2))))
