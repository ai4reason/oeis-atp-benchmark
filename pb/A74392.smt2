;; sequence(s): A74392
;; terms: 2 1 5 5 12 16 30 45 77 121 200 320 522 841 1365 2205 3572 5776 9350 15125
;; small program: loop(loop2(1 + (x + y), x, y, 2, 0) - x, x, 2)
;; fast program: loop(0 - 2, x mod 2, 1) + loop2(x + y, x, x, 1, 2)
(set-logic UFNIA)
