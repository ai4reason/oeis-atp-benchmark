;; sequence(s): A214684
;; terms: 1 1 2 3 1 4 1 1 2 3 1 4 1 1 2 3 1 4 1 1
;; small program: loop2(1 + (y mod (2 + 2)), x + y, x, 1, 0)
;; fast program: loop2(y, x + y, x mod (1 + 2), loop(1 + 2, x mod 2, 1), 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ 1 (mod y (+ 2 2))))))
