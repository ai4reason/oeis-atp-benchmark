;; sequence(s): A100042
;; terms: 8 24 160 896 22528 106496 2228224 9961472 192937984 15569256448 66571993088 5085241278464 90159953477632 378231999954944 6614661952700416 477381560501272576 34011184385901985792
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), y, 2, 0, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x + x, x, 1), y, 2, 0, x)
(set-logic UFNIA)
