;; sequence(s): A52737
;; terms: 0 2 16 384 15360 860160 61931520 5449973760 566797271040 68015672524800 9250131463372800 1406019982432665600 236211357048687820800 43462889696958559027200 8692577939391711805440000 1877596834908609749975040000 435602465698797461994209280000
;; small program: loop2((2 * (x + x)) * y, 1 + y, x - 1, if x <= 0 then 0 else 2, x)
;; fast program: loop((x div 2) * x, 1, loop(x + x, x, 1)) * loop2(x * y, 1 + y, x - 1, 1, x)
(set-logic UFNIA)
