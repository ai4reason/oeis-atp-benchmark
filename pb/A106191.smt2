;; sequence(s): A106191
;; terms: 1 ~1 ~3 ~7 ~17 ~45 ~129 ~393 ~1251 ~4111 ~13835 ~47427 ~164999 ~581023 ~2066823 ~7415703 ~26805393 ~97520733 ~356810313 ~1312087713
;; small program: loop(loop((loop((x - 2) + x, 2, y) * x) div y, y, 1) + x, x, 1)
;; fast program: loop(loop(loop(2 * ((x - (x div y)) + x), x, 1) div ((1 - x) - x), 1, y) + x, x, 1)
(set-logic UFNIA)
