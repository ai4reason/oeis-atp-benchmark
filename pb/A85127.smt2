;; sequence(s): A85127
;; terms: 4 8 12 16 20 24 28 32 36 40 48 56 60 64 72 80 84 96 100 108
;; small program: ((compr(loop((1 + (2 + y)) * (x * x), 1 + (2 + 2), x) mod (1 + x), x) * 2) + 2) * 2
;; fast program: ((compr(loop((1 + (y + y)) * ((x * x) * x), 2 + 2, 2) mod (1 + x), x) * 2) + 2) * 2
(set-logic UFNIA)
