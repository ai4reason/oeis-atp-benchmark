;; sequence(s): A268382
;; terms: 0 1 2 3 4 4 5 6 7 7 7 7 8 8 9 10 11 11 11 11
;; small program: loop(loop((loop2(loop(x + y, y, x), y div 2, x, x, x) div 2) mod 2, 1, y) + x, x, 0)
;; fast program: loop(loop(((loop2(((y - x) mod 2) + x, y div 2, 1 + (2 + (2 + 2)), 0, x) + 1) div 2) mod 2, 1, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (mod (div (w2 x) 2) 2))))
(assert (= g1 1))
...
(assert (forall ((x Int)) (= (f5 x) (mod (div (+ (w6 x) 1) 2) 2))))
(assert (= g5 1))
