;; sequence(s): A99167
;; terms: 1 4 15 49 154 473 1437 4340 13067 39277 117954 354061 1062505 3188036 9564951 28696217 86090858 258276145 774834213 2324511988
;; small program: loop((x + x) + x, x, 2) - loop2(x + y, x, x, 1, 1)
;; fast program: loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - loop2(x + y, x, x, 1, 1)
(set-logic UFNIA)
