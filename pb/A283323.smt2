;; sequence(s): A283323
;; terms: 1 3 7 13 29 53 117 213 469 853 1877 3413 7509 13653 30037 54613 120149 218453 480597 873813
;; small program: (loop2(y + y, 2 * (2 + x), x, 1, 2) div 2) + 1
;; fast program: loop2(2 + (x * y), y, x div 2, loop(2 + 2, x mod 2, 1) + 2, 2 + 2) div 2
(set-logic UFNIA)
