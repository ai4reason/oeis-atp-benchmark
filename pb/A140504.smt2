;; sequence(s): A140504
;; terms: 5 6 8 12 20 36 68 132 260 516 1028 2052 4100 8196 16388 32772 65540 131076 262148 524292
;; small program: 2 + (2 + loop(x + x, x, 1))
;; fast program: 2 + (2 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))))
(set-logic UFNIA)
