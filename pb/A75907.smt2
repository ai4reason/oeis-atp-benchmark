;; sequence(s): A75907
;; terms: 1 40 1040 22400 435456 7956480 139694080 2387968000 40075329536 663887544320 10896534405120 177653730508800 2882307270639616 46596186764738560 751299029274460160 12089975328525516800
;; small program: loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, y, 1, 2) + x, x, 1) * loop(x + x, x + x, 1)
;; fast program: loop(loop(((loop(((x - 1) + x) * ((x * x) - x), 1, loop(x + x, x, 2)) div (1 + 2)) + 1) div 2, 1, y) + (2 * ((x + x) + x)), x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
