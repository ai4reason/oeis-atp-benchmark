;; sequence(s): A192872
;; terms: 1 0 3 4 13 30 81 208 547 1428 3741 9790 25633 67104 175683 459940 1204141 3152478 8253297 21607408
;; small program: loop(loop2(((x - y) + x) + x, 1 + x, y - 1, 1, 0) - x, x, 1)
;; fast program: ((((if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x - 1, 1 - 1, 2)) - 1) - (x mod 2)) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (- (* (ite (<= x 0) 0 (w2 x)) (w3 x)) 1) (mod x 2)) 2))))
