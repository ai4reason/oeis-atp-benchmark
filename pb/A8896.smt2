;; sequence(s): A8896
;; terms: 66 33 98 49 146 73 218 109 326 163 488 244 122 61 182 91 272 136 68 34
;; small program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, loop((2 * (x * x)) - x, 2, 2))
;; fast program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 2 + loop((x * x) * x, 1, 2 + 2))
(set-logic UFNIA)
