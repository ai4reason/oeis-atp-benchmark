;; sequence(s): A135620
;; terms: 1 2 8 32 512 2048 32768 131072 2097152 134217728 536870912 34359738368 549755813888 2199023255552 35184372088832 2251799813685248 144115188075855872 576460752303423488 36893488147419103232 590295810358705651712
;; small program: ((loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), x, 2, 0, x) div 2) div 2) div 2
;; fast program: ((loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x + x, x, 1), x, 2, 0, x) div 2) div 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (div (div (w0 x) 2) 2) 2))))
...
(assert (forall ((x Int)) (= (fast x) (div (div (div (w4 x) 2) 2) 2))))
