;; sequence(s): A186444
;; terms: 0 0 1 1 1 2 2 2 2 2 2 3 3 3 4 4 4 4 4 4
;; small program: x + loop2(y - x, (y - 2) div (1 + 2), 2 + 2, 1, x)
;; fast program: loop2(y - x, y div (1 + 2), 2 + 2, 1, 1 + x) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (div (- y 2) (+ 1 2)))))
(assert (= h0 (+ 2 2)))
(assert (= i0 1))
