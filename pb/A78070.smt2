;; sequence(s): A78070
;; terms: 1 ~3 4 ~3 1 0 1 ~3 4 ~3 1 0 1 ~3 4 ~3 1 0 1 ~3
;; small program: loop(loop2(0 - (x + y), x, y, 1, 1) - x, x, 1)
;; fast program: loop(1 + (2 + 2), (x mod (1 + 2)) - 1, 2) - (1 + ((x mod 2) * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (v2 x) (+ 1 (* (mod x 2) (+ 2 2)))))))
