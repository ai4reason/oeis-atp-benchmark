;; sequence(s): A183984
;; terms: 81 83 86 92 102 122 158 230 366 638 1166 2222 4302 8462 16718 33230 66126 131918 263246 525902
;; small program: ((loop(x + x, x div 2, 2 + (x mod 2)) - 2) + loop((2 + x) * x, 2, 2)) + loop(x + x, x, 1)
;; fast program: ((loop(x + x, x div 2, 2 + (x mod 2)) - 2) + loop((2 + x) * x, 2, 2)) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (+ (- (v0 x) 2) v1) (v2 x)))))
(assert (forall ((x Int)) (= (f3 x) (+ x x))))
(assert (forall ((x Int)) (= (g3 x) (div x 2))))
(assert (forall ((x Int)) (= (h3 x) (+ 2 (mod x 2)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (- (v3 x) 2) v4) (v5 x)))))
