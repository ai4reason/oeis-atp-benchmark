;; sequence(s): A153183
;; terms: 3 5 7 11 13 15 21 23 25 27 33 35 37 43 47 51 53 55 61 65
;; small program: compr(loop((2 - loop(x + x, x, 2)) mod (1 + x), 1, (x + x) + x), 1 + x) + 1
;; fast program: (compr(((loop(if (((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2) <= 0 then 1 else 2, 1, (x + x) + x) mod (1 + 2)) - 1) mod (1 + x), 1 + x) * 2) + 1
(set-logic UFNIA)
