;; sequence(s): A193643
;; terms: 1 7 19 67 217 721 2377 7855 25939 85675 282961 934561 3086641 10194487 33670099 111204787 367284457 1213058161 4006458937 13232434975
;; small program: loop(loop2(((x + x) + x) + y, x, y, 2, 2) - x, x, 1)
;; fast program: ((loop2(((x + x) + x) + y, x, x - 1, (if x <= 0 then 0 else 2) + 1, 1) + (x mod 2)) * 2) - 1
(set-logic UFNIA)
