;; sequence(s): A285197
;; terms: 1 1 2 6 20 67 221 717 2294 7258 22760 70863 219353 675769 2073674 6342414 19345052 58867195 178779893 542042565
;; small program: loop(((x - 1) + x) + x, x, 1) + loop2(y - x, x, x + x, 0, 1)
;; fast program: (1 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div 2)) - loop2(((x - y) + x) + x, x, x - 2, if (x - 1) <= 0 then x else (1 + 2), 1)
(set-logic UFNIA)
