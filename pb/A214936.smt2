;; sequence(s): A214936
;; terms: 1 1 2 4 12 36 108 324 1296 5184 20736 82944 331776 1327104 5308416 21233664 106168320 530841600 2654208000 13271040000
;; small program: loop(loop(loop(x div 2, x, y) + x, y, 0) * x, x, 1)
;; fast program: loop(loop(loop((loop(2 + ((x div y) + x), x, 1) + x) div (1 + x), 1, x div 2), 1, y) * x, x, 1)
(set-logic UFNIA)
