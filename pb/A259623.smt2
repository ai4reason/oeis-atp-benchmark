;; sequence(s): A259623
;; terms: 1 2 3 4 5 6 8 9 13 14 21 22 34 35 55 56 89 90 144 145
;; small program: loop(loop2(x + y, x, y, 2, 1), x div 2, 1) + (x mod 2)
;; fast program: loop(((if x <= 0 then 1 else loop2(x + y, x, x, 2, 1)) - x) - x, 1, x div 2) + x
(set-logic UFNIA)
