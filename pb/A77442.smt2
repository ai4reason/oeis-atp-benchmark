;; sequence(s): A77442
;; terms: 1 3 9 19 53 111 309 647 1801 3771 10497 21979 61181 128103 356589 746639 2078353 4351731 12113529 25363747
;; small program: (loop(loop2((x + x) + y, x, y - 1, 1, x mod 2) + x, x, 0) * 2) + 1
;; fast program: (loop2((x + x) + y, x, x, 1 + 2, 1) - loop2(y, x - (y + y), x, 1, 1)) div 2
(set-logic UFNIA)
