;; sequence(s): A85464
;; terms: 1 19 134 586 1919 5173 12124 25572 49677 90343 155650 256334 406315 623273 929272 1351432 1922649 2682363 3677374 4962706
;; small program: loop(loop(loop(x * x, 2, y) + x, y div 2, x), 2 + (x + x), 0)
;; fast program: loop(loop((((loop(loop((x + y) * x, 2, y) + x, x, 1) + x) * 2) - 1) - x, 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (- (- (* (+ (v5 x) x) 2) 1) x))))
(assert (= g4 1))
