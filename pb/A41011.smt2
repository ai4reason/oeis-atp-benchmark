;; sequence(s): A41011
;; terms: 1 1 5 6 29 35 169 204 985 1189 5741 6930 33461 40391 195025 235416 1136689 1372105 6625109 7997214
;; small program: loop2((x + x) + y, x, x, 1, 0) div (1 + (x mod 2))
;; fast program: loop2((2 * ((x + x) + x)) - y, x, x div 2, 1, 1 - (x mod 2))
(set-logic UFNIA)
