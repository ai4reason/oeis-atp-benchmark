;; sequence(s): A133020
;; terms: 1 2 4 5 8 10 16 20 25 40 50 80 100 125 200 250 400 500 625 1000
;; small program: loop(compr(loop(x * x, 2, 2 + (2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
;; fast program: (compr(loop(x * x, 1, loop(1 + ((2 + x) * x), 2, 2)) mod (1 + x), x) + 1) div (1 mod 2)
(set-logic UFNIA)
