;; sequence(s): A83719
;; terms: 0 1 6 18 44 90 174 294 472 702 1010 1430 1932 2574 3346 4230 5264 6494 7938 9538
;; small program: loop(compr((2 - loop(x + x, x, 2)) mod (1 + x), y - 1) + x, x, x) * x
;; fast program: loop(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + x, x - 1, x) * x
(set-logic UFNIA)
