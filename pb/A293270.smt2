;; sequence(s): A293270
;; terms: 1 1 12 270 8960 393750 21555072 1413199788 107961384960 9418192087590 923780000000000 100633991211229476 12055263261877075968 1575041416811693275900 222887966509090352332800 33962507149515380859375000 5543988061027763016035205120
;; small program: (loop(2 * ((x - (x div y)) + x), x, loop2(x * y, y, x, 1, x)) + 1) div 2
;; fast program: loop(2 * (((x div y) + x) + x), x - 1, 1) * loop2(x * y, y, x - 1, 1, x)
(set-logic UFNIA)
