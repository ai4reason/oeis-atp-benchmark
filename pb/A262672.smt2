;; sequence(s): A262672
;; terms: 3 2 2 1 4 3 3 2 5 4 4 3 6 5 5 4 7 6 6 5
;; small program: loop(loop2(y - 1, 2 + x, x, 2, y), 2, x)
;; fast program: (1 + (2 - (x mod (2 + 2)))) + ((2 + x) div (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ 1 (- 2 (mod x (+ 2 2)))) (div (+ 2 x) (+ 2 2))))))
