;; sequence(s): A167821
;; terms: 0 0 2 6 16 38 86 188 402 846 1760 3630 7438 15164 30794 62342 125904 253782 510758 1026684
;; small program: loop(x + x, x, 2) - loop2(x + y, x, x, 2, 2)
;; fast program: (2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - loop2(x + y, x, x, 2, 2)
(set-logic UFNIA)
