;; sequence(s): A134165
;; terms: 1 3 8 24 86 348 1478 6324 26846 112668 467798 1925124 7867406 31980588 129475718 522603924 2104600766 8461122108 33972973238 136278002724
;; small program: loop2((loop((x - 2) + y, y - 1, x) + x) + x, y + y, x, 1, 1)
;; fast program: ((loop(((2 + (2 + x)) * x) + x, 1, loop(x + x, x, 1)) div 2) - 1) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (div (v2 x) 2) 1) (w4 x)))))
