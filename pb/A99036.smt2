;; sequence(s): A99036
;; terms: 1 1 3 6 13 27 56 115 235 478 969 1959 3952 7959 16007 32158 64549 129475 259560 520107
;; small program: loop(x + x, x, 1) - loop2(x + y, x, x, 0, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (v2 x) (ite (<= x 0) 0 (w5 x))))))
