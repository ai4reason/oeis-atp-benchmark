;; sequence(s): A24675
;; terms: 4 6 9 12 15 18 21 26 30 34 39 42 45 50 56 60 64 69 72 76
;; small program: (loop2(compr((loop(x + x, x, 2) - 1) mod (2 + x), y) + x, 1 + y, 2, 1, x) div 2) + 2
;; fast program: loop2(compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, 1 + y) + x, 1 + y, 2, 1, x)
(set-logic UFNIA)
