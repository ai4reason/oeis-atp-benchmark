;; sequence(s): A3158
;; terms: 2 7 10 13 18 23 28 31 34 39 42 45 50 53 56 61 66 71 74 77
;; small program: compr(loop(if (x mod 2) <= 0 then ((x div 2) - x) else x, x, x), 1 + x) + x
;; fast program: (compr((loop(loop(x div loop(1, x mod (2 + 2), 2 + 2), 2, x), 1 - (x mod (2 + 2)), x) + 1) mod 2, x) * 2) + x
(set-logic UFNIA)
