;; sequence(s): A83920
;; terms: 0 0 1 1 2 3 3 4 5 6 6 7 8 9 10 10 11 12 13 14
;; small program: x - loop(y div (2 + x), x + x, 0)
;; fast program: ((loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2 + 2, x - 1) + 1) * (0 - 1)) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (+ (w1 x) 1) (- 0 1)) x))))
