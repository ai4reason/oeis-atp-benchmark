;; sequence(s): A66534
;; terms: 0 1 6 30 152 840 5232 37072 297600 2680704 26812160 294945024 3539364864 46011796480 644165265408 9662479226880 154599668154368 2628194359738368 47307498477649920 898842471080329216
;; small program: loop((x * y) + loop(x + x, y, y), x, 0) div 2
;; fast program: loop((x * y) + loop(x + x, y - 1, 2), x - 1, 1) * x
(set-logic UFNIA)
