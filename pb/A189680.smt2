;; sequence(s): A189680
;; terms: 2 6 10 12 16 20 22 26 30 32 36 40 44 46 50 54 56 60 64 66
;; small program: (loop(loop(x div 2, x, loop2(x + y, x, y, 1, 2)) + x, x, 1) + x) * 2
;; fast program: (((x + x) - ((x - (x div (2 * (2 + (2 + 2))))) div (1 + 2))) * 2) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (- (+ x x) (div (- x (div x (* 2 (+ 2 (+ 2 2))))) (+ 1 2))) 2) 2))))
