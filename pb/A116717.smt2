;; sequence(s): A116717
;; terms: 1 2 5 12 26 52 98 177 310 531 895 1491 2463 4044 6611 10774 17520 28446 46136 74771
;; small program: loop(loop(loop2(x + y, x, y, 1, 1) + x, y, x) - y, x, 1)
;; fast program: loop((loop2(x + y, x, x, 1 + 2, 2) - (((x * x) + x) div 2)) - x, 1, 2 + x) - 2
(set-logic UFNIA)
