;; sequence(s): A115008
;; terms: 1 0 2 4 5 7 13 22 34 54 89 145 233 376 610 988 1597 2583 4181 6766
;; small program: loop2(x + y, x, x, 1, 0) + loop2(0 - y, x, x, 0, 1)
;; fast program: (loop(y, x mod (2 + 2), 2) - 2) + loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
