;; sequence(s): A109664
;; terms: 1 2 8 48 384 4608 64512 1161216 23224320 557383680 16721510400 535088332800 20333356646400 854000979148800 37576043082547200 1803650067962265600 97397103669962342400 5843826220197740544000
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y - 1) + 2) * x, x, 1)
;; fast program: loop((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * x) + x, x - 1, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
