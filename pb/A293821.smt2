;; sequence(s): A293821
;; terms: 1 1 2 4 6 10 12 20 23 35 38 56 60 84 88 120 125 165 170 220
;; small program: loop(loop(loop(x * x, x mod 2, 1 + (x div 2)), 1, y) + x, x, 2) div 2
;; fast program: loop(loop(loop(x * x, x mod 2, x div 2), 1, y) + x, 2 + x, 1) div 2
(set-logic UFNIA)
