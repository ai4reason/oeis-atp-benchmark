;; sequence(s): A177500
;; terms: 1 2 3 4 6 7 8 9 12 14 16 18 21 24 28 32 36 42 48 56
;; small program: loop(compr((2 * loop(((2 * (2 + (x + x))) + x) * x, 2, 2)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 * loop((((x * x) * x) - x) * x, 1, 2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
