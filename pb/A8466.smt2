;; sequence(s): A8466
;; terms: 0 0 1 3 8 19 43 94 201 423 880 1815 3719 7582 15397 31171 62952 126891 255379 513342
;; small program: loop(x + x, x, 1) - loop2(x + y, x, x, 1, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x + y, x, x, 1, 1)
(set-logic UFNIA)
