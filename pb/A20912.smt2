;; sequence(s): A20912
;; terms: 1 1 1 1 2 2 2 3 3 3 4 4 4 5 5 5 6 6 7 7
;; small program: loop(loop((x div 2) div 2, x, loop2(x + y, x, y, 1, 0)) + x, x, 1)
;; fast program: ((((1 + (((x div (2 + (2 + 2))) + x) div (1 + 2))) + x) div 2) + 1) div (if x <= 0 then 1 else 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (div (+ (+ 1 (div (+ (div x (+ 2 (+ 2 2))) x) (+ 1 2))) x) 2) 1) (ite (<= x 0) 1 2)))))
