;; sequence(s): A140796
;; terms: 1 5 14 44 128 392 1160 3512 10472 31544 94376 283640 849896 2551736 7651112 22961528 68868200 206637368 619846568 1859670776
;; small program: loop2(2 * ((x + y) + y), x - y, x, 1 + 2, 1) div 2
;; fast program: loop2(2 * ((x + y) + y), x - y, x - 1, (if x <= 0 then 0 else (2 + 2)) + 1, 1)
(set-logic UFNIA)
