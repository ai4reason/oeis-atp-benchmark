;; sequence(s): A7039
;; terms: 2 2 2 6 12 20 30 46 74 122 200 324 522 842 1362 2206 3572 5780 9350 15126
;; small program: loop2(x + y, x, x, 1, 2) + loop2(x - y, x, x, 1, 2)
;; fast program: loop2(x - y, x, x mod (2 + (2 + 2)), 1, 2) + loop2(x + y, x, x, 1, 2)
(set-logic UFNIA)
