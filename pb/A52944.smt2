;; sequence(s): A52944
;; terms: 0 2 5 10 19 36 69 134 263 520 1033 2058 4107 8204 16397 32782 65551 131088 262161 524306
;; small program: (loop(x + x, x, 1) - 1) + x
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) + x
(set-logic UFNIA)
