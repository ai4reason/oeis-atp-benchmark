;; sequence(s): A55591
;; terms: 0 1 4 85 35917545547686059365808220080151141317128
;; small program: loop(loop((x + x) + x, x, 1) + x, x, 0)
;; fast program: loop(x + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))), x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (+ x (w3 x)))))
