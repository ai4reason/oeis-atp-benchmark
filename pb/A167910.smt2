;; sequence(s): A167910
;; terms: 0 0 1 3 13 39 133 399 1261 3783 11605 34815 105469 316407 953317 2859951 8596237 25788711 77431669 232295007
;; small program: (loop(((loop2(y + y, x + x, y, 1, 0) + x) + x) + x, x, 0) div 2) div 2
;; fast program: (loop2(((x + y) + y) + y, x + x, x - 1, 1, 1) - loop(x + x, x - 1, 1)) div 2
(set-logic UFNIA)
