;; sequence(s): A98647
;; terms: 1 12 224 4608 96256 2015232 42205184 883949568 18513657856 387755016192 8121246285824 170093589823488 3562486393470976 74613683694600192 1562729279488262144 32730226951263879168
;; small program: loop2(y, 2 * ((x + x) + y), x + x, 1, 1) * loop(x + x, x, 1)
;; fast program: (loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2) * loop((x * x) * x, 1, loop(x + x, x, 1))) div 2
(set-logic UFNIA)
