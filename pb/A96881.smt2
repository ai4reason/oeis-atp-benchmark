;; sequence(s): A96881
;; terms: 1 4 17 68 289 1156 4913 19652 83521 334084 1419857 5679428 24137569 96550276 410338673 1641354692 6975757441 27903029764 118587876497 474351505988
;; small program: loop2((2 * (x + x)) + y, if y <= 0 then x else 0, x, 1, 0)
;; fast program: loop2(x * y, y, x div 2, loop(2 + 2, x mod 2, 1), 1 + (2 * (2 * (2 + 2))))
(set-logic UFNIA)
