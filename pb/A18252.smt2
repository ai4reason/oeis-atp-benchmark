;; sequence(s): A18252
;; terms: 1 4 6 8 9 10 12 14 15 16 18 20 21 22 24 25 26 27 28 30
;; small program: loop(compr(loop(x * y, x, 2) mod (2 + x), y) + 2, x, 1)
;; fast program: compr(loop((if (loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, x div 2, x) mod (1 + x), x) + 1
(set-logic UFNIA)
