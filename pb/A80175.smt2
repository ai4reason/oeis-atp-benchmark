;; sequence(s): A80175
;; terms: 625 28561 83521 707281 1874161 2825761 7890481 13845841 28398241 62742241 88529281 104060401 141158161 163047361 352275361 492884401 607573201 895745041 1073283121 1387488001
;; small program: loop2(loop(compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), 1 - (x mod (2 + 2)), x) - 1, 2 + x) + 1, 1, y) * x, y, 2 + 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), (1 + (x div 2)) mod 2, x) - 2, 1 + y) + 1) * x, y, 2 + 2, 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (mod (w4 x) (+ 1 x)))))
(assert (forall ((x Int)) (= (g3 x) (- 1 (mod x (+ 2 2))))))
...
(assert (forall ((x Int)) (= (g7 x) (mod (+ 1 (div x 2)) 2))))
