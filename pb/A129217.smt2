;; sequence(s): A129217
;; terms: 1 0 55 440 6435 88088 1326325 21209760 360590230 6490575520 123321027258 2466420377200 51794828215130 1139486220235440 26208183066232310 628996393588267936 15724909839708741375
;; small program: loop((x * y) + loop(0 - x, y, 1), x, 1) * loop((loop((x + x) + x, 2, x) div y) + x, x, 1)
;; fast program: (loop((x * y) + loop(0 - x, y, 1), x, 1) * loop2(x * y, 1 + y, x, 1, 2 + (2 * (2 + 2)))) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (v4 x) (w6 x)) (v7 x)))))
