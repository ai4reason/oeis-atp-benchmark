;; sequence(s): A99628
;; terms: 2 4 5 8 9 11 16 17 19 23 32 33 35 39 47 64 65 67 71 79
;; small program: compr((if loop(loop((2 + x) mod y, x, 1), 2, x) <= 0 then 1 else x) - 1, 2 + x) - 1
;; fast program: ((compr((((loop2(((y mod 2) * x) + x, y div 2, 2 * (2 + (2 + 2)), 1, x) - 1) div 2) - 1) mod (1 + x), 1 + x) - 1) - 2) + 2
(set-logic UFNIA)
