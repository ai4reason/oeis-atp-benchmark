;; sequence(s): A122012
;; terms: 0 3 3 7 9 18 24 47 63 123 165 322 432 843 1131 2207 2961 5778 7752 15127
;; small program: loop2(1 + y, x + y, x, x mod 2, 2)
;; fast program: loop2(y, x + y, x, x mod 2, 1 + 2)
(set-logic UFNIA)
