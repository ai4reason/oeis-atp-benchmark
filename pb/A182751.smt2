;; sequence(s): A182751
;; terms: 1 3 6 9 18 27 54 81 162 243 486 729 1458 2187 4374 6561 13122 19683 39366 59049
;; small program: if x <= 0 then 1 else loop2((y + y) + y, x, x, 2, 1)
;; fast program: if x <= 0 then 1 else loop2(x * y, y, x div 2, 2 + (x mod 2), 1 + 2)
(set-logic UFNIA)
