;; sequence(s): A255459
;; terms: 1 5 25 101 361 1205 3865 12101 37321 114005 346105 1046501 3155881 9500405 28566745 85831301 257756041 773792405 2322425785 6969374501
;; small program: 1 + loop2((2 * (x + y)) + x, 2 + (y + y), x, 0, 2)
;; fast program: (((loop2(x * y, y, x div 2, loop(1 + (2 * (2 + 2)), x mod 2, 1 + 2), 1 + (2 * (2 + 2))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2)))) * 2) + 1) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (* (- (w1 x) (v3 x)) 2) 1) 2))))
