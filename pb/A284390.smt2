;; sequence(s): A284390
;; terms: 3 6 7 8 11 14 17 18 19 22 23 24 27 28 29 32 35 38 39 40
;; small program: (compr(loop(if (x mod 2) <= 0 then ((x div 2) - x) else x, x, x), 1 + x) - x) + 1
;; fast program: (compr(loop((if (x mod 2) <= 0 then 2 else x) div 2, 1 + (2 + (2 * (2 * (2 + 2)))), x), x) - x) + 2
(set-logic UFNIA)
