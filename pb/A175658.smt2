;; sequence(s): A175658
;; terms: 1 4 10 26 66 166 414 1026 2530 6214 15214 37154 90546 220294 535230 1298946 3149506 7630726 18476494 44714786
;; small program: loop2((x + x) + y, x, x, 2, 2) - loop(x + x, x, 1)
;; fast program: loop2((x + x) + y, x, x, 2, 2) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
