;; sequence(s): A42134
;; terms: 24 73 3528 10657 515064 1555849 75195816 227143297 10978074072 33161365513 1602723618696 4841332221601 233986670255544 706801342988233 34160451133690728 103188154744060417 4987191878848590744
;; small program: loop2(loop((2 + y) * x, 2, x) + y, x, x, 2 + (2 + 2), 1) * loop(1, x mod 2, 2 + 2)
;; fast program: loop2((2 * (2 * ((x + x) + x))) + y, x, x, 2 + (2 + 2), 1) * loop(1, x mod 2, 2 + 2)
(set-logic UFNIA)
