;; sequence(s): A28082
;; terms: 1 29 547 8561 121219 1617833 20812219 261490097 3235181587 39620718137 481957803691 5836292549633 70462254871555 848987132460041 10215522905076763 122808633740991569 1475488118109230323
;; small program: loop(loop(loop2(((2 * (y * y)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop(loop(((loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div 2) div (1 + 2)) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
