;; sequence(s): A81250
;; terms: 1 3 11 33 101 303 911 2733 8201 24603 73811 221433 664301 1992903 5978711 17936133 53808401 161425203 484275611 1452826833
;; small program: loop(1 + ((x + x) + x), x, 2) div 2
;; fast program: loop((x div (2 + 2)) + x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
