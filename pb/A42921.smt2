;; sequence(s): A42921
;; terms: 1 2 125 252 15749 31750 1984249 4000248 249999625 503999498 31497968501 63499936500 3968494031501 8000487999502 499998750000625 1007997988000752 62995874006047249 126999746000095250 7936980126011952749 16000959998024000748
;; small program: loop2((loop(2, x mod 2, loop(2 + (x + x), 2 + 2, 2)) * x) + y, x, x, 1, 0)
;; fast program: loop2((loop((2 * (2 * (2 * (2 * (x + x))))) - x, y mod 2, 2) * x) + y, x, x - 1, if x <= 0 then 1 else 2, 1)
(set-logic UFNIA)
(declare-fun f1 () Int)
