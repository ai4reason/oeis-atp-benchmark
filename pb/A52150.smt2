;; sequence(s): A52150
;; terms: 1 6 24 82 261 804 2440 7356 22113 66394 199248 597822 1793557 5380776 16142448 48427480 145282593 435847950 1307544040 3922632330
;; small program: loop((loop(x + y, 1 + y, x) + x) + x, x, 1)
;; fast program: (loop((((1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2) - ((2 + x) * x), 1, 2 + x) div 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (- (div (* (+ 1 2) (w3 x)) 2) (* (+ 2 x) x)))))
(assert (= g2 1))
