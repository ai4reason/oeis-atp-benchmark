;; sequence(s): A18700
;; terms: 1 2 3 6 7 9 14 18 21 42 49 63 98 126 147 294 441 882
;; small program: loop(compr(loop(2 + (2 * (x * y)), 2 + 2, 1) mod (1 + x), y), x, 0) + 1
;; fast program: loop2(compr((2 * loop((2 + x) * (x * x), 1, 1 + (2 + (2 + 2)))) mod (1 + x), y) + x, y, 2, 2, x) div 2
(set-logic UFNIA)
