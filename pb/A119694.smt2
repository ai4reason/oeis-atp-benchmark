;; sequence(s): A119694
;; terms: 0 1 2 10 42 210 1056 5577 30030 165308 923780 5231954 29953728 173095700 1008263880 5913855450 34898020290 207042729630 1234218400800 7388927397390
;; small program: loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x, 0, 1)) div (1 + x)
;; fast program: loop(2 * ((x - (x div y)) + x), x, if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) div (1 + x)
(set-logic UFNIA)
