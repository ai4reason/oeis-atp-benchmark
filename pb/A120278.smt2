;; sequence(s): A120278
;; terms: 2 10 38 136 486 1760 6466 24042 90238 341190 1297574 4958114 19019254 73196994 282492254 1092867904 4236849774 16455966944 64020347914 249431257704
;; small program: loop(loop(loop(2 * ((x - (x div y)) + x), y, 1) + x, 1 + y, x), x, 2)
;; fast program: (loop(loop((loop(2 * (((x div y) + x) + x), y, 1) div (1 + y)) + x, y, x), x, 1) + x) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (div (v5 x y) (+ 1 y)) x))))
