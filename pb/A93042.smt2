;; sequence(s): A93042
;; terms: 0 1 1 6 15 55 168 559 1785 5814 18755 60787 196560 636323 2058797 6663030 21561015 69774527 225792504 730684103
;; small program: loop(1 - (x + x), x, 0) * loop2(y - x, x, x, 0, 1)
;; fast program: (loop(1 + (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)) * loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (v2 x) (+ 1 2)) (w5 x)))))
