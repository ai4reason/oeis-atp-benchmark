;; sequence(s): A17918
;; terms: 1 20 289 3740 46321 563300 6797569 81762860 982121041 11790305780 141507994849 1698217742780 20379222467761 244553718979460 2934659879368129 35215994824839500 422592319303230481
;; small program: loop(((loop((loop(loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop(x * x, 1, loop(x + x, x, 2)) div (1 + 2)) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
