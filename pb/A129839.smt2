;; sequence(s): A129839
;; terms: 0 0 0 1 36 625 8100 90601 933156 9150625 87048900 812307001 7486748676 68447640625 622473660900 5641104760201 51003678922596 460438253730625 4152386009780100 37422167780506201
;; small program: loop2(loop((1 - loop2(((x - y) + x) + x, y + y, x - 1, 1, 2)) div 2, 1, y) * x, y, 2, 1, x)
;; fast program: loop2(loop((loop(x + x, x - 1, 2) - loop2(x * y, y, x - 1, 1, 1 + 2)) div 2, 1, y) * x, y, 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (div (- 1 (w2 x)) 2))))
(assert (= g1 1))
...
(assert (forall ((x Int)) (= (f4 x) (div (- (v5 x) (w6 x)) 2))))
(assert (= g4 1))
