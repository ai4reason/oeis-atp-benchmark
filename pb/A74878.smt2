;; sequence(s): A74878
;; terms: 1 2 6 14 32 70 150 316 658 1358 2784 5678 11534 23356 47178 95110 191440 384854 772902 1550972
;; small program: loop((x + x) + loop2(y, x + y, y, 2, 0), x, 1)
;; fast program: ((1 + 2) * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - loop2(x + y, x, x, 2, 2)
(set-logic UFNIA)
