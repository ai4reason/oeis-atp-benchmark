;; sequence(s): A51747
;; terms: 2 10 31 76 161 308 546 912 1452 2222 3289 4732 6643 9128 12308 16320 21318 27474 34979 44044
;; small program: loop(loop(loop(loop(x + y, y, x), y, x) + y, 1 + y, x), x, 2)
;; fast program: ((loop((x * x) * x, 1, 2 + x) - x) div (2 + (2 + 2))) + loop(((x * (2 + (1 + 2))) div y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (div (* x (+ 2 (+ 1 2))) y) x))))
(assert (forall ((x Int)) (= (g5 x) x)))
(assert (= h5 1))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v5 x) (u5 (g5 x) h5))))
(assert (forall ((x Int)) (= (fast x) (+ (div (- (v4 x) x) (+ 2 (+ 2 2))) (v5 x)))))
