;; sequence(s): A279312
;; terms: 1 2 4 8 12 24 40 80 128 256 416 832 1344 2688 4352 8704 14080 28160 45568 91136
;; small program: loop2(x + y, x, x div 2, 1, 1) * loop2(y + y, x, x, 1, 1)
;; fast program: loop(x + x, x - (x div 2), 1) * loop2(x + y, x, x div 2, 1, 1)
(set-logic UFNIA)
