;; sequence(s): A6858
;; terms: 0 1 14 84 330 1001 2548 5712 11628 21945 38962 65780 106470 166257 251720 371008 534072 752913 1041846 1417780
;; small program: loop(loop(loop(x + y, 2 * (y * y), x), y, x), x, 0) div (1 + 2)
;; fast program: loop(loop(loop((((2 * ((x * x) * x)) + x) div (1 + 2)) * x, 1, y) + x, y, x), x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (* (div (+ (* 2 (* (* x x) x)) x) (+ 1 2)) x))))
(assert (= g5 1))
