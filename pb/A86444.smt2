;; sequence(s): A86444
;; terms: 1 3 10 37 150 653 2990 14157 68470 335533 1657470 8227277 40957190 204250413 1019649550 5093448397 25452860310 127221189293 635976675230 3179495693517
;; small program: (loop2((x + x) + y, (2 * (y + y)) + y, x, 1, 1) + loop((x + x) + x, x, 1)) div 2
;; fast program: (((loop(x + x, x, 2) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))) div (1 + 2)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (div (+ (v2 x) (w3 x)) (+ 1 2)) (w6 x)) 2))))
