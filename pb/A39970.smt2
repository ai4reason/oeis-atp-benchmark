;; sequence(s): A39970
;; terms: 1 0 1 0 2 0 2 0 2 0 0 0 0 0 0 0 2 0 2 0
;; small program: loop((2 * ((2 * (x * y)) - x)) div (1 + y), x div 2, 1 - (x mod 2)) mod (1 + 2)
;; fast program: loop((((2 * (y + y)) - 2) * x) div (1 + y), x div 2, 1 - (x mod 2)) mod (1 + 2)
(set-logic UFNIA)
