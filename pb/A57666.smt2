;; sequence(s): A57666
;; terms: 0 960 10800 60480 235200 725760 1905120 4435200 9408960 18532800 34354320 60540480 102211200 166333440 262180800 401863680 600935040 879076800 1260871920 1776667200
;; small program: loop2((1 + y) * (x * y), 1 + y, 2 + 2, 1, x) div (2 + x)
;; fast program: loop((loop((((x * x) * x) - x) * x, 1, 2 + x) * x) * x, 1, 1 + x) * x
(set-logic UFNIA)
