;; sequence(s): A81350
;; terms: 1 2 3 4 15 16 35 36 63 64 99 100 143 144 195 196 255 256 323 324
;; small program: (loop((y * y) - y, 2 * (x div 2), 2) - 1) + x
;; fast program: (((loop((2 * (x * x)) - x, 1, loop(2, 2 - x, x) div 2) + x) * 2) - 1) - x
(set-logic UFNIA)
