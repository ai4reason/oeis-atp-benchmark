;; sequence(s): A28010
;; terms: 1 29 548 8566 120423 1583943 19921666 242775872 2891343125 33848546017 391123415904 4474230519018 50782770006307 572842223354651 6430299748764062 71901261449271604 801472079960561169
;; small program: loop((loop((loop(loop((x + x) + x, y + y, 1) + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop((((loop2(x * y, y, x, 1, 1 + (2 + (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))) div 2) - loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) div 2, 1, 2 + x) div 2, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
