;; sequence(s): A287452
;; terms: 1 5 9 12 13 17 20 24 25 29 33 34 37 41 45 48 49 53 57 58
;; small program: loop(compr(loop2(y - x, y div (1 + 2), x, 0, x) mod (1 + 2), y), x, 0) + 1
;; fast program: ((((loop2(y - x, y div (1 + 2), 1 + (2 + 2), 0, x) mod (1 + 2)) + 1) + x) + x) + x
(set-logic UFNIA)
