;; sequence(s): A267799
;; terms: 3 7 18 49 138 397 1158 3409 10098 30037 89598 267769 801258 2399677 7190838 21556129 64635618 193841317 581392878 1743916489
;; small program: loop(((x - 1) + x) + x, x, 2) + loop(x + x, x, 1)
;; fast program: ((((1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) + 1
(set-logic UFNIA)
