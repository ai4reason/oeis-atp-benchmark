;; sequence(s): A184423
;; terms: 1 12 540 33600 2425500 190702512 15849497664 1369618398720 121821136479900 11079206239530000 1025579963180813040 96310511463483233280 9152842704012278107200 878622906816654279840000
;; small program: ((loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + x) div loop((y * x) * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 1 + x)) div loop(x * y, x, 1)
;; fast program: ((((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 2 + x)) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1 + x, 1 + x)) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (div (* (div (w4 x) (v5 x)) (w6 x)) (v7 x)) (w8 x)) (v9 x)))))
