;; sequence(s): A89833
;; terms: 0 1 10 115 1666 30198 665148 17296851 518916970 17643220738 670442556004 28158587998814 1295295050441588 64764752531737100 3497296636751245560 202843204931717665155 12576278705767060962330
;; small program: loop(2 * ((x - (x div y)) + x), x, loop((y * x) + x, x, 1) - 1) div (1 + x)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1)) * loop(x - 1, 1, loop(x * y, x, 1 + x))
(set-logic UFNIA)
