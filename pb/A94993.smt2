;; sequence(s): A94993
;; terms: 1 1 2 3 6 9 15 23 37 58 91 144 226 356 559 879 1382 2172 3414 5365
;; small program: loop(x div (1 + (2 + (2 + 2))), x, loop(loop((2 + y) * x, 2, x) - x, x, 1))
;; fast program: (loop2(x * y, y, x - 1, 1, 1 + (2 + (2 * (2 + 2)))) * (if x <= 0 then 1 else (1 + (2 + (2 * (2 + 2)))))) div loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1)
(set-logic UFNIA)
