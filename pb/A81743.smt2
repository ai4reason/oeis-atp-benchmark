;; sequence(s): A81743
;; terms: 1 2 2 2 2 3 3 2 2 3 3 3 3 4 4 2 2 3 3 3
;; small program: loop2(((y div 2) mod 2) + x, y div 2, x, 1, 1 + x)
;; fast program: loop(loop2(x - y, y div 2, 1 + (2 + 2), x, x div 2), 1, (x div 2) + (x mod 2)) + 1
(set-logic UFNIA)
...
(assert (= g1 1))
(assert (forall ((x Int)) (= (h1 x) (+ (div x 2) (mod x 2)))))
