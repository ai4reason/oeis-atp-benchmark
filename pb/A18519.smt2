;; sequence(s): A18519
;; terms: 1 2 4 5 7 8 10 14 16 20 28 35 40 56 70 80 112 140 280 560
;; small program: compr(loop((2 + x) * ((x * x) - x), 2, 2) mod (1 + x), x) + 1
;; fast program: compr(loop((2 + x) * ((x * x) - x), 1, 2 * (2 + 2)) mod (1 + x), x) + 1
(set-logic UFNIA)
