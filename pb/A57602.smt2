;; sequence(s): A57602
;; terms: 2 4 6 9 15 25 35 49 77 121 143 169 221 289 323 361 437 529 667 841
...
(assert (forall ((x Int) (y Int)) (= (g1 x y) (div (+ 1 y) 2))))
...
(assert (forall ((x Int) (y Int)) (= (g4 x y) (div (+ 1 y) 2))))
