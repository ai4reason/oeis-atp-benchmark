;; sequence(s): A50231
;; terms: 0 0 1 3 8 20 47 107 238 520 1121 2391 5056 10616 22159 46023 95182 196132 402873 825259
;; small program: loop((loop2((((y * y) - y) div (x + y)) + y, x + y, y, 1, 0) + x) + x, x, 0)
;; fast program: loop((loop2(((y * y) div ((x + 2) + y)) + y, x + y, y - 1, 1, 1) + x) + x, x - 1, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (div (* y y) (+ (+ x 2) y)) y))))
