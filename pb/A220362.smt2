;; sequence(s): A220362
;; terms: 0 3 10 48 195 840 3536 15015 63546 269280 1140535 4831632 20466720 86699067 367262090 1555748880 6590255259 27916773720 118257343984 500946159615
;; small program: loop(loop2(x + y, x, y + y, 0, 1) - x, x, 0) * loop2(x + y, x, x, 2, 1)
;; fast program: (((loop(x * x, 1, loop2(x + y, x, x - 1, 2, 1)) - (x mod 2)) - (x mod 2)) + 1) * loop2(x + y, x, x, 0, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (+ (- (- (v3 x) (mod x 2)) (mod x 2)) 1) (w5 x)))))
