;; sequence(s): A115099
;; terms: 4 8 20 56 164 488 1460 4376 13124 39368 118100 354296 1062884 3188648 9565940 28697816 86093444 258280328 774840980 2324522936
;; small program: 2 + loop((x + x) + x, x, 2)
;; fast program: 2 + loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
