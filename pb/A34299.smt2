;; sequence(s): A34299
;; terms: 1 1 4 6 15 27 58 112 229 453 912 1818 3643 7279 14566 29124 58257 116505 233020 466030
;; small program: loop((loop(0 - x, y, y) + x) + x, x, 2) div 2
;; fast program: loop((y - x) - x, x, 2) div loop(0 - x, x, 2)
(set-logic UFNIA)
