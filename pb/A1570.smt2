;; sequence(s): A1570
;; terms: 1 13 181 2521 35113 489061 6811741 94875313 1321442641 18405321661 256353060613 3570537526921 49731172316281 692665874901013 9647591076297901 134373609193269601 1871582937629476513 26067787517619401581 363077442309042145621
;; small program: loop2((2 * (x + x)) - y, x, x + x, 2, 1) div 2
;; fast program: loop(((x + x) + x) * x, 1, loop2((2 * (x + x)) - y, x, x - 1, (if x <= 0 then 0 else 2) + 1, 1)) div 2
(set-logic UFNIA)
