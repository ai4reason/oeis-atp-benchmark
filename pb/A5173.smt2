;; sequence(s): A5173
;; terms: 0 1 12 61 240 841 2772 8821 27480 84481 257532 780781 2358720 7108921 21392292 64307941 193185960 580082161 1741295052 5225982301
;; small program: loop(((loop(2 * (x + y), y, 0) + x) + x) + x, x, 0) - x
;; fast program: loop(((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div 2) - loop(x + x, x, 2)) + 2, 1, 2 + x) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (+ (- (div (w3 x) 2) (v5 x)) 2))))
(assert (= g2 1))
