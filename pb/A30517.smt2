;; sequence(s): A30517
;; terms: 1 2 13 52 273 1302 6573 32552 163073 813802 4070573 20345052 101733073 508626302 2543170573 12715657552 63578483073 317891438802 1589458170573 7947285970052
;; small program: loop(loop((loop((2 * (x + x)) + x, x div 2, 1) + loop((2 * (x + x)) + x, x, 1)) div 2, 1, y) - x, x, 1)
;; fast program: loop(loop((loop2(x * y, y, x div 2, 1, 1 + (2 + 2)) + loop2(x * y, y, x, 1, 1 + (2 + 2))) div 2, 1, y) - x, x, 1)
(set-logic UFNIA)
