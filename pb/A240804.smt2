;; sequence(s): A240804
;; terms: 1 13 103 1153 15013 255253 4849843 111546433 3234846613 100280245063 3710369067403 152125131763603 6541380665835013 307444891294245703 16294579238595022363 961380175077106319533 58644190679703485491633 3929160775540133527939543 278970415063349480483707693
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, 1 + x, 1) - 2
;; fast program: loop(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, 1 + x, 1) - 2
(set-logic UFNIA)
