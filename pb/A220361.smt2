;; sequence(s): A220361
;; terms: 1 7 28 123 515 2192 9269 39291 166396 704935 2986039 12649248 53582777 226980767 961505180 4073002563 17253513691 73087060144 309601749709 1311494066355
;; small program: loop(loop2(x + y, x, 2 + (y + y), 1, 1) - x, x, 1) * loop2(x + y, x, x, 1, 0)
;; fast program: ((((loop2(x + y, x, x, 1, 1) * loop2(x + y, x, x, 2, 1)) - 1) + (x mod 2)) + (x mod 2)) * loop2(x + y, x, x, 1, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (+ (+ (- (* (w3 x) (w4 x)) 1) (mod x 2)) (mod x 2)) (w5 x)))))
