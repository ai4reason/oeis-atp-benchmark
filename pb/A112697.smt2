;; sequence(s): A112697
;; terms: 1 4 22 157 1291 11497 107725 1045948 10428178 106126924 1097913928 11511677470 122057782762 1306480339462 14098243951822 153208673236237 1675240428936307 18417589741637077 203464608460961377
;; small program: loop(loop((loop(2 - ((2 + y) * x), 2, y) * x) div (1 + y), y, 1) + x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x - 1, x)) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (div (* (v2 x y) x) (+ 1 y)))))
