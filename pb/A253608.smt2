;; sequence(s): A253608
;; terms: 2 9 12 35 42 49 56 135 150 165 180 195 210 225 240 527 558 589 620 651
;; small program: loop((x mod y) + y, 1 + x, 0) * (2 + x)
;; fast program: (loop((loop((((((1 + loop((x mod y) + y, x div (2 + 2), 0)) * (if (x - 1) <= 0 then 1 else 2)) * (if x <= 0 then 1 else 2)) - x) - 1) + x, 1, x div 2) * 2) + x, 1, 1 + x) - x) * (2 + x)
(set-logic UFNIA)
