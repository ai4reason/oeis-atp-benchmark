;; sequence(s): A135568
;; terms: 1 2 3 5 8 19 41 101 240 614 1782 5024 15492 48859 150069 470216 1557591 5405758 18319515 64600395
;; small program: loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, x, 1) div loop(x * y, x, 1)
;; fast program: loop(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x - 1, if x <= 0 then 1 else 2) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (v4 x) (v7 x)))))
