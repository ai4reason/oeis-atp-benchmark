;; sequence(s): A151889
;; terms: 2 3 8 13 34 55 144 233 610 987 2584 4181 10946 17711 46368 75025 196418 317811 832040 1346269
;; small program: loop2(x + y, x, (x div 2) + x, 2, 1)
;; fast program: loop2((2 * (x + x)) + y, x, x div 2, 2 + (x mod 2), x mod 2)
(set-logic UFNIA)
