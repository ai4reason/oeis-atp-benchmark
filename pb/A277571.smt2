;; sequence(s): A277571
;; terms: 5 11 17 23 29 30 35 41 47 53 59 65 66 71 77 83 89 95 101 102
;; small program: compr((loop(x div loop(1, x mod (2 + (2 + 2)), 2 + (2 + 2)), x div (2 + 2), x) + 1) mod (2 + (2 + 2)), x)
;; fast program: compr(((loop(x div loop(1, x mod (2 + (2 + 2)), 2 + (2 + 2)), x div (2 + (2 + 2)), x) + 1) mod (2 + (2 + 2))) - 1, 1 + x)
(set-logic UFNIA)
(declare-fun f2 () Int)
...
(assert (forall ((x Int)) (= (f0 x) (mod (+ (v1 x) 1) (+ 2 (+ 2 2))))))
