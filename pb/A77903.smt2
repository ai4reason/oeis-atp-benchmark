;; sequence(s): A77903
;; terms: 1 0 2 ~3 6 ~12 25 ~48 98 ~195 390 ~780 1561 ~3120 6242 ~12483 24966 ~49932 99865 ~199728
;; small program: loop((loop2(1 + (x - y), x, y, 1, 0) - x) - x, x, 1)
;; fast program: loop((x div (1 + (2 + (2 + 2)))) + x, 1, loop(2 - (x + x), x, 1))
(set-logic UFNIA)
