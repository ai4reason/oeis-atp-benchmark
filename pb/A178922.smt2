;; sequence(s): A178922
;; terms: 1 1 7 55 561 7151 109873 1979503 40949569 956953279 24937424601 717070946087 22555076751793 770416688131663 28399211252136481 1123728578581456351 47508270371060021505 2137250367863029663487 101941438738172545000873 5138752649702088758467159
;; small program: loop2((x * y) + x, y, x, 1, x) - loop2(x * y, y, x - 2, x, x)
;; fast program: (loop2(x * y, y, x - (x div 2), 1, 1 + x) * loop2(x * y, y, x div 2, 1, 1 + x)) - loop2(x * y, y, x - 2, x, x)
(set-logic UFNIA)
