;; sequence(s): A338550
;; terms: 1 1 4 60 3360 705600 558835200 1678182105600 19198403288064000 840083731079104512000 141100463472046393835520000 91242050302344912388163665920000 227753296409896438988240405704212480000 2199573010737856838816729366169572868096000000 82356764599728553816070191604819734458909327360000000
;; small program: loop(loop(2 * ((x - (x div y)) + x), y, x), x, 1) div (1 + x)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1), 1, y) * x, x - 1, 1) * loop2(x * y, 1 + y, x - 1, 1, 2 + x)
(set-logic UFNIA)
