;; sequence(s): A120192
;; terms: 7 8 10 11 13 14 16 19 21 24 28 32 36 42 48 54 62 71 81 93
;; small program: ((loop((x div (1 + (2 + (2 + 2)))) + x, x, loop(2 + (x + x), 2 + 2, 2)) div 2) div 2) div 2
;; fast program: loop((x div (1 + (2 + (2 + 2)))) + x, x, (2 * (2 * (2 * (2 * (2 + 2))))) - 2) div (2 * (2 + 2))
(set-logic UFNIA)
