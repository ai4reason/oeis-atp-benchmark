;; sequence(s): A76040
;; terms: 0 ~1 4 ~13 40 ~121 364 ~1093 3280 ~9841 29524 ~88573 265720 ~797161 2391484 ~7174453 21523360 ~64570081 193710244 ~581130733
;; small program: (x mod 2) - loop(2 - ((x + x) + x), x, 0)
;; fast program: loop(1 - x, x mod 2, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2
(set-logic UFNIA)
