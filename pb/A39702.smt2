;; sequence(s): A39702
;; terms: 2 3 1 3 3 1 1 3 3 1 3 1 1 3 3 1 3 1 3 3
;; small program: (compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), 1 + x) mod (2 + 2)) + 1
;; fast program: loop((compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), 1 - (x mod 2), x) - 1, 1 + x) mod (2 + 2)) - 1, 2, x) + 2
(set-logic UFNIA)
