;; sequence(s): A258326
;; terms: 3 4 8 8 14 14 20 24 24 34 34 38 44 48 52 54 64 64 68 76
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) - x, 1 + y, 1 + 2, 0, x)
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 1 + y, 1 + 2, 0, x)
(set-logic UFNIA)
