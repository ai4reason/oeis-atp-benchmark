;; sequence(s): A88014
;; terms: 2 1 5 7 21 41 107 239 593 1393 3395 8119 19665 47321 114371 275807 666113 1607521 3881411 9369319
;; small program: loop2(y + y, x, x, 1, 0) + loop2(y, (x + y) + y, x, 1, 1)
;; fast program: loop2((x + x) + y, x, x - 1, 1, 1) + loop(x + x, x div 2, 1 - (x mod 2))
(set-logic UFNIA)
