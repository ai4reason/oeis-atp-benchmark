;; sequence(s): A99780
;; terms: 1 3 9 29 99 351 1273 4677 17307 64295 239361 892125 3327091 12412143 46313289 172824629 644952459 2406919671 8982595153 33523198797
;; small program: loop((x + loop2(y, (2 * (y + y)) - x, y, 1, 1)) + x, x, 1)
;; fast program: (loop2((2 * (x + x)) - y, x, x - 1, (if x <= 0 then 0 else (1 + 2)) + 2, 1) + loop(x + x, x, 2)) div (1 + 2)
(set-logic UFNIA)
