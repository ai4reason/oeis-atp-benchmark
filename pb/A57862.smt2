;; sequence(s): A57862
;; terms: 0 0 0 1 2 0 11 4 2 34 1 64 37 173 438 394 118 1160 1663 1
;; small program: loop(x + x, x, 2) mod loop2(x + y, x, x, 1, 0)
;; fast program: (2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, (x div 2) - 1, 2)))) mod loop2(x + y, x, x - 2, 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (* 2 (v2 x)) (w5 x)))))
