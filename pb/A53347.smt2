;; sequence(s): A53347
;; terms: 1 10 54 210 660 1782 4290 9438 19305 37180 68068 119340 201552 329460 523260 810084 1225785 1817046 2643850 3782350
;; small program: (loop((loop(2 + (x + y), 2, y) * x) div y, x, 2 + (2 + x)) div 2) div 2
;; fast program: loop((((2 * ((x + x) + x)) + x) div y) + x, x, 2 + (2 + x)) div (2 + 2)
(set-logic UFNIA)
