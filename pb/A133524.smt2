;; sequence(s): A133524
;; terms: 87 204 364 628 940 1348 2020 2692 3700 4852 5860 7108 8548 10348 12220 14500 16732 18580 21100 23500
;; small program: loop2(loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2, 1, x), 1, y) + x, 1 + y, 2 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x), 1, y) + x, 1 + y, 2 + 2, 0, x)
(set-logic UFNIA)
