;; sequence(s): A6499
;; terms: 1 3 9 12 16 28 49 77 121 198 324 522 841 1363 2209 3572 5776 9348 15129 24477
;; small program: loop2(x + y, x, x, 1 + 2, 1) - loop2(y, 0 - x, x, 2, 1)
;; fast program: loop2(x + y, x, x - (x div 2), 1, 2) * loop2(x + y, x, x div 2, 1, 2)
(set-logic UFNIA)
