;; sequence(s): A228448
;; terms: 1 0 0 0 0 0 0 2 6 18 61 225 901 3905 18226 91134 486048 2754274 16525645 104662422
;; small program: loop(x div (1 + 2), x, loop(x * y, x, 1))
;; fast program: ((if x <= 0 then 1 else x) * loop(x * y, x - 1, 1)) div loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (ite (<= x 0) 1 x) (v2 x)) (w3 x)))))
