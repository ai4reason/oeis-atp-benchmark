;; sequence(s): A28034
;; terms: 1 22 313 3682 39109 391174 3769921 35484394 328932637 3018821806 27523981849 249859595986 2261664434485 20432811986518 184363359728497 1662082800576058 14975637634031053 134882161611414910
;; small program: loop(loop(loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1) * loop((x + x) + x, x, 1), 1, y) + (2 * (x + x)), x, 1)
;; fast program: loop(loop((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) + 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x)), x, 2) div 2
(set-logic UFNIA)
