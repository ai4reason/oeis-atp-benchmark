;; sequence(s): A70199
;; terms: 10 19 109 199 1099 1999 10999 19999 109999 199999 1099999 1999999 10999999 19999999 109999999 199999999 1099999999 1999999999 10999999999 19999999999
;; small program: loop2(loop((x + x) + x, 2, y) + x, x - y, 1 + x, 2, 1) - 1
;; fast program: loop(loop2(x * y, y, x div 2, loop(1 + (2 + (2 * (2 + 2))), x mod 2, 2), 2 + (2 * (2 + 2))), 1, 1 + x) - 1
(set-logic UFNIA)
