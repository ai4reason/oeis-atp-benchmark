;; sequence(s): A136408
;; terms: 1 2 4 7 13 27 55 107 211 427 859 1707 3403 6827 13675 27307 54571 109227 218539 436907
;; small program: (loop((loop2(1 - (y + y), x, y, 0, 0) + x) + x, x, 1) div 2) + 1
;; fast program: loop((loop2(2 - (y + y), x, y - 2, 1, 1) + x) + x, x, 0) + 1
(set-logic UFNIA)
