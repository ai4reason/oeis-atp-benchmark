;; sequence(s): A177018
;; terms: 3 3 3 4 4 5 5 6 8 8 10 11 11 12 14 16 16 18 19 19
;; small program: ((compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) div 2) - x) + 2
;; fast program: (compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x) - x) + 2
(set-logic UFNIA)
