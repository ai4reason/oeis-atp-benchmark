;; sequence(s): A26567
;; terms: 1 4 13 31 85 193 517 1165 3109 6997 18661 41989 111973 251941 671845 1511653 4031077 9069925 24186469 54419557
;; small program: loop2((y + y) + y, 2 * (2 + x), x, 0, 1) + 1
;; fast program: loop2(2 + (x * y), y, x div 2, loop(1 + (2 + 2), x mod 2, 2), 2 + (2 + 2)) - 1
(set-logic UFNIA)
