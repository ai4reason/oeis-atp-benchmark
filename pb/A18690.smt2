;; sequence(s): A18690
;; terms: 1 2 3 4 6 8 9 12 16 18 24 27 32 36 48 54 72 96 108 144
;; small program: compr((2 * loop((1 + 2) * (x * x), 2, 2)) mod (1 + x), x) + 1
;; fast program: compr((2 * (2 * loop((x * x) * x, 1, 2 + (2 + 2)))) mod (1 + x), x) + 1
(set-logic UFNIA)
