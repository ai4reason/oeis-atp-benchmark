;; sequence(s): A295725
;; terms: 0 0 ~1 1 ~2 3 ~3 8 ~3 21 2 55 25 144 105 377 354 987 1085 2584
;; small program: loop2(y, x + y, x, 1, 0) - loop2(y + y, x, x, 1, 0)
;; fast program: loop2(y, x + y, x, 1, 0) - loop(x + x, x div 2, 1 - (x mod 2))
(set-logic UFNIA)
