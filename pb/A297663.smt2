;; sequence(s): A297663
;; terms: 1 7 14 23 36 57 94 163 296 557 1074 2103 4156 8257 16454 32843 65616 131157 262234 524383
;; small program: ((2 * (x + x)) + loop(x + x, x, 1)) + x
;; fast program: ((2 * (x + x)) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) + x
(set-logic UFNIA)
