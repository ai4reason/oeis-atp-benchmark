;; sequence(s): A242475
;; terms: 9 10 12 16 24 40 72 136 264 520 1032 2056 4104 8200 16392 32776 65544 131080 262152 524296
;; small program: (2 * (2 + 2)) + loop(x + x, x, 1)
;; fast program: (2 * (2 + 2)) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
