;; sequence(s): A182143
;; terms: 1 3 5 15 33 83 197 479 1153 2787 6725 16239 39201 94643 228485 551615 1331713 3215043 7761797 18738639
;; small program: loop2(y, (x + y) + y, x, 2, 2) - loop(0 - x, x, 1)
;; fast program: loop2((x + x) + y, x, x - 1, 2, 2) - loop(0 - 1, x mod 2, 1)
(set-logic UFNIA)
