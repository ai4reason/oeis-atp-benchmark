;; sequence(s): A173524
;; terms: 1 2 3 4 2 3 4 5 3 4 5 6 4 5 6 7 2 3 4 5
;; small program: loop2((y mod (2 + 2)) + x, (y div 2) div 2, x, 1, x)
;; fast program: ((loop2(x - y, y div (2 + 2), 2 + 2, x, x) * (1 + 2)) + 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (* (w1 x) (+ 1 2)) 1) x))))
