;; sequence(s): A26492
;; terms: 1 1 1 1 1 1 1 2 1 1 1 1 1 1 2 1 1 1 1 1
;; small program: (loop2((y - x) div 2, x, x, x div 2, x) mod 2) + 1
;; fast program: (loop2((y - x) div 2, x, 1 + (2 + (2 + 2)), x div 2, x) mod 2) + 1
(set-logic UFNIA)
