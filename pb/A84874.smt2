;; sequence(s): A84874
;; terms: 0 0 9 162 2025 21870 219429 2112642 19847025 183642390 1682955549 15327821322 139038251625 1257873017310 11360034454869 102475388237202 923689006041825 8321664254958630 74945757885541389 674816499677616282
;; small program: loop2((((x - 1) + x) + x) + y, y + y, x, 0, 1) * loop((x + x) + x, x, 1)
;; fast program: (loop((x * x) + x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2) - loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
