;; sequence(s): A206604
;; terms: 1 1 3 9 27 73 189 465 1115 2601 5973 13489 30149 66641 146233 318369 689403 1484137 3181797 6790641
;; small program: loop((loop(loop(x + x, x, 1) - loop((x * y) div (y - (y div 2)), x - 1, 2), 1, y) + x) + x, x, 0) + 1
;; fast program: (loop((loop(loop(x + x, x, 1) - loop((x * y) div (y - (y div 2)), x, 1), 1, y) + x) + x, x - 1, 0) * 2) + 1
(set-logic UFNIA)
