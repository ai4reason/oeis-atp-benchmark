;; sequence(s): A81909
;; terms: 1 3 10 36 135 513 1944 7290 26973 98415 354294 1259712 4428675 15411789 53144100 181752822 617003001 2080591515 6973568802 23245229340
;; small program: (((x - 1) * loop2(x * y, y, x - 2, x, 1 + 2)) div 2) + loop((x + x) + x, x, 1)
;; fast program: (((x - 1) * loop2(x * y, y, x - 2, x, 1 + 2)) div 2) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (div (* (- x 1) (w0 x)) 2) (v1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (div (* (- x 1) (w2 x)) 2) (w3 x)))))
