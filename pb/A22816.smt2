;; sequence(s): A22816
;; terms: 1 11 44 121 271 532 952 1590 2517 3817 5588 7943 11011 14938 19888 26044 33609 42807 53884 67109
;; small program: loop(loop(loop((loop(x + y, 2 + y, x) + y) + y, y, x), y, x) + y, x, 1) + x
;; fast program: loop(loop((loop(loop(((loop((((((x * x) * x) - x) div (2 + (2 + 2))) + (2 * ((x * x) + x))) + x, 1, 1 + x) - 2) - x) - x, 1, y) + x, x, 1) - x) - x, 1, y) + x, x, 1)
(set-logic UFNIA)
