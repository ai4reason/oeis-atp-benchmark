;; sequence(s): A254030
;; terms: 10 20 50 146 470 1610 5750 21146 79430 303050 1169750 4554746 17852390 70322090 278050550 1102537946 4381257350 17438542730 69495104150 277204002746
;; small program: loop((x * x) + x, 1, 1 + loop(x + x, x, 1)) + (2 + loop((x + x) + x, x, 2))
;; fast program: ((loop(((2 + x) * x) + x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))) + 2) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (v3 x) (w5 x)) 2) 2))))
