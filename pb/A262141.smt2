;; sequence(s): A262141
;; terms: 181 7021 266761 10130041 384674941 14607517861 554701003921 21064030631281 799878462984901 30374317562795101 1153424188923229081 43799744861519910121 1663236880548833355661 63159201715994147605141 2398386428327228775639841
;; small program: (loop2((2 * ((x + x) + x)) + y, x, 2 + (x + x), 1 + (2 + 2), 0) - 2) - 2
;; fast program: loop2(((((((loop2((loop(2 + (x * x), 2, 2) * x) - y, x, x, 1, 1) - 1) * (1 + (2 + 2))) div 2) div 2) * 2) * 2) + 1, x * x, 1, 1 + x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (+ (* (* (div (div (* (- (w2 x) 1) (+ 1 (+ 2 2))) 2) 2) 2) 2) 1))))
