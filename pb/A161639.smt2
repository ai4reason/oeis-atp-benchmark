;; sequence(s): A161639
;; terms: 8 9 10 11 12 13 14 15 40 41 42 43 44 45 46 47 56 57 58 59
;; small program: ((loop((compr((loop(if ((x div 2) mod 2) <= 0 then 2 else (x div 2), x, x div 2) + x) mod 2, 1 + x) - 1) - x, 1, x div 2) * 2) + 2) + x
;; fast program: ((((loop((((((loop(((compr((loop(loop(x div loop(1, x mod (2 + 2), 2 + 2), 2, x), 1 - (x mod (2 + 2)), x) - 1) mod 2, x) * 2) - 1) - x, 1, x div 2) * 2) + x) * 2) + 1) - x) - x, 1, x div (2 + 2)) + x) * 2) - 1) - x) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (ite (<= (mod (div x 2) 2) 0) 2 (div x 2)))))
...
(assert (forall ((x Int)) (= (f4 x) (- (- (* (v5 x) 2) 1) x))))
(assert (= g4 1))
(assert (forall ((x Int)) (= (h4 x) (div x 2))))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int)) (= (v4 x) (u4 g4 (h4 x)))))
(assert (forall ((x Int)) (= (f3 x) (- (- (+ (* (+ (* (v4 x) 2) x) 2) 1) x) x))))
(assert (= g3 1))
(assert (forall ((x Int)) (= (h3 x) (div x (+ 2 2)))))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 g3 (h3 x)))))
(assert (forall ((x Int)) (= (fast x) (- (- (- (* (+ (v3 x) x) 2) 1) x) 1))))
