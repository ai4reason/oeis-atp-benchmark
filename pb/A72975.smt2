;; sequence(s): A72975
;; terms: 1 24 420 6720 102960 1537536 22573824 327444480 4707014400 67190323200 953748956160 13476348887040 189694258790400 2661556369489920 37240665709608960 519828326870679552
;; small program: loop2(2 * ((x * y) + x), 1 + y, 1 + x, 1, x + x) div loop(x * y, x, 2)
;; fast program: ((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * (1 + ((x + x) + x))) * loop(x + x, x, 1 + (x + x))
(set-logic UFNIA)
