;; sequence(s): A62289
;; terms: 2 4 5 6 8 9 10 11 12 13 14 16 17 18 19 20 21 22 23 24
;; small program: loop(loop(2 + ((x div y) + x), x, y) div x, x, 2)
;; fast program: loop(2 + ((x div y) + x), 1 + x, x) div (1 + x)
(set-logic UFNIA)
