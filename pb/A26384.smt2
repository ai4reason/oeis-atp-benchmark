;; sequence(s): A26384
;; terms: 1 3 8 18 43 93 218 468 1093 2343 5468 11718 27343 58593 136718 292968 683593 1464843 3417968 7324218
;; small program: loop2(loop(1 + (x + x), 2, y) + y, x, x, 1, 0)
;; fast program: loop2((x * y) - 1, y, x div 2, loop(2 + 2, x mod 2, 2), 1 + (2 + 2)) - 1
(set-logic UFNIA)
