;; sequence(s): A28064
;; terms: 1 25 402 5306 62699 691299 7275724 74105812 736913397 7196762573 69311524646 660250818318 6234443691295 58450533199447 544794370231968 5053142176005224 46678603740543593 429711934071787521
;; small program: loop(((loop((loop(loop((x + x) + x, y + y, 1) + (2 * (2 * (x + x))), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop(((1 + 2) * (x * x)) - x, 1, loop2(x * y, y, x, 1, 1 + 2)) div 2, 1, y) + (2 * (2 * (x + x))), y, 1) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f7 x) (- (* (+ 1 2) (* x x)) x))))
(assert (= g7 1))
