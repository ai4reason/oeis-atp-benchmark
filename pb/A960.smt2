;; sequence(s): A960
;; terms: 1 3 7 13 19 27 39 49 63 79 91 109 133 147 181 207 223 253 289 307
;; small program: loop2((x div y) + x, y - 1, x, x, x) + 1
;; fast program: (loop2((x div y) + x, y - 1, x - 1, x, x) * 2) + 1
(set-logic UFNIA)
