;; sequence(s): A330569
;; terms: 1 2 1 3 1 2 1 5 1 2 1 3 1 2 1 9 1 2 1 3
;; small program: (loop2(1 + (y mod (x + x)), y, x, 1, x) div 2) + 1
;; fast program: (loop((((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) div 2) + 1) - (x mod 2)) + x, x mod 2, x) - x) + 1
(set-logic UFNIA)
