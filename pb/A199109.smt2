;; sequence(s): A199109
;; terms: 4 11 32 95 284 851 2552 7655 22964 68891 206672 620015 1860044 5580131 16740392 50221175 150663524 451990571 1355971712 4067915135
;; small program: 2 + loop((1 + 2) * (1 + x), x, 2)
;; fast program: loop((2 * (x + x)) - (x div 2), 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (- (* 2 (+ x x)) (div x 2)))))
(assert (= g1 1))
