;; sequence(s): A245806
;; terms: 2 13 109 1027 10081 100243 1000729 10002187 100006561 1000019683 10000059049 100000177147 1000000531441 10000001594323 100000004782969 1000000014348907 10000000043046721 100000000129140163 1000000000387420489 10000000001162261467
;; small program: loop((x + x) + x, x, 1) + loop(2 * ((2 * (x + x)) + x), x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
