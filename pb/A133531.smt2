;; sequence(s): A133531
;; terms: 722 3107 17667 45603 126723 242403 493683 1117443 1910643 3504963 5623443 8118723 11124243 16188963 24887523 33853683 46114323 59408643 73961043 92760003
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 2 + 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((x * x) * x), y, 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
(set-logic UFNIA)
