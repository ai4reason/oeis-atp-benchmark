;; sequence(s): A145071
;; terms: 3 8 17 34 67 132 261 518 1031 2056 4105 8202 16395 32780 65549 131086 262159 524304 1048593 2097170
;; small program: 1 + (loop(2 + (x + x), x, 2) + x)
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - 1) + x
(set-logic UFNIA)
