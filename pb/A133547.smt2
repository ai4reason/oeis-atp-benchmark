;; sequence(s): A133547
;; terms: 9 34 83 204 373 662 1023 1552 2393 3354 4723 6404 8253 10462 13271 16752 20473 24962 30003 35332
;; small program: loop(loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, y, 2, 1, y) + x, 1 + x, 0)
;; fast program: loop(loop(loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x), 1, y) + x, 1 + x, 0)
(set-logic UFNIA)
