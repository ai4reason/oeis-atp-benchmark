;; sequence(s): A313615
;; terms: 1 5 10 14 20 24 30 34 40 44 49 54 59 64 68 74 78 84 88 94
;; small program: loop((((((x * x) div (2 + loop(x * x, 2, 2))) + x) mod 2) + 1) + x, (x + x) + x, 2) - 1
;; fast program: loop((((((x * x) div (2 + (2 * (2 * (2 + 2))))) + x) mod 2) + 1) + x, (x + x) + x, 2) - 1
(set-logic UFNIA)
