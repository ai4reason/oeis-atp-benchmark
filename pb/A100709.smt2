;; sequence(s): A100709
;; terms: 1001 3004 1502 751 2254 1127 3382 1691 5074 2537 7612 3806 1903 5710 2855 8566 4283 12850 6425 19276
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(2 + ((x * x) * x), 2, 2) - 1)
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + loop((x * x) * x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
