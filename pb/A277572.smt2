;; sequence(s): A277572
;; terms: 1 4 6 7 10 13 16 19 22 24 25 28 31 34 36 37 40 42 43 46
;; small program: compr(((loop(x div loop(1, x mod (2 + (2 + 2)), 2 + (2 + 2)), x div 2, x) mod (1 + 2)) + 1) mod 2, x) div 1
;; fast program: compr(((loop(x div (if (x mod (2 + (2 + 2))) <= 0 then (2 + (2 + 2)) else 1), x div (1 + 2), x) mod (1 + 2)) - 1) mod (1 + x), 1 + x)
(set-logic UFNIA)
(declare-fun f2 () Int)
