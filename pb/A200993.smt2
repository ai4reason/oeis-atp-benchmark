;; sequence(s): A200993
;; terms: 0 10 990 97020 9506980 931587030 91286021970 8945098566040 876528373449960 85890835499530050 8416425350580494950 824723793521388975060 80814515339745539060940 7918997779501541438997070 775980967875811315482651930 76038215854050007375860892080
;; small program: loop(loop2(y, (2 * ((2 * (y + y)) + y)) - x, y + y, 0, 1) + x, x, 0)
;; fast program: loop(x * x, 1, loop2((2 * ((2 * (x + x)) + x)) - y, x, x - 1, (if x <= 0 then 0 else (2 * (2 + 2))) + 1, 1)) div (2 * (2 + 2))
(set-logic UFNIA)
