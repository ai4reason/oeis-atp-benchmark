;; sequence(s): A87944
;; terms: 1 2 6 20 70 252 922 3404 12630 46988 175066 652764 2434966 9085052 33901146 126511340 472127830 1761967212 6575675482 24540603644
;; small program: loop((loop2(y, (2 * (y + y)) - x, y - 1, 0, 2) + x) + x, x, 1)
;; fast program: ((2 * loop2((2 * (x + x)) - y, x, x - 1, 2, 1)) + loop(x + x, x, 1)) div (1 + 2)
(set-logic UFNIA)
