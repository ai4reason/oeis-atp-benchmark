;; sequence(s): A64056
;; terms: 3 19 68 185 426 875 1652 2922 4905 7887 12232 18395 26936 38535 54008 74324 100623 134235 176700 229789
;; small program: loop(loop(loop(loop(loop(x + y, y, x), y, x), y, x) - 2, y, x), 2 + x, x) + 2
;; fast program: loop(((2 * ((x + x) + x)) div y) + x, 1 + x, 1) - loop(x * x, 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (v5 x) (v6 x)))))
