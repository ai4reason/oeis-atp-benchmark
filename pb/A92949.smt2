;; sequence(s): A92949
;; terms: 6 9 13 19 25 31 37 43 53 61 69 79 85 91 101 113 121 129 139 145
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 2, 1, x) + 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + x, 1 + y, 2, 1, 1 + x) + 2
(set-logic UFNIA)
