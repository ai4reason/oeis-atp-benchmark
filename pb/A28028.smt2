;; sequence(s): A28028
;; terms: 1 21 286 3234 33187 322455 3035152 28040628 256229413 2326373049 21042916258 189930286182 1712158289479 15423616827003 138884571944404 1250325501927096 11254768340210185 101302177508279517
;; small program: loop(((loop((loop(loop((x + x) + x, y + y, 1) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop(((1 + 2) * (x * x)) - x, 1, loop2(x * y, y, x, 1, 1 + 2)) div 2, 1, y) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
