;; sequence(s): A193410
;; terms: 1 3 0 ~54 ~324 ~972 0 17496 104976 314928 0 ~5668704 ~34012224 ~102036672 0 1836660096 11019960576 33059881728 0 ~595077871104
;; small program: loop((x + x) + x, x, loop2(x + y, y - x, x, 1, 0))
;; fast program: (loop2(0 - y, x, x div 2, 1, x mod 2) * loop(x + x, x div 2, 1)) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (= i2 1))
(assert (forall ((x Int)) (= (j2 x) (mod x 2))))
