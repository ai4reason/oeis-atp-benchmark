;; sequence(s): A303427
;; terms: 2 0 1 1 3 1 4 2 7 3 11 5 18 8 29 13 47 21 76 34
;; small program: loop2(y, x + y, x div 2, if (x mod 2) <= 0 then 2 else 0, 1)
;; fast program: loop2(y, x + y, x div 2, loop(0, x mod 2, 2), 1)
(set-logic UFNIA)
