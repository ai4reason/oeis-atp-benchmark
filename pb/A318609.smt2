;; sequence(s): A318609
;; terms: 2 4 6 24 90 252 702 2160 6642 19764 58806 176904 532170 1595052 4780782 14346720 43053282 129146724 387400806 1162241784
;; small program: loop(0 - ((x + x) + x), x div 2, 1) + loop((x + x) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) + loop2(x * y, y, x div 2, 1, 0 - (1 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f0 x) (- 0 (+ (+ x x) x)))))
