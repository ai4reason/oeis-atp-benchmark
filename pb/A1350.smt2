;; sequence(s): A1350
;; terms: 0 1 1 4 5 11 16 29 45 76 121 199 320 521 841 1364 2205 3571 5776 9349
;; small program: loop(loop2(x + y, x, y, 1, 2) - x, x, 1) - 1
;; fast program: loop2(y, x + y, x, 2, 1) - loop(0, x mod 2, 2)
(set-logic UFNIA)
