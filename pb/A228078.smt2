;; sequence(s): A228078
;; terms: 0 0 2 5 12 26 55 114 234 477 968 1958 3951 7958 16006 32157 64548 129474 259559 520106
;; small program: (loop(x + x, x, 1) - 1) - loop2(x + y, x, x, 0, 1)
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) - (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (v2 x) 1) (ite (<= x 0) 0 (w5 x))))))
