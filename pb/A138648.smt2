;; sequence(s): A138648
;; terms: 0 2 24 93 526 1182 8274 42293 296051 1291107 9037749 24201743 169412201 453463532 732838474 17336900568 121358303976 696920237207 3352562754199 12023847482518
;; small program: loop((2 * ((x + x) + x)) + x, x, 1) mod loop((2 * (x + x)) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) mod loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
