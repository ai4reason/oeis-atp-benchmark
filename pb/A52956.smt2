;; sequence(s): A52956
;; terms: 2 3 6 11 21 40 77 149 290 567 1113 2192 4329 8569 16994 33755 67133 133656 266325 531053
;; small program: loop(x + x, x, 1) + loop2(x + y, x, x, 1, 0)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
