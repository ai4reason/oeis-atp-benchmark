;; sequence(s): A130261
;; terms: 0 1 2 4 6 8 10 12 15 18 21 24 27 30 33 36 39 42 45 48
;; small program: loop((loop((y div loop2(x + y, x, x, 1, 0)) + x, y, 1) div 2) + x, x, 0)
;; fast program: loop(loop((loop((y div loop2(x + y, x, x, 1 + 2, 2)) + x, x, 0) + 1) div 2, 1, y) + x, x, x)
(set-logic UFNIA)
