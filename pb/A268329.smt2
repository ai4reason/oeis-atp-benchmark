;; sequence(s): A268329
;; terms: 2 10 40 150 550 2002 7280 26520 96900 355300 1307504 4828850 17895150 66533250 248124000 927983760 3479939100 13082337900 49295766000 186156379500
;; small program: ((loop((2 + (2 + y)) * x, x + x, 1) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + (2 + 2))) * 2
;; fast program: ((loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + (2 + 2)) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + (2 + 2))) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (div (div (v0 x) (v1 x)) (w2 x)) 2))))
...
(assert (forall ((x Int)) (= (fast x) (* (div (div (w3 x) (v4 x)) (w5 x)) 2))))
