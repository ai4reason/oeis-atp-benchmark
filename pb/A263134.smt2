;; sequence(s): A263134
;; terms: 1 5 26 146 861 5229 32361 202905 1284480 8191380 52543545 338641305 2191124301 14224347181 92603307541 604342068085 3952451061076 25898039418496 169977746765071 1117287239602471
;; small program: loop(loop(loop2((2 + y) * x, 1 + y, x, 1, x + x) div loop(x * y, x, 1), 1, y) + x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * (1 + ((x + x) + x)), 1, y) + x, x, 1)
(set-logic UFNIA)
