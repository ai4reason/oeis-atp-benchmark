;; sequence(s): A273264
;; terms: 2 3 4 5 5 5 5 4 3 3 2 1 1 1 0 0 0 0 0 0
;; small program: loop(((y * y) + x) + y, 1 + x, 2) div loop2(x + y, x, x, 2, 1)
;; fast program: (loop((2 + (x * x)) * x, 1, 2 + x) div (1 + 2)) div loop2(x + y, x, x, 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (div (v2 x) (+ 1 2)) (w3 x)))))
