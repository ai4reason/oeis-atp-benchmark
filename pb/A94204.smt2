;; sequence(s): A94204
;; terms: 1 2 2 2 6 6 2 6 2 4 6 6 4 4 4 4 2 2 6 6
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) - x, 1 + y, 2, 0, x + x)
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 1 + y, 2, 0, x + x)
(set-logic UFNIA)
