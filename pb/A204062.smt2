;; sequence(s): A204062
;; terms: 1 4 26 148 867 5048 29428 171512 999653 5826396 33958734 197925996 1153597255 6723657520 39188347880 228406429744 1331250230601 7759094953844 45223319492482 263580822001028
;; small program: loop(loop(loop2((2 * ((x + x) + x)) - y, x, y, 1, 0) - x, y, 1) - x, x, 1)
;; fast program: loop(loop(((loop2((2 * ((x + x) + x)) - y, x, x, 1 + (2 + (2 + 2)), 1) div (2 + 2)) + 1) div 2, 1, y) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (div (+ (div (w5 x) (+ 2 2)) 1) 2))))
(assert (= g4 1))
