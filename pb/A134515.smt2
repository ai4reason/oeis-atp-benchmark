;; sequence(s): A134515
;; terms: 1 0 0 10 15 168 1008 8244 73125 726440 7939008 94744494 1225760627 17088219120 255365758560 4072255216296 69021889788969 1239055874931312 23484788783212480 468656477004105810
;; small program: loop(loop((x * y) + loop(0 - x, y, 1), y - 1, 1) - x, x, 1) * loop((1 + x) + y, x, 1)
;; fast program: loop(loop((x * y) + loop(0 - x, y, 1), y - 1, 1) - x, x, 1) * (((1 + x) * (2 + x)) div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (v4 x) (div (* (+ 1 x) (+ 2 x)) 2)))))
