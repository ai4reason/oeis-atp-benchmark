;; sequence(s): A122685
;; terms: 1 1 ~2 6 0 120 0 5040 0 362880 0 39916800 0 6227020800 0 1307674368000 0 355687428096000 0 121645100408832000
;; small program: loop2(x * y, 1 + y, x - 1, 1, 0 - loop(0 - x, x, 2))
;; fast program: loop2(x * y, 1 + y, x - 1, 1, 2 - loop(0, x mod 2, 2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j0 x) (- 0 (v1 x)))))
