;; sequence(s): A34386
;; terms: 1 1 2 6 6 30 30 210 210 210 210 2310 2310 30030 30030 30030 30030 510510 510510 9699690
;; small program: loop(((loop((loop(x * y, x, x) mod (1 + x)) mod 2, 1, y) * x) * y) + x, x - 1, 1)
;; fast program: loop(loop(if (loop((1 - loop(x + x, (x div 2) - 1, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1, 1, y) * x, x - 1, 1)
(set-logic UFNIA)
