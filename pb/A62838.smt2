;; sequence(s): A62838
;; terms: 1 8 27 125 216 343 1000 1331 2197 2744 3375 4913 6859 9261 10648 12167 17576 24389 27000 29791
;; small program: loop2((compr(loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x, y) * x) + x, y, 1 + 2, 1, x)
;; fast program: loop2((compr(loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x - (x div 2), x) - x, y) * x) + x, y, 1 + 2, 1, x)
(set-logic UFNIA)
