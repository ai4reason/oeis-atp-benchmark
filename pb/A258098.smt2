;; sequence(s): A258098
;; terms: 79 238 119 358 179 538 269 808 404 202 101 304 152 76 38 19 58 29 88 44
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop((2 + x) * x, 2, 2) - 1)
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(x * x, 2, 1 + 2) - 2)
(set-logic UFNIA)
