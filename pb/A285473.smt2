;; sequence(s): A285473
;; terms: 1 11 1 1111 1 111111 1 11111111 1 1111111111 1 111111111111 1 11111111111111 1 1111111111111111 1 111111111111111111 1 11111111111111111111
;; small program: loop(1 + (2 * ((2 * (x + x)) + x)), (x mod 2) * x, 1)
;; fast program: loop2(loop2(1 + (x * y), y, y, 1, 2 + (2 * (2 + 2))), 0, x mod 2, 1, x)
(set-logic UFNIA)
