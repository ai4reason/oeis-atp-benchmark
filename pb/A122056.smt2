;; sequence(s): A122056
;; terms: 0 0 1 3 6 10 15 21 28 36 46 58 72 88 106 126 148 172 199 229
;; small program: loop(loop(loop((y mod 2) + x, (y div 2) div 2, x), 2 + y, x), x, 0)
;; fast program: loop(loop((y div (2 * (2 + 2))) + x, y - 2, x) + y, x, 0) - x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (div y (* 2 (+ 2 2))) x))))
