;; sequence(s): A55417
;; terms: 1 3 6 11 20 36 63 106 171 265 396 573 806 1106 1485 1956 2533 3231 4066 5055
;; small program: 1 + loop(loop(loop(x + y, y - 2, x), y, x) + y, x, x)
;; fast program: ((loop((x * x) + x, 1, 2 + (((x * x) - x) div 2)) div (2 + (2 + 2))) + x) + x
(set-logic UFNIA)
