;; sequence(s): A66601
;; terms: 0 1 0 1 3 3 3 1 0 9 3 9 3 9 12 1 3 9 3 1
;; small program: loop((x + x) + x, 1 + x, 1) mod (1 + x)
;; fast program: loop2(loop(loop2(x * y, y, x - (x div 2), 1, 1 + 2), 1, y) * x, 1 + y, 2, 1, x) mod (1 + x)
(set-logic UFNIA)
