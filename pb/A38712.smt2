;; sequence(s): A38712
;; terms: 1 3 1 7 1 3 1 15 1 3 1 7 1 3 1 31 1 3 1 7
;; small program: loop2(((y mod x) * 2) + 2, y, x, 2, x) - 1
;; fast program: ((loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 1) + x, x mod 2, x) - x) * 2) + 1
(set-logic UFNIA)
