;; sequence(s): A107660
;; terms: 1 6 21 72 225 702 2133 6480 19521 58806 176661 530712 1592865 4780782 14344533 43040160 129127041 387400806 1162222101 3486725352
;; small program: loop(((x + x) + loop2((y + y) + y, x, y, 1, 1)) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 * (2 + 2)), x mod 2, 1 + 2), 1 + (2 * (2 + 2))) - loop2(x * y, y, x div 2, 2 + (x mod 2), 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (+ (+ x x) (w1 x y)) x))))
