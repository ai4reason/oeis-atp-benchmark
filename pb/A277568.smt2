;; sequence(s): A277568
;; terms: 2 8 12 14 20 26 32 38 44 48 50 56 62 68 72 74 80 84 86 92
;; small program: (compr(((loop(x div loop(1, x mod (2 + (2 + 2)), 2 + (2 + 2)), x div 2, x) mod (1 + 2)) + 1) mod 2, x) + 0) * 2
;; fast program: compr(((loop(x div (if (x mod (2 + (2 + 2))) <= 0 then (2 + (2 + 2)) else 1), x div (1 + 2), x) mod (1 + 2)) - 1) mod (1 + x), 1 + x) * 2
(set-logic UFNIA)
(declare-fun f2 () Int)
