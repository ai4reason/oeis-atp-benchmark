;; sequence(s): A70406
;; terms: 1 7 4 13 1 7 4 13 1 7 4 13 1 7 4 13 1 7 4 13
;; small program: loop(loop(2 + (x + y), 2, loop(y - x, x, x)), x, 1)
;; fast program: loop2(1 + (2 + (2 + y)), x - y, x mod (2 + 2), 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ 1 (+ 2 (+ 2 y))))))
