;; sequence(s): A270301
;; terms: 136 152 184 232 248 296 328 344 376 424 472 488 536 568 584 632 664 712 776 808
;; small program: ((loop(compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + x) + 1, 1, 2 + (2 + x)) * 2) * 2) * 2
;; fast program: ((loop((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, x) * 2) + 1, 1, 2 + (2 + (2 + x))) * 2) * 2) * 2
(set-logic UFNIA)
