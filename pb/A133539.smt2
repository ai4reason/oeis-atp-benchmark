;; sequence(s): A133539
;; terms: 1834 4023 8909 15643 27467 50525 78119 123859 185921 253261 332695 451781 606507 764567 985823 1239911 1480051 1767711 2112517 2516723
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * (x * x), y, 2, 1, x), 1, y) + x, 1 + y, 1 + (2 + 2), 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), (1 + x) mod 2, x) - 2, 1 + y) + 1) * x, y, 1 + 2, 1, x), 1, y) + x, 1 + y, 1 + (2 + 2), 1, x) - 1
(set-logic UFNIA)
