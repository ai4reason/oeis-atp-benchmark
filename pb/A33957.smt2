;; sequence(s): A33957
;; terms: 3 4 6 6 6 6 6 10 8 8 10 6 6 10 12 8 8 10 6 8
;; small program: loop2(compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 2 + y, 2, 0, x)
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 2 + y, 2, 0, x)
(set-logic UFNIA)
