;; sequence(s): A52964
;; terms: 1 0 3 1 10 7 35 36 127 165 474 715 1807 3004 6995 12393 27370 50559 107883 204820
;; small program: loop((x + loop2(y - x, x, y, 1, 0 - 1)) + x, x, 1)
;; fast program: (loop2(y - x, x, 2 + x, 2, 1) + loop(x + x, x, 2)) div (1 + (2 + 2))
(set-logic UFNIA)
