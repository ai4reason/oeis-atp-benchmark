;; sequence(s): A90914
;; terms: 1 1 12 1800 3528000 93350880000 34157460395520000 176018448722253096960000 12957844528516872887046144000000 13783997562964632581368087262085120000000
;; small program: loop(loop((x * y) div (y - (y div 2)), y, x), x + x, 1) div (1 + x)
;; fast program: loop(loop(loop2((1 + y) * (x * y), 1 + y, x, 1, 2 + x) div loop((y * x) * y, x, 1), 1, y) * x, x - 1, 1)
(set-logic UFNIA)
