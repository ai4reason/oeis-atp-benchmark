;; sequence(s): A18718
;; terms: 1 2 3 4 6 8 12 16 19 24 38 48 57 76 114 152 228 304 456 912
;; small program: loop(compr(loop((x + y) * (x * y), 1 + 2, 1) mod (1 + x), y), x, 0) + 1
;; fast program: loop2(compr((2 * (2 * loop((2 + (x * x)) * x, 1, 2 + (2 + 2)))) mod (1 + x), y) + x, y, 2, 2, x) div 2
(set-logic UFNIA)
