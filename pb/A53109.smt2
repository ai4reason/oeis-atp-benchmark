;; sequence(s): A53109
;; terms: 1 100 5500 220000 7150000 200200000 5005000000 114400000000 2431000000000 48620000000000 923780000000000 16796000000000000 293930000000000000 4974200000000000000 81719000000000000000
;; small program: loop2(loop((loop((x + x) + x, 2, x) div y) + x, y, x), 1, 1 + x, 1, x)
;; fast program: (loop2(x * y, 1 + y, x, 1, 2 + (2 * (2 + 2))) div loop(x * y, x, 1)) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
