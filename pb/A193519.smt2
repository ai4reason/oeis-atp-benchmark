;; sequence(s): A193519
;; terms: 0 0 2 10 40 144 490 1610 5168 16320 50930 157546 484120 1480080 4507162 13683050 41439200 125259264 378051170 1139641930
;; small program: loop((x + x) + x, x, 1) - loop2((x + x) + y, x, x, 1, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop2((x + x) + y, x, x, 1, 1)
(set-logic UFNIA)
