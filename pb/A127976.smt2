;; sequence(s): A127976
;; terms: 1 1 5 9 25 53 125 273 609 1325 2885 6217 13353 28517 60685 128641 271857 572829 1203925 2524345
;; small program: loop(loop(loop(x + x, y, 2 + y) - x, y, 2) - x, x, 2) div 2
;; fast program: loop(loop(loop(x + x, y, (1 + 2) + y) - x, y - 1, 2) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (h5 x y) (+ (+ 1 2) y))))
