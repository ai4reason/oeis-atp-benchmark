;; sequence(s): A179432
;; terms: 1 2 15 816 316251 873642672 17743125256857 2739097835911193328 3301626910467952067341626 31698997711344336177849363574320 2460103385023594223069956382123378560008
;; small program: loop2(x * y, y - 1, x, 1, loop((x + x) + x, x - 1, 2)) div loop(x * y, x, 1)
;; fast program: loop2(x * y, y - 1, x, 1, loop2(x * y, y, x - 1, 2, 1 + 2)) div loop(x * y, x, 1)
(set-logic UFNIA)
