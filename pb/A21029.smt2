;; sequence(s): A21029
;; terms: 1 12 97 672 4333 26964 164809 998184 6017605 36192156 217414561 1305276336 7834033117 47011340388 282089500153 1692601439928 10155802087669 60935393132460 365614101138385
;; small program: loop(((loop2((2 * (((x + x) + x) + y)) - 1, y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop(((((loop2(x * y, y, x, 1, 2 + (2 + 2)) div (1 + (2 + 2))) + 1) + loop(x + x, x, 1)) - loop2(x * y, y, x, 1, 1 + 2)) div 2, 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (div (- (+ (+ (div (w3 x) (+ 1 (+ 2 2))) 1) (v4 x)) (w5 x)) 2))))
(assert (= g2 1))
