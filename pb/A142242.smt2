;; sequence(s): A142242
;; terms: 2 2 0 2 0 0 ~4 2 0 0 ~4 0 ~4 ~4 ~12 2 0 0 ~4 0
;; small program: (loop(loop((2 + x) mod (1 + y), x, 0), x, x) * (0 - 1)) + 2
;; fast program: ((loop(loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), 1 + (x mod 2), x div 2), 1, 1 + x) - 2) - 2) * (1 - 2)
(set-logic UFNIA)
