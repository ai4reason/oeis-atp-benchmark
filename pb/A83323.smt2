;; sequence(s): A83323
;; terms: 1 2 6 20 66 212 666 2060 6306 19172 58026 175100 527346 1586132 4766586 14316140 42981186 129009092 387158346 1161737180
;; small program: 1 + loop2(((x + x) + x) + y, y + y, x, 0, 1)
;; fast program: 1 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x, 1))
(set-logic UFNIA)
