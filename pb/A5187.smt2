;; sequence(s): A5187
;; terms: 0 1 3 4 7 8 10 11 15 16 18 19 22 23 25 26 31 32 34 35
;; small program: loop2(x + y, y div 2, x, 0, x)
;; fast program: loop2(((y div 2) + x) + y, y div (2 + 2), 1 + 2, x, x div 2)
(set-logic UFNIA)
