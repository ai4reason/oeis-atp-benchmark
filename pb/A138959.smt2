;; sequence(s): A138959
;; terms: 0 3 14 12 346 1518 12144 65902 370966 1405228 9288699 45012717 115961111 439407638 3515261104 28122088832 102906398156 365487513373 1398021200734 14998866871497
;; small program: loop(x + x, (x + x) + x, 1) mod loop((2 * (x + x)) + x, x, 1)
;; fast program: loop((x * x) * x, 1, loop(x + x, x - 1, 2)) mod loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
