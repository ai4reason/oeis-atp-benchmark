;; sequence(s): A270775
;; terms: 2 12 80 252 1100 1872 4352 6156 11132 22736 27900 47952 65600 75852 99452 143312 198476 219600 291852 347900
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * (x * x)) - 1, y, 2, 1, x) + 1
