;; sequence(s): A309057
;; terms: 1 1 3 1 9 3 3 1 27 9 9 3 9 3 3 1 81 27 27 9
;; small program: loop2(((loop((loop(1, x, x) + x) mod 2, 1, y) * 2) * x) + x, y div 2, x, 1, x)
;; fast program: loop2(((loop((loop(y, x mod 2, 2) + x) mod (1 + x), 1, y) * 2) * x) + x, y div 2, 2 + (2 + 2), 1, x)
(set-logic UFNIA)
(declare-fun f2 () Int)
