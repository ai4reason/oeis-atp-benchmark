;; sequence(s): A130053
;; terms: 1 2 3 5 7 10 14 18 23 29 36 44 52 61 71 82 94 107 121 136
;; small program: loop(loop(y div (2 + x), x + x, 0) + x, x, 1)
;; fast program: loop2((if (x - y) <= 0 then x else y) + x, y - 1, x, 1, x)
(set-logic UFNIA)
