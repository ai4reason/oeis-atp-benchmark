;; sequence(s): A130624
;; terms: 0 1 5 12 23 43 84 169 341 684 1367 2731 5460 10921 21845 43692 87383 174763 349524 699049
;; small program: loop((loop2(1 + y, y - x, y - 1, 1, 2) + x) + x, x, 0)
;; fast program: (((loop(x + x, x, 2) - loop2(x - y, x, x - 1, 2, 2)) * 2) + 1) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (* (- (v2 x) (w3 x)) 2) 1) (+ 1 2)))))
