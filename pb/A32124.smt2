;; sequence(s): A32124
;; terms: 2 5 12 33 90 261 756 2241 6642 19845 59292 177633 532170 1595781 4785156 14353281 43053282 129153285 387440172 1162300833
;; small program: loop((x + x) + x, x, 1) + loop2(y, (x + x) + x, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, 1 + (x mod 2), 1 + 2) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
