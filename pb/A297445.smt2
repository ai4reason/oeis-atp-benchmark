;; sequence(s): A297445
;; terms: 1 5 11 47 101 425 911 3827 8201 34445 73811 310007 664301 2790065 5978711 25110587 53808401 225995285 484275611 2033957567
;; small program: loop(1 + ((x + x) + x), x, 2 + (x mod 2)) div 2
;; fast program: loop2(2 + (x * y), y, x div 2, loop(1 + (2 + 2), x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
