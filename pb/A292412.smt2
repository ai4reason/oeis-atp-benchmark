;; sequence(s): A292412
;; terms: 1 1 2 4 5 11 13 29 34 76 89 199 233 521 610 1364 1597 3571 4181 9349
;; small program: loop2(y, x + y, x, 1 + (x mod 2), 1)
;; fast program: loop2(x + y, x, x - 1, 1, 1 + (x mod 2))
(set-logic UFNIA)
