;; sequence(s): A25942
;; terms: 1 23 361 4907 62545 773171 9415897 113824139 1370909089 16481083619 197954225833 2376538571771 28524991618033 342339076723667 4108303998843769 49301058498065003 591621165177427777
;; small program: loop((loop(loop2(((2 * (y * y)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + x) + x, x, 1)
;; fast program: loop((loop((loop((2 * ((x * x) div (1 + 2))) - x, 1, loop(x + x, x, 2)) + 1) * loop((x + x) + x, x, 1), 1, y) + x) + x, x, 1)
(set-logic UFNIA)
