;; sequence(s): A254332
;; terms: 1 3 22 96 817 3627 31006 137712 1177393 5229411 44709910 198579888 1697799169 7540806315 64471658494 286352060064 2448225223585 10873837476099 92968086837718 412919472031680
;; small program: (loop2((2 * ((x + x) + x)) + y, x, x, 1, loop(0 - x, x, 1)) div 2) + 1
;; fast program: (loop2((2 * ((x + x) + x)) + y, x, x, 1, loop(0 - 1, x mod 2, 1)) div 2) + 1
(set-logic UFNIA)
