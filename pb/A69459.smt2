;; sequence(s): A69459
;; terms: 1 8 124 2400 161050 4826808 410338672 16983563040 1801152661462 420707233300200 25408476896404830 6582952005840035280 925103102315013629320 73885357344138503765448 12063348350820368238715342 3876269050118516845397872320 1271991467017507741703714391418
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + x, 1, x) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + 1) * x, y, 1 + x, 1, 1 + x) - 1
(set-logic UFNIA)
