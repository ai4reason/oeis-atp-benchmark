;; sequence(s): A135553
;; terms: 1 3 5 7 9 15 21 25 35 45 49 63 75 105 147 175 225 245 315 441
;; small program: loop(compr(loop((((y mod 2) + y) * x) + x, 2 + (2 + 2), 1) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop(x * x, 1, 1 + (2 * (2 * (2 + (2 * (2 * (2 + (2 + 2)))))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
