;; sequence(s): A5653
;; terms: 2 4 5 7 10 12 13 15 18 20 23 25 26 28 31 33 34 36 38 39
;; small program: compr(loop(2 + (((y * y) div x) + y), x + x, 2) mod 2, 1 + x)
;; fast program: compr(loop2(((y * y) div (2 + x)) + y, 1 + y, 1 + x, 1, x) mod 2, 1 + x)
(set-logic UFNIA)
