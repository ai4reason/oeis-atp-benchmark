;; sequence(s): A92339
;; terms: 0 0 0 1 1 0 1 2 2 1 0 1 2 1 2 3 3 2 1 2
;; small program: loop2(loop((loop(2 - y, x, x) div 2) mod 2, 1, y) + x, y div 2, x, 0, x)
;; fast program: loop2(loop(loop(x + y, x - 2, 2) mod 2, 1, y) + x, y div 2, x, 0, x)
(set-logic UFNIA)
