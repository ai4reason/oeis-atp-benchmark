;; sequence(s): A188299
;; terms: 3 6 9 10 13 16 17 20 23 26 27 30 33 34 37 40 43 44 47 50
;; small program: ((loop(((((y * y) div 2) + y) div (x * x)) + x, x, 1) * 2) + 1) + x
;; fast program: loop(((((((2 * (x + x)) div (1 + (2 * (2 * (2 * (2 + 2)))))) + x) + x) div (1 + 2)) * 2) + x, 1, 1 + x) + 2
(set-logic UFNIA)
