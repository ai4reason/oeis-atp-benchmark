;; sequence(s): A221874
;; terms: 1 5 43 191 1633 7253 62011 275423 2354785 10458821 89419819 397159775 3395598337 15081612629 128943316987 572704120127 4896450447169 21747674952197 185936173675435 825838944063359
;; small program: loop2((2 * ((x + x) + x)) + y, x, x, 1, loop(0 - x, x, 1))
;; fast program: loop2((2 * ((x + x) + x)) + y, x, x, 1, loop(0 - 1, x mod 2, 1))
(set-logic UFNIA)
