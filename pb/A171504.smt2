;; sequence(s): A171504
;; terms: 2 6 9 12 14 16 19 22 24 26 29 32 34 36 39 41 43 45 47 50
;; small program: (loop(compr(loop(x * y, x, 2) mod (2 + x), y) + 1, x, 0) + 2) + x
;; fast program: (compr(loop((if (loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, x div 2, x) mod (1 + x), x) + 2) + x
(set-logic UFNIA)
