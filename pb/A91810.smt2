;; sequence(s): A91810
;; terms: 1 2 96 497664 825564856320 1027134771639091200000 1932215036193527461576704000000000 9973959265081827837426668870219857920000000000000
;; small program: loop(loop(((y div 2) * x) + x, y, x), x + x, 1)
;; fast program: loop(x * x, 2, loop(loop(x * y, y, x), x, 1)) * loop(x * y, x, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (* (div y 2) x) x))))
