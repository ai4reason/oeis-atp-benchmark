;; sequence(s): A28892
;; terms: ~1 0 ~1 0 ~1 1 0 5 5 18 23 57 80 169 249 482 731 1341 2072 3669
;; small program: loop2(x + y, x, x, 0, 1) - loop(x + x, x div 2, 1)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) - loop(x + x, x div 2, 1)
(set-logic UFNIA)
