;; sequence(s): A23515
;; terms: 1 5 14 34 76 142 220 322 436 666 898 1146 1516 1762 2020 2490 3126 3598 4086 4756
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), y) * x) + x, 1 + y, 2, 1, x) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) * x) + x, 1 + y, 2, 1, x) - 1
(set-logic UFNIA)
