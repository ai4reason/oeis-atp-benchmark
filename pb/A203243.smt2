;; sequence(s): A203243
;; terms: 3 39 390 3630 33033 298389 2688780 24208860 217909263 1961271939 17651713170 158866215690 1429798332693 12868192168689 115813751041560 1042323823944120 9380914609207323 84428232063996639 759854090319361950
;; small program: loop(loop((x div 2) * x, 1, loop((x + x) + x, y, 1)) + x, 1 + x, 0)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div 2) div (2 + 2), 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h4 x) (div (w5 x) 2))))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int)) (= (v4 x) (u4 g4 (h4 x)))))
(assert (forall ((x Int)) (= (f3 x) (div (v4 x) (+ 2 2)))))
(assert (= g3 1))
