;; sequence(s): A180447
;; terms: 0 1 1 1 1 2 2 2 2 2 2 2 3 3 3 3 3 3 3 3
;; small program: loop(loop((y div 2) + x, x, y) div x, x + x, 1) div 2
;; fast program: ((loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x div (1 + 2)) + x, 1 + 2, x) - 1) - x) div (1 + 2)
(set-logic UFNIA)
