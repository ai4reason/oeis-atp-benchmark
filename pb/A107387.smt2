;; sequence(s): A107387
;; terms: 0 1 1 2 3 7 16 41 105 274 715 1871 4896 12817 33553 87842 229971 602071 1576240 4126649
;; small program: loop2((2 * ((x div 2) + x)) - y, 2 + x, x, 1, 0) div 2
;; fast program: loop2(loop2(x + y, x, y, 1, 0 - 2) * x, 1 + y, 2, 1, x) + 1
(set-logic UFNIA)
