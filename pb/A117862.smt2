;; sequence(s): A117862
;; terms: 0 2 4 10 16 34 52 106 160 322 484 970 1456 2914 4372 8746 13120 26242 39364 78730
;; small program: loop2(y, (2 * (2 + x)) + x, x, 0, 2)
;; fast program: loop(x + x, x mod 2, loop2(x * y, y, x div 2, 2, 1 + 2)) - 2
(set-logic UFNIA)
