;; sequence(s): A6096
;; terms: 1 15 155 1395 11811 97155 788035 6347715 50955971 408345795 3269560515 26167664835 209386049731 1675267338435 13402854502595 107225699266755 857817047249091 6862582190715075 54900840777134275 439207459223777475
;; small program: loop((loop2((((y - 1) + y) * (y * y)) + x, y + y, y, 1, 2) + x) + x, x, 1)
;; fast program: loop(loop(loop(((x - 1) + x) * ((x * x) - x), 1, loop(x + x, x, 2)) div (1 + 2), 1, y) + x, x, 2) div 2
(set-logic UFNIA)
