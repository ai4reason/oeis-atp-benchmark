;; sequence(s): A216369
;; terms: 0 0 1 2 4 2 6 6 1 6 1 2 10 8 4 6 13 8 9 6
;; small program: loop((x * y) + loop(0 - x, y, 1), x, 1) mod (1 + x)
;; fast program: (loop(1 - (x * y), x, 1) * loop(0 - x, x mod 2, 1)) mod (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (* (v2 x) (v3 x)) (+ 1 x)))))
