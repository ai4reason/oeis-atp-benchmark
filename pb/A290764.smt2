;; sequence(s): A290764
;; terms: 3 15 54 174 537 1629 4908 14748 44271 132843 398562 1195722 3587205 10761657 32285016 96855096 290565339 871696071 2615088270 7845264870
;; small program: loop((1 + 2) * (x + y), 1 + x, 0)
;; fast program: loop(((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - x) - x) div (2 + 2), 1, 2 + x) * (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (div (- (- (w2 x) x) x) (+ 2 2)))))
(assert (= g1 1))
