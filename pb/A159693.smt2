;; sequence(s): A159693
;; terms: 1 2 4 8 11 20 24 40 45 70 76 112 119 168 176 240 249 330 340 440
;; small program: loop(loop(loop(x * x, x mod 2, 1 + (x div 2)), 1, y) + x, x, 1)
;; fast program: loop(loop(loop((2 + x) * x, x mod 2, x div 2), 1, y) + x, x, 1) + x
(set-logic UFNIA)
