;; sequence(s): A79496
;; terms: 1 1 3 5 17 29 99 169 577 985 3363 5741 19601 33461 114243 195025 665857 1136689 3880899 6625109
;; small program: loop2((y - x) - x, x, x, 1 - (x mod 2), 1)
;; fast program: loop2((2 * ((x + x) + x)) - y, x, x div 2, 1, loop(1, x mod 2, 1 + 2))
(set-logic UFNIA)
