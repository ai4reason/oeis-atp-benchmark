;; sequence(s): A133224
;; terms: 0 2 14 78 400 1960 9312 43232 197120 885888 3934720 17307136 75509760 327182336 1409343488 6039920640 25770065920 109522223104 463857647616 1958507577344
;; small program: loop2((2 * (x + x)) - y, y + y, x - 1, 2, 1) * x
;; fast program: (loop(((1 + 2) * (x * x)) + x, 1, loop(x + x, x - 1, 1)) div 2) * x
(set-logic UFNIA)
