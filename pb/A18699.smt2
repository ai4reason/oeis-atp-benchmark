;; sequence(s): A18699
;; terms: 1 2 4 5 8 10 11 16 20 22 40 44 55 80 88 110 176 220 440 880
;; small program: loop(compr((2 * loop((x + y) * x, 2, 2 + 2)) mod (1 + x), y), x, 0) + 1
;; fast program: loop2(compr((2 * loop((x + y) * x, 2, 2 + 2)) mod (1 + x), y) + x, y, 2, 2, x) div 2
(set-logic UFNIA)
