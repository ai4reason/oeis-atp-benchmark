;; sequence(s): A87480
;; terms: 2 11 136 2537 163588 4990397 415329070 17398892111 1818551553574 422525784853775 25831002681258606 6608783008521293887 931711885323534923208 74817069229462038688657
;; small program: loop(loop(loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, y, 1 + x, 1, x), 1, y) + x, x, 2)
;; fast program: loop(loop(loop2(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 1 + x, 1, x), 1, y) + x, x, 2)
(set-logic UFNIA)
