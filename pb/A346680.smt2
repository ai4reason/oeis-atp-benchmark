;; sequence(s): A346680
;; terms: 1 0 4 18 122 847 6237 47583 373149 2989111 24354777 201214021 1681719343 14193619647 120800146953 1035593096367 8934344395053 77510878324671 675799844685937 5918354494345863
;; small program: loop(loop(loop2(x * y, y - 1, x - 1, 1, 2 * (x + x)) div loop(x * y, x, 1), 1, y) - x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + ((x + x) + x)) div loop(x * y, x, 1), 1, y) - x, x, 1)
(set-logic UFNIA)
