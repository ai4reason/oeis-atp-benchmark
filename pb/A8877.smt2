;; sequence(s): A8877
;; terms: 57 172 86 43 130 65 196 98 49 148 74 37 112 56 28 14 7 22 11 34
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(1 + ((x * x) + x), 2, 2))
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + loop((x * x) - x, 1, 2 * (2 + 2)))
(set-logic UFNIA)
