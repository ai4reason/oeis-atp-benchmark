;; sequence(s): A68113
;; terms: 1 3 5 7 11 143 221 323 7429 437 667 20677 899 33263 1363783 2022161 3065857 3065857 162490421 4391633
;; small program: loop2(((loop((loop(x * y, x, 2) div (1 + x)) mod 2, 1, y) * x) * y) + x, 1 + y, x, 1, x + x)
;; fast program: loop2(loop(if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1, 1, y) * x, 1 + y, x, 1, x + x)
(set-logic UFNIA)
