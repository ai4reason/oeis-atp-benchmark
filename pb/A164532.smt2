;; sequence(s): A164532
;; terms: 1 4 6 24 36 144 216 864 1296 5184 7776 31104 46656 186624 279936 1119744 1679616 6718464 10077696 40310784
;; small program: loop2(y + y, (x + x) + x, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, loop(2 + 2, x mod 2, 1), 2 + (2 + 2))
(set-logic UFNIA)
