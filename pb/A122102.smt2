;; sequence(s): A122102
;; terms: 16 97 722 3123 17764 46325 129846 260167 540008 1247289 2170810 4044971 6870732 10289533 15169214 23059695 35177056 49022897 69174018 94585699
;; small program: loop(loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), y) * x) + x, y, 2 + 2, 1, x), 1, y) + x, 1 + x, 0)
;; fast program: loop(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + 1) * ((x * x) * x), y, 2, 1, x), 1, y) + x, 1 + x, 0)
(set-logic UFNIA)
