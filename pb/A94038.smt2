;; sequence(s): A94038
;; terms: 0 1 2 8 24 84 280 960 3264 11152 38048 129920 443520 1514304 5170048 17651712 60266496 205762816 702517760 2398545920
;; small program: (loop2(((x + x) + x) + y, x + y, x, 0, 1) + loop2(x + y, x - y, x, 0, 1)) div 2
;; fast program: (((((loop2(2 * ((x - y) + x), x, x - 1, 1, 0) div loop(x + x, x div 2, 1)) * (if x <= 0 then 1 else 2)) div 2) + 1) div 2) * loop2(x * y, y, x div 2, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (+ (div (* (div (w2 x) (v3 x)) (ite (<= x 0) 1 2)) 2) 1) 2) (w4 x)))))
