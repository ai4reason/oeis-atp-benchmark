;; sequence(s): A94966
;; terms: 0 1 1 3 3 8 8 21 21 55 55 144 144 377 377 987 987 2584 2584 6765
;; small program: loop2(y, x + y, x, x mod 2, 1)
;; fast program: if x <= 0 then 0 else loop2(((x - y) + x) + x, x, (x - 1) div 2, 1, 0)
(set-logic UFNIA)
