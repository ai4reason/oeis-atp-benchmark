;; sequence(s): A136201
;; terms: 0 0 0 1 2 8 18 53 124 328 780 1969 4718 11648 28014 68405 164824 400240 965304 2337409
;; small program: ((loop2(y, (x + y) + y, x, 1, 1) - loop2(y, (x + x) + x, x, 1, 1)) div 2) div 2
;; fast program: ((loop2((x + x) + y, x, x - 2, if x <= 0 then 1 else (1 + 2), 1) - loop2(x * y, y, x div 2, 1, 1 + 2)) div 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (div (- (w0 x) (w1 x)) 2) 2))))
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ x x) y))))
(assert (forall ((x Int)) (= (g2 x) x)))
(assert (forall ((x Int)) (= (h2 x) (- x 2))))
(assert (forall ((x Int)) (= (i2 x) (ite (<= x 0) 1 (+ 1 2)))))
(assert (= j2 1))
