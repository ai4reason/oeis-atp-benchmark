;; sequence(s): A223925
;; terms: 1 4 3 16 5 64 7 256 9 1024 11 4096 13 16384 15 65536 17 262144 19 1048576
;; small program: if (x mod 2) <= 0 then (1 + x) else loop(x + x, x, 2)
;; fast program: 1 + loop(loop(x * x, 1, loop(x + x, x div 2, 2)) - y, x mod 2, x)
(set-logic UFNIA)
