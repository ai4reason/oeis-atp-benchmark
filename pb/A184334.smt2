;; sequence(s): A184334
;; terms: 1 2 2 0 ~2 ~2 0 2 2 0 ~2 ~2 0 2 2 0 ~2 ~2 0 2
;; small program: if x <= 0 then 1 else loop2(y, y - x, x, 0, 2)
;; fast program: loop2(y, y - x, x mod (2 + (2 + 2)), if x <= 0 then 1 else 0, 2)
(set-logic UFNIA)
