;; sequence(s): A166329
;; terms: 36 225 1225 5929 20449 48841 104329 190969 444889 808201 1315609 2301289 3108169 4084441 6205081 9778129 12952801 16703569 22629049 26863489
;; small program: loop2(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, 1 + y, 2, x, y), y, 2, 1, x)
;; fast program: loop(loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + 1) * x, y, 2, 1, x), 1, y) * x, 1 + y, 2, 1, x), 1, 1 + x)
(set-logic UFNIA)
