;; sequence(s): A280076
;; terms: 1 4 9 25 49 121 169 289 361 529 841 961 1369 1681 1849 2209 2809 3481 3721 4489
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), y) * x) + x, y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) * x) + x, y, 2, 1, x)
(set-logic UFNIA)
