;; sequence(s): A261066
;; terms: 6 150 180150 519264540150 8628341205030630049260150 4764689404827483203666304150636608674826622242700150
;; small program: loop2((1 + (x * y)) * x, y + y, 1 + x, 1 + 2, 1) div 2
;; fast program: loop2((1 + (x * y)) * x, y + y, x, 2 + (2 + 2), 2 + 2)
(set-logic UFNIA)
