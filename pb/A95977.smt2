;; sequence(s): A95977
;; terms: 2 4 14 32 82 188 438 984 2202 4852 10622 23056 49762 106796 228166 485448 1029162 2174820 4582670 9631360
;; small program: loop(loop(loop(x + x, y, 1 + y) - x, y, 1) - x, x, 1) * 2
;; fast program: loop((loop2(y - (x mod 2), (x + x) + y, y, 1, 1) + x) + x, x, 1) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (- y (mod x 2)))))
(assert (forall ((x Int) (y Int)) (= (g4 x y) (+ (+ x x) y))))
