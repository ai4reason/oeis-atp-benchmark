;; sequence(s): A345888
;; terms: 1 3 7 10 17 21 31 36 41 46 61 67 85 92 99 106 129 137 163 172
;; small program: (loop((loop((x * y) * y, y, 1) mod (1 + y)) + x, x, 1) * x) + 1
;; fast program: (loop(loop(if (((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2) <= 0 then 1 else 0, 1, y) + x, x div 2, 2) * x) + 1
(set-logic UFNIA)
