;; sequence(s): A116851
;; terms: 1 2 5 14 41 116 307 760 1779 3986 8641 18282 38005 78024 158791 321236 647247 1300630 2609029 5227766
;; small program: (loop(2 * loop(loop(loop(x + y, y - 2, x), y, x), y, x), x, 2) - 1) - x
;; fast program: ((loop((loop(loop((x * x) - x, 1, ((x * x) - x) div 2) div (2 + (2 + 2)), 1, y) + x) + x, x, 1) * 2) - 1) - x
(set-logic UFNIA)
