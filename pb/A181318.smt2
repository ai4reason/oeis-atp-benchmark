;; sequence(s): A181318
;; terms: 0 1 1 9 1 25 9 49 4 81 25 121 9 169 49 225 16 289 81 361
;; small program: loop(x div (2 - (x mod 2)), 2 + 2, x * x)
;; fast program: loop(loop(x div loop(1, x mod 2, 2 + 2), 2, x), 1 - (x mod 2), x * x)
(set-logic UFNIA)
