;; sequence(s): A71228
;; terms: 4 12 24 36 50 72 98 120 144 180 220 252 286 336 375 416 459 504 570 640
;; small program: (compr(loop(x * y, x, 2) mod (1 + x), 2 + x) + 1) * (1 + x)
;; fast program: (compr(loop((if (loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, x div 2, x), 1 + x) + 1) * (1 + x)
(set-logic UFNIA)
