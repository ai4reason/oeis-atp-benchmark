;; sequence(s): A176961
;; terms: 1 2 8 12 36 52 148 212 596 852 2388 3412 9556 13652 38228 54612 152916 218452 611668 873812
;; small program: loop2(y + y, 2 + (x + x), x, 1, 1)
;; fast program: loop2((x * y) + y, y, x div 2, 1 + (x mod 2), 2 + 2)
(set-logic UFNIA)
