;; sequence(s): A90964
;; terms: 1 4 2 5 3 8 6 9 7 12 10 13 11 16 14 17 15 20 18 21
;; small program: (loop2(y - x, 0, x, (x div 2) mod 2, 2) + 1) + x
;; fast program: (if x <= 0 then 1 else loop(y - x, (1 + x) mod (2 + 2), 2)) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i0 x) (mod (div x 2) 2))))
(assert (= j0 2))
