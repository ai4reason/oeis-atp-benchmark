;; sequence(s): A18656
;; terms: 1 5 7 23 35 115 161 805
;; small program: loop(compr(loop((1 + x) * y, 1 + (2 + 2), 2 + 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + (2 * (2 + loop(x * x, 1, 2 * (2 + (2 * (2 + 2))))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
