;; sequence(s): A151334
;; terms: 1 1 5 42 462 6006 87516 1385670 23371634 414315330 7646001090 145862174640 2861142656400 57468093927120
;; small program: loop(x * y, (x + x) + x, 1) div loop((((y * y) + y) * x) * (2 + y), x, 1)
;; fast program: ((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 2 + x)) div loop((2 + y) * x, x, 1)
(set-logic UFNIA)
