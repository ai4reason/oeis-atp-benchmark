;; sequence(s): A55045
;; terms: 5 13 20 21 29 37 45 52 53 61 69 77 80 84 85 93 101 109 116 117
;; small program: compr(loop((loop(x div (if (x mod (2 + 2)) <= 0 then (2 + 2) else 1), x div (2 + (2 + 2)), x) + 1) mod (2 * (2 + 2)), 1, (x + x) + x) - 1, 1 + x)
;; fast program: compr(loop((loop(x div loop(1, x mod (2 + 2), 2 + 2), x div (2 * (2 * (2 + (2 + 2)))), x) + 1) mod (2 * (2 + 2)), 1, (x + x) + x) - 1, 1 + x)
(set-logic UFNIA)
