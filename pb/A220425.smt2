;; sequence(s): A220425
;; terms: 1 5 12 23 40 67 112 191 336 611 1144 2191 4264 8387 16608 33023 65824 131395 262504 524687
;; small program: ((2 + x) * x) + loop(x + x, x, 1)
;; fast program: ((2 + x) * x) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
