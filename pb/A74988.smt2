;; sequence(s): A74988
;; terms: 1 3 7 14 29 59 119 238 476 953 1907 3814 7629 15259 30519 61038 122077 244154 488309 976618
;; small program: loop((loop(if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x) <= 0 then 1 else 0, 1, y) + x) + x, x, 1)
;; fast program: loop((loop(if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x - (x div 2), x) - x) <= 0 then 1 else 0, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
