;; sequence(s): A18707
;; terms: 1 2 3 6 149 298 447 894
;; small program: loop(compr((loop(2 * (((x * x) - x) * x), 2, 2) - 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + (2 + loop((2 + x) * (x * x), 1, 1 + (2 * (2 + 2))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
