;; sequence(s): A179257
;; terms: 1 1 2 5 13 32 72 148 281 499 838 1343 2069 3082 4460 6294 8689 11765 15658 20521
;; small program: loop(loop(loop(loop(x + y, y - 2, x), y, x), y, x) + y, x, 1) - x
;; fast program: (((loop(loop(loop((x * x) - x, 1, ((x * x) - x) div 2) div (1 + 2), 1, y) + x, x, 1) - x) + 1) + (x * x)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (+ (- (v4 x) x) 1) (* x x)) 2))))
