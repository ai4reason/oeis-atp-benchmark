;; sequence(s): A72939
;; terms: 3 7 9 11 15 19 23 25 27 31 33 35 39 41 43 47 51 55 57 59
;; small program: compr(loop(if (x mod 2) <= 0 then ((x div 2) - x) else x, x, x), 1 + x) + 1
;; fast program: compr((loop(loop((if (x mod 2) <= 0 then 2 else x) div 2, 1 + (2 * (2 + 2)), x), 2, x) + 1) mod 2, x) + compr(0, 2)
(set-logic UFNIA)
