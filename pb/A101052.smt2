;; sequence(s): A101052
;; terms: 1 1 3 13 51 181 603 1933 6051 18661 57003 173053 523251 1577941 4750203 14283373 42915651 128878021 386896203 1161212893
;; small program: 2 - loop2(((x - y) + x) + x, y + y, x, 1, 2)
;; fast program: 2 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x, 2))
(set-logic UFNIA)
