;; sequence(s): A6587
;; terms: 3 36 720 16128 380160 9225216 228114432 5715394560 144599482368 3685869158400 94513444945920 2435255516528640 62999001405849600 1635260233414606848 42568679092062781440 1110895735754245275648
;; small program: loop2(2 * (2 * ((x * y) + x)), 1 + y, x, 1 + 2, x + x) div loop(x * y, x, 1)
;; fast program: ((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * (1 + (x + x))) * loop2(x * y, y, x, 1 + 2, 2 + 2)
(set-logic UFNIA)
