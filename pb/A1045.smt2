;; sequence(s): A1045
;; terms: 0 1 1 3 5 11 21 43 85 171 341 683 1365 2731 5461 10923 21845 43691 87381 174763
;; small program: loop2(x + y, x + x, x, 0, 1)
;; fast program: loop(1 + (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)
(set-logic UFNIA)
