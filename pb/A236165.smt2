;; sequence(s): A236165
;; terms: 1 1 0 0 2 3 3 5 10 16 24 39 65 105 168 272 442 715 1155 1869
;; small program: loop2(loop2(x + y, x, y, 1, 0) - x, 2 + y, x div 2, 1, x mod 2)
;; fast program: loop2(x + y, x, x div 2, 1, x mod 2) * loop2(x + y, x, x div 2, 1, 0 - 1)
(set-logic UFNIA)
