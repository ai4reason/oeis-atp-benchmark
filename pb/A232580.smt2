;; sequence(s): A232580
;; terms: 0 0 0 1 4 12 31 74 168 369 792 1672 3487 7206 14788 30185 61356 124308 251199 506578
;; small program: 1 + (loop(x + x, x, 1) - loop2(x + y, x, x, 2, 1))
;; fast program: 1 + (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x + y, x, x, 2, 1))
(set-logic UFNIA)
