;; sequence(s): A24450
;; terms: 4 13 38 87 208 377 666 1027 1556 2397 3358 4727 6408 8257 10466 13275 16756 20477 24966 30007
;; small program: loop(loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, y, 2, 1, y) + x, x, 2) + 2
;; fast program: loop(loop(loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x), 1, y) + x, x, 2) + 2
(set-logic UFNIA)
