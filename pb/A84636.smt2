;; sequence(s): A84636
;; terms: 1 1 2 4 8 16 33 71 157 349 768 1662 3534 7398 15291 31297 63595 128555 258930 520240
;; small program: loop(loop(loop(loop(x + y, (y - 2) - 2, x), y, x), y, x) + x, x - 1, 1)
;; fast program: loop(loop(loop(((y * y) + x) + y, y - 2, x), y - 2, x) + x, x - 1, 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (+ (* y y) x) y))))
