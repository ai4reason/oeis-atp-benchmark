;; sequence(s): A51049
;; terms: 1 1 4 7 16 31 64 127 256 511 1024 2047 4096 8191 16384 32767 65536 131071 262144 524287
;; small program: loop(x + x, x, 1) - (x mod 2)
;; fast program: loop((x - 1) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
