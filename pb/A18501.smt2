;; sequence(s): A18501
;; terms: 1 3 5 7 15 21 25 35 75 105 175 525
;; small program: loop(compr(loop((2 + (2 + x)) * x, 2, 1 + 2) mod (1 + x), y), x, 0) + 1
;; fast program: (compr(((1 + 2) * loop((2 + x) * (x * x), 1, 1 + (2 + 2))) mod (1 + (x + x)), x) * 2) + 1
(set-logic UFNIA)
