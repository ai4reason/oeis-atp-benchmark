;; sequence(s): A28370
;; terms: 1 4 192 5160960 685597979049984000 565069169599661316277495386764665159680000000
;; small program: loop(2 * (x * y), loop(x + x, x, 1), 1) div 2
;; fast program: loop2(loop(loop2(x * y, (2 * (2 + 2)) + y, x, 1, 2 + 2), 1, y) * x, y + y, x, 1, 1)
(set-logic UFNIA)
