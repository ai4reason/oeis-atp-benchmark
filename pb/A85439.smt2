;; sequence(s): A85439
;; terms: 1 82 1378 11378 62003 256484 871140 2550756 6651381 15802006 34776742 71791798 140366759 261917384 469277384 811379400 1359360681 2214396762 3517606762 5462416762
;; small program: loop(loop(x * x, 2, loop((1 + x) + y, y, 1)) + x, x, 1)
;; fast program: (((loop(loop(loop(x * x, 2, (x * x) + x), 1, y) + x, 1 + x, 0) div 2) div 2) div 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (div (div (div (v3 x) 2) 2) 2) 2))))
