;; sequence(s): A120159
;; terms: 15 20 27 36 48 64 85 114 152 202 270 360 480 640 853 1137 1516 2022 2696 3594
;; small program: (loop((x div (1 + 2)) + x, x, loop(2 + (x + x), 2 + 2, 2)) div 2) div 2
;; fast program: loop((x div (1 + 2)) + x, x, (2 * (2 * (2 * (2 + (2 + 2))))) - 1) div (1 + 2)
(set-logic UFNIA)
