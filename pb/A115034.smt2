;; sequence(s): A115034
;; terms: 1 2 2 1 2 2 4 2 8 4 32 8 256 32 8192 256 2097152 8192 17179869184 2097152
;; small program: loop2(y, x * y, loop(y - (x div 1), x, 1), 2, 1)
;; fast program: loop(loop2(y, x * y, x, 2, 1), 1, loop(y - x, x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (- y (div x 1)))))
