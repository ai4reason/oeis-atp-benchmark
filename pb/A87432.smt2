;; sequence(s): A87432
;; terms: 1 1 3 7 19 51 143 407 1179 3451 10183 30207 89939 268451 802623 2402407 7196299 21567051 64657463 193885007
;; small program: loop(((x - loop2(y + y, x + y, y, 1, 0)) + x) + x, x - 1, 1)
;; fast program: ((1 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div 2)) + loop(x + x, x - 1, 2)) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (+ 1 (div (w2 x) 2)) (v4 x)) (+ 1 2)))))
