;; sequence(s): A4399
;; terms: 4 6 10 15 24 34 51 74 112 173 264 414 651 1030 1644 2637 4240 6826 11013 17782
;; small program: (compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + x) + 1) + loop2(x + y, x, x, 2, 1)
;; fast program: ((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, x) * 2) + 1) + loop2(x + y, x, x - 1, 1 + 2, 2)
(set-logic UFNIA)
