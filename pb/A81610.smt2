;; sequence(s): A81610
;; terms: 0 0 1 1 1 2 3 4 5 5 5 6 6 6 7 8 9 10 11 12
;; small program: loop(loop(if (x mod 2) <= 0 then (x div (1 + 2)) else 1, x, y + y) + x, x, 1) - 1
;; fast program: loop(loop(if (loop2((x * y) + x, y div (1 + 2), 2 + 2, 1, x) mod (1 + 2)) <= 0 then 1 else 0, 1, y) + x, x, 0)
(set-logic UFNIA)
