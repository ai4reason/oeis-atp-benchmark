;; sequence(s): A138419
;; terms: 4 24 200 784 4840 9464 27744 43320 93104 235480 307520 624264 941360 1138984 1625824 2629224 4037960 4614040 6715544 8468880
;; small program: (loop2((loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 2, 1, x), 1, y) * x) - 1, y, 2, 1, x) div (1 + 2)) + 1
;; fast program: (loop2((loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x), 1, y) * x) - 1, y, 2, 1, x) div (1 + 2)) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (w5 x) (+ 1 2)) 1))))
