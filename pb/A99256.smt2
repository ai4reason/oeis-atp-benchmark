;; sequence(s): A99256
;; terms: 3 8 9 23 24 61 63 160 165 419 432 1097 1131 2872 2961 7519 7752 19685 20295 51536
;; small program: loop2(x + y, x, x, 1 + (2 + 2), 2) - loop2(y - x, x, x, 2, 1)
;; fast program: loop2(((x - y) + x) + x, x, x div 2, loop(2 + (2 + 2), x mod 2, 1) + 2, x mod 2)
(set-logic UFNIA)
