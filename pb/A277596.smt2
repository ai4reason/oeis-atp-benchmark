;; sequence(s): A277596
;; terms: 9 19 29 39 49 59 69 79 89 90 99 109 119 129 139 149 159 169 179 189
;; small program: compr(((loop(x div loop(1, x mod (2 + (2 * (2 + 2))), 2 + (2 * (2 + 2))), x div (2 + (2 + 2)), x) + 1) mod (2 + (2 * (2 + 2)))) - 1, 1 + x)
;; fast program: compr(((loop(x div loop(1, x mod (2 + (2 * (2 + 2))), 2 + (2 * (2 + 2))), x div (2 + (2 * (2 + 2))), x) + 1) mod (2 + (2 * (2 + 2)))) - 1, 1 + x)
(set-logic UFNIA)
(declare-fun f2 () Int)
...
(assert (forall ((x Int)) (= (f0 x) (- (mod (+ (v1 x) 1) (+ 2 (* 2 (+ 2 2)))) 1))))
...
(assert (forall ((x Int)) (= (f3 x) (- (mod (+ (v4 x) 1) (+ 2 (* 2 (+ 2 2)))) 1))))
