;; sequence(s): A78014
;; terms: 1 0 0 ~2 ~2 ~2 2 6 10 6 ~6 ~26 ~38 ~26 26 102 154 102 ~102 ~410
;; small program: loop(loop2(x + y, y - x, y, 1, 0) - x, x, 1)
;; fast program: (2 + loop2(2 * (x - y), x, x, 1 + 2, 2)) div (1 + (2 + 2))
(set-logic UFNIA)
