;; sequence(s): A24013
;; terms: 1 1 ~4 ~19 ~48 ~93 ~152 ~215 ~256 ~217 24 717 2368 5995 13640 29393 61440 126159 256312 517429
;; small program: loop(x + x, x, 1) - ((x * x) * x)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - ((x * x) * x)
(set-logic UFNIA)
