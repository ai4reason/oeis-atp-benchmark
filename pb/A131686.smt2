;; sequence(s): A131686
;; terms: 208 373 653 989 1469 2189 2981 4061 5381 6701 8069 9917 12029 14069 16709 19541 22061 24821 27989 31421
;; small program: loop2(loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2, 1, x), 1, y) + x, 1 + y, 1 + (2 + 2), 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x), 1, y) + x, 1 + y, (2 * 2) + 1, 0, x)
(set-logic UFNIA)
