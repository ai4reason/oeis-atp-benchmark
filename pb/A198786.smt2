;; sequence(s): A198786
;; terms: 1 2 4 4 0 ~4 0 8 0 ~20 0 56 0 ~168 0 528 0 ~1716 0 5720
;; small program: loop2(2 * (x * y), y - 2, x - 1, if x <= 0 then 1 else 2, x) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, y - 2, x - 2, 1, x - 2) * loop(x + x, x, 1)) div loop(x * y, x - 1, 1)
(set-logic UFNIA)
