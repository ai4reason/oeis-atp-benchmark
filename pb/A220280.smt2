;; sequence(s): A220280
;; terms: 1 1 1 1 1 2 1 1 2 1 1 1 2 1 2 1 1 2 1 2
;; small program: loop(loop(loop(y, x - y, x), x, x), 2, 1 + x)
;; fast program: loop(loop(x - (if (y - x) <= 0 then y else 0), x - (x div 2), x), 2, x) + 1
(set-logic UFNIA)
