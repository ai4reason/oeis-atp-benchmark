;; sequence(s): A86304
;; terms: 1 5 7 11 13 17 23 25 31 35 37 41 47 53 55 61 65 67 73 77
;; small program: (compr((1 + loop(x + x, x, x)) mod (2 + x), 2 + x) - 2) - 2
;; fast program: ((loop(compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x), 1, 2 + x) - 2) * 2) - 1
(set-logic UFNIA)
