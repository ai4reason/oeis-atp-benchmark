;; sequence(s): A71044
;; terms: 1 3 2 6 2 6 4 12 2 6 4 12 4 12 8 24 2 6 4 12
;; small program: loop2(((y mod 2) * x) + x, y div 2, x, 2 + (x mod 2), x) div 2
;; fast program: loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), loop(1 + 2, x mod 2, 1), x div 2)
(set-logic UFNIA)
