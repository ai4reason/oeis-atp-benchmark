;; sequence(s): A168613
;; terms: ~4 ~2 4 22 76 238 724 2182 6556 19678 59044 177142 531436 1594318 4782964 14348902 43046716 129140158 387420484 1162261462
;; small program: ((loop((x + x) + x, x, 1) - 1) - 2) - 2
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - 1) - 2) - 2
(set-logic UFNIA)
