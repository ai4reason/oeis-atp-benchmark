;; sequence(s): A119915
;; terms: 0 1 4 13 40 117 332 921 2512 6761 18004 47525 124536 324317 840092 2166065 5562272 14232273 36300196 92321085
;; small program: loop2(x + y, (x + x) + y, x, x, 1) div 2
;; fast program: loop2((x + x) + y, x, x - 1, 1 + x, x) div 2
(set-logic UFNIA)
