;; sequence(s): A18756
;; terms: 1 2 4 5 7 10 14 20 28 35 49 70 98 140 196 245 490 980
;; small program: loop(compr((2 + loop((1 + 2) * (2 + (x * x)), 2, 2)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((2 - (x * x)) * x, 1, 2 + (2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
