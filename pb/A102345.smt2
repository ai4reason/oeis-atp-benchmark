;; sequence(s): A102345
;; terms: 2 2 10 26 82 242 730 2186 6562 19682 59050 177146 531442 1594322 4782970 14348906 43046722 129140162 387420490 1162261466
;; small program: loop2(y, (2 * (x + y)) + x, x, 2, 2)
;; fast program: 1 + loop(x - 2, x mod 2, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
