;; sequence(s): A133550
;; terms: 243 3368 20175 181226 552519 1972376 4448475 10884818 31395967 60025118 129369075 245225276 392233719 621578726 1039774219 1754698518 2599294819 3949419926 5753649277 7826720870
;; small program: loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 1 + (2 + 2), 1, y) + x, 1 + x, 0)
;; fast program: loop(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (((x * x) * x) * x), y, 2, 1, x), 1, y) + x, 1 + x, 0)
(set-logic UFNIA)
