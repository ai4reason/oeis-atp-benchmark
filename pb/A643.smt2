;; sequence(s): A643
;; terms: 0 0 1 2 4 8 24 280 16777496 1942668892225729070919461906823518906642406839052139521251812409738904285205225275672
;; small program: loop2(x + loop2(y + y, x, y, 0, 1), x, x, 1, 0) div 2
;; fast program: loop2(loop(loop(x * x, 1, loop(x + x, x div 2, 1)) div (2 - (x mod 2)), 1, y) + x, x, x, 1, 0) - 1
(set-logic UFNIA)
