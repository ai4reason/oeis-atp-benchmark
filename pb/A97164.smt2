;; sequence(s): A97164-A133628
;; terms: 1 4 8 20 36 84 148 340 596 1364 2388 5460 9556 21844 38228 87380 152916 349524 611668 1398100
;; small program: loop2(y + y, 2 + (x + x), x, 1, 2)
;; fast program: loop2((x * y) + y, y, x div 2, loop(2 + 2, x mod 2, 1), 2 + 2)
(set-logic UFNIA)
