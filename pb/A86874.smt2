;; sequence(s): A86874
;; terms: 2187 78125 823543 19487171 62748517 410338673 893871739 3404825447 17249876309 27512614111 94931877133 194754273881 271818611107 506623120463 1174711139837 2488651484819 3142742836021 6060711605323
;; small program: loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + y) + 1) * (x * x), y, 1 + 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop((x * x) * x, 1, x * x), y, 2, 1, 1 + x)
(set-logic UFNIA)
