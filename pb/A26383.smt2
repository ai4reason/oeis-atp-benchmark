;; sequence(s): A26383
;; terms: 1 2 5 10 25 50 125 250 625 1250 3125 6250 15625 31250 78125 156250 390625 781250 1953125 3906250
;; small program: loop2(y, (2 * (x + x)) + x, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, 1 + (x mod 2), 1 + (2 + 2))
(set-logic UFNIA)
