...
;; small program: loop(loop(((1 + y) div loop2(x + y, x, x, 1, 0)) + x, y, 1) + (x div 2), x, 2) mod 2
;; fast program: loop2(loop((y div loop2(x + y, x, x, 1, 0)) + x, y, 1) + x, 1 + y, 2, 1, x) mod 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (w3 x) 2))))
