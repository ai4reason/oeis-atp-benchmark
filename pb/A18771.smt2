;; sequence(s): A18771
;; terms: 1 3 5 15 67 201 335 1005
;; small program: loop(compr((1 + (2 + loop(2 + ((x * x) * x), 2, 2))) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((1 + (2 + ((x * x) * x))) * (1 - (x * x)), 1, 2 + 2) mod (1 + x), y), x, x) + 1
(set-logic UFNIA)
