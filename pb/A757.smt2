;; sequence(s): A757
;; terms: 1 0 0 1 1 8 36 229 1625 13208 120288 1214673 13469897 162744944 2128047988 29943053061 451123462673 7245940789072 123604151490592 2231697509543361
;; small program: loop(loop((x * y) + loop(0 - x, y, 1), y - 1, 1) - x, x, 1)
;; fast program: loop(loop(loop(0 - 1, x mod 2, 1) + (x * y), y - 1, 1) - x, x, 1)
(set-logic UFNIA)
