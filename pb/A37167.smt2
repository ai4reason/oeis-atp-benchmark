;; sequence(s): A37167
;; terms: 3 10 28 66 130 204 304 414 638 868 1110 1476 1720 1974 2438 3068 3538 4020 4686 5110
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + 1) * (x - 1), 1 + y, 2, 2, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x - 1), 1 + y, 2, 2, x)
(set-logic UFNIA)
