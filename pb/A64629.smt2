;; sequence(s): A64629
;; terms: 0 1 7 10 13 52 451 1075 6487 6265 44743 119923 302545 147298 589192 11922706 33341917 4227505 146050183 584200732
;; small program: loop(x + x, x + x, 1) mod loop((x + x) + x, x, 1)
;; fast program: loop(x * x, 1, loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
