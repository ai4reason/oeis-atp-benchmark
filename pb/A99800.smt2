;; sequence(s): A99800
;; terms: 2 30 2310 510510 223092870 200560490130 304250263527210 614889782588491410 1922760350154212639070 7858321551080267055879090 40729680599249024150621323470 267064515689275851355624017992790
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, x + x, 2)
;; fast program: loop(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x + x, 2)
(set-logic UFNIA)
