;; sequence(s): A18055
;; terms: 1 22 343 4696 60493 755146 9267091 112644652 1361819305 16412435710 197443515919 2372782379968 28497610413637 342140879536114 4106877441223627 49290837516564244 591548207794982689
;; small program: loop(((loop((loop(loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop(x * x, 1, loop(x + x, x, 2)) div (1 + 2)) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
