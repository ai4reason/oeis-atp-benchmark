;; sequence(s): A124400
;; terms: 1 1 4 7 18 38 88 195 441 988 2223 4992 11220 25208 56645 127277 285992 642615 1443946 3244514
;; small program: loop(loop2(((((y - x) * y) div (1 - x)) + x) + x, x, y - 1, 2, 1) - x, x, 1)
;; fast program: loop(loop2(((((y - x) * y) div (1 - x)) + x) + x, x, y, 2, 1) - x, x - 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (+ (div (* (- y x) y) (- 1 x)) x) x))))
