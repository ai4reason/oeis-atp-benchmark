;; sequence(s): A59967
;; terms: 1 9 117 1785 29799 527085 9706503 184138713 3573805950 70625252863 1416298046436 28748759731965 589546754316126 12195537924351375 254184908607118800 5332692942907262361 112524941404978156215
;; small program: loop2(x * y, y - 1, x, 1, loop((x + x) + x, 2, 1 + x)) div loop((x * y) + x, x, 1)
;; fast program: loop2(x * y, y - 1, x, 1, loop((x + x) + x, 2, 1 + x)) div loop(x * y, x, 1 + x)
(set-logic UFNIA)
