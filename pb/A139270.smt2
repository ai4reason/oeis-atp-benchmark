;; sequence(s): A139270
;; terms: 2 8 12 16 18 20 24 28 30 32 36 40 42 44 48 50 52 54 56 60
;; small program: loop(compr(loop(x * y, x, 2) mod (2 + x), y) + 2, x, 1) * 2
;; fast program: (compr(loop((if (loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, x div 2, x) mod (1 + x), x) * 2) + 2
(set-logic UFNIA)
