;; sequence(s): A99431
;; terms: 0 1 0 6 8 30 60 154 336 774 1700 3762 8184 17758 38220 81930 174752 371382 786420 1660258
;; small program: loop2(y + y, x + y, x - 1, x, 0)
;; fast program: (loop(2 * (2 + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (2 + (2 + 2))) * x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (v1 x) (+ 2 (+ 2 2))) x))))
