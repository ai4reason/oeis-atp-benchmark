;; sequence(s): A71858
;; terms: 0 1 1 2 1 2 2 0 1 2 2 0 2 0 0 1 1 2 2 0
;; small program: (x + loop2(x - y, y div 2, x, x, x)) mod (1 + 2)
;; fast program: loop2(x - y, y div 2, 2 + (2 + 2), x, x div 2) mod (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (mod (+ x (w0 x)) (+ 1 2)))))
