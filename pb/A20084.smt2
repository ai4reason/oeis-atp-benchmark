;; sequence(s): A20084
;; terms: 1 0 0 1 4 20 108 694 5142 43193 406016 4222569 48137291 596902408 7998492273 115178288736 1773745646539 29089428603255 506156057696641 9313271461618195
;; small program: loop2(x * y, 1 + (2 + (2 + y)), x, 1, 2) div loop((2 * (x + x)) + x, x, 1)
;; fast program: loop2(x * y, 1 + (2 + (2 + y)), x, 1, 2) div loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
