...
(assert (forall ((x Int)) (= (f2 x) (div (+ (v3 x) (v4 x)) 2))))
(assert (= g2 1))
...
(assert (forall ((x Int) (y Int)) (= (f10 x y) (* 2 (+ (- x (div x y)) x)))))
(assert (forall ((x Int)) (= (g10 x) (div x 2))))
(assert (forall ((x Int)) (= (h10 x) (- 1 (mod x 2)))))
...
(assert (forall ((x Int)) (= (f9 x) (div (+ (v10 x) (v11 x)) 2))))
(assert (= g9 1))
