;; sequence(s): A18646
;; terms: 1 2 3 6 131 262 393 786
;; small program: loop(compr(loop(2 + ((2 + y) * (x * x)), 2, 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 + loop(x * x, 1, 2 * (2 + (2 * (2 + (2 + 2)))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
