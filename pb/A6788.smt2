;; sequence(s): A6788
;; terms: 1 1 1 2 3 5 9 16 28 51 93 170 315 585 1092 2048 3855 7281 13797 26214
;; small program: loop(x + x, x, 1) div (1 + x)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + x)
(set-logic UFNIA)
