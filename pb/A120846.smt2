;; sequence(s): A120846
;; terms: 2 6 15 38 101 280 799 2322 6825 20204 60083 179206 535549 1602528 4799367 14381690 43112273 129271252 387682651 1162785774
;; small program: loop2(((x - y) + x) + x, y + y, x, 2, 1) + x
;; fast program: (loop(x + x, x, 1) + x) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (v1 x) x) (w2 x)))))
