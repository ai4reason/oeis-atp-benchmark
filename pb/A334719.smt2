;; sequence(s): A334719
;; terms: 0 4 30 250 2245 21221 208129 2098565 21619910 226593015 2408424760 25899375645 281273231985 3080585212120 33986840371400 377364606387005 4213620859310140 47284625533425750 532996618440511710 6032169040263819485
;; small program: loop2(loop(loop2((2 + y) * x, 1 + y, x - 1, 1, 2 * (x + x)) div loop(x * y, x, 1), 1, y) - x, 1 + y, 2, 0, x)
;; fast program: loop2(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + (2 * (x + x))) div loop(x * y, x, 1), 1, y) - x, 1 + y, 2, 0, x)
(set-logic UFNIA)
