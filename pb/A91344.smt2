;; sequence(s): A91344
;; terms: 0 1 7 31 115 391 1267 3991 12355 37831 115027 348151 1050595 3164071 9516787 28599511 85896835 257887111 774054547 2322950071
;; small program: 1 - loop2((x - y) + x, (y + y) + y, x, 1, 2)
;; fast program: 1 + (loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - loop(x + x, x, 1 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ 1 (- (w1 x) (v3 x))))))
