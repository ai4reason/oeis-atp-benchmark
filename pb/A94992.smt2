;; sequence(s): A94992
;; terms: 1 1 2 2 4 5 8 12 17 24 35 50 72 103 147 210 300 429 614 877
;; small program: loop(x div (1 + (2 + (2 + 2))), x, loop((2 + (2 * (2 + 2))) * x, x, 1))
;; fast program: (loop(x + x, x, 1) * loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), 1 + (2 * (2 * (2 + (2 + 2)))))) div loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (v2 x) (w3 x)) (w5 x)))))
