;; sequence(s): A19747
;; terms: 1 26 468 7240 103376 1406496 18541888 239158400 3036523776 38104777216 473923294208 5853743400960 71911576293376 879605537447936 10721932937084928 130329861195857920 1580624998153650176
;; small program: loop(loop2((2 * ((2 * (x + x)) + x)) + (y * y), y + y, y, 1, 2) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x + x, x - 1, 2), 1, y) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
