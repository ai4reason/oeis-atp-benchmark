;; sequence(s): A246986
;; terms: 1 5 21 84 331 1300 5111 20144 79611 315420 1252351 4980904 19837091 79086740 315557991 1259856864 5032285771 20107685260 80366302031 321271760024
;; small program: (loop2(1 + ((2 * (x + x)) + y), y + y, x, 1, 2) + loop((x + x) + x, x, 1)) div 2
;; fast program: ((((((1 + (2 + (2 + 2))) * loop(x * x, 1, loop(x + x, x, 1))) div (1 + 2)) + 1) - loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (- (+ (div (* (+ 1 (+ 2 (+ 2 2))) (v2 x)) (+ 1 2)) 1) (v4 x)) (w5 x)) 2))))
