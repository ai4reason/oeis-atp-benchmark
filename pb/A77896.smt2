;; sequence(s): A77896
;; terms: 1 0 3 0 7 0 15 0 31 0 63 0 127 0 255 0 511 0 1023 0
;; small program: loop2((y div x) + y, x, x, 2, 1) - 1
;; fast program: loop2(loop(x + x, y div 2, 2), y, 1 - (x mod 2), 1, x) - 1
(set-logic UFNIA)
