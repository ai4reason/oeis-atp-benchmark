;; sequence(s): A152692
;; terms: 0 0 8 54 256 1050 3984 14406 50432 172530 580240 1926078 6328128 20619690 66732176 214742070 687698944 2193154530 6968850192 22073006382
;; small program: loop2(((x + x) + x) + y, y + y, x, 0, x) - x
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x - 1, 2)) * x) - x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (- (w1 x) (v3 x)) x) x))))
