;; sequence(s): A215037
;; terms: 1 4 19 79 339 1431 6072 25707 108922 461362 1954426 8278978 35070483 148560678 629313573 2665814361 11292572005 47836100785 202636977730 858384007525
;; small program: loop(loop(loop2(loop2(x + y, x, y, x, 0), 1 + y, 1 + 2, 1, x), 1, y) + x, x, 2) div 2
;; fast program: loop(loop((((loop(x * x, 1, loop2(x + y, x, x, 1, 1)) - (x mod 2)) - (x mod 2)) + 1) * loop2(x + y, x, x, 1, 1), 1, y) + x, x, 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (* (+ (- (- (v6 x) (mod x 2)) (mod x 2)) 1) (w8 x)))))
(assert (= g5 1))
