;; sequence(s): A335649
;; terms: 0 10 200 3040 43320 607050 8468880 118007680 1643826800 22896269770 318906570840 4441805503200 61866406977960 861688028423050 12001766499380000 167163044860403200 2328280868627854560 32428769142358413450 451674487223023755240 6291014052348080593120
;; small program: loop2(loop2((2 * (x + x)) + y, 1 - x, y, 0, 1) * x, 1 + y, 2, 1, x) * 2
;; fast program: loop2(loop((if x <= 0 then 1 else loop2((2 * (x + x)) - y, x, x - 1, 1 + 2, 1)) div 2, 1, y) * x, 1 + y, 2, 2, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (div (ite (<= x 0) 1 (w4 x)) 2))))
(assert (= g3 1))
