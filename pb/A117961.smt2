;; sequence(s): A117961
;; terms: 6 15 45 91 231 325 561 703 1035 1653 1891 2701 3321 3655 4371 5565 6903 7381 8911 10011
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + x) * x, y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x) * x, y, 2, 1, x)
(set-logic UFNIA)
