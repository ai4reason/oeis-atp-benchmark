;; sequence(s): A102526
;; terms: 1 1 2 2 4 5 9 12 21 30 51 76 127 195 322 504 826 1309 2135 3410
;; small program: (loop2(x + y, x, loop(y - x, x, 1), 1, 0) + loop2(x + y, x, x, 1, 0)) div 2
;; fast program: (loop2(x + y, x, x - 1, 1, 1) + loop2(x + y, x, x div 2, 1, 1 - (x mod 2))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (+ (w0 x) (w2 x)) 2))))
...
(assert (= i4 1))
(assert (forall ((x Int)) (= (j4 x) (- 1 (mod x 2)))))
