;; sequence(s): A62113
;; terms: 1 2 3 7 10 24 34 82 116 280 396 956 1352 3264 4616 11144 15760 38048 53808 129904
;; small program: loop2(y, (((y mod x) + x) + x) + x, x, 1, 2)
;; fast program: loop2(2 * ((x - y) + x), x, x div 2, loop(2 + 2, x mod 2, 2), 1) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (+ (+ (+ (mod y x) x) x) x))))
