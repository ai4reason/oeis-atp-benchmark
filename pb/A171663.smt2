;; sequence(s): A171663
;; terms: 1 5 5 13 25 41 113 145 481 545 1985 2113 8065 8321 32513 33025 130561 131585 523265 525313
;; small program: loop(2 * ((x * x) - x), 1, loop2(y - x, x + y, x, 1, 0)) + 1
;; fast program: (loop(x * x, 1, loop(x + x, x div 2, 2) - loop(0 - 1, x mod 2, 1)) div 2) + 1
(set-logic UFNIA)
