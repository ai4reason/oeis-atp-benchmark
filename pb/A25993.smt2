;; sequence(s): A25993
;; terms: 1 23 344 4258 47487 496725 4981918 48547136 463544213 4361492707 40596873252 374857310334 3440520848779 31434357529169 286207079508746 2598999610410652 23553202070626785 213115529239825311
;; small program: loop((loop((loop((loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop((((loop2(x * y, y, x, 1, 1 + (2 + 2)) + loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) div 2) - loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) div 2, 1, 2 + x) div 2, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
