;; sequence(s): A79079
;; terms: 3 6 12 24 42 63 90 120 180 240 304 399 462 528 648 810 930 1054 1224 1332
;; small program: (loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + 2) * x, 1 + y, 2, 1, x) div 2) div 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 2) * x, 1 + y, 2, 1, x) div (2 + 2)
(set-logic UFNIA)
