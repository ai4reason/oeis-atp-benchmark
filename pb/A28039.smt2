;; sequence(s): A28039
;; terms: 1 23 342 4198 46403 481341 4792264 46410716 440901285 4131534979 38331795866 353038275954 3233774790247 29499248911337 268261230188748 2433731253526312 22039259605258889 199303153044040815
;; small program: loop(((loop((loop(loop((x + x) + x, y + y, 1) + (2 * (x + x)), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop(((1 + 2) * (x * x)) - x, 1, loop2(x * y, y, x, 1, 1 + 2)) div 2, 1, y) + (2 * (x + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
