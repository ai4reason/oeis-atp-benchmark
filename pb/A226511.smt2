;; sequence(s): A226511
;; terms: 0 3 24 147 816 4323 22344 113907 576096 2900163 14559864 72976467 365413776 1828663203 9148098984 45754843827 228817265856 1144215469443 5721464767704 28608486099987
;; small program: loop2((1 + 2) * ((x + x) + y), (y - x) + y, x, 0, 1)
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2) * (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (- (w1 x) (w4 x)) 2) (+ 1 2)))))
