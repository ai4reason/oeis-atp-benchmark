;; sequence(s): A136636
;; terms: 2 30 2448 1265004 4368213360 106458751541142 19173684851378353296 26413015283743616538733008 285290979402099025600644272168880 24601033850235942230699563821233785600080
;; small program: loop2(x * y, y - 1, 1 + x, 1, loop((x + x) + x, x, 2)) div loop(x * y, x, 1)
;; fast program: loop2(x * y, y - 1, 1 + x, 1, loop2(x * y, y, x, 2, 1 + 2)) div loop(x * y, x, 1)
(set-logic UFNIA)
