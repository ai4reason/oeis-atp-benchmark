;; sequence(s): A345367
;; terms: 1 2 6 28 168 1137 8221 62041 482773 3845033 31188921 256757719 2139691083 18015030073 153008796673 1309402039993 11279339531413 97724562251137 851035285261745 7445189624293545
;; small program: loop(loop(loop2(x * y, y - 1, x - 1, 1, 2 * (x + x)) div loop(x * y, x, 1), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + ((x + x) + x)) div loop(x * y, x - 1, x), 1, y) + x, x, 1)
(set-logic UFNIA)
