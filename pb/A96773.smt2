;; sequence(s): A96773
;; terms: 0 3 1 13 5 53 21 213 85 853 341 3413 1365 13653 5461 54613 21845 218453 87381 873813
;; small program: loop2(1 + (y + y), x + x, x, 0, 1)
;; fast program: loop(2 * ((2 * (x + x)) + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)
(set-logic UFNIA)
