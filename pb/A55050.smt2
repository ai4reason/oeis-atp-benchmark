;; sequence(s): A55050
;; terms: 3 7 11 12 15 19 23 27 28 31 35 39 43 44 47 48 51 55 59 60
;; small program: compr(((loop(x div loop(1, x mod (2 + 2), 2 + 2), x, x) + 1) div 2) mod 2, 1 + x)
;; fast program: compr(((loop(x div loop(1, x mod (2 + 2), 2 + 2), loop(x * x, 1, 2 + 2) mod (1 + x), x) + 1) mod (2 + 2)) - 1, 1 + x)
(set-logic UFNIA)
(declare-fun f2 () Int)
...
(assert (forall ((x Int)) (= (f0 x) (mod (div (+ (v1 x) 1) 2) 2))))
...
(assert (= v6 (u6 g6 h6)))
(assert (forall ((x Int)) (= (g4 x) (mod v6 (+ 1 x)))))
(assert (forall ((x Int)) (= (h4 x) x)))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int)) (= (v4 x) (u4 (g4 x) (h4 x)))))
(assert (forall ((x Int)) (= (f3 x) (- (mod (+ (v4 x) 1) (+ 2 2)) 1))))
