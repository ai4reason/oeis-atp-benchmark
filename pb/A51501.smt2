;; sequence(s): A51501
;; terms: 2 5 37 137438953481
;; small program: loop2(1 + (loop2(y, 2 * (x + x), x, 2, 1) + y), x + y, x, 1, 2) + 1
;; fast program: loop2((loop2(x * y, y, x div 2, loop(1, x mod 2, 2), 2 + 2) + 1) + y, x + y, x, 1, 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (w3 x) 1) y))))
