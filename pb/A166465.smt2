;; sequence(s): A166465
;; terms: 1 5 3 15 9 45 27 135 81 405 243 1215 729 3645 2187 10935 6561 32805 19683 98415
;; small program: loop2((x + y) + y, x - y, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), 1 + 2)
(set-logic UFNIA)
