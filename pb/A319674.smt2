;; sequence(s): A319674
;; terms: 1 3 6 2 ~3 ~9 ~2 6 15 5 ~6 ~18 ~5 9 24 8 ~9 ~27 ~8 12
;; small program: loop(loop(0 - x, y div (1 + 2), 1 + y) + x, x, 1)
;; fast program: loop(loop(0 - x, (y div (1 + 2)) mod 2, 1 + y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g3 x y) (mod (div y (+ 1 2)) 2))))
