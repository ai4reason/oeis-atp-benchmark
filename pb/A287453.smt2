;; sequence(s): A287453
;; terms: 2 6 7 10 14 18 21 22 26 30 31 35 38 42 43 46 50 54 55 59
;; small program: loop(compr(loop2(y - x, y div (1 + 2), x, 1, x) mod (1 + 2), y), x, 1) + 1
;; fast program: ((((loop2(2 * (x + y), y div (1 + 2), 2 + 2, 1, x) mod (1 + 2)) + 1) + x) + x) + x
(set-logic UFNIA)
