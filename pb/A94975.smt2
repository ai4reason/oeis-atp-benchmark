;; sequence(s): A94975
;; terms: 1 2 5 12 29 69 161 376 878 2050 4783 11162 26044 60771 141799 330865 772020 1801380 4203220 9807513
;; small program: loop(x div (1 + 2), x, loop((2 * ((x + x) + x)) + x, x, 1))
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) div loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
