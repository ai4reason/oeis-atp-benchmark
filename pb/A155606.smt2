;; sequence(s): A155606
;; terms: 1 10 72 538 4176 33010 262872 2099338 16783776 134237410 1073800872 8590111738 68720008176 549757408210 4398051294072 35184386437738 281475019757376 2251799942825410 18014398896902472 144115189238117338
;; small program: (loop((x + x) + x, x, 1) - 1) + loop(x + x, (x + x) + x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) - 1) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
