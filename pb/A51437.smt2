;; sequence(s): A51437
;; terms: 1 3 4 10 16 36 64 136 256 528 1024 2080 4096 8256 16384 32896 65536 131328 262144 524800
;; small program: loop(x + x, x, 1) + loop2(y, x + x, x, 0, 1)
;; fast program: loop(1 + (x + x), x mod 2, loop(x + x, x div 2, 1)) * loop(x + x, x div 2, 1)
(set-logic UFNIA)
