;; sequence(s): A215604
;; terms: 0 1 0 1 1 2 1 2 0 1 0 1 1 2 1 2 1 2 1 2
;; small program: loop2(x + y, y div 2, x, 0, x) mod (1 + 2)
;; fast program: loop2((y mod 2) + x, y div (2 + 2), 1 + 2, x, x div 2) mod (1 + 2)
(set-logic UFNIA)
