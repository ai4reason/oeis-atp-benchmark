;; sequence(s): A268741
;; terms: 4 5 3 7 ~1 15 ~17 47 ~81 175 ~337 687 ~1361 2735 ~5457 10927 ~21841 43695 ~87377 174767
;; small program: 1 + (2 + loop(2 * (2 - x), x, 1))
;; fast program: 1 + (2 + loop2((x * y) - y, y, x div 2, 1 + (x mod 2), 2 + 2))
(set-logic UFNIA)
