;; sequence(s): A295732
;; terms: ~1 ~1 ~1 1 2 9 15 36 59 119 194 361 587 1044 1695 2931 4754 8069 13079 21916
;; small program: loop2(x + y, 2 + x, x, 1, 1) - loop2(2 + y, x + x, x, 2, 1)
;; fast program: loop2(x + y, x, x, 1 + 2, 1) - loop(x + x, x div 2, 2 + ((x mod 2) + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h3 x) (+ 2 (+ (mod x 2) 2)))))
