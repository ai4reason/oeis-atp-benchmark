;; sequence(s): A83578
;; terms: 1 1 26 76 776 3376 25376 131776 872576 4907776 30757376 179301376 1096779776 6496792576 39316299776 234555621376 1412702437376 8454739787776 50814338072576 304542431051776
;; small program: loop2(y, (loop(x * y, 2 + 2, x) + y) + y, x, 1, 1)
;; fast program: (loop(0 - x, x mod 2, loop(x * x, 1, loop(x + x, x, 1))) + loop2(x * y, y, x, 1, 2 + (2 + 2))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (v2 x) (w5 x)) 2))))
