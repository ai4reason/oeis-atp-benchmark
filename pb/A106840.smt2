...
(assert (forall ((x Int)) (= (f6 x) (div x 2))))
...
(assert (forall ((x Int)) (= (f2 x) (div (v3 x) 2))))
(assert (forall ((x Int)) (= (g2 x) (mod x 2))))
(assert (forall ((x Int)) (= (h2 x) (div x 2))))
(assert (forall ((x Int) (y Int)) (= (u2 x y) (ite (<= x 0) y (f2 (u2 (- x 1) y))))))
(assert (forall ((x Int)) (= (v2 x) (u2 (g2 x) (h2 x)))))
(assert (forall ((x Int)) (= (f1 x) (+ (+ (mod (+ (v2 x) 1) 2) 1) x))))
(assert (= g1 2))
(assert (forall ((x Int)) (= (h1 x) x)))
(assert (forall ((x Int) (y Int)) (= (u1 x y) (ite (<= x 0) y (f1 (u1 (- x 1) y))))))
(assert (forall ((x Int)) (= (v1 x) (u1 g1 (h1 x)))))
(assert (forall ((x Int)) (= (f0 x) (mod (* (mod (div (- (v1 x) x) 2) 2) 2) (+ 1 x)))))
(assert (forall ((x Int)) (= (g0 x) (+ 1 x))))
(assert (forall ((x Int)) (= (t0 x) (ite (<= (f0 x) 0) x (t0 (+ x 1))))))
(assert (forall ((x Int)) (= (u0 x) (ite (<= x 0) (t0 0) (t0 (+ (u0 (- x 1)) 1))))))
(assert (forall ((x Int)) (= (v0 x) (u0 (g0 x)))))
(assert (forall ((x Int)) (= (small x) (+ (div (v0 x) 2) 1))))
(assert (forall ((x Int)) (= (f14 x) (div x 2))))
(assert (forall ((x Int)) (= (g14 x) (mod x 2))))
...
(assert (= f15 (+ 2 (+ 2 2))))
(assert (forall ((x Int)) (= (g15 x) (mod x 2))))
(assert (= h15 1))
...
(assert (= g12 1))
(assert (forall ((x Int)) (= (h12 x) (div x 2))))
...
(assert (forall ((x Int)) (= (f10 x) (div (v11 x) 2))))
...
(assert (forall ((x Int)) (= (fast x) (- (+ (div (+ (v8 x) 1) 2) x) x))))
