;; sequence(s): A194073
;; terms: 1 4 7 13 19 28 37 49 61 76 91 109 127 148 169 193 217 244 271 301
;; small program: loop(loop2(1 + (2 + y), x, y, x, x), x, 1)
;; fast program: 1 + loop(x - (x div (2 + 2)), 1, (2 + x) * x)
(set-logic UFNIA)
