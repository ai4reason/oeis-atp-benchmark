;; sequence(s): A83199
;; terms: 0 1 0 0 3 2 1 0 0 1 0 2 1 0 0 1 0 1 0 2
;; small program: loop((loop((x div 2) + x, x, 2) mod 2) + x, x, x) - x
;; fast program: loop((loop((x div 2) + x, x - 1, 1 + 2) mod 2) + x, x, x) - x
(set-logic UFNIA)
