;; sequence(s): A93667
;; terms: 4 5 9 9 15 15 21 25 25 35 35 39 45 49 53 55 65 65 69 77
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) - x, 1 + y, 1 + 2, 0, x) + 1
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 1 + y, 1 + 2, 0, x) + 1
(set-logic UFNIA)
