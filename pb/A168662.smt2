;; sequence(s): A168662
;; terms: 0 1 2112 266814 8396800 122109375 1088531136 6921055372 34360786944 141217159725 500005000000 1569223931946 4458068140032 11649073935499 28347008894400 64873254375000 140737622573056 291311323784217
;; small program: (loop(x + y, loop(x * x, 2, x) * x, 0) * x) * x
;; fast program: loop2((x + y) * x, x, 1, loop((x * x) * x, 1, x * x), x) div 2
(set-logic UFNIA)
