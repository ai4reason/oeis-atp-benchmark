;; sequence(s): A293168
;; terms: 0 1 2 3 4 5 6 8 9 10 11 13 14 16 18 19 20 21 22 24
;; small program: loop(loop(loop2(x - y, y div 2, x, x, x) + x, 2, y) + x, x, 0)
;; fast program: loop(loop((((((loop2(x - y, y div 2, 2 + (2 + 2), x, x div 2) * (1 + (2 + 2))) + 2) div 2) div 2) + 1) mod 2, 1, y) + x, x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (mod (+ (div (div (+ (* (w5 x) (+ 1 (+ 2 2))) 2) 2) 2) 1) 2))))
(assert (= g4 1))
