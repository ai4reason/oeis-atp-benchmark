;; sequence(s): A291876
;; terms: 2 6 12 20 32 48 66 90 122 158 206 260 324 396 492 600 728 872 1034 1226
;; small program: (loop(compr(loop(2 * (x * x), 2 + 2, 1 + 2) mod (1 + x), y) + x, x, x) * 2) + 2
;; fast program: (loop(compr(loop((x * x) * x, 2, 2 * (2 + (2 + 2))) mod (1 + x), y) + x, x, x) * 2) + 2
(set-logic UFNIA)
