;; sequence(s): A94970
;; terms: 1 3 12 42 150 525 1838 6433 22518 78815 275854 965491 3379220 11827271 41395451 144884079 507094277 1774829971 6211904899 21741667147
;; small program: loop(x div 2, x, loop((2 * ((x + x) + x)) + x, x, 1))
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) div loop(x + x, x, 1)
(set-logic UFNIA)
