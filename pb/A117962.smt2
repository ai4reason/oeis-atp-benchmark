;; sequence(s): A117962
;; terms: 6 21 66 157 388 713 1274 1977 3012 4665 6556 9257 12578 16233 20604 26169 33072 40453 49364 59375
;; small program: loop(loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), y) + x) * x, y, 2, 1, x), 1, y) + x, 1 + x, 0)
;; fast program: loop(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + x) * x, y, 2, 1, x), 1, y) + x, 1 + x, 0)
(set-logic UFNIA)
