;; sequence(s): A137213
;; terms: 0 1 4 15 52 173 560 1779 5576 17305 53308 163287 497980 1513541 4587944 13878075 41910032 126395953 380795380 1146267039
;; small program: loop((x + x) + x, x, 1) - loop2((x + x) + y, x, x, 1, 0)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - (if x <= 0 then 1 else loop2((x + x) + y, x, x - 1, 2, 1))
(set-logic UFNIA)
