;; sequence(s): A338691
;; terms: 2 3 7 8 10 11 12 15 18 19 23 26 27 28 31 32 34 35 39 40
;; small program: compr(1 - (loop(loop(y - x, x, x), 2 + x, x) mod 2), x)
;; fast program: compr(((1 + loop(loop(y - x, x, x), x, x)) mod 2) * x, 1 + x)
(set-logic UFNIA)
