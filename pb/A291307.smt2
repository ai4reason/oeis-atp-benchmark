;; sequence(s): A291307
;; terms: 0 0 1 2 0 3 3 3 4 5 3 6 6 6 7 8 6 9 9 9
;; small program: (loop(loop2(y - x, 0 - x, y, 2, 1) - x, x, 0) + x) div 2
;; fast program: (((loop(1 - x, x mod (1 + 2), 2) + x) div 2) - 1) + (x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (div (+ (v2 x) x) 2) 1) (mod x 2)))))
