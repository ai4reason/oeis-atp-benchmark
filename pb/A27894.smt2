;; sequence(s): A27894
;; terms: 1 3 9 11 33 99 101 303 909 1111 3333 9999
;; small program: loop(compr((loop(x * x, 2, 2 + (2 * (2 + 2))) + x) mod (1 + x), y), x, 0) + 1
;; fast program: (((compr((loop(((x * x) * x) * x, 1, 2 + (2 * (2 + 2))) + x) mod (1 + x), x) + 1) * 2) div 2) div 1
(set-logic UFNIA)
