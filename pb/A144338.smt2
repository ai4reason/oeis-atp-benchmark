;; sequence(s): A144338
;; terms: 2 3 5 6 7 10 11 13 14 15 17 19 21 22 23 26 29 30 31 33
;; small program: loop(loop((if ((y * y) mod x) <= 0 then 1 else 0) + x, x, 1 + x), x, 2)
;; fast program: (compr(((loop(((loop(((loop((if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x) <= 0 then 1 else 0) - x, 2, x) + 1) + x) mod 2, 1, x div 2) + x) mod 2) + x, (1 + x) mod 2, x) + 1) + x) mod 2, 1 + x) div 2) + 1
(set-logic UFNIA)
