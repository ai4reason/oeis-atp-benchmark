;; sequence(s): A256511
;; terms: 1 6 40320 1307674368000 620448401733239439360000 10333147966386144929666651337523200000000 12413915592536072670862289047373375038521486354677760000000000
;; small program: loop(x * y, (2 + x) * x, 1)
;; fast program: (loop(loop((loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + (x * x)) * (1 + x)) * (1 + x), 1, y) * x, x, 1) div (1 + x)) div (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (div (v1 x) (+ 1 x)) (+ 1 x)))))
