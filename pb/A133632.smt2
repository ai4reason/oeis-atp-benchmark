;; sequence(s): A133632
;; terms: 1 4 5 20 25 100 125 500 625 2500 3125 12500 15625 62500 78125 312500 390625 1562500 1953125 7812500
;; small program: loop2((x + x) + y, (x - y) - y, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, loop(2 + 2, x mod 2, 1), 1 + (2 + 2))
(set-logic UFNIA)
