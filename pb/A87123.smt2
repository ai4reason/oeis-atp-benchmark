;; sequence(s): A87123
;; terms: 1 2 1 5 2 13 5 34 13 89 34 233 89 610 233 1597 610 4181 1597 10946
;; small program: loop2(y, x + y, x, 1, 2 * (x mod 2))
;; fast program: loop2(x + y, x, x - loop(0, x mod 2, 1 + 2), 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h1 x) (- x (v2 x)))))
(assert (= i1 1))
(assert (= j1 1))
