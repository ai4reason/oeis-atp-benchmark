;; sequence(s): A131833
;; terms: 1 6 13 24 43 78 145 276 535 1050 2077 4128 8227 16422 32809 65580 131119 262194 524341 1048632
;; small program: 1 + loop2(2 + (x + y), y + y, x, x, 2)
;; fast program: ((2 * (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + x)) - 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (* 2 (+ (v1 x) x)) 1) x))))
