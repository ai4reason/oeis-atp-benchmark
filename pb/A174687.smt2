;; sequence(s): A174687
;; terms: 1 2 9 48 275 1638 9996 62016 389367 2466750 15737865 100975680 650872404 4211628008 27341497800 177996090624 1161588834303 7596549816030 49772989810635 326658445806000
;; small program: loop2((2 + y) * x, 1 + y, x - 1, 1 + x, x + x) div loop(x * y, x, 1)
;; fast program: ((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x - 1, 1)) div (if x <= 0 then 1 else x)) * (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (div (w2 x) (v3 x)) (ite (<= x 0) 1 x)) (+ 1 x)))))
