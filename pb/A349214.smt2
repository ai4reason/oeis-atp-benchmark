;; sequence(s): A349214
;; terms: 1 3 6 7 12 13 20 21 22 23 34 35 48 49 50 51 68 69 88 89
;; small program: loop((loop(((x * y) * y) * y, y, 1) mod (1 + y)) + x, x, 1) + x
;; fast program: loop(loop(if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then x else 0, 1, y) + x, x, 1) + x
(set-logic UFNIA)
