;; sequence(s): A94626
;; terms: 0 1 2 12 22 122 222 1222 2222 12222 22222 122222 222222 1222222 2222222 12222222 22222222 122222222 222222222 1222222222
;; small program: loop2(y, 2 + (2 * ((2 * (x + x)) + x)), x, 0, 1)
;; fast program: loop2(2 + (x * y), y, x div 2, loop(1, x mod 2, 0), 2 + (2 * (2 + 2)))
(set-logic UFNIA)
