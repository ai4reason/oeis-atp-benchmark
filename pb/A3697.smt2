;; sequence(s): A3697-A6253
;; terms: 1 2 9 32 121 450 1681 6272 23409 87362 326041 1216800 4541161 16947842
;; small program: loop(loop2((2 * (x + x)) - y, x, y, 1, 1) - x, x, 1)
;; fast program: (1 + loop2((2 * (x + x)) - y, x, x, 2, 1)) div (1 + 2)
(set-logic UFNIA)
