;; sequence(s): A89215
;; terms: 1 2 3 2 4 3 2 3 5 4 3 4 2 3 4 3 6 5 4 5
;; small program: loop2(loop(loop2(x + y, y div 2, x, 0, x) mod 2, 1, y) + x, y div 2, x, 1, x)
;; fast program: loop2(loop(loop2(x + y, y div 2, 1 + (2 + (2 + 2)), 2, x) mod 2, 1, y) + x, y div 2, 1 + (2 + (2 + 2)), 1, x)
(set-logic UFNIA)
