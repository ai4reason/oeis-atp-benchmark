;; sequence(s): A42420
;; terms: 27 163 8829 53137 2878227 17322499 938293173 5647081537 305880696171 1840931258563 99716168658573 600137943210001 32507165101998627 195643128555201763 10597236107082893829
;; small program: loop2((2 * loop((x + x) + x, 2, x)) + y, x, x, 1 + (2 * (2 + 2)), 1) * loop(1, x mod 2, 1 + 2)
;; fast program: loop2((2 * ((2 * (2 * (x + x))) + x)) + y, x, x, 1 + (2 * (2 + 2)), 1) * loop(1, x mod 2, 1 + 2)
(set-logic UFNIA)
