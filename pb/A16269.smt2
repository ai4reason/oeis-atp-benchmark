;; sequence(s): A16269
;; terms: 1 9 55 285 1351 6069 26335 111645 465751 1921029 7859215 31964205 129442951 522538389 2104469695 8460859965 33972448951 136276954149 546269553775 2188563950925
;; small program: loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2)
;; fast program: loop((loop((x * x) + x, 1, loop(x + x, x - 1, 2)) div 2) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))), 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (- (div (v2 x) 2) (w4 x)))))
(assert (= g1 1))
