;; sequence(s): A21504
;; terms: 1 19 244 2674 27055 261793 2467018 22871728 209866789 1912958047 17361652672 157125321262 1419351371803 12805505620381 115437617402806 1040066979064876 9367373410791697 84346984486082395
;; small program: loop(loop(loop((x + x) + x, x, loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1)), 1, y) + x, x, 1)
;; fast program: loop(loop((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) + 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + x, x, 2) div 2
(set-logic UFNIA)
