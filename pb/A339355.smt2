;; sequence(s): A339355
;; terms: 8 16 64 112 272 432 832 1232 2072 2912 4480 6048 8736 11424 15744 20064 26664 33264 42944 52624
;; small program: loop(loop(loop(((y * y) + x) + y, y + y, x), y div 2, x), 2 + x, 0)
;; fast program: ((loop(loop(loop((y * y) + x, y, x), y div 2, x), 2 + x, 0) * 2) * 2) * 2
(set-logic UFNIA)
