;; sequence(s): A100922
;; terms: 1 2 3 3 4 5 5 6 6 7 7 7 8 9 9 10 10 11 11 11
;; small program: loop(loop(loop2(x + y, y div 2, x, 0, y) + x, x, y) div x, x, 1)
;; fast program: loop(((loop(loop2(x + y, y div 2, x, 0, y) + x, x, 1) - 1) + y) div x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (w2 x y) (u2 (h2 x) i2 (j2 x y)))))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (div (+ (- (v4 x) 1) y) x))))
