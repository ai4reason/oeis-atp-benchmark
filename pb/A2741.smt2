;; sequence(s): A2741
;; terms: 0 1 ~1 2 0 9 35 230 1624 13209 120287 1214674 13469896 162744945 2128047987 29943053062 451123462672 7245940789073 123604151490591 2231697509543362
;; small program: loop(loop((x * y) + loop(0 - x, y, 1), y - 1, 1) - x, x, 0)
;; fast program: loop(loop(loop(0 - 1, x mod 2, 1) + (x * y), y - 1, 1) - x, x, 0)
(set-logic UFNIA)
