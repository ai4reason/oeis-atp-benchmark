;; sequence(s): A88859
;; terms: 3 3 7 12 23 43 82 157 303 588 1147 2247 4418 8713 17227 34132 67743 134643 267922 533637
;; small program: loop(x + x, x, 1) + loop2(y, x + y, x, 2, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(y, x + y, x, 2, 1)
(set-logic UFNIA)
