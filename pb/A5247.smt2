;; sequence(s): A5247
;; terms: 2 1 3 2 7 5 18 13 47 34 123 89 322 233 843 610 2207 1597 5778 4181
;; small program: loop2(y - x, x, x, if (x mod 2) <= 0 then 2 else 0, 1)
;; fast program: loop2(y - x, x, x, loop(0, x mod 2, 2), 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i0 x) (ite (<= (mod x 2) 0) 2 0))))
(assert (= j0 1))
