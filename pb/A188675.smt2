;; sequence(s): A188675
;; terms: 1 4 19 103 598 3601 22165 138445 873916 5560741 35605756 229142476 1480820176 9603245620 62463474700 407330900284 2662179813931 17433248900656 114359597479261 751343566800961
;; small program: loop(loop2(x * y, 1 + y, y, 1, (1 + y) + y) + (x * y), x, 1) div loop(x * y, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 1 + (x + x)) div loop(x * y, x - 1, 1)) * (1 + 2), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (= i1 1))
(assert (forall ((x Int) (y Int)) (= (j1 x y) (+ (+ 1 y) y))))
...
(assert (forall ((x Int)) (= (f4 x) (* (div (w5 x) (v6 x)) (+ 1 2)))))
(assert (= g4 1))
