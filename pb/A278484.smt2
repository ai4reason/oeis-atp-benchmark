;; sequence(s): A278484
;; terms: 0 2 6 12 18 26 38 48 62 78 90 108 132 146 180 206 222 252 288 306
;; small program: loop2((x div y) + x, y - 1, x, x, x)
;; fast program: loop2((x div y) + x, y - 1, x - 1, x, x) * 2
(set-logic UFNIA)
