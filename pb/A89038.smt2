;; sequence(s): A89038
;; terms: 0 1 3 4 6 7 9 12 13 16 18 19 21 24 27 28 31 33 34 37
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + x) div 2) - 2
;; fast program: compr(((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) - 1, 2 + x) - 2
(set-logic UFNIA)
