;; sequence(s): A214260
;; terms: 0 1 3 6 13 29 64 141 311 686 1513 3337 7360 16233 35803 78966 174165 384133 847232 1868629
;; small program: loop(loop2(((((y * y) + y) div (x + y)) + x) + y, x + y, y, 1, 0), x, 0)
;; fast program: loop2((((y * y) div (x - 1)) + x) + x, x, x - 2, if (x - 1) <= 0 then x else (1 + 2), 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (div (* y y) (- x 1)) x) x))))
