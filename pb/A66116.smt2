;; sequence(s): A66116
;; terms: 90 525 2695 11011 31603 71383 141151 291479 599633 1031153 1739999 2674471 3563023 5034311 7789357 11254073 14709113 19441859 24655531 29890361
;; small program: loop2(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, 1 + y, 2, 1, y) * x, 1 + y, 2, 1, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 2, 1, x), 1, y) * x, 1 + y, 2, 1, x)
(set-logic UFNIA)
