;; sequence(s): A103729
;; terms: 1 5 13 41 61 113 145 221 365 421 613 761 841 1013 1301 1625 1741 2113 2381 2521
;; small program: (loop2((compr((1 + loop(x + x, x, x)) mod (2 + x), y) + 0) * x, y, 2, 1, x) div 2) + 1
;; fast program: (loop2(loop(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 2 + x) - 1, 1, y) * x, y, 2, 1, x) div 2) + 1
(set-logic UFNIA)
