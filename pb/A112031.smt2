;; sequence(s): A112031
;; terms: 3 1 5 1 11 3 21 5 43 11 85 21 171 43 341 85 683 171 1365 341
;; small program: loop2((x + y) + y, x, loop((y - 1) - x, x, 1), 1, 1)
;; fast program: ((loop(x + x, x div 2, loop(1, x mod 2, 2 + 2)) div (1 + 2)) * 2) + 1
(set-logic UFNIA)
