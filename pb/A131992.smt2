;; sequence(s): A131992
;; terms: 31 121 781 2801 16105 30941 88741 137561 292561 732541 954305 1926221 2896405 3500201 4985761 8042221 12326281 14076605 20456441 25774705
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + 1) + x, y, 2 + 2, 1, x)
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1) + x, y, 2 + 2, 1, x)
(set-logic UFNIA)
