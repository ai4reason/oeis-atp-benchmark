;; sequence(s): A293656
;; terms: 1 3 12 30 120 315 1344 3780 17280 51975 253440 810810 4193280 14189175 77414400 275675400 1579253760 5892561675 35300966400 137493105750
;; small program: (loop(loop(x * y, 1 + y, y) div x, x, 1) * (2 + x)) div 2
;; fast program: (loop2(x * y, y - 2, x div 2, 1 + x, x) * (2 + x)) div 2
(set-logic UFNIA)
