;; sequence(s): A23
;; terms: 1 ~1 2 ~2 8 8 112 656 5504 49024 491264 5401856 64826368 842734592 11798300672 176974477312 2831591702528 48137058811904 866467058876416 16462874118127616
;; small program: loop((x * y) + loop(0 - (x + x), y, 1), x, 1)
;; fast program: loop(loop(x + x, y - 1, 2) - (x * y), x, 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
