;; sequence(s): A319074
;; terms: 1 4 31 400 16105 402234 25646167 943531280 81870575521 15025258332150 846949229880161 182859777940000980 23127577557875340733 1759175174860440565844 262246703278703657363377 74543635579202247026882160 21930887362370823132822661921 2279217547342466764922495586798
;; small program: loop2(((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + 1) + x, y, x, 1, x)
;; fast program: loop2((loop((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, x) * 2) + 1, 1, y) * x) + 1, y, x, 1, x)
(set-logic UFNIA)
