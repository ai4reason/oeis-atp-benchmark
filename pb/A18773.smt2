;; sequence(s): A18773
;; terms: 1 2 5 10 101 202 505 1010
;; small program: loop(compr(loop(((x * x) * x) + x, 2, 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop(((x * x) * x) + x, 1, 2 + (2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
