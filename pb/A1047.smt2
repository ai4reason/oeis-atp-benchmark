;; sequence(s): A1047
;; terms: 0 1 5 19 65 211 665 2059 6305 19171 58025 175099 527345 1586131 4766585 14316139 42981185 129009091 387158345 1161737179
;; small program: loop2(((x + x) + x) + y, y + y, x, 0, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
