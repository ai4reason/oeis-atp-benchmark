;; sequence(s): A175540
;; terms: 1 3 5 8 10 13 15 18 22 24 28 31 33 36 40 44 46 50 53 55
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) div 2) + x
;; fast program: compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x) + compr(0, x)
(set-logic UFNIA)
