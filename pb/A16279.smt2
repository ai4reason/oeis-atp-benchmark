;; sequence(s): A16279
;; terms: 1 15 169 1755 17761 178275 1784809 17854395 178563121 1785689235 17857067449 178571201835 1785713604481 17857140811395 178571422430089 1785714267282075 17857142801829841 178571428405456755
;; small program: loop(((loop2((2 * ((2 * (x + x)) + x)) + y, y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop(((loop((loop2(x * y, y, x, 1 + (2 + 2), 1 + (2 + 2)) div 2) * loop(x + x, x - 1, 1), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
