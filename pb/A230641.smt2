;; sequence(s): A230641
;; terms: 0 2 4 4 6 8 8 10 12 10 12 14 14 16 18 18 20 22 20 22
;; small program: 2 * (loop2(x - y, y div (1 + 2), x, x, x) + x)
;; fast program: loop2(x - y, y div (1 + 2), 2 + 2, x, x div (1 + 2)) * 2
(set-logic UFNIA)
