;; sequence(s): A216263
;; terms: 1 6 27 110 429 1638 6187 23238 87021 325358 1215435 4538430 16942381 63239286 236031147 880918070 3287706669 12270039678 45792714187 170901341358
;; small program: loop((x + x) + loop2((2 * (x + x)) - y, x, y, 1, 0), x, 1)
;; fast program: loop((loop2((2 * (x + x)) - y, x, x - 1, if x <= 0 then 1 else 2, 1) - loop(x + x, x, 1)) div (1 + 2), 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (div (- (w3 x) (v4 x)) (+ 1 2)))))
(assert (= g2 1))
