;; sequence(s): A300613
;; terms: 1 1 8 324 35840 7906250 2931489792 1645181968584 1302784779485184 1384565648740109550 1902231808400000000000 3281726715984295577534536 6946466406905591840863420416 17702487251379919853870809258728 53467000591059566447137539120168960
;; small program: (loop2(x * y, y - 1, x - 1, 1, x * x) div loop(x * y, x, 1)) * loop2(x * y, y, x, 1, x)
;; fast program: (loop2(x * y, y - 1, x - 1, 1, x * x) div loop(x * y, x - 1, 1)) * loop2(x * y, y, x - 1, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (div (w0 x) (v1 x)) (w2 x)))))
