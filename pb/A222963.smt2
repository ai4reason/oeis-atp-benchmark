;; sequence(s): A222963
;; terms: 0 4 10 28 40 70 88 130 208 238 340 418 460 550 700 868 928 1120 1258 1330
;; small program: ((loop2((compr((1 + loop(x + x, x, x)) mod (2 + x), y) + 2) * x, y, 2, 1, x) div 2) div 2) - 2
...
(assert (forall ((x Int)) (= (small x) (- (div (div (w0 x) 2) 2) 2))))
