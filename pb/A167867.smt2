;; sequence(s): A167867
;; terms: 1 10 236 8472 359944 16722896 822334816 42068907200 2215884717400 119364801362800 6545334930678816 364137834051739200 20502307365808906816 1166063313963833813632 66893439680369963627264
;; small program: loop((loop2(loop(2 * ((x - (x div y)) + x), y, 1) * x, y, 1 + 2, 1, y) + x) + x, x, 1)
;; fast program: loop((loop(loop((x * x) * x, 1, loop(2 * ((x - (x div y)) + x), x, 1)), 1, y) + x) + x, x, 1)
(set-logic UFNIA)
