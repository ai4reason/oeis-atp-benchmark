;; sequence(s): A343933
;; terms: 0 1 0 0 2 5 6 4 8 7 0 4 10 3 10 4 12 15 3 4
;; small program: loop(loop(loop2(0 - (x * y), y, x, 1, x), 1, y) + x, x, 0) mod (1 + x)
;; fast program: loop(loop(loop2(x * y, y, x - 1, 1, 1 - x), 1, y) + x, x, 0) mod (1 + x)
(set-logic UFNIA)
