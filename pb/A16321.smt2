;; sequence(s): A16321
;; terms: 1 21 313 4065 49081 566721 6350473 69654225 751887961 8016991521 84652923433 886876310385 9231886792441 95586981129921 985282830165193 10117545471478545 103557909243290521 1057021183189581921
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x, x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + (2 + 2), 1 + (2 + 2)) div 2) * loop(x + x, x - 1, 1), 1, y) + x) + (((x + x) * 2) * 2), x, 1)
(set-logic UFNIA)
