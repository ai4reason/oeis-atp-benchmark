;; sequence(s): A131730
;; terms: 0 ~1 1 0 1 ~2 2 ~1 2 ~3 3 ~2 3 ~4 4 ~3 4 ~5 5 ~4
;; small program: loop(loop((y div 2) - x, y, x), x, x mod 2)
;; fast program: loop(y - x, x mod (2 + 2), ((2 + 2) + x) div (2 + 2)) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (div (+ (+ 2 2) x) (+ 2 2)))))
