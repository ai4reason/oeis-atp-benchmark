;; sequence(s): A99856
;; terms: 1 6 18 54 162 486 1458 4374 13122 39366 118098 354294 1062882 3188646 9565938 28697814 86093442 258280326 774840978 2324522934
;; small program: if x <= 0 then 1 else loop((x + x) + x, x, 2)
;; fast program: if x <= 0 then 1 else loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
