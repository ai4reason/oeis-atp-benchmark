;; sequence(s): A89241
;; terms: 6 8 12 16 24 28 36 40 48 60 64 76 84 88 96 108 120 124 136 144
;; small program: (loop(compr((1 + loop(2 * x, x, x)) mod (1 + x), y), x, 1) + 2) * 2
...
(assert (forall ((x Int)) (= (fast x) (* (- (+ (+ (* (v3 x) 2) 2) 2) (ite (<= x 0) 1 2)) 2))))
