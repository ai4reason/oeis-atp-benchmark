;; sequence(s): A89622
;; terms: 3 7 32 263 3136 46669 823560 16777235 387420512 10000000029 285311670642 8916100448293 302875106592294 11112006825558059 437893890380859422 18446744073709551669 827240261886336764236
;; small program: (compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + x) + 1) + loop2((x * y) + x, y, 1 + x, 1, x)
;; fast program: (compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + x) + 1) + loop2(x * y, y, x, 1 + x, 1 + x)
(set-logic UFNIA)
