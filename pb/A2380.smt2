;; sequence(s): A2380
;; terms: 0 1 1 3 1 19 25 11 161 227 681 1019 3057 5075 15225 29291 55105 34243 233801 439259
;; small program: loop((x + x) + x, x, 1) mod loop(x + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) mod loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
