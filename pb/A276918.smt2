;; sequence(s): A276918
;; terms: 1 5 9 25 49 113 225 481 961 1985 3969 8065 16129 32513 65025 130561 261121 523265 1046529 2095105
;; small program: loop((x + loop2(y + y, x, y, 0, 2)) + x, x, 0) + 1
;; fast program: loop((2 * loop((x * x) - x, 1, loop(x + x, x div 2, 1))) * (1 + (x mod 2)), 1, 1 + x) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (* (* 2 (v3 x)) (+ 1 (mod x 2))))))
(assert (= g2 1))
