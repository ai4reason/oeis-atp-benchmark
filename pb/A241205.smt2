;; sequence(s): A241205
;; terms: 0 0 1 14 95 436 1554 4632 12078 28380 61347 123838 236093 428792 746980 1255008 2042652 3232584 4989381 7530270
;; small program: loop(loop(loop(loop(((((y * y) * y) + y) * y) + x, y, x), y, x), y - 1, x), x, 1) div 2
;; fast program: loop(loop(loop(loop(((((y * y) * y) + y) * y) + x, y, x), y, x), y, x), x - 1, 0) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (+ (* (+ (* (* y y) y) y) y) x))))
