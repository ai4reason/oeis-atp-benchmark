;; sequence(s): A294262
;; terms: 1 1 7 27 117 493 2091 8855 37513 158905 673135 2851443 12078909 51167077 216747219 918155951 3889371025 16475640049 69791931223 295643364939
;; small program: loop(loop2((2 * (x + x)) + y, x, y, 0, 2) - x, x, 1)
;; fast program: ((loop2((2 * (x + x)) + y, x, x - 1, 1 + 2, 1) div (2 + 2)) * 2) + 1
(set-logic UFNIA)
