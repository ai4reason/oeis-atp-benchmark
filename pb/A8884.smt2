;; sequence(s): A8884
;; terms: 27 82 41 124 62 31 94 47 142 71 214 107 322 161 484 242 121 364 182 91
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop((x * x) + y, 2, 2))
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop((x * x) * x, 1, 1 + 2))
(set-logic UFNIA)
