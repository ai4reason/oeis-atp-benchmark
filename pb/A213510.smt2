;; sequence(s): A213510
;; terms: 1 3 5 7 10 13 16 19 22 25 28 31 34 38 42 46 50 54 58 62
;; small program: loop(loop(loop((1 + x) div (1 + 2), x, 1 + y) + x, y, 1) + x, x, 1)
;; fast program: loop(loop((y div loop2(1 + (x * y), y, x, 1, 1 + 2)) + x, y, 1) + x, x, 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (div (+ 1 x) (+ 1 2)))))
