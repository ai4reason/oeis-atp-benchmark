;; sequence(s): A7907
;; terms: 1 11 121 1221 12321 123321 1234321 12344321 123454321 1234554321 12345654321 123456654321 1234567654321 12345677654321 123456787654321 1234567887654321 12345678987654321
;; small program: loop2(loop(1 + (2 * ((2 * (x + x)) + x)), y div 2, 1) * x, 1 + y, 2, 1, x)
;; fast program: loop2(loop(loop2(1 + (x * y), y, x div 2, 1, 2 + (2 * (2 + 2))), 1, y) * x, 1 + y, 2, 1, x)
(set-logic UFNIA)
