;; sequence(s): A155640
;; terms: 1 3 25 219 1777 13683 102025 745419 5374177 38400483 272709625 1928498619 13597146577 95668307283 672119557225 4717043931819 33080342678977 231867574534083 1624598900644825 11379821699045019
;; small program: 1 + loop2(((2 * ((x + x) + x)) + x) + y, (2 * (y + y)) + y, x, 0, 2)
;; fast program: 1 + (loop2(x * y, y, x, 1, 1 + (2 + (2 + 2))) - loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))))
(set-logic UFNIA)
