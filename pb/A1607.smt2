;; sequence(s): A1607
;; terms: 0 1 ~1 ~1 3 ~1 ~5 7 3 ~17 11 23 ~45 ~1 91 ~89 ~93 271 ~85 ~457
;; small program: loop2(y - x, 0 - (x + x), x, 0, 1)
;; fast program: loop(0 - x, x mod 2, loop2(x - y, x + x, x, 0, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g0 x) (- 0 (+ x x)))))
