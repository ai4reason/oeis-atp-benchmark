;; sequence(s): A94125
;; terms: 5 12 30 78 210 582 1650 4758 13890 40902 121170 360438 1075170 3213222 9615090 28796118 86290050 258673542 775627410 2326095798
;; small program: loop((x + x) + x, x, 2) + loop(x + x, x, 1 + 2)
;; fast program: loop(x + x, x, 1 + 2) + loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
