;; sequence(s): A209724
;; terms: 8 9 10 12 14 18 22 30 38 54 70 102 134 198 262 390 518 774 1030 1542
;; small program: 2 + (2 + (2 + loop2(x + y, x - y, x, 2, 1)))
;; fast program: 2 + (2 + (2 + loop(x + x, x div 2, 2 + (x mod 2))))
(set-logic UFNIA)
