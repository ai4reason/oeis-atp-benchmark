;; sequence(s): A132708
;; terms: 4 2 1 ~4 ~2 ~1 4 2 1 ~4 ~2 ~1 4 2 1 ~4 ~2 ~1 4 2
;; small program: loop(0 - x, x, 1) + loop2(x - y, x, x, 1 + 2, 0)
;; fast program: loop2(x - y, x, x mod (2 + (2 + 2)), 1 + 2, 0) + loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
