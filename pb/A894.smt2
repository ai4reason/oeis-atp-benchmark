;; sequence(s): A894
;; terms: 1 6 60 700 8820 116424 1585584 22084920 312869700 4491418360 65166397296 953799087696 14062422446800 208618354980000 3111393751416000 46619049708716400 701342468412012900
;; small program: loop(loop2(2 * ((x - (x div y)) + x), 1 + y, 2, x, y), x, 1)
;; fast program: (loop(x * x, 1, loop(2 * ((x - (x div y)) + x), x, 1)) div (1 + x)) * (1 + (x + x))
(set-logic UFNIA)
