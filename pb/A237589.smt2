;; sequence(s): A237589
;; terms: 1 4 9 16 27 40 57 76 99 128 159 196 237 280 327 380 439 500 567 638
;; small program: loop(compr((1 + loop(x + x, x, x)) mod (1 + x), y) + x, x, 1) + x
;; fast program: ((loop(compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) + x, x, 0) * 2) + 1) + x
(set-logic UFNIA)
