;; sequence(s): A1027
;; terms: 1 18 324 5832 104976 1889568 34012224 612220032 11019960576 198359290368 3570467226624 64268410079232 1156831381426176 20822964865671168 374813367582081024 6746640616477458432 121439531096594251776 2185911559738696531968 39346408075296537575424 708235345355337676357632
;; small program: loop(2 * loop((x + x) + x, 2, x), x, 1)
;; fast program: loop(x + x, x, 1) * loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
