;; sequence(s): A216134
;; terms: 0 1 4 9 26 55 154 323 900 1885 5248 10989 30590 64051 178294 373319 1039176 2175865 6056764 12681873
;; small program: loop(loop2(y, (x + y) + y, y, x mod 2, 1) + x, x, 0)
;; fast program: loop(loop2((x + x) + y, x, y - 1, 1, x mod 2) + x, x, 0)
(set-logic UFNIA)
...
(assert (= i3 1))
(assert (forall ((x Int)) (= (j3 x) (mod x 2))))
