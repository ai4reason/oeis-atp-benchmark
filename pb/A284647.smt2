;; sequence(s): A284647
;; terms: 0 1 6 36 231 1540 10440 71253 487578 3339820 22885995 156848616 1075018896 7368190921 50502074766 346145696820 2372516138895 16261462918828 111457712887128 763942497430365
;; small program: loop((x * x) + x, 1, loop2(x + y, x, x + x, 0, 1)) div 2
;; fast program: loop((x * x) + x, 1, loop2(((x - y) + x) + x, x, x - 2, if (x - 1) <= 0 then x else (1 + 2), 1)) div 2
(set-logic UFNIA)
