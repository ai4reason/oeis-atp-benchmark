;; sequence(s): A127335
;; terms: 77 98 124 150 180 210 240 270 304 340 372 408 442 474 510 546 582 620 660 696
;; small program: ((loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 2 * (2 + 2), 2, x) + 2) + 2) + 2
;; fast program: ((loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 2 * (2 + 2), 2, x) + 2) + 2) + 2
(set-logic UFNIA)
