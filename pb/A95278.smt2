;; sequence(s): A95278
;; terms: 0 1 2 4 5 7 10 11 14 16 17 19 20 25 26 31 32 34 37 40
;; small program: compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x) div 2
;; fast program: compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) div 2
(set-logic UFNIA)
