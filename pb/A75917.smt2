;; sequence(s): A75917
;; terms: 1 60 2340 75600 2204496 60419520 1591202880 40800672000 1027086863616 25522067450880 628349082117120 15366613964083200 373968813041012736 9068526888588656640 219326169845571010560
;; small program: loop(((loop2(((2 * (y * y)) - y) + x, y + y, y, 1, 2) + x) + x) + x, x, 1) * loop(2 * ((x + x) + x), x, 1)
;; fast program: loop(((loop((loop((x * x) + x, 1, 2 * (loop(x + x, x, 2) - 1)) div 2) div (1 + 2), 1, y) + x) + x) + x, x, 1) * loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h5 x) (* 2 (- (v6 x) 1)))))
