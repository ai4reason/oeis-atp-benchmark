;; sequence(s): A25943
;; terms: 1 20 263 2890 28833 271320 2457211 21670550 187473605 1598611300 13480822719 112690635330 935435043817 7720854845360 63428474542787 519059289782830 4233894901355469 34441103679651900
;; small program: loop(((loop((loop2(((2 * ((x + x) + x)) + ((y * y) * y)) + x, y + y, y, 1, 2) + x) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(((loop(loop(((x * x) * x) - x, 1, loop(x + x, x, 2)) div (2 + (2 + 2)), 1, y) + x) + x) + x, y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
