;; sequence(s): A186497
;; terms: 1 4 6 7 9 11 12 14 15 16 18 19 21 22 23 25 26 27 28 30
;; small program: loop(loop(x + y, x, y) div x, (x + x) + x, 1) + x
;; fast program: loop2(loop(x + y, x, y) div x, y, 1 + (2 + 2), 2 + 2, (x + x) + x) + x
(set-logic UFNIA)
