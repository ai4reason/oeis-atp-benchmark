;; sequence(s): A135399
;; terms: 3 0 14 18 98 210 794 2058 6818 19170 60074 175098 535538 1586130 4799354 14316138 43112258 129009090 387682634 1161737178
;; small program: loop2(y, (2 * ((x + x) + x)) + y, x, 2, 1) + loop(0 - x, x, 1)
;; fast program: loop(0 - x, x mod 2, 1 + loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
