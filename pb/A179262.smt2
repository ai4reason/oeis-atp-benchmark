;; sequence(s): A179262
;; terms: 7 17 49 97 241 337 577 721 1057 1681 1921 2737 3361 3697 4417 5617 6961 7441 8977 10081
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2, 2, x) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 2, x) - 1
(set-logic UFNIA)
