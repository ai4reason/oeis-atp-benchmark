;; sequence(s): A345727
;; terms: 9 20 42 88 156 238 342 460 696 930 1184 1558 1806 2068 2544 3186 3660 4154 4828 5256
;; small program: loop2(((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 1) + x, 1 + y, 2, 1, x) - 1
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1) + x, 1 + y, 2, 1, x) - 1
(set-logic UFNIA)
