;; sequence(s): A216685
;; terms: 0 1 2 2 2 3 2 2 2 3 3 3 4 2 1 1 2 3 3 3
;; small program: loop(loop(loop2(x - y, y div 2, x, x, x) + x, 1, x + y), x, 0)
;; fast program: (loop((loop2(x - y, y div 2, 2 + (2 + 2), 1, x div 2) + x) + y, x, 1) - 1) - x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (+ (w4 x) x) y))))
