;; sequence(s): A81410
;; terms: 1 1 2 4 8 12 21 35 56 92 150 242 393 637 1030 1668 2700 4368 7069 11439
;; small program: loop2(y, loop((x + y) + y, x mod 2, 1 + x) + y, x, 2, 2) div 2
;; fast program: ((((loop2(y, x + y, x, 1 + 2, 2) div 2) * 2) - 1) + loop2(x + y, x, x - 1, 1, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (- (* (div (w2 x) 2) 2) 1) (w3 x)) 2))))
