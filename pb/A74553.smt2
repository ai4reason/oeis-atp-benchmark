;; sequence(s): A74553
;; terms: 3 16 98 664 4802 36136 278498 2177464 17174402 136190536 1083566498 8638939864 68964148802 550978111336 4404154809698 35214904015864 281627607648002 2252562882278536 18018213594168098 144134262724445464
;; small program: loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 2, 2) + loop(x + x, (x + x) + x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
