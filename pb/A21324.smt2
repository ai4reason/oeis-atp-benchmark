;; sequence(s): A21324
;; terms: 1 25 437 6629 93429 1260021 16509109 211998133 2682866357 33583284917 416888307381 5141548576437 63087471804085 770938550533813 9390151495286453 114070706832309941 1382737370876575413
;; small program: loop(loop2((2 * (((2 * (x + x)) + x) + y)) - 1, y + y, y, 1, 2) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop(loop(((((loop2(1 + (x * y), y, x, 1, 2 + (2 * (2 + 2))) * (1 + (2 + 2))) + 1) div 2) - loop(x + x, x, 1)) div 2, 1, y) + (2 * (2 * ((x + x) + x))), x, 1)
(set-logic UFNIA)
