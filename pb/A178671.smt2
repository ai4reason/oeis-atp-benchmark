;; sequence(s): A178671
;; terms: ~4 0 20 120 620 3120 15620 78120 390620 1953120 9765620 48828120 244140620 1220703120 6103515620 30517578120 152587890620 762939453120 3814697265620 19073486328120
;; small program: ((loop((2 * (x + x)) + x, x, 1) - 1) - 2) - 2
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) - 1) - 2) - 2
(set-logic UFNIA)
