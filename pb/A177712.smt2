;; sequence(s): A177712
;; terms: 6 10 12 14 18 20 22 24 26 28 30 34 36 38 40 42 44 46 48 50
;; small program: (loop(loop(2 + ((x div y) + x), x, y) div x, x, 2) * 2) + 2
;; fast program: ((loop(2 + ((x div y) + x), 1 + x, x) div (1 + x)) * 2) + 2
(set-logic UFNIA)
