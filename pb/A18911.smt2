;; sequence(s): A18911
;; terms: 1 18 223 2376 23485 222894 2067787 18935172 172107529 1557684810 14063797111 126801537408 1142367430933 10287141958566 92613721463395 833671786093884 7503791834428897 67537872487648962
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop2((2 * (x + x)) + y, (2 * (2 * (y + y))) + y, x, 1, 1) - loop2(x * y, y, x, 1, 1 + (2 + 2))) div 2, 1, 2 + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g4 x y) (+ (* 2 (* 2 (+ y y))) y))))
