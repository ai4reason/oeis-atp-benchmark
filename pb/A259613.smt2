;; sequence(s): A259613
;; terms: 1 5 165 6188 245157 10015005 417225900 17620076360 751616304549 32308782859535 1397281501935165 60727722660586800 2650087220696342700 116043807643289338428 5096278545356362962504 224377658168860057076688
;; small program: loop(loop2(x * y, 1 + y, x, 1, x div 2) div loop(x * y, x, 1), 1, 2 * (x + x))
;; fast program: (((loop2(((y * y) + y) * x, 2 + y, x, 1, 2 * (x + x)) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 1 + x)) + 1) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (div (div (w3 x) (v4 x)) (w5 x)) 1) 2))))
