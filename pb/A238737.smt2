;; sequence(s): A238737
;; terms: 0 1 1 1 3 1 1 3 1 1 3 1 3 5 1 1 3 5 1 3
;; small program: loop2((loop(((loop(x * y, x, 1) mod (2 + x)) + 1) mod 2, 1, y) * x) + 1, 1 + y, x, 0, x)
;; fast program: loop((loop((loop(if (((1 + loop(x + x, x div 2, 1)) mod (1 + x)) - 2) <= 0 then 1 else 0, 1, x + x) + 1) mod 2, 1, y) * x) + 2, x, 1) - 1
(set-logic UFNIA)
