;; sequence(s): A228906
;; terms: 1 2 7 62 1031 24782 774180 29763855 1359654560 71984907423 4335406418694 292753300447894 21909289407621069 1800106653483146619 161097567109713138999 15599377878403186676330 1625083531855929644443019 181238001661004834528467994 21545324993880123460418461719
;; small program: loop(loop(loop2(x * y, 1 + y, x, 1, x * x) div loop(x * y, x, x), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 1 + (x * x)) div loop(x * y, x - 1, 1), 1, y) + x, x, 1)
(set-logic UFNIA)
