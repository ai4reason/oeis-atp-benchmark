;; sequence(s): A333599
;; terms: 0 1 2 1 7 1 20 1 54 1 143 1 376 1 986 1 2583 1 6764 1
;; small program: loop2(y, (x mod y) + y, x, 1 + x, 2) - 1
;; fast program: loop2(loop2(x + y, x, y, 1, 1) - x, 0, 1 - (x mod 2), 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (+ (mod x y) y))))
