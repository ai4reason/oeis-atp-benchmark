;; sequence(s): A227325
;; terms: 1 2 18 320 8750 326592 15529668 899678208 61556811030 4862000000000 435644983598396 43678490079264768 4846281282497517772 589650705050503577600 78074729079345703125000 11177395284330167371038720 1720546364146510165684599270
;; small program: loop(2 * ((x - (x div y)) + x), x, loop2(x * y, y, x - 1, 1, 1 + x))
;; fast program: loop(2 * ((x - (x div y)) + x), x, 1) * loop2(x * y, y, x - 1, 1, 1 + x)
(set-logic UFNIA)
