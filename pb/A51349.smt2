;; sequence(s): A51349
;; terms: 0 1 5 11 19 28 38 50 64 79 95 113 133 154 176 200 225 251 278 306
;; small program: loop((compr(loop(x * y, x, 2) mod (2 + x), y) + 1) + x, x - 1, x)
;; fast program: loop(compr(loop(((if (((1 + loop(x + x, x div 2, 1)) mod (1 + x)) - 2) <= 0 then 1 else 0) mod 2) + x, (1 + x) mod 2, x) - x, y) + x, x - 1, x)
(set-logic UFNIA)
