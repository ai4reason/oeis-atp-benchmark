;; sequence(s): A300402
;; terms: 1 1 2 2 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3
;; small program: 1 + loop2(y, 2, x div 2, 0, 1)
;; fast program: 1 + loop((y - x) mod 2, (2 + 2) - x, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (mod (- y x) 2))))
