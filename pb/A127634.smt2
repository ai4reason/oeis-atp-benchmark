;; sequence(s): A127634
;; terms: 0 1 4 16 54 178 565 1770 5493 16927 51901 158533 482802 1466859 4448104 13467249 40720970 122994566 371156622 1119161662
;; small program: (loop((1 + 2) * (x * y), x, 1) - loop2(x * y, y, x, 1, 1 + x)) div loop(x * y, x, 1)
;; fast program: ((((loop(x * y, x, 1) - loop2(x * y, y, x, 1, 1 + x)) div loop(x * y, x, 1)) + 1) + loop2(x * y, y, x, 1, 1 + 2)) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (- (v0 x) (w1 x)) (v2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (- (+ (+ (div (- (v3 x) (w4 x)) (v5 x)) 1) (w6 x)) 2))))
