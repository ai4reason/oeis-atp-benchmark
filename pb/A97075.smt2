;; sequence(s): A97075
;; terms: 1 0 2 3 9 20 50 119 289 696 1682 4059 9801 23660 57122 137903 332929 803760 1940450 4684659
;; small program: loop(loop2((x + x) + y, x, y, 0, 1) - x, x, 1)
;; fast program: 1 + ((loop2((x + x) + y, x, x - 1, 1, 1) div 2) - (x mod 2))
(set-logic UFNIA)
