;; sequence(s): A175744
;; terms: 196608 327680 458752 720896 851968 1114112 1245184 1507328 1900544 2031616 2424832 2686976 2818048 3080192 3473408 3866624 3997696 4390912 4653056 4784128
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) + 1) * loop(x * x, 2 + 2, 2)
;; fast program: ((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, 1 + x) * 2) + 1) * loop(x * x, 2 + 2, 2)
(set-logic UFNIA)
