;; sequence(s): A123020
;; terms: 1 1 2 5 14 43 142 493 1766 6443 23750 88045 327406 1219531 4546622 16958765 63272054 236096683 881049142 3287968813
;; small program: loop((x - loop2(y, (2 * (y + y)) - x, y - 1, 1, 0)) + x, x, 1)
;; fast program: (loop2((2 * (x + x)) - y, x, x - 2, 2, 1) + loop(x + x, x - 1, 2)) div (1 + 2)
(set-logic UFNIA)
