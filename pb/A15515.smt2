;; sequence(s): A15515
;; terms: 1 1 14 2212 4171832 94375183504 25618521062894816 83450744014073963641408 3262026661649164626974053098368 1530121919008888925087797696409496422656 8612828743790947623482719127044813092555596516864
;; small program: (loop(loop(loop(((2 + y) * x) - 2, 2, x), y, 1) * x, x, 1) + 1) div 2
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (- (* (+ 2 y) x) 2))))
(assert (= g2 2))
