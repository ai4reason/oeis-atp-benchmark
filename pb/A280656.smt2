;; sequence(s): A280656
;; terms: 1 16 32768 67108864 70368744177664 147573952589676412928 19807040628566084398385987584 1329227995784915872903807060280344576 365375409332725729550921208179070754913983135744 25108406941546723055343157692830665664409421777856138051584
;; small program: loop(loop2(loop(x + x, y, x), y div 2, x, 1, x), 1, (2 + x) * x)
;; fast program: loop(loop2((2 - (y mod 2)) * x, y div 2, x, 1, x), 1, (2 * (2 + x)) * x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (* (- 2 (mod y 2)) x))))
