;; sequence(s): A6111
;; terms: 1 31 806 20306 508431 12714681 317886556 7947261556 198682027181 4967053120931 124176340230306 3104408566792806 77610214474995931 1940255363400777181 48506384092648824056 1212659602354367574056 30316490059049924214681
;; small program: loop((loop(1 + ((2 * (x + x)) + x), y, 1) + loop(x * y, 2 + 2, x)) + x, x, 1)
;; fast program: (loop2(loop2(1 + (x * y), y, y, 1, 1 + (2 + 2)) * x, 1 + y, 2, 1, x) div (1 + 2)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (div (w3 x) (+ 1 2)) 2))))
