;; sequence(s): A95342
;; terms: 1 1 5 5 17 25 61 109 233 449 917 1813 3649 7273 14573 29117 58265 116497 233029 466021
;; small program: loop(loop2((x + y) + y, x, y, 2, 0) - x, x, 1)
;; fast program: ((loop2(y - x, y + y, x, 1 + x, 2 + 2) div (1 + 2)) * 2) + 1
(set-logic UFNIA)
