;; sequence(s): A32096
;; terms: 2 3 8 23 74 227 704 2135 6482 19523 58808 176663 530714 1592867 4780784 14344535 43040162 129127043 387400808 1162222103
;; small program: (loop((x + x) + x, x, 1) - loop2(y, (x + x) + x, x, 1, 2)) + 2
;; fast program: 2 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop2(x * y, y, x div 2, 1 + (x mod 2), 1 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ 2 (- (w2 x) (w4 x))))))
