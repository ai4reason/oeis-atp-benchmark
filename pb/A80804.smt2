;; sequence(s): A80804
;; terms: 1 3 4 6 7 8 9 11 12 13 14 15 16 17 18 20 21 22 23 24
;; small program: (1 + loop(loop((x + y) div 2, x, y), x, x)) + x
;; fast program: loop(loop2((if y <= 0 then 0 else 1) + x, y div 2, 2 + (2 + 2), 1, x div 2), 1, 1 + x) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (ite (<= y 0) 0 1) x))))
