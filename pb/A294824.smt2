;; sequence(s): A294824
;; terms: 1 1 2 6 21 77 285 1053 3875 14212 52021 190301 696532 2553047 9377034 34525630 127466481 471935813 1752332838 6525032251
;; small program: loop((((1 + 2) * (x * y)) div (2 + y)) + x, x, 1) - loop2(x + y, x, x + x, 0, 1)
;; fast program: ((loop(2 * (((x div y) + x) + x), x, 2) div (1 + x)) div (2 + x)) - loop2(((x - y) + x) + x, x, x - 1, if x <= 0 then 0 else 1, 0)
(set-logic UFNIA)
