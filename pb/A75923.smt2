;; sequence(s): A75923
;; terms: 1 70 3185 120050 4084101 130590390 4012419145 120031392250 3525181576301 102196720335710 2935410756419505 83751552660170850 2377917929557166101 67273652916778177030 1898215473677945050265
;; small program: loop(((loop2(((2 * (y * y)) - y) + x, y + y, y, 1, 2) + x) + x) + x, x, 1) * loop((2 * ((x + x) + x)) + x, x, 1)
