;; sequence(s): A185970
;; terms: 1 3 24 480 23040 2580480 660602880 380507258880 487049291366400 1371530804487782400 8426685262772935065600 112176034218033311593267200 3216311253099451110002157158400 197610163390430276198532535812096000 25901159335910477161894056533963046912000
;; small program: loop(loop2((2 + y) * x, 0, y, x, y), x, 1)
;; fast program: (((1 + x) * loop(x * y, x, 2 + x)) div 2) * loop2(x * y, y + y, x - 1, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (* (+ 1 x) (v2 x)) 2) (w3 x)))))
