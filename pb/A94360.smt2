;; sequence(s): A94360
;; terms: 1 2 7 5 31 17 127 65 511 257 2047 1025 8191 4097 32767 16385 131071 65537 524287 262145
;; small program: loop2(y, 2 * (x + x), x, 2, 1) - loop(0 - x, x, 1)
;; fast program: 1 + loop((x - 2) + x, (x - 1) mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
