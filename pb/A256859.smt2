;; sequence(s): A256859
;; terms: 1 6 25 80 210 476 966 1800 3135 5170 8151 12376 18200 26040 36380 49776 66861 88350 115045 147840
...
(assert (forall ((x Int)) (= (fast x) (div (* (div (- (v2 x) x) (+ 1 2)) (+ 2 (+ 2 (+ (* x x) x)))) (* 2 (+ 2 2))))))
