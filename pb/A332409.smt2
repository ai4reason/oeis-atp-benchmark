;; sequence(s): A332409
;; terms: 0 0 1 2 0 0 1 6 27 45 71 0 228 73 605 861 956 2376 1199 5235
;; small program: loop(loop((x * y) + x, y, 1) div x, x, 1) mod loop2(x + y, x, x, 1, 0)
;; fast program: (loop2(x * y, y - 2, x div 2, 1, x - 1) * (1 + x)) mod loop2(x + y, x, x, 1, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (mod (v0 x) (w2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (mod (* (w3 x) (+ 1 x)) (w4 x)))))
