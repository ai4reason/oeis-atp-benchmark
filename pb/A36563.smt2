;; sequence(s): A36563
;; terms: ~2 ~1 1 5 13 29 61 125 253 509 1021 2045 4093 8189 16381 32765 65533 131069 262141 524285
;; small program: (loop(x + x, x, 1) - 1) - 2
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) - 2
(set-logic UFNIA)
