;; sequence(s): A18206
;; terms: 1 24 403 5850 78601 1007364 12509263 151886670 1813607701 21378247704 249446413723 2886767617890 33183014997601 379298878576044 4315144805143783 48895164279003510 552132521336304301
;; small program: loop(((loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop((((loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))) - loop2(x * y, y, x, 1 + 2, 1 + 2)) div 2) div 2) div 2, 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (div (div (div (- (w6 x) (w7 x)) 2) 2) 2))))
(assert (= g5 1))
