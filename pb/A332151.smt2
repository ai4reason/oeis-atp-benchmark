;; sequence(s): A332151
;; terms: 1 515 55155 5551555 555515555 55555155555 5555551555555 555555515555555 55555555155555555 5555555551555555555 555555555515555555555 55555555555155555555555 5555555555551555555555555 555555555555515555555555555 55555555555555155555555555555 5555555555555551555555555555555
;; small program: ((loop(1 + (2 * ((2 * (x + x)) + x)), x + x, 1) - loop(2 * ((2 * (x + x)) + x), x, 1)) * (1 + (2 + 2))) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
;; fast program: (((((((loop2(x * y, y, x, 2, 2 + (2 * (2 + 2))) - 1) * (1 + (2 + 2))) - 2) - 2) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) div (1 + (2 * (2 + 2)))) * (1 + (2 + 2))) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (* (- (v0 x) (v1 x)) (+ 1 (+ 2 2))) (w2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (* (div (* (- (- (* (- (w3 x) 1) (+ 1 (+ 2 2))) 2) 2) (w4 x)) (+ 1 (* 2 (+ 2 2)))) (+ 1 (+ 2 2))) (w5 x)))))
