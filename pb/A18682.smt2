;; sequence(s): A18682
;; terms: 1 2 5 10 17 25 34 50 85 170 425 850
;; small program: loop(compr((loop(2 * (2 + (x + x)), 2 + 2, 2) - 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 * loop((2 + ((x + x) + x)) * (x * x), 1, 1 + (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
