;; sequence(s): A192245
;; terms: 0 3 9 29 74 179 403 871 1816 3686 7316 14258 27362 51827 97067 180027 331038 604125 1095085 1973095
;; small program: loop(loop(loop2(1 + y, x + y, x, 0, loop(x + y, x, x)), 1, y) + x, x, 0)
;; fast program: loop(loop((loop2(x + y, x, x - 2, 1, 1) * (1 + x)) * (2 + x), 1, y) + x, x, 0) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (* (* (w6 x) (+ 1 x)) (+ 2 x)))))
(assert (= g5 1))
