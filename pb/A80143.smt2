;; sequence(s): A80143
;; terms: 0 5 13 39 102 272 712 1869 4893 12815 33550 87840 229968 602069 1576237 4126647 10803702 28284464 74049688 193864605
;; small program: loop(loop2(1 + (x + y), x, y + y, 2, 1) - x, x, 1) - 1
;; fast program: ((loop2(x + y, x, x, 1, 1) * loop2(x + y, x, x, 2, 1)) - 2) + (x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (* (w2 x) (w3 x)) 2) (mod x 2)))))
