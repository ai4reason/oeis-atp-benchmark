;; sequence(s): A8974
;; terms: 1 27 46656 10000000000 437893890380859375 5842587018385982521381124421 33145523113253374862572728253364605812736 106387358923716524807713475752456393740167855629859291136
;; small program: loop(loop2(x * y, y, x, 1, x), 1, 1 + loop(x + y, x, x))
;; fast program: loop(loop2(x * y, y, x - (x div 2), 1, x) * loop2(x * y, y, x div 2, 1, x), 1, ((1 + x) * (2 + x)) div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h4 x) (- x (div x 2)))))
(assert (= i4 1))
