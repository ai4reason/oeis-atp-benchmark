;; sequence(s): A83581
;; terms: 1 6 ~4 16 ~24 56 ~104 216 ~424 856 ~1704 3416 ~6824 13656 ~27304 54616 ~109224 218456 ~436904 873816
;; small program: loop(2 * (2 + (2 - x)), x, 1)
;; fast program: loop2((x - 2) * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 1), 2 + 2)
(set-logic UFNIA)
