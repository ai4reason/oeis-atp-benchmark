;; sequence(s): A181709
;; terms: 2 3 4 5 6 7 8 10 11 13 14 15 16 18 20 21 23 24 25 27
;; small program: (compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), (1 + 2) + x) div (1 + 2)) + 1
;; fast program: (compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), (1 + x) mod 2, x) - 1, (1 + 2) + x) div (1 + 2)) + 1
(set-logic UFNIA)
