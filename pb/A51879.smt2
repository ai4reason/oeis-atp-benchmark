;; sequence(s): A51879
;; terms: 1 14 69 224 574 1260 2478 4488 7623 12298 19019 28392 41132 58072 80172 108528 144381 189126 244321 311696
;; small program: loop(loop(loop(loop((x - 2) + y, (y + y) + y, y) + x, y, x), 1 + y, x), x, 1)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (- x 2) y))))
...
(assert (forall ((x Int)) (= (fast x) (div (* (div (v4 x) (* 2 (* 2 (+ 2 (+ 2 2))))) (+ 1 (+ (* 2 (+ 2 (* 2 (+ x x)))) x))) (+ 1 (+ 2 2))))))
