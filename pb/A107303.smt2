;; sequence(s): A107303
;; terms: 4 6 8 12 14 16 22 24 26 28 34 36 38 44 48 52 54 56 62 66
;; small program: compr(loop((2 - loop(x + x, x, 2)) mod (1 + x), 1, (x + x) + x), 1 + x) + 2
;; fast program: (compr(((loop(if (((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2) <= 0 then 1 else 2, 1, (x + x) + x) mod (1 + 2)) - 1) mod (1 + x), 1 + x) * 2) + 2
(set-logic UFNIA)
