;; sequence(s): A5212
;; terms: 0 1 0 6 0 120 0 5040 0 362880 0 39916800 0 6227020800 0 1307674368000 0 355687428096000 0 121645100408832000
;; small program: loop(x * y, x, x mod 2)
;; fast program: loop2(loop(x * y, y - 1, 1), 1 + 2, x mod 2, 0, x) * x
(set-logic UFNIA)
