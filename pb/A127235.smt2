;; sequence(s): A127235
;; terms: 1 4 4320 11496038400 291948240981196800000 190982059064777562218142105600000000 7081230833474514688657438735472338312479375360000000000
;; small program: loop2(loop(x * y, y, 1) * x, x * y, 2, 1 + x, x)
;; fast program: loop(loop2(x * y, 1 + y, x, 1, 1 + x) * loop(x * y, x, 1), 1, ((x * x) + x) div 2) * loop((1 + y) * x, x, 1)
(set-logic UFNIA)
