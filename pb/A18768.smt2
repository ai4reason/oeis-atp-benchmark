;; sequence(s): A18768
;; terms: 1 7 11 13 77 91 143 1001
;; small program: loop(compr((loop(2 + ((x * x) * x), 2, 2) + x) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + loop((x * x) * x, 1, 2 + (2 * (2 + 2)))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
