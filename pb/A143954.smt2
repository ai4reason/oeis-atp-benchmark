;; sequence(s): A143954
;; terms: 0 0 1 5 19 68 243 880 3233 12021 45119 170595 648787 2479057 9509627 36598497 141246127 546433952 2118424887 8227983472
;; small program: loop(loop(loop(2 * ((x - (x div y)) + x), y, 1) + x, y - 1, x), x, 0) div 2
;; fast program: loop(loop(loop(2 * ((x - (x div y)) + x), y, 1) + x, y, x), x - 1, 0) div 2
(set-logic UFNIA)
