;; sequence(s): A89118
;; terms: 2 8 11 26 29 35 38 80 83 89 92 107 110 116 119 242 245 251 254 269
;; small program: compr(loop(if (x mod 2) <= 0 then (x div (1 + 2)) else 1, x, 2 + (x + x)), x + x)
;; fast program: (loop(((((loop((((((loop(((((loop((((((loop(((((loop((2 * (x * x)) - x, 1, x div 2) + x) * (1 + 2)) + 1) - x) - x, 1, x div 2) + x) * (1 + 2)) - 1) - 2) - x) - x, 1, x div 2) + x) * (1 + 2)) + 1) - x) - x, 1, x div 2) + x) * (1 + 2)) - 1) - 2) - x) - x, 1, x div 2) + x) * (1 + 2)) + 1) - x) - x, 1, 1 + x) + x) + x
(set-logic UFNIA)
