;; sequence(s): A133629
;; terms: 1 5 10 30 55 155 280 780 1405 3905 7030 19530 35155 97655 175780 488280 878905 2441405 4394530 12207030
;; small program: loop2((2 * (y + y)) + y, 1 + x, x, 1, 1)
;; fast program: loop2((x * y) + y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), 1 + (2 + 2))
(set-logic UFNIA)
