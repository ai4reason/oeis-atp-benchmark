;; sequence(s): A1348
;; terms: 3 7 31 127 2047 8191 131071 524287 8388607 536870911 2147483647 137438953471 2199023255551 8796093022207 140737488355327 9007199254740991 576460752303423487 2305843009213693951 147573952589676412927 2361183241434822606847
;; small program: (loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), x, 2, 0, x) div 2) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x + x, x - 1, 1), x, 2, 0, x) - 1
(set-logic UFNIA)
