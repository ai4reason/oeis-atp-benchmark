;; sequence(s): A28346
;; terms: 1 4 12 28 58 108 188 308 483 728 1064 1512 2100 2856 3816 5016 6501 8316 10516 13156
;; small program: loop(loop(loop(loop(x + y, y div 2, x), y, x), 2 + y, x), x, 1)
;; fast program: loop(loop(loop(loop(x + y, 1 + y, x), x div 2, 1) * loop2(1 + y, x, x, 1, 2), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ 1 y))))
...
(assert (forall ((x Int)) (= (f5 x) (* (v6 x) (w8 x)))))
(assert (= g5 1))
