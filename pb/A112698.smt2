;; sequence(s): A112698
;; terms: 1 5 37 357 3941 46949 587621 7616357 101332837 1375876965 18987759461 265554114405 3755416368997 53610591434597 771525112379237 11181285666076517 163041321978836837 2390321854565988197
;; small program: loop(loop((loop(2 * (2 * (y - x)), 2, y) * x) div (1 + y), y, 1) + x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x - 1, x)) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + x, x, 1)
(set-logic UFNIA)
