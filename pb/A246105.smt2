;; sequence(s): A246105
;; terms: 2 1 3 2 1 5 4 3 2 1 8 7 6 5 4 3 2 1 13 12
;; small program: loop(loop(loop(((y * y) div (1 + x)) + y, 1 + x, 0), y - x, x), 1 + x, 0) - x
;; fast program: loop(loop(loop(((y * y) div (1 + x)) + y, 1 + x, 0), y - x, x), 1 + x, 2) - x
(set-logic UFNIA)
