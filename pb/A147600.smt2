;; sequence(s): A147600
;; terms: 1 0 3 0 8 0 21 0 55 0 144 0 377 0 987 0 2584 0 6765 0
;; small program: if (x mod 2) <= 0 then loop2(x + y, x, x, 1, 1) else 0
;; fast program: loop2(loop2(x + y, x, y, 1, 1), y, (x - 1) mod 2, 0, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (ite (<= (mod x 2) 0) (w0 x) 0))))
...
(assert (forall ((x Int)) (= (h1 x) (mod (- x 1) 2))))
(assert (= i1 0))
