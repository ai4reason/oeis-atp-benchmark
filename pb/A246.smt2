;; sequence(s): A246
;; terms: 1 1 1 3 9 45 225 1575 11025 99225 893025 9823275 108056025 1404728325 18261468225 273922023375 4108830350625 69850115960625 1187451971330625 22561587455281875
;; small program: loop((((y mod 2) + y) * x) - x, x, 1)
;; fast program: loop2(loop((2 * (x * y)) - x, y div 2, 1) * x, 1 + y, 2, 1, x)
(set-logic UFNIA)
