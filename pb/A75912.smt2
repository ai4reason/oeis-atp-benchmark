;; sequence(s): A75912
;; terms: 1 50 1625 43750 1063125 24281250 532890625 11386718750 238867578125 4946347656250 101481884765625 2068161621093750 41943091064453125 847579699707031250 17082562164306640625 343617765808105468750 6901873153839111328125
;; small program: loop(((loop2(((2 * (y * y)) - y) + x, y + y, y, 1, 2) + x) + x) + x, x, 1) * loop((2 * (x + x)) + x, x, 1)
;; fast program: loop(((loop((loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div 2) div (1 + 2), 1, y) + x) + x) + x, x, 1) * loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (div (div (v5 x) 2) (+ 1 2)))))
(assert (= g4 1))
