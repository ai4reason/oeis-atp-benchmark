;; sequence(s): A244415
;; terms: 0 1 0 1 0 1 0 2 0 1 0 1 0 1 0 2 0 1 0 1
;; small program: ((loop2((y mod 2) + x, y div (2 - (x mod 2)), x, 1, x) div 2) + 1) div 2
;; fast program: (loop(((loop2((y mod 2) + x, y div (2 - (x mod 2)), 2 + (2 + (2 + 2)), 0, x) div 2) + 2) + x, x mod 2, x) - x) div 2
(set-logic UFNIA)
