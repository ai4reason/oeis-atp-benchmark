;; sequence(s): A274072
;; terms: 0 6 24 126 624 3126 15624 78126 390624 1953126 9765624 48828126 244140624 1220703126 6103515624 30517578126 152587890624 762939453126 3814697265624 19073486328126
;; small program: loop((2 * (x + x)) + x, x, 1) - loop(0 - x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) - loop(0 - 1, x mod 2, 1)
(set-logic UFNIA)
