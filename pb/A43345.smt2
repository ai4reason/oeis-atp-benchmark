;; sequence(s): A43345
;; terms: 3 7 11 12 13 14 19 23 27 28 29 30 35 39 43 44 45 46 48 49
;; small program: compr(loop2(((y div 2) * y) + x, y div (2 + 2), x, 1, x) mod 2, x) div 1
;; fast program: compr(loop2(((y div 2) * y) + x, y div (2 + 2), 1 + 2, 1, x) mod 2, x)
(set-logic UFNIA)
