;; sequence(s): A246541
;; terms: 1 2 6 30 180 1440 12960 142560 1995840
;; small program: loop(((compr((loop(x + x, x, 2) - 1) mod (2 + x), y) div 2) * x) + x, x, 1)
;; fast program: loop(compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, 1 + y) * x, x, 1)
(set-logic UFNIA)
