;; sequence(s): A25192
;; terms: 1 2 6 18 54 162 486 1458 4374 13122 39366 118098 354294 1062882 3188646 9565938 28697814 86093442 258280326 774840978
;; small program: loop(2 * ((x div 2) + x), x, 1)
;; fast program: if x <= 0 then 1 else (2 * loop2(x * y, y, (x - 1) div 2, loop(1, x mod 2, 1 + 2), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
