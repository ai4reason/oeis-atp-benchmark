;; sequence(s): A20745
;; terms: 3 5 8 12 18 27 40 59 87 128 188 276 405 594 871 1277 1872 2744 4022 5895
;; small program: 1 + loop2(2 + (((y * y) div x) + x), x, x, 2, 0)
;; fast program: 1 + loop2(2 + (((y * y) div x) + x), x, x - 1, (if x <= 0 then 0 else 2) + 2, 2)
(set-logic UFNIA)
