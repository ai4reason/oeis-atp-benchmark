;; sequence(s): A167993
;; terms: 0 0 1 3 12 36 117 351 1080 3240 9801 29403 88452 265356 796797 2390391 7173360 21520080 64566801 193700403
;; small program: loop2(loop(loop2(y, (2 * x) + x, x, 1, 2) div 2, 1, y) * x, y - 1, 2, 1, x)
;; fast program: (loop2(x * y, y, x - 1, 1, 1 + 2) - loop2(x * y, y, (x - 1) div 2, 1, 1 + 2)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h4 x) (div (- x 1) 2))))
(assert (= i4 1))
(assert (= j4 (+ 1 2)))
