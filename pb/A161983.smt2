;; sequence(s): A161983
;; terms: 0 3 4 5 10 11 12 13 14 21 22 23 24 25 26 27 36 37 38 39
;; small program: loop(compr(loop(2 + (y div x), x + x, 1) mod 2, y), x, 0)
;; fast program: loop((x * x) - x, 1, loop((y div (x * x)) + x, x, 1)) + x
(set-logic UFNIA)
