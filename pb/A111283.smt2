;; sequence(s): A111283
;; terms: 1 2 6 23 96 409 1751 7505 32176 137956 591501 2536132 10873981 46623553 199904321 857114814 3674987126 15756967635 67559972476 289671844661
;; small program: loop(loop(loop2((((((((1 + y) * y) div x) + x) + y) + x) + x) + x, x, x - 1, if x <= 0 then 0 else 1, 0), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2((((((((1 + y) * y) div x) + x) + y) + x) + x) + x, x, x - 2, if (x - 1) <= 0 then 1 else (2 + 2), 1), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (+ (+ (+ (div (* (+ 1 y) y) x) x) y) x) x) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (+ (+ (+ (+ (div (* (+ 1 y) y) x) x) y) x) x) x))))
(assert (forall ((x Int)) (= (g5 x) x)))
(assert (forall ((x Int)) (= (h5 x) (- x 2))))
(assert (forall ((x Int)) (= (i5 x) (ite (<= (- x 1) 0) 1 (+ 2 2)))))
(assert (= j5 1))
