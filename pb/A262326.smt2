;; sequence(s): A262326
;; terms: 3 5 15 33 99 261 783 2241 6723 19845 59535 177633 532899 1595781 4787343 14353281 43059843 129153285 387459855 1162300833
;; small program: loop((x + x) + x, x div 2, 2) + loop((x + x) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, 2, 1 + 2) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
