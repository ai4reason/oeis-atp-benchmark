;; sequence(s): A348331
;; terms: 1 1 1 2 2 1 3 3 2 4 4 1 5 5 3 6 6 2 7 7
;; small program: (loop(x div (1 + (x mod 2)), x, (x + x) div (1 + 2)) div 2) + 1
;; fast program: loop(loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, x div 2), x mod 2, x) div 2, (x mod (1 + 2)) - 1, x div (1 + 2)) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h0 x) (div (+ x x) (+ 1 2)))))
