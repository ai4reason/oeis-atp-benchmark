;; sequence(s): A88837
;; terms: 3 7 3 15 3 7 3 31 3 7 3 15 3 7 3 63 3 7 3 15
;; small program: (loop2(((y mod x) * 2) + 2, y, x, 2, x) * 2) - 1
;; fast program: ((((loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 1) + x, x mod 2, x) - x) * 2) * 2) + 1) + 2
(set-logic UFNIA)
