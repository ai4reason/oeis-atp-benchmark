;; sequence(s): A227200
;; terms: 0 1 0 ~1 ~5 ~14 ~35 ~81 ~180 ~389 ~825 ~1726 ~3575 ~7349 ~15020 ~30561 ~61965 ~125294 ~252795 ~509161
;; small program: loop2(x + y, x, x, 1, 2) - loop(x + x, x, 1)
;; fast program: loop2(x + y, x, x, 1, 2) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
