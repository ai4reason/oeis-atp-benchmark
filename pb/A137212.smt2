;; sequence(s): A137212
;; terms: 0 0 1 5 20 72 245 805 2584 8160 25465 78773 242060 740040 2253581 6841525 20719600 62629632 189025585 569820965
;; small program: loop(((x + loop2(y, (x + y) + y, y, 1, 0)) + x) + x, x, 0)
;; fast program: (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop2((x + x) + y, x, x, 1, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (- (w2 x) (w4 x)) 2))))
