;; sequence(s): A88207
;; terms: 0 2 7 14 24 37 52 70 90 113 139 167 198 232 268 307 348 392 439 488
;; small program: loop((loop(2 + (y div x), x + x, 2) + x) + y, x, 0) - x
;; fast program: loop(loop((((2 * (x + x)) div (1 + (2 * (2 * (2 + 2))))) + x) div 2, 1, y) + x, x, x * x) + x
(set-logic UFNIA)
