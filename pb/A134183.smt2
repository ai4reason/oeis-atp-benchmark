;; sequence(s): A134183
;; terms: 0 1 16 768 131072 83886080 206158430208 1970324836974592 73786976294838206464 10880332376531662572355584 6338253001141147007483516026880
;; small program: loop(x + x, x * x, x) div 2
;; fast program: loop2(x * y, y + y, x - 1, 1, 2) * loop2(x * y, y + y, x - 1, x, 2 + 2)
(set-logic UFNIA)
