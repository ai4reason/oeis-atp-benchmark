;; sequence(s): A246104
;; terms: 2 3 5 5 8 8 8 13 13 13 13 13 21 21 21 21 21 21 21 21
;; small program: (2 - loop(x - (if x <= 0 then 0 else loop2(1 + y, x + y, y, 1, 0)), x, x)) + x
;; fast program: loop(loop(loop(((y * y) div (2 + x)) + y, 1 + x, 0), y - x, x), x, 1) + (if x <= 0 then 1 else 2)
(set-logic UFNIA)
