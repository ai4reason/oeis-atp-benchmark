;; sequence(s): A193052
;; terms: ~1 ~2 0 34 288 1858 10800 59554 318528 1671298 8658000 44456674 226831968 1151999938 5830297200 29429487394 148249876608 745630443778 3745590368400 18797446159714
;; small program: loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 0, 2) - loop(x + x, x + x, 1)
;; fast program: (loop2(x * y, y, x, 1, 1 + (2 + 2)) - loop(x * x, 1, loop(x + x, x, 1))) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (w2 x) (v3 x)) (w5 x)))))
