;; sequence(s): A163941
;; terms: 1 9 52 246 1039 4083 15274 55152 193957 668397 2266816 7589418 25143355 82571751 269173078 871958244 2809322833 9008574945 28768068460 91532284830
;; small program: loop((loop(loop((x + x) + x, y, 1 + y) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(((loop((x + x) + x, x, 1 + (2 + (2 * ((x + x) + x)))) div 2) + 1) div 2, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h5 x) (+ 1 (+ 2 (* 2 (+ (+ x x) x)))))))
