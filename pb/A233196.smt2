;; sequence(s): A233196
;; terms: 1 3 36 528 8256 131328 2098176 33558528 536887296 8590000128 137439215616 2199024304128 35184376283136 562949970198528 9007199321849856 144115188344291328 2305843010287435776
;; small program: loop2((y * y) + y, y + y, x + x, 2, 1) div 2
;; fast program: loop(((1 + x) * x) div 2, 1, loop2(x * y, y, x - 1, if x <= 0 then 1 else 2, 2 + 2))
(set-logic UFNIA)
