;; sequence(s): A72946
;; terms: 1 2 6 4 12 8 24 16 48 32 96 64 192 128 384 256 768 512 1536 1024
;; small program: if x <= 0 then 1 else loop2(y + y, x, x, 1 + 2, 1)
;; fast program: if x <= 0 then 1 else loop(x + x, x div 2, 1 + (2 - (x mod 2)))
(set-logic UFNIA)
