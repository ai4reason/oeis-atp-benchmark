;; sequence(s): A57682
;; terms: 0 1 2 3 3 0 ~9 ~27 ~54 ~81 ~81 0 243 729 1458 2187 2187 0 ~6561 ~19683
;; small program: loop2((x + x) + y, y - x, x, 1, 1) div (1 + 2)
;; fast program: loop2((x - y) + x, x + y, x - 2, if (x - 1) <= 0 then x else 2, 1)
(set-logic UFNIA)
