;; sequence(s): A84921
;; terms: 3 4 12 24 60 84 144 180 264 420 480 684 840 924 1104 1404 1740 1860 2244 2520
;; small program: (loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2, 1, x) + loop(0, x, 2)) div 2
;; fast program: (loop2(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x) * loop(1, x, 2 + (2 + 2))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (w4 x) (v7 x)) 2))))
