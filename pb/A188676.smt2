;; sequence(s): A188676
;; terms: 1 2 13 71 424 2579 15985 100295 635176 4051649 25993366 167543354 1084134346 7038291098 45821937982 299045487602 1955803426045 12815265660680 84111082917925 552872886403775
;; small program: loop(loop(loop2((x * y) + x, 1 + y, x, 1, x + x) div loop(x * y, x, 1), 1, y) - x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x - 1, x)) * (1 + (x + x)), 1, y) - x, x, 1)
(set-logic UFNIA)
