;; sequence(s): A291289
;; terms: 2 0 0 2 0 2 2 2 4 4 6 8 10 14 18 24 32 42 56 74
;; small program: loop(loop(loop2((y * y) div ((x + y) + y), x + y, x, 0, 2), 1, y) - x, x, 1) * 2
;; fast program: loop(loop(loop2((y * y) div ((x + y) + y), x + y, x - 1, if x <= 0 then 0 else 1, 2), 1, y) - x, x, 1) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (div (* y y) (+ (+ x y) y)))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (div (* y y) (+ (+ x y) y)))))
(assert (forall ((x Int) (y Int)) (= (g5 x y) (+ x y))))
(assert (forall ((x Int)) (= (h5 x) (- x 1))))
(assert (forall ((x Int)) (= (i5 x) (ite (<= x 0) 0 1))))
(assert (= j5 2))
