;; sequence(s): A122249
;; terms: 1 4 256 65536 1073741824 70368744177664 73786976294838206464 309485009821345068724781056 332306998946228968225951765070086144 1427247692705959881058285969449495136382746624
;; small program: loop(loop(loop2(loop(x + x, y + y, x), y div 2, x, 1, x), 1, y) * x, x, 1)
;; fast program: loop(loop(loop2(loop(2 * (x + x), y, x), y div 2, x, 1, x), 1, y) * x, x, 1)
(set-logic UFNIA)
