;; sequence(s): A139733
;; terms: 0 1 17 217 2465 26281 7153 588665 9492289 118985033 265558929 5611255833 7551629537 342842572777 886559899441 29969271650489 164170328587905 914583003869833 5979447221143249 53815024990289241
;; small program: loop((x + x) + x, x + x, 1) mod loop(x + x, (x + x) + x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) mod loop((x * x) * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (v2 x) (v5 x)))))
