;; sequence(s): A135485
;; terms: 1 4 29 372 15013 386306 24523875 918395614 79229380895 14586375356764 834214662337565 178751836441797978 22742242136807984059 1741006366419098769302 258407992554086508103671
;; small program: loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, y, 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, x, 1, x), 1, y) + x, x, 1)
(set-logic UFNIA)
