...
(assert (forall ((x Int)) (= (small x) (+ (* (- (mod (div (ite (<= (mod x (+ 2 2)) 0) x 2) 2) (+ 2 2)) 1) (div (div x 2) 2)) x))))
(assert (forall ((x Int)) (= (f0 x) (+ (* (- (mod (div (ite (<= (mod x (+ 2 2)) 0) x 2) 2) (+ 2 2)) 1) (div (div x 2) 2)) x))))
