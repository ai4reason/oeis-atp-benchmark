;; sequence(s): A7843
;; terms: 1 2 4 4 6 8 8 8 10 12 12 14 16 16 16 16 18 20 20 22
;; small program: loop((y div loop2(x + y, y div 2, x, 1, x)) + x, x, 1) * (if x <= 0 then 1 else 2)
;; fast program: loop((y div loop2(x + y, y div 2, 2 + (2 + 2), 1, x)) + x, x, 1) * (if x <= 0 then 1 else 2)
(set-logic UFNIA)
