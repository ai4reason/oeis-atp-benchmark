;; sequence(s): A305750
;; terms: 1 1 2 3 7 11 27 43 107 171 427 683 1707 2731 6827 10923 27307 43691 109227 174763
;; small program: loop2(y, (2 * (x + x)) - 1, x - 1, 1, 2)
;; fast program: (loop2(2 + (x * y), y, x div 2, 1 + (x mod 2), 2 + 2) div (2 + 2)) + 1
(set-logic UFNIA)
