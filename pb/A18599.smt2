;; sequence(s): A18599
;; terms: 1 2 3 6 9 13 18 26 27 39 54 78 117 234 351 702
;; small program: loop(compr(loop((1 + x) * (x + y), 2, 2 + 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((x * x) - x, 1, loop((x * x) * x, 1, 1 + 2)) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
