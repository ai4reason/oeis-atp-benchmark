;; sequence(s): A34963
;; terms: 17 26 36 48 60 72 88 102 120 138 152 168 184 202 220 240 258 272 290 306
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 2 + 2, 2, x) + 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 2 + 2, 2, x) + 2
(set-logic UFNIA)
