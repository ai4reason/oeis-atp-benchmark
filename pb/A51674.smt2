;; sequence(s): A51674
;; terms: 4 27 3125 823543 285311670611 302875106592253 827240261886336764177 1978419655660313589123979 20880467999847912034355032910567 2567686153161211134561828214731016126483469
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop2(x * y, y, x - 1, 1, x), y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop2(x * y, y, x - 2, x, x), y, 2, 1, x)
(set-logic UFNIA)
