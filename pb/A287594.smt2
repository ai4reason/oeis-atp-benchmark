;; sequence(s): A287594
;; terms: 3 4 12 28 72 184 480 1264 3360 8992 24192 65344 177024 480640 1307136 3559168 9699840 26452480 72173568 196989952
;; small program: loop(x + x, x, 1) + loop2(y, 2 * (x + y), x, 2, 2)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(2 * (x + y), x, x - 1, 2, 2)
(set-logic UFNIA)
