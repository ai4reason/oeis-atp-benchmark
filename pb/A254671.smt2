;; sequence(s): A254671
;; terms: 8 11 14 15 17 19 20 23 24 26 27 29 31 32 34 35 38 39 41 43
;; small program: compr(loop((x * y) * y, x div 2, 1) mod (1 + x), 1 + x)
;; fast program: compr(loop(x * y, x div 2, 1 + 2) mod (2 + x), 2 + x) + 1
(set-logic UFNIA)
