...
(assert (forall ((x Int)) (= (small x) (* (div (+ (div (- (w0 x) 1) (+ 1 2)) 1) (ite (<= x 0) 1 2)) (ite (<= x 0) 1 2)))))
...
(assert (forall ((x Int)) (= (fast x) (* (div (+ (div (* (w1 x) (+ 1 (mod x 2))) (+ 1 2)) 1) (ite (<= x 0) 1 2)) (ite (<= x 0) 1 2)))))
