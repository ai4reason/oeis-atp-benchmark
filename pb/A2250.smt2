;; sequence(s): A2250
;; terms: ~1 ~2 ~2 10 94 538 2638 12010 52414 222778 930478 3840010 15714334 63920218 258869518 1045044010 4208873854 16921588858 67944635758 272553384010
;; small program: loop(x + x, x + x, 1) - loop((x + x) + x, x, 2)
;; fast program: loop(x * x, 1, loop(x + x, x, 1)) - loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
