;; sequence(s): A245188
;; terms: 1 3 2 1 2 0 1 3 2 0 1 2 1 3 2 1 2 0 1 2
;; small program: loop2((loop(loop2(x + y, y div 2, x, 0, x) mod 2, 1, y) + x) * x, 1 + y, 2, 1, x) div 2
;; fast program: loop2((loop(loop2(x + y, y div 2, 2 + (2 + 2), x, x div 2) mod 2, 1, y) + x) * x, 1 + y, 2, 1, x) div 2
(set-logic UFNIA)
