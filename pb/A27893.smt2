;; sequence(s): A27893
;; terms: 1 3 9 41 123 271 369 813 2439 11111 33333 99999
;; small program: loop(compr((loop(loop(x * x, 2, x) * x, 1, 2 + (2 * (2 + 2))) + x) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((loop((((x * x) * x) * x) * x, 1, 2 + (2 * (2 + 2))) + x) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
