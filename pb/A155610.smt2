;; sequence(s): A155610
;; terms: 1 3 17 99 545 2883 14897 75939 384065 1933443 9706577 48650979 243609185 1219108803 6098732657 30503229219 152544843905 762810312963 3814309845137 19072324066659
;; small program: 1 + loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 0, 2)
;; fast program: 1 + (loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ 1 (- (w1 x) (w4 x))))))
