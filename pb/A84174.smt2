;; sequence(s): A84174
;; terms: 1 1 3 6 14 29 61 124 252 507 1019 2042 4090 8185 16377 32760 65528 131063 262135 524278
;; small program: (loop(x + x, x, 2) - x) div 2
;; fast program: loop((x - 1) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - (x div 2)
(set-logic UFNIA)
