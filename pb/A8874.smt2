;; sequence(s): A8874
;; terms: 63 190 95 286 143 430 215 646 323 970 485 1456 728 364 182 91 274 137 412 206
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + loop(2 + (x + x), 2 + 2, 2))
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop((x * x) * x, 1, 2 + 2) - 1)
(set-logic UFNIA)
