;; sequence(s): A25990
;; terms: 1 24 381 5096 62517 731640 8337757 93583752 1041282693 11528533016 127276678893 1402901740968 15449475687829 170051606288952 1871222084030589 20587420276057544 226485741460066725 2491489138167004248 27407262770303269645
;; small program: loop((loop(loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x + x, x - 1, 2), 1, y) + (2 * (x + x))) + x, x, 1), 1, y) + x) + ((((x + x) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
