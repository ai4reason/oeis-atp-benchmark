;; sequence(s): A61667
;; terms: 1 3 9 26 73 201 546 1469 3925 10434 27633 72977 192322 506037 1329885 3491810 9161929 24026745 62983842 165055853
;; small program: loop2(x + y, x, x + x, 2, 1) - loop(x + x, x, 1)
;; fast program: loop2(((x - y) + x) + x, x, x, 2, 1) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
