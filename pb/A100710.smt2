;; sequence(s): A100710
;; terms: 2 5 4 11 6 9 8 23 10 13 12 19 14 17 16 47 18 21 20 27
;; small program: loop2(((y mod x) * 2) + 2, y, x, 2, x) + x
;; fast program: ((loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 1) + x, x mod 2, x) * 2) - x) + 2
(set-logic UFNIA)
