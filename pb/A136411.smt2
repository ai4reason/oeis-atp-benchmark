;; sequence(s): A136411
;; terms: 1 3 135 212625 21097715625 207248662456171875 291128066470548703880859375 79746389028864195813528714933837890625 5570294521107277357810167397301815834831695556640625
;; small program: loop(loop((2 * (x * y)) + x, y div 2, x), x + x, 1)
;; fast program: loop(loop(loop2((x * y) * y, 2 + y, x - 1, 1, 1 + 2) * (1 + (x + x)), 1, y) * x, x, 1)
(set-logic UFNIA)
