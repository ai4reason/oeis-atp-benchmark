;; sequence(s): A84151
;; terms: 0 0 1 9 62 390 2359 14007 82412 482652 2820061 16457397 95983370 559619970 3262267891 19015581699 110836005272 646014798840 3765295834489 21945889348257
;; small program: ((loop2((y - x) - x, x, x + x, 1, 1) - loop((x + x) + x, x, 1)) div 2) div (2 + 2)
;; fast program: ((((((2 * loop(x * x, 1, loop2((x + x) + y, x, x - 1, 1, 1))) - 1) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2) + 1) div 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (div (- (w0 x) (v1 x)) 2) (+ 2 2)))))
...
(assert (forall ((x Int)) (= (fast x) (div (div (+ (div (- (- (* 2 (v2 x)) 1) (w4 x)) 2) 1) 2) 2))))
