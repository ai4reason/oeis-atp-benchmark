;; sequence(s): A44243
;; terms: 56 120 184 248 312 376 440 448 504 568 632 696 760 824 888 952 960 1016 1080 1144
;; small program: ((compr(((loop(x div loop(1, x mod (2 * (2 + 2)), 2 * (2 + 2)), x div (2 + 2), x) + 1) mod (2 * (2 + 2))) - 1, 1 + x) * 2) * 2) * 2
;; fast program: ((compr(((loop(x div loop(1, x mod (2 * (2 + 2)), 2 * (2 + 2)), x div (2 * (2 + 2)), x) + 1) mod (2 * (2 + 2))) - 1, 1 + x) * 2) * 2) * 2
(set-logic UFNIA)
(declare-fun f2 () Int)
...
(assert (forall ((x Int)) (= (f3 x) (- (mod (+ (v4 x) 1) (* 2 (+ 2 2))) 1))))
