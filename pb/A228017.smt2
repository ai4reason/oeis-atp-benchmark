;; sequence(s): A228017
;; terms: 1 2 3 4 5 6 7 8 9 12 24 36 48
;; small program: compr(((x div 2) div (1 + (2 + 2))) * (x mod (2 * (2 + (2 + 2)))), 1 + x)
;; fast program: compr((x div (2 + (2 * (2 + 2)))) * (x mod (2 * (2 + (2 + 2)))), 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (* (div x (+ 2 (* 2 (+ 2 2)))) (mod x (* 2 (+ 2 (+ 2 2))))))))
