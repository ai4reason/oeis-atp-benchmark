;; sequence(s): A46699
;; terms: 1 1 2 2 3 4 4 4 5 6 6 7 8 8 8 8 9 10 10 11
;; small program: loop((y div loop2(x + y, y div 2, x, 1, x)) + x, x, 1)
;; fast program: loop2((y div loop2(x + y, y div 2, 1 + (2 + (2 + 2)), 1, x)) + x, y, 1 + 2, 1, x)
(set-logic UFNIA)
