;; sequence(s): A99603
;; terms: 1 2 4 12 20 64 104 336 544 1760 2848 9216 14912 48256 78080 252672 408832 1323008 2140672 6927360
;; small program: loop2(x + y, x, x, loop2(y + y, x, x, 1, 1), 0)
;; fast program: loop(x + x, x - (x div 2), loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
