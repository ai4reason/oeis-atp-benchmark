;; sequence(s): A160713
;; terms: 3 6 6 12 6 12 12 24 6 12 12 24 12 24 24 48 6 12 12 24
;; small program: loop2(((y mod 2) * x) + x, y div 2, x, 1 + 2, x)
;; fast program: loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), 1 + 2, x div 2) * (1 + (x mod 2))
(set-logic UFNIA)
