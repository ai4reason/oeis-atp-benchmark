;; sequence(s): A120582
;; terms: 1 2 0 0 ~16 ~32 ~64 ~128 0 0 1024 2048 4096 8192 0 0 ~65536 ~131072 ~262144 ~524288
;; small program: loop(x + x, x, loop2(x - y, x, x div 2, 1, 1))
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) * loop2(x - y, x, (x div 2) mod (2 + (2 + 2)), 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h5 x) (mod (div x 2) (+ 2 (+ 2 2))))))
(assert (= i5 1))
(assert (= j5 1))
