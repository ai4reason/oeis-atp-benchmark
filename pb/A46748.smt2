;; sequence(s): A46748
;; terms: 1 3 13 61 295 1447 7151 35491 176597 880125 4390901 21920913 109486993 547018941 2733608905 13662695645 68294088535 341399727335 1706739347095 8532741458075
;; small program: loop((loop((loop((x - 2) + x, 2, y) * x) div y, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(2 * ((x - (((x + x) + x) div y)) + x), y, 1) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (* 2 (+ (- x (div (+ (+ x x) x) y)) x)))))
