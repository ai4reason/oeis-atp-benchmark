;; sequence(s): A16318
;; terms: 1 21 315 4145 51051 605241 7007155 79874865 900993051 10089880361 112420339395 1248076978785 13820472734251 152758207825881 1686204348094035 18595160325141905 204922063545486651
;; small program: loop((loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + x) + x, x, 1)
;; fast program: loop((loop(loop(((x * x) * x) - x, 1, loop(x + x, x, 2)) div (1 + 2), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 2) div 2
(set-logic UFNIA)
