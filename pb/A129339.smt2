;; sequence(s): A129339
;; terms: 1 2 4 7 11 16 23 37 74 175 431 1024 2291 4825 9650 18571 34955 65536 124511 242461
;; small program: loop2((x + x) + y, y - x, x - 1, 1, 0) + (loop(x + x, x, 1) div 2)
;; fast program: loop2((x - y) + x, x + y, x - 2, if (x - 1) <= 0 then x else 2, 1) + loop(x + x, x - 1, 1)
(set-logic UFNIA)
