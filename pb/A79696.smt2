;; sequence(s): A79696
;; terms: 5 7 9 10 11 13 15 16 17 19 21 22 23 25 26 27 28 29 31 33
;; small program: compr(loop(x * y, x, 2) mod (1 + x), 2 + x) + 2
;; fast program: compr(loop((if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, (x - 1) div 2, x), 1 + x) + 2
(set-logic UFNIA)
