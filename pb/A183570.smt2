;; sequence(s): A183570
;; terms: 1 2 3 5 6 7 8 9 11 12 13 14 15 16 17 19 20 21 22 23
;; small program: loop(((y div x) + x) div 2, x, 1) + x
;; fast program: ((loop((loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2, x div 2) + 1) + x, 2, x) + 1) + x) div 2
(set-logic UFNIA)
