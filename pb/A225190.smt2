;; sequence(s): A225190
;; terms: 0 0 0 20 64 1668 27712 355279 779264 170190707 6100448256 159424073982 2545667031040 239361355053790 812743283245056 58702956893404802 17949710147773530112 488189490082385976772 38768887410023899070464 313775221076492698014434
;; small program: loop2((2 + y) * x, y, 2 + x, 1, x) mod loop2(x * y, y, x, 1, x)
;; fast program: (loop2((2 + y) * x, y, 2, 1, x) * loop2(x * y, y, x, 1, 2 + x)) mod loop2(x * y, y, x, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (mod (w0 x) (w1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (mod (* (w2 x) (w3 x)) (w4 x)))))
