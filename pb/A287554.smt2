;; sequence(s): A287554
;; terms: 3 6 9 16 18 21 28 31 33 40 43 46 52 55 58 61 66 69 76 79
;; small program: loop(compr(loop2(x + y, y div (2 + 2), x, 2, x) mod (2 + 2), y), x, 2) + 1
;; fast program: (((((1 + (2 - (loop2(x + y, y div (2 + 2), 2 + 2, 1, x) mod (2 + 2)))) + x) + x) + x) + x) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (+ (+ (+ 1 (- 2 (mod (w3 x) (+ 2 2)))) x) x) x) x) 1))))
