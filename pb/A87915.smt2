;; sequence(s): A87915
;; terms: 0 2 4 8 10 14 20 22 28 32 34 38 40 50 52 62 64 68 74 80
;; small program: compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x) - 1
;; fast program: compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) - 1
(set-logic UFNIA)
