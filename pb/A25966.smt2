;; sequence(s): A25966
;; terms: 1 20 260 2800 27216 248640 2182720 18656000 156544256 1296655360 10641146880 86744985600 703688298496 5688011079680 45855653642240 368956766617600 2964331947687936 23790756829593600
;; small program: loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, y, 1, 2) + x, x, 1) * loop(x + x, x, 1)
;; fast program: loop(loop(((loop(((x - 1) + x) * ((x * x) - x), 1, loop(x + x, x, 2)) div (1 + 2)) + 1) div 2, 1, y) + (2 * ((x + x) + x)), x, 1)
(set-logic UFNIA)
