;; sequence(s): A239885
;; terms: 1 3 10 28 88 208 544 1216 2944 7424 15872 37888 83968 176128 385024 868352 1933312 3997696 8781824 18612224
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), x) + 1) * loop(x + x, x - 1, 1)
;; fast program: ((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, x) * 2) + 1) * loop(x + x, x - 1, 1)
(set-logic UFNIA)
