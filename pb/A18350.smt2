;; sequence(s): A18350
;; terms: 1 2 3 4 5 6 8 10 12 15 16 20 24 30 40 48 60 80 120 240
;; small program: 1 + compr(loop((x * y) + x, 2 + 2, 2) mod (1 + x), x)
;; fast program: compr(loop((x * x) - x, 1, 2 * (2 * (2 + 2))) mod (1 + x), x) + 1
(set-logic UFNIA)
