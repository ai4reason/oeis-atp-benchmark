;; sequence(s): A19488
;; terms: 1 21 307 3897 46243 529953 5961259 66380889 735097555 8115781905 89452902331 985061928201 10842178002787 119303005894977 1312567620466123 14439652232597433 158844629298359539
;; small program: loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop(loop((loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))) - loop(x * x, 1, loop(x + x, x, 2))) div (1 + (2 + (2 + 2))), 1, y) + (2 * ((x + x) + x)), x, 1)
(set-logic UFNIA)
