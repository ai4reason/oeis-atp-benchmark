;; sequence(s): A135483
;; terms: 1 4 14 42 130 338 882 2098 5042 12466 28338 66226 150194 326322 711346 1579698 3513010 7510706 16292530 34904754
;; small program: loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), y) + x) + x, y - 1, x, 1, x)
;; fast program: loop2((((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) * 1) + x) + x, y - 1, x, 1, x)
(set-logic UFNIA)
