;; sequence(s): A130599
;; terms: 1 1 1 3 1 9 1 27 1 81 1 243 1 729 1 2187 1 6561 1 19683
;; small program: loop((x + x) + x, (x div 2) * (x mod 2), 1)
;; fast program: loop2(loop(loop2(x * y, y, x div 2, 1, 1 + 2), 1, y), 0, x mod 2, 1, x)
(set-logic UFNIA)
