;; sequence(s): A190941
;; terms: 0 1 3 4 5 7 9 11 13 14 15 17 18 19 21 23 25 27 29 31
;; small program: loop(loop(if (x mod 2) <= 0 then (x div (1 + 2)) else 1, x, y + y) + x, x, x)
;; fast program: loop(loop(if (loop2((x * y) + x, y div (1 + 2), 2 + 2, 1, x) mod (1 + 2)) <= 0 then 1 else 0, 1, y) + x, x, x)
(set-logic UFNIA)
