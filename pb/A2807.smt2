;; sequence(s): A2807
;; terms: 0 0 0 1 7 37 197 1172 8018 62814 556014 5488059 59740609 710771275 9174170011 127661752406 1904975488436 30341995265036 513771331467372 9215499383109573
;; small program: loop((loop(1 + ((x * y) - x), y, 1) - y) + x, x, 0) div 2
;; fast program: loop(loop((loop(1 + (x * y), x - 1, 1) * x) - x, 1, y) + x, x - 1, 0) div 2
(set-logic UFNIA)
