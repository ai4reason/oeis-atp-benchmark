;; sequence(s): A132308
;; terms: 1 4 15 50 157 480 1451 4366 13113 39356 118087 354282 1062869 3188632 9565923 28697798 86093425 258280308 774840959 2324522914
;; small program: (loop((x + x) + x, x, 2) - 1) - x
;; fast program: (loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - 1) - x
(set-logic UFNIA)
