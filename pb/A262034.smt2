;; sequence(s): A262034
;; terms: 1 0 1 1 4 5 30 42 336 504 5040 7920 95040 154440 2162160 3603600 57657600 98017920 1764322560 3047466240
;; small program: loop2((x * y) + x, y - 1, x div 2, 1, x) div (1 + x)
;; fast program: loop2(x * y, y - 1, x div 2, 1, 1 + x) div (1 + x)
(set-logic UFNIA)
