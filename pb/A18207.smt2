;; sequence(s): A18207
;; terms: 1 25 439 6685 94471 1276405 16745119 215226205 2725568791 34135388485 423910350799 5229781276525 64185946519111 784517071831765 9557062002788479 116113315455883645 1407645499737869431
;; small program: loop(((loop(loop(2 * ((2 * (x + x)) + x), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop((loop(x * x, 1, loop(x + x, x, 2)) div (1 + 2)) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
