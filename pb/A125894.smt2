;; sequence(s): A125894
;; terms: 1 1 1 2 2 3 3 4 5 6 7 9 11 13 16 20 24 29 35 43
;; small program: loop(x div 2, x, loop2((x + x) + y, x, x, 1, 1))
;; fast program: loop2((x + x) + y, x, x, 1, 1) div loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
