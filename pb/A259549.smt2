;; sequence(s): A259549
;; terms: 1 2 2 3 4 4 5 5 6 7 7 8 8 9 9 10 11 11 12 12
;; small program: ((2 - loop(y div (x - 2), x, 0)) + x) div 2
;; fast program: ((loop(loop(loop2(loop(x + y, x, y) div x, y, 2, 2 + 2, x div 2) + x, 2, x) - x, 1, x div (2 + 2)) + 1) + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (+ (- 2 (v0 x)) x) 2))))
