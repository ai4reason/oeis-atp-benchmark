;; sequence(s): A5592
;; terms: 1 2 6 17 46 122 321 842 2206 5777 15126 39602 103681 271442 710646 1860497 4870846 12752042 33385281 87403802
;; small program: loop2(y - x, x, x + x, 2, 1) - 1
;; fast program: (loop(x * x, 1, loop2(y - x, x, x, 2, 1)) - 1) - loop(0 - x, x mod 2, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (v1 x) 1) (v3 x)))))
