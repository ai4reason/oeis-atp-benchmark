;; sequence(s): A117865
;; terms: 5 10 40 70 250 430 1510 2590 9070 15550 54430 93310 326590 559870 1959550 3359230 11757310 20155390 70543870 120932350
;; small program: loop2((((2 div x) + y) + y) + y, x + x, 1 + x, 2, 2) - 2
;; fast program: loop(loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 2), 2 + (2 + 2)), 1, 1 + x) - 2
(set-logic UFNIA)
