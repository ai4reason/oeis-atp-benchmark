;; sequence(s): A66532
;; terms: 1 2 1 8 1 32 1 128 1 512 1 2048 1 8192 1 32768 1 131072 1 524288
;; small program: loop(x + x, (x mod 2) * x, 1)
;; fast program: loop2(loop(loop(x * x, 1, loop(x + x, x div 2, 1)) * (1 + (x mod 2)), 1, y), 0, x mod 2, 1, x)
(set-logic UFNIA)
