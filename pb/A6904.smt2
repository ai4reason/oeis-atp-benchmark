;; sequence(s): A6904
;; terms: 1 1 4 5 14 23 52 97 202 395 800 1589 3190 6367 12748 25481 50978 101939 203896 407773
;; small program: loop((loop(0 - x, y, y) + x) + x, x, 1)
;; fast program: loop((y - x) - x, x, 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
