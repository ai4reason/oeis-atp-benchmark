;; sequence(s): A217360
;; terms: 1 2 16 176 2240 31008 453376 6888960 107707392 1721477120 28000141312 461964898304 7712495058944 130050777006080 2211737871974400 37892693797109760 653389823437701120 11330548232319664128 197475886172892823552
;; small program: loop2(2 * (x * y), y - 1, x - 1, if x <= 0 then 1 else 2, 2 * (x + x)) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + ((x + x) + x)) div loop(x * y, x, 1)) * loop(x + x, x, 1)
(set-logic UFNIA)
