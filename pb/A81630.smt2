;; sequence(s): A81630
;; terms: 1 5 ~7 29 ~79 245 ~727 2189 ~6559 19685 ~59047 177149 ~531439 1594325 ~4782967 14348909 ~43046719 129140165 ~387420487 1162261469
;; small program: 1 + loop((2 * (2 - x)) - x, x, 0)
;; fast program: 2 - loop2(x * y, y, x div 2, loop(1 - (2 + 2), x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
