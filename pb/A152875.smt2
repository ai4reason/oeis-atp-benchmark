;; sequence(s): A152875
;; terms: 2 4 8 24 72 288 1152 5760 28800 172800 1036800 7257600 50803200 406425600 3251404800 29262643200 263363788800 2633637888000 26336378880000 289700167680000
;; small program: loop(((y - (y div 2)) * x) + x, x, 2)
;; fast program: loop2(loop((x * y) + x, y div 2, x), 1 + y, 2, 2, x)
(set-logic UFNIA)
