;; sequence(s): A101334
;; terms: 0 0 1 11 131 1829 29849 561399 11994247 287420489 7642052309 223394306387 7123940054219 246181194216957 9165811757198641 365836296342931439 15584321022199735823 705800730789742512401 33866021217511735389485 1716275655660313589123979
;; small program: loop2(x * y, y, x, 1, x) - loop2((x * y) + x, y, x - 1, 1, x)
;; fast program: ((if x <= 0 then 1 else loop2(x * y, y, (x - 1) div 2, x, x)) * loop2(x * y, y, x div 2, 1, x)) - loop2(x * y, y, x - 1, 1, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (ite (<= x 0) 1 (w2 x)) (w3 x)) (w4 x)))))
