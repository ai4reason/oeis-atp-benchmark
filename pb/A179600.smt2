;; sequence(s): A179600
;; terms: 1 3 16 66 304 1332 5968 26472 117952 524496 2334400 10385568 46213120 205619520 914912512 4070872704 18113348608 80595074304 358607125504 1595618388480
;; small program: loop((loop2(2 * ((x + x) + y), x, y, 2, 1) - x) - x, x, 2) div 2
;; fast program: loop((loop2(2 * ((x + x) + y), x, y - 1, 1 + (2 + 2), 1) - x) - x, x, 1)
(set-logic UFNIA)
