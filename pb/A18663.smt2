;; sequence(s): A18663
;; terms: 1 3 7 9 13 21 39 63 91 117 273 819
;; small program: loop(compr((loop(((x * y) * x) + x, 2, 2 + 2) + x) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop(((1 + x) * (x * x)) + x, 1, 1 + (2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
