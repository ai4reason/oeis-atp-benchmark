;; sequence(s): A102397
;; terms: 1 10 100 1001 10010 100101 1001011 10010110 100101100 1001011001 10010110011 100101100110 1001011001101 10010110011010 100101100110100 1001011001101001 10010110011010010 100101100110100101
;; small program: loop((loop(loop2(x + y, y div 2, x, 1, x) mod 2, 1, y) + x) + loop((x + x) + x, 2, x), x, 1)
;; fast program: loop((((((((((loop((loop(loop2(x + y, y div 2, x, 1, x) mod 2, 1, x div 2) + x) mod 2, 1, y) + x) + x) + x) + x) + x) + x) + x) + x) + x) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f6 x) (mod (w7 x) 2))))
(assert (= g6 1))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (v5 x y) x) x) x) x) x) x) x) x) x) x))))
