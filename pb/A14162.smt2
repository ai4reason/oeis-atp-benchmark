;; sequence(s): A14162
;; terms: 0 1 4 11 25 51 97 176 309 530 894 1490 2462 4043 6610 10773 17519 28445 46135 74770
;; small program: loop(loop(loop2(x + y, x, y, 1, 1) + x, y, x) - y, x, 0)
;; fast program: (loop((loop2(x + y, x, x, 1 + 2, 2) - (((x * x) + x) div 2)) - x, 1, 2 + x) - 1) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (- (- (w4 x) (div (+ (* x x) x) 2)) x))))
(assert (= g3 1))
