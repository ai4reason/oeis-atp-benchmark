...
(assert (forall ((x Int)) (= (f0 x) (div (- 1 x) (+ 2 2)))))
(assert (= g0 2))
(assert (forall ((x Int)) (= (h0 x) x)))
(assert (forall ((x Int) (y Int)) (= (u0 x y) (ite (<= x 0) y (f0 (u0 (- x 1) y))))))
(assert (forall ((x Int)) (= (v0 x) (u0 g0 (h0 x)))))
(assert (forall ((x Int)) (= (small x) (div (+ (+ (div (+ 1 (+ (v0 x) x)) (+ 2 2)) 1) x) 2))))
(assert (forall ((x Int)) (= (fast x) (div (+ 2 (* (+ 1 x) (- (* 2 (* 2 (* 2 (+ 2 2)))) 1))) (+ 1 (* 2 (* 2 (* 2 (+ 2 (+ 2 2))))))))))
