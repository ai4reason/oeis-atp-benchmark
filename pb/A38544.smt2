;; sequence(s): A38544
;; terms: 1 3025 25502500 250500250000 2500500025000000 25000500002500000000 250000500000250000000000 2500000500000025000000000000 25000000500000002500000000000000 250000000500000000250000000000000000 2500000000500000000025000000000000000000
;; small program: loop(loop(x * x, 1, ((x * x) + x) div 2), 1, loop(2 * ((2 * (x + x)) + x), x, 1))
;; fast program: loop(loop(x * x, 1, ((1 + x) * x) div 2), 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
...
(assert (= g4 1))
(assert (forall ((x Int)) (= (h4 x) (div (* (+ 1 x) x) 2))))
