;; sequence(s): A135440
;; terms: ~1 4 2 10 14 34 62 130 254 514 1022 2050 4094 8194 16382 32770 65534 131074 262142 524290
;; small program: loop2(y + y, x + y, x, 0 - 1, 2)
;; fast program: loop(2 * (2 + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 2
(set-logic UFNIA)
