;; sequence(s): A54137
;; terms: 2 8 31 97 264 654 1518 3366 7227 15169 31339 64043 129906 262192 527444 1058764 2122373 4250731 8508777 17026409
;; small program: (loop(((loop(((2 * (x + x)) div y) + x, y, 1) + x) * 2) + 1, x, 2) div 2) + 1
;; fast program: (((loop((loop(loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) div (2 * (2 * (2 + (2 + 2)))), 1, y) + x) + x, x, 1) * 2) + 1) + loop(x + x, x, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (+ (* (v2 x) 2) 1) (v5 x)) 2))))
