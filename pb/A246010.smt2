;; sequence(s): A246010
;; terms: 5 11 31 61 151 211 361 451 661 1051 1201 1711 2101 2311 2761 3511 4351 4651 5611 6301
;; small program: (loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * (x * x), 2, 2, 1, x) div 2) div 2
;; fast program: (((((loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x * x), 2, 2, 1, x) div 2) div 2) div 2) * 2) + 1) div 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (* (div (div (div (w3 x) 2) 2) 2) 2) 1) 1))))
