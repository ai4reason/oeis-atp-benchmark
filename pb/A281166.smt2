;; sequence(s): A281166
;; terms: 1 1 3 8 17 33 64 127 255 512 1025 2049 4096 8191 16383 32768 65537 131073 262144 524287
;; small program: loop(x + x, x, 1) + loop2(x - y, x, x, 0, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(x - y, x, x mod (2 + (2 + 2)), 0, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h5 x) (mod x (+ 2 (+ 2 2))))))
(assert (= i5 0))
(assert (= j5 1))
