;; sequence(s): A174030
;; terms: 1 3 7 13 21 33 49 67 91 123 159 207 261 325 397 493 601 729 873 1035
;; small program: (loop(compr(loop(2 * (x * x), 2 + 2, 1 + 2) mod (1 + x), y) + x, x - 1, x) * 2) + 1
;; fast program: (loop(compr(loop((x * x) * x, 2, 2 * (2 + (2 + 2))) mod (1 + x), y) + x, x - 1, x) * 2) + 1
(set-logic UFNIA)
