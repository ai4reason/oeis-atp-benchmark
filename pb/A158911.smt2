;; sequence(s): A158911
;; terms: 0 1 3 4 7 9 15 19 24 31 39 49 63 79 99 124 127 159 199 249
;; small program: compr(loop(loop(x * x, 2, x), 2, 2 + (2 * (2 + 2))) mod (1 + x), x)
;; fast program: compr(loop((x * x) * x, 2, 2 * (2 + (2 * (2 + 2)))) mod (1 + x), x)
(set-logic UFNIA)
