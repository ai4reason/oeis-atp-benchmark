;; sequence(s): A156928
;; terms: 1 7 28 86 227 545 1230 2664 5613 11611 23728 48106 97031 195077 391394 784284 1570353 3142815 6288100 12579070
;; small program: loop(loop((y * y) + x, 1 + y, x) + x, x, 1)
;; fast program: loop((loop(((1 + (x + x)) * ((x * x) + x)) div (1 + 2), 1, y) + x) + x, 1 + x, 0) div 2
(set-logic UFNIA)
