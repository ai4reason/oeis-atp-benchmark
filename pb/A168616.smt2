;; sequence(s): A168616
;; terms: ~4 ~3 ~1 3 11 27 59 123 251 507 1019 2043 4091 8187 16379 32763 65531 131067 262139 524283
;; small program: ((loop(x + x, x, 1) - 1) - 2) - 2
;; fast program: ((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) - 2) - 2
(set-logic UFNIA)
