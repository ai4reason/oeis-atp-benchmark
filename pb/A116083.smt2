;; sequence(s): A116083
;; terms: 2 6 8 24 128 384 32768 98304 2147483648 6442450944
;; small program: loop2(y + y, x * x, x, 2, 1) * loop(1 + 2, x mod 2, 1)
;; fast program: loop2(x * y, y * y, x div 2, loop(1 + 2, x mod 2, 1), 2 + 2) * 2
(set-logic UFNIA)
