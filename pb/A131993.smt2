;; sequence(s): A131993
;; terms: 63 364 3906 19608 177156 402234 1508598 2613660 6728904 21243690 29583456 71270178 118752606 150508644 234330768 426237714 727250580 858672906 1370581548 1830004056
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + 1) + x, y, 1 + (2 + 2), 1, x)
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1) + x, y, 1 + (2 + 2), 1, x)
(set-logic UFNIA)
