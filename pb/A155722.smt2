;; sequence(s): A155722
;; terms: 1 2 4 5 7 10 11 14 16 17 19 22 25 26 29 31 32 35 37 40
;; small program: ((compr((1 + loop(x + x, x, x)) mod (1 + x), (2 + 2) + x) div 2) - 2) - 2
;; fast program: loop(compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 2 + x) - 2, 1, 2 + x) - 2
(set-logic UFNIA)
