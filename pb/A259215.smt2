;; sequence(s): A259215
;; terms: 7 13 24 45 85 162 311 601 1168 2281 4473 8802 17371 34365 68120 135253 268909 535234 1066287 2125809
;; small program: loop((x - loop2(y, x + y, y, 1, 0)) + x, 2 + x, 2)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) + loop2(x + y, x, x, 1 + 2, 2)
(set-logic UFNIA)
