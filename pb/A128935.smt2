;; sequence(s): A128935
;; terms: 1 1 3001 475400918060101145703001 29642179764875707696452732234250095350341524541114277856812964100763567848899514572925690068090872073476146381237687662210078001
;; small program: loop2(x + y, x, loop((2 * (x + x)) + x, x, 1), 0, 1) div loop((2 * (x + x)) + x, x, 1)
;; fast program: loop2(x + y, x, loop((2 * (x + x)) + x, x, 1) - 1, 1, 0) div loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (w3 x) (w5 x)))))
