;; sequence(s): A260259
;; terms: ~1 2 1 7 14 41 103 274 713 1871 4894 12817 33551 87842 229969 602071 1576238 4126649 10803703 28284466
;; small program: loop(loop2(x + y, x, y + y, 0, 1) - x, x, 0 - 1)
;; fast program: ((if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x - 1, 1, 1)) - loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (ite (<= x 0) 0 (w2 x)) (w3 x)) (v4 x)))))
