;; sequence(s): A38521
;; terms: 0 2 1 4 10 12 36 64 120 272 496 1024 2080 4032 8256 16384 32640 65792 130816 262144
;; small program: loop((loop2(0 - (x + y), x - y, y - 1, 2, 1) + x) + x, x, 0)
;; fast program: (loop2(0 - (x + y), x - y, 1 + x, 0, 1) + loop(x + x, x, 1)) div 2
(set-logic UFNIA)
