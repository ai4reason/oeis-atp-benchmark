...
;; small program: loop2(loop(0 - x, y - 1, x), (y - 1) div 2, x, 1, x)
;; fast program: (((loop2((y - x) div 2, x, 1 + (2 + 2), (1 - x) div 2, x) + 1) mod 2) * 2) - 1
(set-logic UFNIA)
...
(assert (= h2 (+ 1 (+ 2 2))))
(assert (forall ((x Int)) (= (i2 x) (div (- 1 x) 2))))
...
(assert (forall ((x Int)) (= (fast x) (- (* (mod (+ (w2 x) 1) 2) 2) 1))))
