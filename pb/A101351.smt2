;; sequence(s): A101351
;; terms: 2 4 9 18 36 71 140 276 545 1078 2136 4239 8424 16760 33377 66522 132668 264727 528468 1055340
;; small program: (loop(x + x, x, 2) - 1) + loop2(x + y, x, x, 1, 0)
;; fast program: ((2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - 1) + loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
