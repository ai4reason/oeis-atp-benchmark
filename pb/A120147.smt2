;; sequence(s): A120147
;; terms: 23 35 52 78 117 176 264 396 594 891 1336 2004 3006 4509 6764 10146 15219 22828 34242 51363
;; small program: loop((x div 2) + x, x, loop((x + y) * x, 2, 2) - 1) div 2
;; fast program: loop((x div 2) + x, x, (2 * (2 * (2 * (2 + (2 + 2))))) - 1) div 2
(set-logic UFNIA)
