;; sequence(s): A238375
;; terms: 1 2 4 6 11 16 28 40 69 98 168 238 407 576 984 1392 2377 3362 5740 8118
;; small program: loop(x + loop2(y, (x + y) + y, y div 2, 1, 2), x, 1)
;; fast program: loop2((x + x) + y, x, x div 2, 2 + (x mod 2), 1) - 1
(set-logic UFNIA)
