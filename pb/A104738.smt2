;; sequence(s): A104738
;; terms: 1 2 3 5 6 9 11 15 17 21 24 29 30 39 41 51 54 59 66 75
;; small program: loop2(((x + y) div (1 + y)) + x, y - 1, x, 1, x)
;; fast program: loop2(1 + ((x div y) + x), y - 1, x, 0, 1 + x) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (div (+ x y) (+ 1 y)) x))))
