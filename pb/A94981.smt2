;; sequence(s): A94981
;; terms: 1 2 5 11 25 57 129 291 656 1477 3325 7481 16834 37876 85222 191751 431439 970739 2184164 4914369
;; small program: loop((x div 2) div 2, x, loop((x + x) + x, x + x, 1))
;; fast program: loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div loop(x * x, 1, loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))))
(set-logic UFNIA)
