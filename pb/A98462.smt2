;; sequence(s): A98462
;; terms: 2 3 13 91 881 10901 164305 2920695 59823937 1387420489 35937424601 1028320041299 32214185570737 1096589879846397 40304932850948641 1590815394987706351 67107935949376420097 3013151821625033296145 143473758373207779108265
;; small program: loop2((x * y) + x, y, x, 1, x) + loop2(x * y, y, x, 1, x)
;; fast program: (loop2(x * y, y, x - (x div 2), 1, 1 + x) * loop2(x * y, y, x div 2, 1, 1 + x)) + loop2(x * y, y, x, 1, x)
(set-logic UFNIA)
