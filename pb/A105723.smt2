;; sequence(s): A105723
;; terms: 0 4 8 28 80 244 728 2188 6560 19684 59048 177148 531440 1594324 4782968 14348908 43046720 129140164 387420488 1162261468
;; small program: 2 * loop2(y - x, (y + y) + y, x, 0, 2)
;; fast program: loop(2 + x, x mod 2, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - 1
(set-logic UFNIA)
