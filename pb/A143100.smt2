;; sequence(s): A143100
;; terms: 1 3 4 6 13 30 64 129 256 510 1021 2046 4096 8193 16384 32766 65533 131070 262144 524289
;; small program: (loop(x + x, x, 1) - 1) + loop2(y, y - x, x, 1, 2)
;; fast program: (loop2(y, y - x, x mod (2 + (2 + 2)), 1, 2) + loop2(x * y, y, x div 2, 1 + (x mod 2), 2 + 2)) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (+ (w2 x) (w3 x)) 1))))
