;; sequence(s): A294689
;; terms: ~17 ~25 ~37 ~55 ~82 ~41 ~61 ~91 ~136 ~68 ~34 ~17 ~25 ~37 ~55 ~82 ~41 ~61 ~91 ~136
;; small program: loop(loop(1 + ((x + x) + x), x mod 2, x) div 2, x, 1 - (2 + loop(x * x, 2, 2)))
;; fast program: loop(loop(1 + ((x + x) + x), x mod 2, x) div 2, x, 1 - (2 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
