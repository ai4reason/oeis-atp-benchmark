;; sequence(s): A57861
;; terms: 2 4 4 5 6 8 9 12 15 18 23 28 35 43 53 66 82 101 125 155
;; small program: loop(x + x, x, 2) div loop2(x + y, x, x, 1, 0)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) div loop2(x + y, x, x - 1, 2, 2)
(set-logic UFNIA)
