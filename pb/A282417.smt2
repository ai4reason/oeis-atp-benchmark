;; sequence(s): A282417
;; terms: 1 2 3 12 7 56 15 240 31 992 63 4032 127 16256 255 65280 511 261632 1023 1047552
;; small program: loop((x * x) + x, x mod 2, loop(1 + (x + x), x div 2, 1))
;; fast program: loop(x + (x * x), x mod 2, loop(x + x, x div 2, 2) - 1)
(set-logic UFNIA)
