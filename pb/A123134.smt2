;; sequence(s): A123134
;; terms: 8 18 40 84 154 234 340 456 690 928 1178 1554 1804 2064 2538 3180 3658 4148 4824 5254
;; small program: loop2(((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 1) + x, y - 1, 2, 1, 1 + x) - 1
;; fast program: loop2((loop(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 2 + x) + 1, 1, y) * x) + 1, y - 1, 2, 1, x) - 1
(set-logic UFNIA)
