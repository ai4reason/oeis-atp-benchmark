;; sequence(s): A24700
;; terms: 8 16 40 56 96 120 176 280 320 456 560 616 736 936 1160 1240 1496 1680 1776 2080
;; small program: loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + y) * x) + 2, y, 2, 1, x) div (1 + 2)
;; fast program: loop(loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x), 1, 2 + x) div (1 + 2)
(set-logic UFNIA)
