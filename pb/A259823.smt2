;; sequence(s): A259823
;; terms: 0 1 3 6 10 16 24 33 45 61 79 103 130 162 198 246 300 364 436 517
;; small program: loop(compr(loop(2 * (x * x), 2 + 2, 1 + 2) mod (1 + x), y - 1) + x, x, x)
;; fast program: loop(compr(loop((x * x) * x, 2, 2 * (2 + (2 + 2))) mod (1 + x), y) + x, x - 1, x)
(set-logic UFNIA)
