;; sequence(s): A70323
;; terms: 2 2 4 8 32 64 256 512 2048 12288 24576 147456 589824 1179648 4718592 28311552 169869312 339738624 2038431744 8153726976
;; small program: loop(loop(loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) - x, 1 + y, 2, 0, x), 1, y) * x, x - 1, 2)
;; fast program: loop(loop(loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 1 + y, 2, 0, x), 1, y) * x, x - 1, 2)
(set-logic UFNIA)
