;; sequence(s): A34785
;; terms: 4 8 32 128 2048 8192 131072 524288 8388608 536870912 2147483648 137438953472 2199023255552 8796093022208 140737488355328 9007199254740992 576460752303423488 2305843009213693952
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), x, 2, 0, x) div 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x + x, x - 1, 1), x, 2, 0, x)
(set-logic UFNIA)
