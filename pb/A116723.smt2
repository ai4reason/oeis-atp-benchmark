;; sequence(s): A116723
;; terms: 1 2 4 8 18 53 219 1201 8055 62860 556070 5488126 59740688 710771367 9174170117 127661752527 1904975488573 30341995265190 513771331467544 9215499383109764
;; small program: loop((loop(1 + ((x * y) - x), y, 1) + x) + y, x, 2) div 2
;; fast program: (loop((loop(1 + (x * y), y, 1) + x) + y, x - 1, 1 + x) div 2) + 1
(set-logic UFNIA)
