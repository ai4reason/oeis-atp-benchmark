;; sequence(s): A110199
;; terms: 1 1 2 2 4 4 9 9 23 23 65 65 197 197 626 626 2056 2056 6918 6918
;; small program: loop((loop(2 * ((x - (x div y)) + x), y, 1) div (1 + y)) + x, x div 2, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1), 1, y) + x, x div 2, 1)
(set-logic UFNIA)
