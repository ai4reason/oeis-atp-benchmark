;; sequence(s): A99407
;; terms: 1 4 12 30 60 96 144 198 308 420 540 720 840 966 1196 1508 1740 1980 2310 2520
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x, 1 + y, 2, 1, x) div 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x, 1 + y, 2, 1, x) div 2
(set-logic UFNIA)
