;; sequence(s): A74092
;; terms: 1 2 8 40 144 448 1280 3456 8960 22528 55296 133120 315392 737280 1703936 3899392 8847360 19922944 44564480 99090432
;; small program: loop(x + x, x, 1) * loop(y, (((x * x) + x) div 2) - 1, 1)
;; fast program: loop2((x + x) + y, 1 - x, x - 2, if (x - 1) <= 0 then 1 else 2, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g1 x) (- (div (+ (* x x) x) 2) 1))))
(assert (= h1 1))
