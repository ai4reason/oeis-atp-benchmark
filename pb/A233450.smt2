;; sequence(s): A233450
;; terms: 0 1 6 15 64 153 638 1519 6320 15041 62566 148895 619344 1473913 6130878 14590239 60689440 144428481 600763526 1429694575
;; small program: loop2(((2 - (y mod 2)) * (x + y)) + x, x + y, x, 1, 1) div 2
;; fast program: loop2(((2 - (y mod 2)) * (x + y)) + x, x + y, x - 1, (if x <= 0 then 0 else 2) + 1, 2) div 2
(set-logic UFNIA)
