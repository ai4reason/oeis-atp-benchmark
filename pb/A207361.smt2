;; sequence(s): A207361
;; terms: 0 1 11 53 173 448 994 1974 3606 6171 10021 15587 23387 34034 48244 66844 90780 121125 159087 206017
;; small program: loop((loop((y * y) + x, y, 0) * y) + x, x, 0)
;; fast program: loop((loop(((1 + (x + x)) * ((x * x) + x)) div (1 + 2), 1, y) * y) + x, x, 0) div 2
(set-logic UFNIA)
