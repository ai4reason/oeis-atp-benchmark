;; sequence(s): A34955
;; terms: 6 28 66 190 276 496 946 1128 1770 2278 2556 3160 3486 5356 5778 8128 8646 9730 11476 13366
;; small program: loop2((compr(((1 + loop(x + x, x, loop(1, x mod 2, 1 + 2))) mod (1 + (x + x))) - 2, 1 + y) + x) * x, y, 2, 1, x)
;; fast program: loop2((compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + y) + x) * x, y, 2, 1, x)
(set-logic UFNIA)
