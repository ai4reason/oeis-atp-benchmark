;; sequence(s): A61981
;; terms: 0 0 4 20 72 232 716 2172 6544 19664 59028 177124 531416 1594296 4782940 14348876 43046688 129140128 387420452 1162261428
;; small program: loop(loop2((x + y) + y, 2, y, x, x), x, 0)
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - 1) - x) - x
(set-logic UFNIA)
