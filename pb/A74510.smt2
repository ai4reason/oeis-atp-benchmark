;; sequence(s): A74510
;; terms: 3 12 74 540 4178 33012 262874 2099340 16783778 134237412 1073800874 8590111740 68720008178 549757408212 4398051294074 35184386437740 281475019757378 2251799942825412 18014398896902474 144115189238117340
;; small program: 1 + (loop((x + x) + x, x, 1) + loop(x + x, (x + x) + x, 1))
...
(assert (forall ((x Int)) (= (fast x) (+ 1 (+ (v2 x) (w4 x))))))
