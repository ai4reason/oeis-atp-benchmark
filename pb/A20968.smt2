;; sequence(s): A20968
;; terms: 1 26 455 6700 89661 1130766 13712035 161844800 1874156921 21406992706 242089527615 2717862993300 30349359729781 337562780465846 3743627395703195 41428143398876200 457728746687336241
;; small program: loop((loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop(loop((loop((loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))) - loop((x * x) * x, 1, loop(x + x, x, 2))) div (1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1), 1, x)
(set-logic UFNIA)
