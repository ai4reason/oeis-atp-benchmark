;; sequence(s): A182136
;; terms: 1 3 5 7 10 12 15 18 21
;; small program: 1 + loop((x - (x div (1 + 2))) + y, x, x)
;; fast program: (loop(loop(2, 2 - x, y), (x - 1) - 2, 1) + x) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (- x (div x (+ 1 2))) y))))
