;; sequence(s): A140161
;; terms: 1 33 114 1138 1763 9539 11940 44708 51269 151269 165910 414742 443303 981127 1031752 2080328 2163849 4053417 4183738 7383738
;; small program: loop(loop(loop2((x * y) + x, y, 2 + (2 + (x mod 2)), 1, x), 1, y) + x, x, 1)
;; fast program: loop(loop(loop(x * x, x mod 2, 1 + x) * loop((x * x) * x, 1, 1 + x), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (+ 2 (+ 2 (mod x 2))))))
(assert (= i2 1))
