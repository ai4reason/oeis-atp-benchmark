;; sequence(s): A86652
;; terms: 6 13 28 58 120 244 496 1000 2016 4048 8128 16288 32640 65344 130816 261760 523776 1047808 2096128 4192768
;; small program: loop(x + x, x + 2, 2) - loop2(x + y, x - y, x, 2, 1)
;; fast program: (2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2)))) - loop(x + x, x div 2, 2 + (x mod 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* 2 (v2 x)) (v5 x)))))
