;; sequence(s): A164587
;; terms: 1 8 2 16 4 32 8 64 16 128 32 256 64 512 128 1024 256 2048 512 4096
;; small program: loop2(y + y, x, x, 1, 2 + 2)
;; fast program: loop(x + x, x div 2, loop(2 * (2 + 2), x mod 2, 1))
(set-logic UFNIA)
