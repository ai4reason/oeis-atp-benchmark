;; sequence(s): A132584
;; terms: 0 4 80 1444 25920 465124 8346320 149768644 2687489280 48225038404 865363202000 15528312597604 278644263554880 5000068431390244 89722587501469520 1610006506595061124 28890394531209630720 518417095055178291844 9302617316461999622480
;; small program: loop2(y - (2 * (x + x)), x, x + x, 1, 2) div 2
;; fast program: loop(x * x, 1, loop2((2 * (x + x)) + y, x, x - 1, if x <= 0 then 1 else 2, 1)) - (1 - (x mod 2))
(set-logic UFNIA)
