;; sequence(s): A76009
;; terms: 1 54 2025 65610 1974861 57041334 1607609025 44625100770 1226874595221 33521945231214 912229968911625 24758714599712730 670798674525559581 18153207600055622694 490886209059873519825
;; small program: loop((x + x) + x, x + x, loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1))
