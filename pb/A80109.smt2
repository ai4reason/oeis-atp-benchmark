...
(assert (forall ((x Int) (y Int)) (= (f10 x y) (div (* (- (* 2 (+ y y)) 2) x) (+ 1 y)))))
...
(assert (forall ((x Int)) (= (f9 x) (mod (- (mod (v10 x) (+ 1 (+ x x))) 2) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (f8 x) (mod (mod (ite (<= (- (v9 x) 2) 0) 1 0) (+ 1 x)) 2))))
(assert (= g8 1))
...
(assert (forall ((x Int)) (= (f7 x) (mod (+ (- (mod (+ (v8 x) x) 2) (mod x 2)) 1) 2))))
(assert (= g7 1))
