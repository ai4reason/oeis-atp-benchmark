;; sequence(s): A34472
;; terms: 2 4 10 28 82 244 730 2188 6562 19684 59050 177148 531442 1594324 4782970 14348908 43046722 129140164 387420490 1162261468
;; small program: 1 + loop((x + x) + x, x, 1)
;; fast program: 1 + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
