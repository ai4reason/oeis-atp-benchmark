;; sequence(s): A93194
;; terms: 50 130 250 610 850 1450 1810 2650 4210 4810 6850 8410 9250 11050 14050
;; small program: loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + y) * x) + 2, y, 2, 1, x) * (1 + (2 + 2))
;; fast program: (((loop2(loop((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, 1 + x) * 2) + 1, 1, y) * x, y, 2, 1, x) * (1 + (2 + 2))) + 1) + 2) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (* (w3 x) (+ 1 (+ 2 2))) 1) 2) 2))))
