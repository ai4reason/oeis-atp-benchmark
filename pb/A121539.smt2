;; sequence(s): A121539
;; terms: 0 2 3 4 6 8 10 11 12 14 15 16 18 19 20 22 24 26 27 28
;; small program: loop(loop((if (x mod 2) <= 0 then 2 else x) div 2, y, x) + x, x + x, 0)
;; fast program: compr(loop((if (x mod 2) <= 0 then 2 else x) div 2, 1 + (2 + (2 * (2 * (2 + 2)))), x), x) div 2
(set-logic UFNIA)
