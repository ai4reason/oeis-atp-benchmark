;; sequence(s): A225081
;; terms: 1 2 1 2 4 2 1 2 4 8 4 2 4 2 1 2 4 8 4 8
;; small program: loop(loop2(((((y div 2) + y) mod 2) * x) + x, y div 2, x, 1, x), 1, 1 + x) div 2
;; fast program: loop2(((((y div 2) + y) mod 2) * x) + x, y div 2, 1 + (2 + (2 + 2)), 1, 1 + x) div 2
(set-logic UFNIA)
