;; sequence(s): A182122
;; terms: 1 2 2 0 ~2 0 4 0 ~10 0 28 0 ~84 0 264 0 ~858 0 2860 0
;; small program: loop2(2 * ((x * y) + x), y - 2, x, 1, x) div loop((1 + y) * x, x, 1)
;; fast program: (loop2(x * y, 2 + y, x - 1, 1, 1 + (2 - x)) * loop(x + x, x, 1)) div loop(x * y, x, 1)
(set-logic UFNIA)
