;; sequence(s): A262414
;; terms: 0 4 12 48 144 468 1404 4320 12960 39204 117612 353808 1061424 3187188 9561564 28693440 86080320 258267204 774801612 2324483568
;; small program: loop((x + x) + x, x, 2) - loop((x + x) + x, x div 2, 2)
;; fast program: loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - loop2(x * y, y, x div 2, 2, 1 + 2)
(set-logic UFNIA)
