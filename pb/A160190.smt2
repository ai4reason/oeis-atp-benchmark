;; sequence(s): A160190
;; terms: 4 9 25 56 143 273 578 1045 2047 4176 7223 13949 25010 42441 75059 136952 246679 412665 733382 1257481
;; small program: (compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + x) + 1) * loop2(x + y, x, x, 2, 1)
;; fast program: (compr(loop((1 - loop(x + x, (x div 2) - 1, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + x) + 1) * loop2(x + y, x, x, 2, 1)
(set-logic UFNIA)
