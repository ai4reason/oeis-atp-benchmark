;; sequence(s): A271662
;; terms: 1 10 49 164 434 980 1974 3648 6303 10318 16159 24388 35672 50792 70652 96288 128877 169746 220381 282436
;; small program: loop(loop(((1 + y) * loop(((x + y) + y) + y, y, 1)) + x, y, x), x, 1) + x
;; fast program: loop(loop(loop((1 + ((1 + 2) * (((x * x) + x) div 2))) * (1 + x), 1, y) + x, y, x), x, 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (* (+ 1 y) (v2 x y)) x))))
...
(assert (forall ((x Int)) (= (f5 x) (* (+ 1 (* (+ 1 2) (div (+ (* x x) x) 2))) (+ 1 x)))))
(assert (= g5 1))
