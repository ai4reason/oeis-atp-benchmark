;; sequence(s): A262261
;; terms: 1 4 112 24640 44844800 695273779200 93581069585203200 110803729631663996928000 1165466869384731418887782400000 109720873815210197693149787062272000000 93006053830822450607559730484293052399616000000
;; small program: loop(loop(loop2(x * y, y - 1, x, 1, 2 * (x + x)) div loop(x * y, x, 1), 1, y) * x, x, 1)
;; fast program: loop(loop(loop2(x * y, y - 1, x, 1, 2 * (x + x)) div loop(x * y, x - 1, x), 1, y) * x, x, 1)
(set-logic UFNIA)
