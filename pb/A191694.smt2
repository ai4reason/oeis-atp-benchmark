;; sequence(s): A191694
;; terms: 1 2 6 16 42 110 294 788 2130 5802 15918 43945 122010 340470 954409 2686324 7588770 21508796 61144062 174286791
;; small program: loop2(((x + x) + x) + y, y + y, x, 1, 2) div (1 + x)
;; fast program: (loop2(x * y, y, x div 2, loop(1 + (2 * (2 + 2)), x mod 2, 1 + 2), 1 + (2 * (2 + 2))) - loop(x + x, x, 2)) div (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (- (w1 x) (v3 x)) (+ 1 x)))))
