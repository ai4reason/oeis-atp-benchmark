;; sequence(s): A212291
;; terms: 1 1 1 5 17 89 529 3709 29665 266993 2669921 29369141 352429681 4581585865 64142202097 962133031469 15394128503489 261700184559329 4710603322067905 89501463119290213
;; small program: loop((x * y) + loop(0 - x, y, 1 - y), x, 1)
;; fast program: (loop(2 - (x * y), x, 2) - 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
