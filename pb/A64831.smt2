;; sequence(s): A64831
;; terms: 0 1 3 9 24 64 168 441 1155 3025 7920 20736 54288 142129 372099 974169 2550408 6677056 17480760 45765225
;; small program: loop(loop2(x + y, x, y + y, 2, 0) - x, x, 1) div 2
;; fast program: (loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1)) - 1) + (x mod 2)
(set-logic UFNIA)
