;; sequence(s): A273926
;; terms: 0 1 3 2 7 4 10 5 15 8 18 9 22 11 25 12 31 16 34 17
;; small program: loop2(x + y, y div 2, x, (1 - x) * (x mod 2), x)
;; fast program: loop2(x + y, y div 2, 2 + (2 + 2), loop(1, x mod 2, x), x div 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i0 x) (* (- 1 x) (mod x 2)))))
