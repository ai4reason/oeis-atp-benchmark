;; sequence(s): A59015
;; terms: 1 1 2 2 4 5 6 6 9 11 13 14 16 17 18 18 22 25 28 30
;; small program: loop(loop((loop2(((if y <= 0 then 0 else 1) + x) + y, y div 2, x, 0, x) - x) - x, 1, y) + x, x, 1)
;; fast program: loop(loop(loop2((if y <= 0 then 0 else (1 + y)) + x, y div 2, 2 + (2 + 2), 1, x div 2) - x, 1, y) + x, x, 1)
(set-logic UFNIA)
