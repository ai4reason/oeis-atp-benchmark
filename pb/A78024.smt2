;; sequence(s): A78024
;; terms: 1 ~1 2 ~1 3 0 5 3 10 11 23 32 57 87 146 231 379 608 989 1595
;; small program: loop(loop2(y, x + y, y, 1, 0) - x, x, 1)
;; fast program: (2 - loop2(y - x, x, x - 1, 1, 1)) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
