;; sequence(s): A133526
;; terms: 3123 17748 46228 129124 257044 522244 1200964 2040964 3784804 6330724 9042244 12998404 19014724 28306324 38733364 54004804 71526004 87806884 112911124 140218324
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 2 + 2, 1, x), 1, y) + x, 1 + y, 2 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((x * x) * x), y, 2, 1, x), 1, y) + x, 1 + y, 2 + 2, 0, x)
(set-logic UFNIA)
