;; sequence(s): A299338
;; terms: 1 1 7 7 28 28 84 84 210 210 462 462 924 924 1716 1716 3003 3003 5005 5005
;; small program: loop(((2 * ((x + x) + x)) div y) + x, x div 2, 1)
;; fast program: loop((loop((loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) div (2 * (2 * (2 + (2 + 2))))) * x, 1, 2 + x) * (1 + x)) div ((2 * (2 * (2 * (2 + 2)))) - 2), 1, x div 2)
(set-logic UFNIA)
