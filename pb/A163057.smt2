;; sequence(s): A163057
;; terms: 2 4 6 9 11 14 16 19 23 25 29 32 34 37 41 45 47 51 54 56
;; small program: ((compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) div 2) + 1) + x
;; fast program: (compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x) + 1) + x
(set-logic UFNIA)
