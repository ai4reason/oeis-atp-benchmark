;; sequence(s): A18452
;; terms: 1 2 3 4 6 8 9 12 16 18 24 27 36 48 54 72 108 144 216 432
;; small program: compr(loop((1 + 2) * (x * x), 2, 2) mod (1 + x), x) + 1
;; fast program: 1 + compr((2 * loop((x * x) * x, 1, 2 + (2 + 2))) mod (1 + x), x)
(set-logic UFNIA)
