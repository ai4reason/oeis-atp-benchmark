;; sequence(s): A211227
;; terms: 1 2 3 4 8 8 20 16 48 32 112 64 256 128 576 256 1280 512 2816 1024
;; small program: loop2(y + y, x, x, 2 + (x div 2), 2) div 2
;; fast program: loop(x + x, x div 2, loop(2, x mod 2, x div 2) + 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i0 x) (+ 2 (div x 2)))))
(assert (= j0 2))
