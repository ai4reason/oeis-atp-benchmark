;; sequence(s): A90239
;; terms: 2 0 1 0 1 2 1 2 0 0 1 2 1 2 0 2 0 1 1 2
;; small program: loop2(x + y, y div (1 + 2), x, 2, x) mod (1 + 2)
;; fast program: loop2(x + y, y div (1 + 2), 2 + 2, 2 + x, x div (1 + 2)) mod (1 + 2)
(set-logic UFNIA)
