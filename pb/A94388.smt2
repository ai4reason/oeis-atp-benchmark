;; sequence(s): A94388
;; terms: 1 2 4 10 28 82 244 730 2188 6562 19684 59050 177148 531442 1594324 4782970 14348908 43046722 129140164 387420490
;; small program: 1 + loop2(y, (y + y) + y, x, 0, 1)
;; fast program: 1 + (if x <= 0 then 0 else loop2(x * y, y, (x - 1) div 2, loop(1, x mod 2, 1 + 2), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
