;; sequence(s): A170935
;; terms: 1 1 2 6 12 24 54 117 247 532 1148 2460 5280 11352 24381 52353 112462 241570 518840 1114416
;; small program: loop2(loop2(((y * y) + x) div (x + y), x + y, y, 1, 1) * x, 1 + y, 2, 1, x)
;; fast program: loop2(loop(loop2(((y * y) div (1 + x)) + x, x, x - 1, 2, 2) - 1, 1, y) * x, y - 1, 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (div (* y y) (+ 1 x)) x))))
