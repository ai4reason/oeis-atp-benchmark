;; sequence(s): A134693
;; terms: 3 9 6 18 12 36 24 72 48 144 96 288 192 576 384 1152 768 2304 1536 4608
;; small program: (1 + 2) * loop2(x + y, x - y, x, 1, 2)
;; fast program: loop(x + x, x div 2, loop(x * x, x mod 2, 1 + 2))
(set-logic UFNIA)
