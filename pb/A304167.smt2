;; sequence(s): A304167
;; terms: 4 9 25 75 229 699 2125 6435 19429 58539 176125 529395 1590229 4774779 14332525 43013955 129074629 387289419 1161999325 3486260115
;; small program: 2 + loop2(((x + x) + x) + y, y + y, x, 2, 1)
;; fast program: (((1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) + 2
(set-logic UFNIA)
