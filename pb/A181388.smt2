;; sequence(s): A181388
;; terms: 0 1 3 11 75 1099 33867 2131019 270566475 68990043211 35253362132043 36064050381096011 73823040345219302475 302305277944002512979019 2476182383848704552311227467 40567295389687189552446813799499 1329268563080305560093359507094144075
;; small program: loop(x + loop2(x * y, y + y, y, 1, 1), x, 0)
;; fast program: loop2(1 + (x * y), y div 2, x, 0, loop(x + x, x - 1, 2))
(set-logic UFNIA)
