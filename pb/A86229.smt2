;; sequence(s): A86229
;; terms: 1 1 3 20 280 8064 473088 56229888 13495173120 6525665935360 6348167821918208 12410090985684467712 48713743815806763925504 383714412826047125074739200 6062249191894029093752222515200
;; small program: loop(loop(x + x, y, 1 + (y + y)) * x, x - 1, 1) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 1 + y, x, 1, x) div loop(x * y, x, 1)) * loop2(x * y, y + y, x - 2, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (h1 x y) (+ 1 (+ y y)))))
