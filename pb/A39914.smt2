;; sequence(s): A39914
;; terms: 5 5 19 41 109 155 271 341 505 811 929 1331 1639 1805 2161 2755 3421 3659 4421 4969
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 1, y, 2, 1, x) + loop(0 - 2, x, 2)
;; fast program: loop2((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1, y, 2, 1, x) + loop(0 - 2, x, 2)
(set-logic UFNIA)
