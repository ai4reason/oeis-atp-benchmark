;; sequence(s): A136853
;; terms: 0 1 3 10 30 100 300 1000 3000 10000 30000 100000 300000 1000000 3000000 10000000 30000000 100000000 300000000 1000000000
;; small program: loop2(((x + x) + x) + y, if y <= 0 then x else 0, x, 0, 1)
;; fast program: if x <= 0 then 0 else loop2(x * y, y, (x - 1) div 2, loop(1, x mod 2, 1 + 2), 2 + (2 * (2 + 2)))
(set-logic UFNIA)
