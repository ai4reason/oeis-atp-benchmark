;; sequence(s): A80468
;; terms: 0 1 0 1 2 1 0 1 2 1 2 3 2 1 0 1 2 1 2 3
;; small program: ((2 * loop((y div loop2(x + y, y div 2, x, 0, x)) + x, x, 1)) - 2) - x
;; fast program: ((2 * loop((y div loop2(x + y, y div 2, 1 + (2 + 2), x, x div 2)) + x, x, 1)) - 2) - x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (- (- (* 2 (v0 x)) 2) x))))
