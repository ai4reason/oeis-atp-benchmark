;; sequence(s): A167762
;; terms: 0 0 1 2 7 14 37 74 175 350 781 1562 3367 6734 14197 28394 58975 117950 242461 484922
;; small program: loop(x + x, x, 1) - loop2(y, (x + x) + x, x, 1, 2)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x * y, y, x div 2, 1 + (x mod 2), 1 + 2)
(set-logic UFNIA)
