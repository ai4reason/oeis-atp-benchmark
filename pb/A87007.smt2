;; sequence(s): A87007
;; terms: 1 2 3 5 6 7 10 11 13 14 15 17 21 22 26 30 33 34 35 39
;; small program: loop(compr(loop((1 + (2 * (2 + x))) * ((x * x) + x), 2, 2 + (2 + 2)) mod (1 + x), y), x, 0) + 1
;; fast program: compr(loop((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 2 + (2 + 2), 2) mod (1 + x), x) + 1
(set-logic UFNIA)
