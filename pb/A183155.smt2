;; sequence(s): A183155
;; terms: 1 1 3 9 23 53 115 241 495 1005 2027 4073 8167 16357 32739 65505 131039 262109 524251 1048537
;; small program: 1 + (2 - loop(2 * (x - y), x, 2))
;; fast program: (2 * (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - x)) - 1
(set-logic UFNIA)
