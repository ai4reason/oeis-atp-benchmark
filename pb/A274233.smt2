;; sequence(s): A274233
;; terms: 1 1 3 7 14 27 48 80 127 192 280 397 547 736 972 1261 1610 2028 2523 3104
;; small program: (loop(((x * x) div (2 + (2 + 2))) + x, 1, loop(x + y, x, 0)) div 2) + 1
;; fast program: (loop(((x * x) div (2 + (2 + 2))) + x, 1, ((x * x) + x) div 2) div 2) + 1
(set-logic UFNIA)
