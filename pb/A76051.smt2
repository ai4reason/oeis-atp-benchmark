;; sequence(s): A76051
;; terms: 2 3 5 11 23 63 153 489 1329 4785 14235 56475 181215 780255 2672145 12348945 44781345 220253985 840523635 4370620275
;; small program: loop((loop(loop(loop(x * y, y - 1, 1) div x, x, 1), 1, y) * y) + x, x, 2)
;; fast program: loop2(loop(loop2(x * y, y - 2, x div 2, 1, x), 1, y) + x, 1 + y, 2, 0, x)
(set-logic UFNIA)
