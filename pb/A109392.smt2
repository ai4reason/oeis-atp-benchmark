;; sequence(s): A109392
;; terms: 0 1 13 175 2735 49610 1029386 24088590 628068366 18061990371 568061990371 19398632250697 714854467214665 28276489167109688 1195037205850701368 53742304051553826368 2562499498076052846144
;; small program: loop(loop2(x * y, y, 1 + y, 1 + y, y) + x, x, 1) div 2
;; fast program: loop(loop(loop2(x * y, y, x - 2, 1 + x, x) * ((x * x) * x), 1, y) + x, x, 0) div 2
(set-logic UFNIA)
