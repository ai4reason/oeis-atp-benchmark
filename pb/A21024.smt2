;; sequence(s): A21024
;; terms: 1 11 80 490 2751 14721 76630 392480 1990901 10041031 50466780 253122870 1267989451 6347088941 31756902530 158848951660 794438206401 3972771638451 19865600535880 99333230758850
;; small program: loop(((loop2(((2 * ((x + x) + y)) - 1) + x, y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) + 1) div 2, 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (- (* 2 (+ (+ x x) y)) 1) x))))
