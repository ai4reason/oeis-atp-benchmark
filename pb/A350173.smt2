;; sequence(s): A350173
;; terms: 4 3 25 7 121 13 289 19 529 29 961 37 1681 43 2209 53 3481 61 4489 71
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2 - (x mod 2), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2 - (x mod 2), 1, x)
(set-logic UFNIA)
