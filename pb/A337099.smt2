;; sequence(s): A337099
;; terms: 1 7 11 71 111 711 1111 7111 11111 71111 111111 711111 1111111 7111111 11111111 71111111 111111111 711111111 1111111111 7111111111
;; small program: loop2(1 + (y + y), (2 * (x + x)) + x, x, 1, 1 + 2)
;; fast program: loop2(1 + (x * y), y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), 2 + (2 * (2 + 2)))
(set-logic UFNIA)
