;; sequence(s): A189050
;; terms: 3 1 7 3 17 7 41 17 99 41 239 99 577 239 1393 577 3363 1393 8119 3363
;; small program: loop2((x + x) + y, x, loop(y - x, x, 1), 1, 1)
;; fast program: loop2((x + x) + y, x, x div 2, loop(0, x mod 2, 2) + 1, 1)
(set-logic UFNIA)
