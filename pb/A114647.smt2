;; sequence(s): A114647
;; terms: 3 2 7 12 31 70 171 408 987 2378 5743 13860 33463 80782 195027 470832 1136691 2744210 6625111 15994428
;; small program: 1 + loop(loop2((x + x) + y, x, y, 1, 1) - x, x, 2)
;; fast program: (if x <= 0 then 1 else loop2((x + x) + y, x, x - 1, 2, 1)) + loop(0, x mod 2, 2)
(set-logic UFNIA)
