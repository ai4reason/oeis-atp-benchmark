;; sequence(s): A131885
;; terms: 1 2 4 6 8 12 24 56 128 272 544 1056 2048 4032 8064 16256 32768 65792 131584 262656
;; small program: loop(x + x, x - 1, 1) + loop2(x + y, y - x, x, 0, 1)
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(x + y, y - x, x - 1, 2, 2)) div 2
(set-logic UFNIA)
