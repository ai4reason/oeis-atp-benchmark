;; sequence(s): A78789
;; terms: 1 3 10 35 127 474 1807 6995 27370 107883 427351 1698458 6765175 26985675 107746282 430470899 1720537327 6878624730 27505271455 109996928003
;; small program: loop((loop2(x + y, x, y, 1, 1) - x) - x, x + x, 1)
;; fast program: loop(2 * ((x - loop2(((x - y) + x) + x, x, y, 1, 2)) + x), x, 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* 2 (+ (- x (w3 x y)) x)))))
