;; sequence(s): A133537
;; terms: 793 16354 133274 1889210 6598370 28964378 71183450 195081770 742859210 1482327002 3453230090 7315830650 11071467290 17100578378 32943576458 64344894770 93700908002 141978756530 218558666090 279434510210
;; small program: loop2(loop(loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2 + (2 + 2), 1, x), 1, y) + x, 1 + y, 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((((x * x) * x) * x) * x), y, 2, 1, x), 1, y) + x, 1 + y, 2, 0, x)
(set-logic UFNIA)
