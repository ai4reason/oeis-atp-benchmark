;; sequence(s): A220791
;; terms: 1 12 26208 9726417792 610296923230525440 6471875909051511775903457280 11598637276362103019770723830073032376320 3512938445418644176053176560741858449740612202579886080
;; small program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, 1 + (2 * (2 + (2 + 2))))) * x, x, 1) div loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 + 2))))
;; fast program: loop(loop((loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 + 2)))) - 1) * loop2(x * y, y, x - 1, 1, 1 + (2 * (2 + (2 + 2)))), 1, y) * x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (v0 x) (w3 x)))))
