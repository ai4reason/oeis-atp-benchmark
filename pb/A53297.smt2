;; sequence(s): A53297
;; terms: 1 5 22 92 372 1468 5688 21728 82064 307088 1140320 4206912 15434048 56350912 204875648 742104064 2679197952 9644109056 34623075840 124001176576
;; small program: loop2(((x + x) + x) + y, x + y, x, 2 + x, 1) div 2
;; fast program: (loop2(2 * ((x - y) + x), x, 1 + x, 1 + x, x) div 2) div 2
(set-logic UFNIA)
