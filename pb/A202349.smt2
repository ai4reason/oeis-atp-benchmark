;; sequence(s): A202349
;; terms: 1 3 9 20 39 75 148 297 597 1196 2391 4779 9556 19113 38229 76460 152919 305835 611668 1223337
;; small program: loop((loop2(1 + y, y - x, y - 1, 1, 2) + x) + x, x, 1)
;; fast program: ((((loop(x + x, x, 2) - loop2(x - y, x, x - 1, 2, 2)) * 2) + 1) div (1 + 2)) + loop(x + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (+ (* (- (v2 x) (w3 x)) 2) 1) (+ 1 2)) (v4 x)))))
