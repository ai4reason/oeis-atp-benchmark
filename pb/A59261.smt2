;; sequence(s): A59261
;; terms: 0 1 2 1 2 3 4 3 4 5 6 5 4 3 2 3 4 5 6 5
;; small program: (loop(loop(loop2(((y div 2) * y) + x, (y div 2) div 2, x, 1, x) mod 2, 1, y) + x, x, 0) * 2) - x
;; fast program: (loop(loop(loop2(((y div 2) * y) + x, y div (2 + 2), 1 + 2, 1, x) mod 2, 1, y) + x, x, 0) * 2) - x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (* (div y 2) y) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* (div y 2) y) x))))
