;; sequence(s): A30078
;; terms: 8 27 125 343 1331 2197 4913 6859 12167 24389 29791 50653 68921 79507 103823 148877 205379 226981 300763 357911
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * (x * x), y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((x * x) * x), 0, 2, 1, x) div 2
(set-logic UFNIA)
