;; sequence(s): A269019
;; terms: 2 ~1 5 5 17 29 65 125 257 509 1025 2045 4097 8189 16385 32765 65537 131069 262145 524285
;; small program: loop2(y - x, 2 + (y + y), x, 2, 1)
;; fast program: 1 + loop(2 * (x - 2), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
