;; sequence(s): A73388
;; terms: 1 4 16 56 188 608 1920 5952 18192 54976 164608 489088 1443776 4238336 12382208 36022272 104407296 301618176 868765696 2495715328
;; small program: loop(loop((loop2(y, 2 * (x + y), x, 1, 2) div 2) * (2 + x), 1, y) + x, x, 1)
;; fast program: loop(loop((if x <= 0 then 1 else loop2(2 * (x + y), x, x - 1, 2, 1)) * (2 + x), 1, y) + x, x, 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (* (ite (<= x 0) 1 (w5 x)) (+ 2 x)))))
(assert (= g4 1))
