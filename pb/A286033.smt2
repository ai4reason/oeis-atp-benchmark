;; sequence(s): A286033
;; terms: 0 3 5 21 69 253 923 3433 12869 48621 184755 705433 2704155 10400601 40116599 155117521 601080389 2333606221 9075135299 35345263801
;; small program: loop(2 * ((x - (x div y)) + x), x, 1) - loop(0 - x, x, 1)
;; fast program: loop(2 * ((x - (x div y)) + x), x, 1) - loop(0 - 1, x mod 2, 1)
(set-logic UFNIA)
