;; sequence(s): A104103
;; terms: 2 2 3 3 4 4 5 5 5 6 6 7 7 7 7 8 8 8 9 9
;; small program: loop((((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 0) div (x * x)) + x, x, 2)
;; fast program: loop((((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) div (x * x)) + x, x, 2)
(set-logic UFNIA)
