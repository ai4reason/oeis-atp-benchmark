;; sequence(s): A66872
;; terms: 5 10 26 50 122 170 290 362 530 842 962 1370 1682 1850 2210 2810 3482 3722 4490 5042
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 2, y, 2, 1, x)
;; fast program: loop2(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x) + loop(1, x, 2 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (w3 x) (v6 x)))))
