;; sequence(s): A47946
;; terms: 3 2 8 17 48 122 323 842 2208 5777 15128 39602 103683 271442 710648 1860497 4870848 12752042 33385283 87403802
;; small program: loop(0 - x, x, 1) + loop2(y - x, x, x + x, 2, 1)
;; fast program: loop(2 + x, x mod 2, loop(x * x, 1, loop2(y - x, x, x, 2, 1))) - 1
(set-logic UFNIA)
