;; sequence(s): A87452
;; terms: 2 1 25 37 337 781 4825 14197 72097 242461 1107625 4017157 17308657 65514541 273218425 1059392917 4338014017 17050729021 69106897225 273715645477
;; small program: loop2(y, loop((2 + y) * x, 2, x) + y, x, 2, 1)
;; fast program: loop(x * x, 1, loop(x + x, x, 1)) - loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1) - 2, ((2 + 2) * 2) + 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i4 x) (- (v5 x) 2))))
(assert (= j4 (+ (* (+ 2 2) 2) 1)))
