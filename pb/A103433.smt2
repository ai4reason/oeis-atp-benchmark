;; sequence(s): A103433
;; terms: 0 1 5 30 199 1355 9276 63565 435665 2986074 20466835 140281751 961505400 6590256025 45170286749 309601751190 2122041971551 14544692049635 99690802375860 683290924581349
;; small program: loop(loop(x * x, 1, loop2(((x - y) + x) + x, x, y, 1, 2)) + x, x, 0)
;; fast program: ((((loop2(x + y, x, 2 * (x + x), 0, 2) - x) div (1 + (2 + 2))) + 1) + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (+ (div (- (w3 x) x) (+ 1 (+ 2 2))) 1) x) 2))))
