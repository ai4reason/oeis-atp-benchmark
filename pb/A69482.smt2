;; sequence(s): A69482
;; terms: 5 16 24 72 48 120 72 168 312 120 408 312 168 360 600 672 240 768 552 288
;; small program: loop2(loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2, 1, x), 1, y) - x, 1 + y, 2, 1, x) - 1
