;; sequence(s): A189660
;; terms: 0 0 1 1 1 2 3 4 4 4 4 5 5 5 6 7 8 8 9 10
;; small program: loop(loop(loop2(((y + y) div (1 + 2)) + x, y div (1 + 2), x, 0, x) mod 2, 1, y) + x, x, 0)
;; fast program: loop(loop(loop2(((y + y) div (1 + 2)) + x, y div (1 + 2), 2 + 2, 0, x) mod 2, 1, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (div (+ y y) (+ 1 2)) x))))
