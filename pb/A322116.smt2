;; sequence(s): A322116
;; terms: 2 6 26 78 242 726 2186 6558 19682 59046 177146 531438 1594322 4782966 14348906 43046718 129140162 387420486 1162261466 3486784398
;; small program: (2 * loop2((2 * (x + y)) + y, x, x, 2, 0)) - 2
;; fast program: ((1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - loop(2 + x, x mod 2, 1)
(set-logic UFNIA)
