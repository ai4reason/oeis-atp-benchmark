;; sequence(s): A171498
;; terms: 3 11 35 107 323 971 2915 8747 26243 78731 236195 708587 2125763 6377291 19131875 57395627 172186883 516560651 1549681955 4649045867
;; small program: 1 + loop((2 * (2 + x)) + x, x, 2)
;; fast program: (2 * loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))) - 1
(set-logic UFNIA)
