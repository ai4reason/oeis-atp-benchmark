;; sequence(s): A267465
;; terms: 3 9 24 62 160 418 1112 3018 8352 23522 67240 194554 568304 1672146 4946808 14692970 43767616 130647490 390566216 1168815066
;; small program: loop2(1 + ((x + x) + y), y + y, x, 2, 1) + loop((x + x) + x, x, 1)
;; fast program: ((loop(x + x, x, 2 + (2 + (2 + x))) div 2) - 1) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (div (v2 x) 2) 1) (w3 x)))))
