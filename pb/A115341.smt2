;; sequence(s): A115341
;; terms: 2 4 0 8 8 24 40 88 168 344 680 1368 2728 5464 10920 21848 43688 87384 174760 349528
;; small program: 2 * loop2(y + y, x + y, x - 1, if x <= 0 then 1 else 2, 0)
;; fast program: (((((loop(2 * (2 + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div 2) div (1 + 2)) * 2) + 2) - (if x <= 0 then 1 else 2)) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- (+ (* (div (div (v1 x) 2) (+ 1 2)) 2) 2) (ite (<= x 0) 1 2)) 2))))
