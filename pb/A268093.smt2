;; sequence(s): A268093
;; terms: 1 3 9 26 74 208 580 1608 4440 12224 33584 92128 252448 691200 1891392 5173376 14145920 38671360 105700096 288873984
;; small program: loop((x + loop2(2 * (x + y), x, y, 1, 0)) + x, x, 2) div 2
;; fast program: (loop2(2 * (x + y), x, x, 1 + 2, 1) - loop(x + x, x, 1)) div 2
(set-logic UFNIA)
