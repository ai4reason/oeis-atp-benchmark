;; sequence(s): A114201
;; terms: 1 24 450 7700 126126 2018016 31855824 498841200 7773608700 120784604512 1873533922260 29034766346040 449790717967500 6967723880880000 107959904588606400 1673378521123399200 25949671331244477300 402629171550425820000 6250759024406391495000
;; small program: loop2((1 + (2 + (2 + y))) * (x * y), 1 + y, x, 1, 2 + x) div loop((y * x) * y, x, 1)
;; fast program: ((loop2(x * y, 1 + y, x, 1, 1 + (2 + (2 + (2 + x)))) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 2 + x)) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (div (w2 x) (v3 x)) (w4 x)) (v5 x)))))
