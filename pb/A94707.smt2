;; sequence(s): A94707
;; terms: 0 0 1 2 3 4 6 8 11 14 19 24 32 40 53 66 87 108 142 176
;; small program: loop(x + loop2(x + y, x, y div 2, 0, 1), x, 0)
;; fast program: loop2(x + y, x, x div 2, 2, 1 + (x mod 2)) - 2
(set-logic UFNIA)
