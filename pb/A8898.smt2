;; sequence(s): A8898
;; terms: 84 42 21 62 31 92 46 23 68 34 17 50 25 74 37 110 55 164 82 41
;; small program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 2 * loop((x * x) + x, 2, 2))
;; fast program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 2 * loop((x * x) + x, 1, 2 + (2 + 2)))
(set-logic UFNIA)
