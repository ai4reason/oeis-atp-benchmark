;; sequence(s): A36543
;; terms: 1 9 33 105 321 969 2913 8745 26241 78729 236193 708585 2125761 6377289 19131873 57395625 172186881 516560649 1549681953 4649045865
;; small program: loop((1 + 2) * (2 + x), x, 1)
;; fast program: 1 + (2 * (loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - 2))
(set-logic UFNIA)
