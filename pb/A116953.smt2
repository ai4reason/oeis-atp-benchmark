;; sequence(s): A116953
;; terms: 1 1 2 5 10 23 50 107 232 500 1078 2323 5007 10789 23248 50092 107934 232566 501111 1079745
;; small program: loop2((1 + 2) * ((x + x) + y), x, x, 1, 0 - 1) div loop((x + x) + x, x, 1)
;; fast program: loop2((1 + 2) * ((x + x) + y), x, x - 1, (if x <= 0 then 0 else 2) + 1, 1) div loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* (+ 1 2) (+ (+ x x) y)))))
