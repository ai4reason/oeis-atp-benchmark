;; sequence(s): A133530
;; terms: 160 495 1799 3871 8441 13969 23939 43415 66347 104833 149365 199081 252251 332207 458079 581237 733123 885655 1047691 1239967
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 1 + 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x * x), y, 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
(set-logic UFNIA)
