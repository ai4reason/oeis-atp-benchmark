;; sequence(s): A112044
;; terms: 1 5 17 57 169 521 1353 3529 8393 20169 49865 113353 264905 600777 1305289 2845385 6318793 14052041 30042825 65170121
;; small program: (loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) + x) + x, y - 1, x, 1, x) * 2) - 1
;; fast program: (loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + x) + x, y - 1, x, 1, x) * 2) - 1
(set-logic UFNIA)
