;; sequence(s): A45505
;; terms: 1 21 262 2525 20754 152946 1040556 6659037 40599130 237978598 1350216660 7453221490 40188242420 212349718980 1102352779992 5634083759325 28400234400810 141402315307550 696257439473860
;; small program: loop(loop((((loop((((loop((((loop(((((loop(2 * ((x - (x div y)) + x), y, 1) div (1 + y)) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop((((loop((((loop((((loop((((loop(loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1), 1, y) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (* 2 (+ (- x (div x y)) x)))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (+ (+ (div (v5 x y) (+ 1 y)) x) x) x) x))))
...
(assert (forall ((x Int) (y Int)) (= (g12 x y) (+ 1 y))))
(assert (forall ((x Int)) (= (h12 x) (- x 1))))
(assert (= i12 1))
(assert (forall ((x Int)) (= (j12 x) (+ 2 x))))
...
(assert (forall ((x Int)) (= (w12 x) (u12 (h12 x) i12 (j12 x)))))
...
(assert (forall ((x Int)) (= (f11 x) (div (w12 x) (v13 x)))))
(assert (= g11 1))
...
(assert (forall ((x Int) (y Int)) (= (f10 x y) (+ (+ (+ (+ (v11 x y) x) x) x) x))))
...
(assert (forall ((x Int) (y Int)) (= (f9 x y) (+ (+ (+ (+ (v10 x y) x) x) x) x))))
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (v7 x y) (* 2 (+ x x))))))
