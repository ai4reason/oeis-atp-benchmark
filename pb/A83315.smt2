;; sequence(s): A83315
;; terms: 1 4 19 97 505 2629 13609 69997 357985 1822309 9241849 46731997 235754065 1187152789 5969306089 29980723597 150440439745 754349584069 3780337658329 18936047636797
;; small program: loop2((2 * (x + x)) - y, y + y, x, 0, 1) + loop((2 * (x + x)) + x, x, 1)
;; fast program: (loop((1 - x) * x, 1, loop(x + x, x, 1)) div 2) + loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
