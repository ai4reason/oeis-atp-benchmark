;; sequence(s): A66206
;; terms: 3 21 273 5187 150423 5565651 239322993 12684118629 773731236369 54934917782199 4339858504793721 386247406926641169 39010988099590758069 4174175726656211113383 471681857112151855812279 61790323281691893111408549 8588854936155173142485788311
;; small program: loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y + y) * x) + x, 1 + x, 1)
;; fast program: loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, 2 + y, x, 1 + 2, 1 + 2)
(set-logic UFNIA)
