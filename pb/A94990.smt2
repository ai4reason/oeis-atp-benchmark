;; sequence(s): A94990
;; terms: 1 1 1 1 1 1 2 2 2 3 3 4 4 5 6 7 8 9 11 12
;; small program: loop(x + x, (x + x) + x, 1) div loop((2 * ((x + x) + x)) + x, x, 1)
;; fast program: loop((x * x) * x, 1, loop(x + x, x, 1)) div loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1)
(set-logic UFNIA)
