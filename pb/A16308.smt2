;; sequence(s): A16308
;; terms: 1 19 261 3191 37037 419055 4679557 51894967 573363933 6322119551 69634013813 766518346503 8434966982989 92804227849807 1020964052585829 11231309855904599 123548640079779005
;; small program: loop((loop2((2 * ((x + x) + x)) + y, y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x + x, x - 1, 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
