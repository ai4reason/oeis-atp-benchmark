;; sequence(s): A213706
;; terms: 0 1 3 5 8 11 15 19 24 29 35 41 48 55 62 69 77 85 94 103
;; small program: loop(loop(loop(loop2(x + y, y div 2, x, 0, x) - x, x, y) + x, y, 0) + x, x, 0)
;; fast program: loop(loop(loop(loop(loop2(x + y, y div 2, x, 0, x), 1, x div 2), x, y) + x, y, 1) + x, x, 0)
(set-logic UFNIA)
