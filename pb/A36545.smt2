;; sequence(s): A36545
;; terms: 1 17 65 209 641 1937 5825 17489 52481 157457 472385 1417169 4251521 12754577 38263745 114791249 344373761 1033121297 3099363905 9298091729
;; small program: (2 * loop((1 + 2) * (2 + x), x, 1)) - 1
;; fast program: 1 + (2 * (2 * (loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - 2)))
(set-logic UFNIA)
