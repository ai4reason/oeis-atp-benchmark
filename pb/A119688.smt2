;; sequence(s): A119688
;; terms: 1 2 3 3 3 6 1 6 5 1 3 8 7 0 1 13 9 1 15 0
;; small program: loop(loop((x * y) + x, y, 1) div x, x, 1) mod (2 + x)
;; fast program: loop(loop2(x * y, y - 2, x div 2, 2 + (x mod 2), 1) mod (1 + x), 1, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i3 x) (+ 2 (mod x 2)))))
(assert (= j3 1))
