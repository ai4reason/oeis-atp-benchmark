;; sequence(s): A191790
;; terms: 0 0 1 1 4 5 14 20 49 76 175 286 637 1078 2353 4081 8788 15521 33098 59279
;; small program: loop(loop((x * y) div (y - (y div 2)), y, 2) - x, x, 1) div 2
;; fast program: loop(loop(loop(2 * ((x - (x div y)) + x), x div 2, 1 + (x mod 2)), 1, y) - x, 1 + x, 1) div 2
(set-logic UFNIA)
