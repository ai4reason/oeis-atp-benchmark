;; sequence(s): A336102
;; terms: 0 0 1 1 3 3 8 8 20 20 48 48 112 112 256 256 576 576 1280 1280
;; small program: (loop(x + x, x div 2, 1 + (x div 2)) div 2) div 2
;; fast program: loop(loop(x + x, x - 1, 1 + x), 1, x div 2) div 2
(set-logic UFNIA)
