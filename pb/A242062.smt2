;; sequence(s): A242062
;; terms: 0 1 0 0 1 1 0 1 2 1 1 2 2 1 2 3 2 2 3 3
;; small program: loop(loop2(y - (x div 2), 0 - x, y, 1, 1) + x, x, 0)
;; fast program: loop(loop(loop(((1 * (2 + (x + x))) div (1 + (2 + (2 + 2)))) mod 2, 1, y) + x, x + x, 0) - x, 2, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (mod (div (* 1 (+ 2 (+ x x))) (+ 1 (+ 2 (+ 2 2)))) 2))))
(assert (= g4 1))
