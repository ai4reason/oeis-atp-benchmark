;; sequence(s): A104487
;; terms: 1 4 14 47 154 496 1577 4964 15502 48103 148490 456416 1397905 4268740 13002638 39522143 119912698 363262672 1099015481 3321204260
;; small program: loop(((x + loop2(y - x, x, y + y, 1, 1)) + x) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 * (2 + 2)), x mod 2, 1 + 2), 1 + (2 * (2 + 2))) - loop2(((x - y) + x) + x, x, x, 2, 1)
(set-logic UFNIA)
