;; sequence(s): A192883
;; terms: 2 0 5 8 26 63 170 440 1157 3024 7922 20735 54290 142128 372101 974168 2550410 6677055 17480762 45765224
;; small program: loop(loop2(x + y, x, y + y, 1, 0) - x, x, 2)
;; fast program: 1 + loop(x - 2, x mod 2, loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1)))
(set-logic UFNIA)
