;; sequence(s): A123877
;; terms: 1 ~1 0 3 ~9 18 ~27 27 0 ~81 243 ~486 729 ~729 0 2187 ~6561 13122 ~19683 19683
;; small program: loop2(0 - (x + y), (x - y) - y, x, 1, 0)
;; fast program: loop2((x - y) + x, x + y, x - 1, 1, 2) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
