;; sequence(s): A36554
;; terms: 2 6 8 10 14 18 22 24 26 30 32 34 38 40 42 46 50 54 56 58
;; small program: compr(loop(if (x mod 2) <= 0 then ((x div 2) - x) else x, x, x), 1 + x)
;; fast program: compr((loop(loop((if (x mod 2) <= 0 then 2 else x) div 2, 1 + (2 * (2 + 2)), x), 2, x) + 1) mod 2, x) + compr(0, 1)
(set-logic UFNIA)
