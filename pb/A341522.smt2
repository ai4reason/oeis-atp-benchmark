;; sequence(s): A341522
;; terms: 2 5 6 11 10 13 14 23 18 21 22 27 26 29 30 47 34 37 38 43
;; small program: ((loop2(1 + (y mod (x + x)), y, x, 1, x) + 1) + x) + x
;; fast program: (loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 1) + x, x mod 2, x) + 2) + x
(set-logic UFNIA)
