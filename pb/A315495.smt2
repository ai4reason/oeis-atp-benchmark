;; sequence(s): A315495
;; terms: 1 6 11 16 22 28 34 39 44 50 56 61 66 72 78 84 89 94 100 106
;; small program: ((((loop((((loop((x * x) mod (1 + (2 + (2 + 2))), x mod 2, x + x) + x) mod 2) + 1) + x, x, 2) - 1) + x) + x) + x) + x
;; fast program: ((((loop(((loop(((x * x) mod (1 + (2 + (2 + 2)))) - 1, x mod 2, x + x) mod 2) + 1) + x, x, 2) - 1) + x) + x) + x) + x
(set-logic UFNIA)
