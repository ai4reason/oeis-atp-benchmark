;; sequence(s): A133146
;; terms: 2 5 7 14 18 29 35 50 58 77 87 110 122 149 163 194 210 245 263 302
;; small program: loop(loop2(2 + y, x, y, 0, y) + x, x, 2)
;; fast program: (((2 + x) * x) - loop((2 + x) * x, 1, x div 2)) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (* (+ 2 x) x) (v2 x)) 2))))
