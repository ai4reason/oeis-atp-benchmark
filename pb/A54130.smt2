;; sequence(s): A54130
;; terms: 2 11 58 236 802 2396 6508 16448 39331 90102 199652 431128 912644 1902808 3921896 8014336 16273829 32893762 66268224 133194248
;; small program: (loop(((loop((loop(2 + (x + y), 2, y) * x) div y, y, 1) + x) * 2) + 1, x, 2) div 2) + 1
;; fast program: (loop((loop((((2 * ((x + x) + x)) + x) div y) + x, y, 1) + x) * 2, x, 1 + 2) + 1) div 2
(set-logic UFNIA)
