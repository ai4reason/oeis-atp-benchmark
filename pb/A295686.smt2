;; sequence(s): A295686
;; terms: 2 1 2 1 4 7 10 15 26 43 68 109 178 289 466 753 1220 1975 3194 5167
;; small program: loop2(y, x + y, x, 2, 0) - loop2(0 - y, x, x, 0, 1)
;; fast program: (loop2(y, x + y, x, 2, 0) - loop(y, x mod (2 + 2), 2)) + 2
(set-logic UFNIA)
