;; sequence(s): A115730
;; terms: 0 0 1 2 6 16 42 110 289 756 1980 5184 13572 35532 93025 243542 637602 1669264 4370190 11441306
;; small program: loop((y div 2) + x, loop2(x + y, x, x, 1, 0), 0)
;; fast program: loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1)) div (2 + 2)
(set-logic UFNIA)
