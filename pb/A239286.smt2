;; sequence(s): A239286
;; terms: 1 1 0 ~2 1 3 ~5 1 6 ~8 1 9 ~11 1 12 ~14 1 15 ~17 1
;; small program: loop2(y, 0 - (x + y), x, 1 - x, 1)
;; fast program: loop2((y - 1) - x, 0, (x - 1) mod (1 + 2), 1, x)
(set-logic UFNIA)
...
(assert (= g1 0))
(assert (forall ((x Int)) (= (h1 x) (mod (- x 1) (+ 1 2)))))
(assert (= i1 1))
