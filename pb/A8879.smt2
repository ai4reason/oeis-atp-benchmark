;; sequence(s): A8879
;; terms: 87 262 131 394 197 592 296 148 74 37 112 56 28 14 7 22 11 34 17 52
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(1 + (x * y), 2 + 2, 2) - 2)
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, (2 + loop((x * x) * x, 1, 1 + 2)) * (1 + 2))
(set-logic UFNIA)
