;; sequence(s): A3157
;; terms: 3 8 11 14 19 24 29 32 35 40 43 46 51 54 57 62 67 72 75 78
;; small program: (compr(loop(if (x mod 2) <= 0 then ((x div 2) - x) else x, x, x), 1 + x) + 1) + x
;; fast program: ((compr((loop(loop(x div loop(1, x mod (2 + 2), 2 + 2), 2, x), 1 - (x mod (2 + 2)), x) + 1) mod 2, x) * 2) + 1) + x
(set-logic UFNIA)
