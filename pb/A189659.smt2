...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (mod (+ y y) (+ 1 2)) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* (div (mod y (+ 1 2)) 2) x) x))))
...
(assert (forall ((x Int)) (= (f4 x) (mod (- (mod (- (mod (w5 x) (+ 1 2)) 1) (+ 1 2)) 1) (+ 1 x)))))
