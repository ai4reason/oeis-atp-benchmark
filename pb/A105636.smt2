;; sequence(s): A105636
;; terms: 0 1 8 28 72 153 288 496 800 1225 1800 2556 3528 4753 6272 8128 10368 13041 16200 19900
;; small program: loop((y div 2) + x, (2 + x) * x, 0) div 2
;; fast program: loop(x * x, 1, (2 + x) * x) div (2 * (2 + 2))
(set-logic UFNIA)
