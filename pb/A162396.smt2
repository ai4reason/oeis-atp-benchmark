;; sequence(s): A162396
;; terms: 5 2 10 4 20 8 40 16 80 32 160 64 320 128 640 256 1280 512 2560 1024
;; small program: loop2(y + y, x, x, 1 + (2 + 2), 1)
;; fast program: loop(x + x, x div 2, 1 + loop(1, x mod 2, 2 + 2))
(set-logic UFNIA)
