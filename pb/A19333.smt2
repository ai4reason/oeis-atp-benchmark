;; sequence(s): A19333
;; terms: 1 18 220 2280 21616 194208 1685440 14290560 119232256 983566848 8047836160 65462691840 530198327296 4280634482688 34479631482880 277245459333120 2226418414452736 17862092934217728
;; small program: loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop(x + x, x, 1)
;; fast program: loop(((loop((1 + x) * (x * x), 1, loop(x + x, x, 1)) div 2) - loop2(x * y, y, x, 1, 2 + (2 + 2))) div 2, 1, 2 + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (div (- (div (v3 x) 2) (w5 x)) 2))))
(assert (= g2 1))
