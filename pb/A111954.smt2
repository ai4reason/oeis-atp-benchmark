;; sequence(s): A111954
;; terms: 1 0 3 4 13 28 71 168 409 984 2379 5740 13861 33460 80783 195024 470833 1136688 2744211 6625108
;; small program: loop(loop2(y, (x + y) + y, y, 1, 1) - x, x, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1) + loop(0 - 1, x mod 2, 1)
(set-logic UFNIA)
