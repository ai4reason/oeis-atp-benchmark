;; sequence(s): A271675
;; terms: 0 4 7 15 20 32 39 55 64 84 95 119 132 160 175 207 224 260 279 319
;; small program: loop(loop2(2 + y, x, y, 0, y) + x, x, x)
;; fast program: (((2 + x) * x) - loop((2 + x) * x, 1, x div 2)) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (* (+ 2 x) x) (v2 x)) x))))
