;; sequence(s): A119697
;; terms: 0 1 4 30 168 1050 6336 39039 240240 1487772 9237800 57551494 359444736 2250244100 14115694320 88707831750 558368324640 3519726403710 22215931214400 140389620550410
;; small program: loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x, 0, x)) div (1 + x)
;; fast program: (loop(2 * (((x div y) + x) + x), x - 1, 2) div (1 + x)) * (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (v2 x) (+ 1 x)) (ite (<= x 0) 0 (w3 x))))))
