...
;; small program: loop2(y, 0 - x, (x div 2) + x, x mod 2, 1)
;; fast program: 2 - loop(y, (((((x div 2) mod 2) + x) div 2) + x) mod (2 + 2), 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g1 x) (mod (+ (div (+ (mod (div x 2) 2) x) 2) x) (+ 2 2)))))
(assert (= h1 2))
