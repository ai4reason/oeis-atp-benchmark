;; sequence(s): A153481
;; terms: 6 25 123 341 1329 2195 4911 6857 12165 24387 29789 50651 68919 79505 103821 148875 205377 226979 300761 357909
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + 2, 1, x) - 2
;; fast program: (loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((x * x) * x), 0, 2, 1, x) div 2) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (div (w3 x) 2) 2))))
