;; sequence(s): A24699-A168581
;; terms: 1 1 2 2 3 3 4 5 5 6 7 7 8 9 10 10 11 12 12 13
;; small program: ((compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), (1 + 2) + x) div 2) + 1) div (1 + 2)
;; fast program: ((compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), (1 + x) mod 2, x) - 1, (1 + 2) + x) div 2) + 1) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (+ (div (v0 x) 2) 1) (+ 1 2)))))
...
(assert (forall ((x Int)) (= (fast x) (div (+ (div (v2 x) 2) 1) (+ 1 2)))))
