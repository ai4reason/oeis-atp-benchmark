;; sequence(s): A22220
;; terms: 1 43 1591 57535 2072815 74630671 2686760143 96723701071 3482055254095 125354001240655 4512744117222991 162458788655384143 5848516394205967951 210546590207087679055 7579677247549193442895 272868380912335185925711
;; small program: loop(loop(1 + (2 * ((x + x) + x)), y, 1) + loop(2 * ((x + x) + x), 2, x), x, 1)
;; fast program: loop2(loop(1 + (2 * ((x + x) + x)), y, 1) * x, 1 + y, 2, 2, x) div loop(2 + (x + x), 2, 2)
(set-logic UFNIA)
...
(assert (= v5 (u5 g5 h5)))
(assert (forall ((x Int)) (= (fast x) (div (w3 x) v5))))
