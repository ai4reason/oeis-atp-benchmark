;; sequence(s): A14131
;; terms: 0 6 12 30 60 126 252 510 1020 2046 4092 8190 16380 32766 65532 131070 262140 524286 1048572 2097150
;; small program: loop(2 * (2 + x), x, 0) + (2 * (x mod 2))
;; fast program: (loop(2 + (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - 2) - 2
(set-logic UFNIA)
