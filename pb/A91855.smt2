;; sequence(s): A91855
;; terms: 1 4 7 11 13 16 19 21 25 28 31 35 37 41 44 47 49 52 55 59
;; small program: loop(loop(if ((x div 2) mod 2) <= 0 then 2 else (x div 2), x, x) + x, x + x, 1)
;; fast program: compr((((loop((((loop(loop2(x + y, y div 2, 2 * (2 + (2 + 2)), 1, x) mod 2, 1, x div 2) + x) mod 2) + x) - 1, 2, x) + 1) + x) mod 2) mod (1 + x), 1 + x) * 1
(set-logic UFNIA)
