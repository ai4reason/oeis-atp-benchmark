;; sequence(s): A5521
;; terms: 1 2 4 7 12 18 26 35 46 60 75 93 113 134 157 183 212 242 275 310
;; small program: loop(compr((1 + loop(x + x, x, x)) mod (1 + x), y) + x, x, 2) div 2
;; fast program: loop(compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) + x, x, 1)
(set-logic UFNIA)
