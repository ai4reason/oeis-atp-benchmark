;; sequence(s): A177698
;; terms: 0 1 0 ~3 0 45 0 ~1575 0 99225 0 ~9823275 0 1404728325 0 ~273922023375 0 69850115960625 0 ~22561587455281875
;; small program: loop2(x * y, y - 2, x, x mod 2, x)
;; fast program: x * loop2(x * y, y - 2, x - 1, 1, x - 2)
(set-logic UFNIA)
