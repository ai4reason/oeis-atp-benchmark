;; sequence(s): A60647
;; terms: 1 3 5 11 17 35 53 107 161 323 485 971 1457 2915 4373 8747 13121 26243 39365 78731
;; small program: loop2(2 + y, (x + x) + x, x, 1, 1)
;; fast program: loop(x + x, x mod 2, loop2(x * y, y, x div 2, 2, 1 + 2)) - 1
(set-logic UFNIA)
