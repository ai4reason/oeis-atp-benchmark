;; sequence(s): A6278
;; terms: 5 65 1105 32045 1185665 48612265 2576450045 157163452745 11472932050385 1021090952484265 99045822390973705 10003628061488344205 1090395458702229518345 123214686833351935572985
;; small program: loop((compr((1 - loop((x * y) div (y - (y div 2)), x, 1)) mod (1 + x), 1 + y) * x) + x, 1 + x, 1)
;; fast program: loop(loop(compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), (((1 + x) * (2 + x)) div 2) mod 2, x) - 2, 2 + x) + 1, 1, y) * x, 1 + x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g6 x) (mod (div (* (+ 1 x) (+ 2 x)) 2) 2))))
