;; sequence(s): A13928
;; terms: 0 1 2 3 3 4 5 6 6 6 7 8 8 9 10 11 11 12 12 13
;; small program: loop(loop(if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x) <= 0 then 1 else 0, 1, y - 1) + x, x, 0)
;; fast program: loop(loop(if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x - (x div 2), x) - x) <= 0 then 1 else 0, 1, y) + x, x - 1, if x <= 0 then 0 else 1)
(set-logic UFNIA)
