;; sequence(s): A134366
;; terms: 1 1 2 36 13824 207360000 193491763200000 16390160963076096000000 173238200573946282828103680000000 300679807141675805997423113304381849600000000
;; small program: loop2(loop(x * y, y, x), y, x - 1, 1, x)
;; fast program: loop2(x * y, y, (x - (x div 2)) - 1, 1, loop(x * y, x, 1)) * loop2(x * y, y, x div 2, 1, loop(x * y, x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (- (- x (div x 2)) 1))))
(assert (= i2 1))
