;; sequence(s): A1241
;; terms: 1 50 1660 46760 1217776 30480800 747497920 18139003520 437786795776 10536798272000 253246254177280 6082300519393280 146028165842661376 3505313580591718400 84135194495708938240 2019336829962040279040
;; small program: loop(loop(loop2(((2 * (y * y)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 2 + (2 + 2)), 1, y) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop(loop(((loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div 2) div (1 + 2)) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x)), x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
