;; sequence(s): A185346
;; terms: ~8 ~7 ~5 ~1 7 23 55 119 247 503 1015 2039 4087 8183 16375 32759 65527 131063 262135 524279
;; small program: (loop(x + x, x, 1) - 1) - (2 * (2 + 2))
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) - (2 * (2 + 2))
(set-logic UFNIA)
