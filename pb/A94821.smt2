;; sequence(s): A94821
;; terms: 1 4 15 54 190 660 2276 7816 26776 91600 313104 1069728 3653728 12477504 42606656 145479808 496722304 1695962368 5790470400 19770087936
;; small program: loop((x + loop2(2 * ((x - y) + x), x, y, 1, 0)) + x, x, 2) div 2
;; fast program: (loop2(2 * ((x - y) + x), x, x, 1 + 2, 1) - loop(x + x, x, 1)) div 2
(set-logic UFNIA)
