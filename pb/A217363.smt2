;; sequence(s): A217363
;; terms: 1 3 27 324 4455 66339 1041012 16953624 283848543 4855304025 84482290035 1490628232080 26607713942628 479621100042756 8718235759397880 159628084420459248 2941328850997439439 54501093415540789605 1014898739548854163185
;; small program: loop2(x * y, 1 + y, x - 1, loop((x + x) + x, x, 1), 2 + (x + x)) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
