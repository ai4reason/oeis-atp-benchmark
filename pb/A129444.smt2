;; sequence(s): A129444
;; terms: 0 1 2 7 16 65 154 639 1520 6321 15042 62567 148896 619345 1473914 6130879 14590240 60689441 144428482 600763527
;; small program: (loop2(((2 - (y mod 2)) * (x + y)) + x, x + y, x, 0, 1) + 1) div 2
;; fast program: (loop2(((2 - (y mod 2)) * (x + y)) + x, x + y, x - 1, if x <= 0 then 0 else 1, 1) + 1) div 2
(set-logic UFNIA)
