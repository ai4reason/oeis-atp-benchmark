;; sequence(s): A131326
;; terms: 1 3 4 9 13 24 37 63 100 165 265 432 697 1131 1828 2961 4789 7752 12541 20295
;; small program: loop(loop2(2 + (x + y), x, y, 1, 1) - x, x, 1)
;; fast program: loop2(x + y, x, x, 1 + 2, 0) - loop(0, x mod 2, 2)
(set-logic UFNIA)
