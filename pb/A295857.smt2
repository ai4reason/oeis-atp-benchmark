;; sequence(s): A295857
;; terms: 0 0 2 3 9 14 31 49 96 153 281 450 795 1277 2200 3541 5997 9666 16175 26097
;; small program: loop2(2 + (x + y), x, x, 1, 0) - loop2(2 + y, x + x, x, 1, 1)
;; fast program: loop2(x + y, x, x, 1 + 2, 2) - loop(x + x, x div 2, loop(1 + 2, x mod 2, 1) + 2)
(set-logic UFNIA)
