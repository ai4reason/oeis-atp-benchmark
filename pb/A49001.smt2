;; sequence(s): A49001
;; terms: 2 7 23 47 119 167 287 359 527 839 959 1367 1679 1847 2207 2807 3479 3719 4487 5039
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2, 1, x) - 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x) - 2
(set-logic UFNIA)
