;; sequence(s): A156664
;; terms: 1 2 6 16 42 108 274 688 1714 4244 10458 25672 62826 153372 373666 908896 2207842 5357348 12988074 31464568
;; small program: loop2((x + x) + y, x, x, 2, 0) - loop(x + x, x, 1)
;; fast program: loop2((x + x) + y, x, x, 2, 0) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
