;; sequence(s): A153785
;; terms: 0 5 35 90 170 275 405 560 740 945 1175 1430 1710 2015 2345 2700 3080 3485 3915 4370
;; small program: loop((x - 2) + y, (2 * (x + x)) + x, 0)
;; fast program: loop(((x - 2) * x) - x, 1, (2 * (x + x)) + x) div 2
(set-logic UFNIA)
