...
(assert (forall ((x Int)) (= (f10 x) (ite (<= (- 1 (mod x (+ 1 2))) 0) (div x (+ 1 2)) x))))
(assert (forall ((x Int)) (= (g10 x) (- x (div x 2)))))
...
(assert (forall ((x Int)) (= (f9 x) (mod (+ (v10 x) x) 2))))
(assert (= g9 1))
...
(assert (forall ((x Int)) (= (f8 x) (- (+ (mod (+ (v9 x) x) 2) x) 1))))
(assert (= g8 2))
...
(assert (forall ((x Int)) (= (f6 x) (mod (div (- (v7 x) x) 2) 2))))
(assert (= g6 1))
