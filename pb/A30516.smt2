;; sequence(s): A30516-A92758
;; terms: 64 729 15625 117649 1771561 4826809 24137569 47045881 148035889 594823321 887503681 2565726409 4750104241 6321363049 10779215329 22164361129 42180533641 51520374361 90458382169 128100283921
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2 + (2 + 2), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop((x * x) * x, 1, x * x), 0, 2, 1, x) div 2
(set-logic UFNIA)
