;; sequence(s): A242328
;; terms: 3 7 27 127 627 3127 15627 78127 390627 1953127 9765627 48828127 244140627 1220703127 6103515627 30517578127 152587890627 762939453127 3814697265627 19073486328127
;; small program: 2 + loop((2 * (x + x)) + x, x, 1)
;; fast program: 2 + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
