;; sequence(s): A160467
;; terms: 1 1 1 2 1 1 1 4 1 1 1 2 1 1 1 8 1 1 1 2
;; small program: (loop(loop(loop(y - 1, x, y), x, 0), x, x) div 2) + 1
;; fast program: ((loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 1) + x, x mod 2, x) - x) div 2) + 1
(set-logic UFNIA)
