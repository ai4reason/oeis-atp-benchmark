;; sequence(s): A99788
;; terms: 1 6 210 30030 9699690 6469693230 7420738134810 13082761331670030 32589158477190044730 117288381359406970983270 557940830126698960967415390 3217644767340672907899084554130 23768741896345550770650537601358310 232862364358497360900063316880507363070
;; small program: loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, x + x, 1)
;; fast program: loop(loop(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x - 1, if x <= 0 then 1 else 2), 1, x + x)
(set-logic UFNIA)
