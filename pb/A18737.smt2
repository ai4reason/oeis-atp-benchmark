;; sequence(s): A18737
;; terms: 1 2 11 22 43 86 473 946
;; small program: loop(compr((1 + loop((2 * (x * y)) + x, 2 + 2, 1)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((2 * (x * x)) - x, 1, 2 + loop((x * x) + x, 1, 2 + 2)) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
