;; sequence(s): A152548
;; terms: 1 4 10 24 54 120 260 560 1190 2520 5292 11088 23100 48048 99528 205920 424710 875160 1798940 3695120
;; small program: loop((loop((x * y) div (y - (y div 2)), y - 1, 2) + x) + x, x, 1)
;; fast program: loop(2 * ((x - (x div y)) + x), x - (x div 2), 1) * (loop(1, x mod 2, 1 + x) + x)
(set-logic UFNIA)
