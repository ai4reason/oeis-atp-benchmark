;; sequence(s): A107583
;; terms: 1 0 3 18 69 228 711 2166 6537 19656 59019 177114 531405 1594284 4782927 14348862 43046673 129140112 387420435 1162261410
;; small program: ((loop((x + x) + x, x, 1) - x) - x) - x
;; fast program: ((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - x) - x) - x
(set-logic UFNIA)
