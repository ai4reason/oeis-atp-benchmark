;; sequence(s): A107079
;; terms: 1 2 3 4 4 5 6 7 7 7 8 9 9 10 11 12 12 13 13 14
;; small program: loop(loop(if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x) <= 0 then 1 else 0, 1, y - 1) + x, x, 1)
;; fast program: loop(loop(if (loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x - (x div 2), x) - x) <= 0 then 1 else 0, 1, y) + x, x - 1, if x <= 0 then 1 else 2)
(set-logic UFNIA)
