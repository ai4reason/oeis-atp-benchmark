;; sequence(s): A337821
;; terms: 0 0 1 0 0 1 2 0 0 0 1 1 0 2 3 0 0 0 1 0
;; small program: loop2((y mod 2) + x, y div (2 - (x mod 2)), x, 0, 1 + x) div 2
;; fast program: loop2((y mod 2) + x, y div (2 - (x mod 2)), 2 * (2 + (2 + 2)), 0, 1 + x) div 2
(set-logic UFNIA)
