;; sequence(s): A250130
;; terms: 2 12 90 840 11550 180180 3573570 77597520 2007835830 64696932300 2206165391430 89048857617720 3955253425853730 183158658643380420 9223346738827371150 521426535635040715680 32686925952621614864190 2111190864469325477698860
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, x, 2) * (1 + x)
;; fast program: loop(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x, 2) * (1 + x)
(set-logic UFNIA)
