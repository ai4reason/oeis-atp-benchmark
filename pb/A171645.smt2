;; sequence(s): A171645
;; terms: 2 4 8 12 18 30 50 70 98 154 242 286 338 442 578 646 722 874 1058 1334
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), y div 2) + 1) * x, 1 + y, 2, 2, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), (1 + x) mod 2, x) - 2, y div 2) + 1) * x, 1 + y, 2, 2, x)
(set-logic UFNIA)
