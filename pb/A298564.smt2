;; sequence(s): A298564
;; terms: 0 1 10 53 218 789 2658 8581 26986 83477 255506 776709 2350554 7092565 21359554 64242437 193054922 579820053 1740770802 5224933765
;; small program: loop(loop2(((x + x) + x) + y, 2 + ((1 + y) * 2), y, 0, 1) + x, x, 0)
;; fast program: (loop(loop(((1 + 2) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - loop(2 * (2 + x), x, 1), 1, y) + x, x, 0) - x) - x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g1 x y) (+ 2 (* (+ 1 y) 2)))))
