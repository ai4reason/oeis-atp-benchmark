;; sequence(s): A256967
;; terms: 1 2 4 7 10 14 18 22 27 32 37 42 47 53 59 65 71 77 83 89
;; small program: loop(loop((y div loop2(x + y, x, x, 1, 1)) + x, y, 0) + x, x, 1)
;; fast program: loop(loop((y div loop2(x + y, x, x, 2, 1)) + x, y, 0) + x, x, 1) + x
(set-logic UFNIA)
