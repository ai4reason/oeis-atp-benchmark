;; sequence(s): A242124
;; terms: 2 3 5 7 11 13 17 19 23 3 5 11 15 17 21 1 7 9 15 19
;; small program: (compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), 1 + x) mod loop(1 + (x * x), 2, 2)) + 1
;; fast program: (compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), (1 + x) mod 2, x) - 1, 1 + x) + 1) mod loop(2 + x, ((2 + 2) + 2) * 2, 2)
(set-logic UFNIA)
