;; sequence(s): A138611
;; terms: 0 2 4 24 16 608 1600 1408 41216 116224 697344 2086912 12521472 41574400 249446400 959807488 3611361280 4488298496 61289529344 230298222592
;; small program: loop(2 * ((x + x) + x), x, 1) mod loop(x + x, x + x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 1), loop(x * x, 1, 2 + (2 + 2))) mod loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (w2 x) (v5 x)))))
