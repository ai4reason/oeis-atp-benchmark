;; sequence(s): A127233
;; terms: 1 1 12 4320 87091200 156920924160000 36785478363630796800000 1536637256843037856927580160000000 14998770936168817088309737749441675264000000000 43408511507665453002645192043544271642563569306828800000000000
;; small program: loop(x * y, loop(x + y, x, 0), 1) * loop(x * y, x, 1)
;; fast program: loop2((loop(loop2(x * y, y - 1, x, 1, ((x * x) + x) div 2), 1, y) * y) * x, 1 + y, x - 1, 1, 2)
(set-logic UFNIA)
...
(assert (= i5 1))
(assert (forall ((x Int)) (= (j5 x) (div (+ (* x x) x) 2))))
