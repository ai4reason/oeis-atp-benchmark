;; sequence(s): A6668
;; terms: 0 0 1 6 32 160 784 3808 18432 89088 430336 2078208 10035200 48455680 233967616 1129701376 5454692352 26337607680 127169265664 614027624448
;; small program: (loop2(y, (x + y) + y, x, 1, 1) div 2) * loop(x + x, x - 2, 1)
;; fast program: (loop2((x + x) + y, x, x - 1, 1, 1) div 2) * loop(x + x, x - 2, 1)
(set-logic UFNIA)
