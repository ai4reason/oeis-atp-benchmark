;; sequence(s): A34008
;; terms: 1 0 1 2 4 8 16 32 64 128 256 512 1024 2048 4096 8192 16384 32768 65536 131072
;; small program: loop2(y, y + y, x, 2, 1) div 2
;; fast program: loop(x div 2, x mod 2, loop(x * x, 1, loop(x + x, (x - 1) div 2, 1)))
(set-logic UFNIA)
