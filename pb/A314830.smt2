...
(assert (forall ((x Int)) (= (small x) (div (+ (+ (+ (+ (+ (+ (+ (+ (+ (mod (w0 x) 2) x) x) x) x) x) x) x) x) x) (ite (<= x 0) 1 2)))))
(assert (forall ((x Int)) (= (fast x) (+ (+ (div (+ (+ (- (+ (+ (+ (+ (div (+ (+ (* (+ (+ (div (+ (+ (+ (+ (+ (+ (div (+ (+ (* (div (+ 1 (+ x x)) (+ 1 2)) (+ 2 (+ 2 2))) 1) x) (ite (<= x 0) 1 2)) x) x) x) x) x) x) (ite (<= x 0) 1 2)) x) x) 2) 1) x) (+ 1 2)) x) x) x) x) (ite (<= x 0) 1 2)) x) x) (+ 1 2)) 1) x))))
