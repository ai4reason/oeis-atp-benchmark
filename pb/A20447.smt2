;; sequence(s): A20447
;; terms: 1 24 393 5480 70161 853944 10066393 116192520 1322205921 14898923864 166735197993 1856912289960 20608880226481 228161663489784 2521496249891193 27830232878409800 306882907287251841
;; small program: loop((loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop((loop((loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))) - loop((x * x) * x, 1, loop(x + x, x, 2))) div (1 + 2), 1, y) + (2 * (x + x))) + x, x, 1), 1, x)
(set-logic UFNIA)
