;; sequence(s): A36555
;; terms: 0 2 2 2 2 4 2 3 2 4 4 2 2 4 3 4 2 4 4 4
;; small program: (loop2(x - y, y div 2, x, x, (x div 2) + x) + x) + x
;; fast program: loop(loop2(x - y, y div 2, 2 + (2 + (2 + 2)), x, x div 2), 1, (x + x) + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j0 x) (+ (div x 2) x))))
