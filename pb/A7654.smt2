;; sequence(s): A7654
;; terms: 0 3 48 675 9408 131043 1825200 25421763 354079488 4931691075 68689595568 956722646883 13325427460800 185599261804323 2585064237799728 36005300067391875 501489136705686528 6984842613812219523 97286307456665386800 1355023461779503195683
;; small program: loop2((2 * (x + x)) - y, x, x + x, 1, 2) div 2
;; fast program: loop((1 + x) * (x - 1), 1, loop2((2 * (x + x)) - y, x, x - 1, if x <= 0 then 1 else 2, 1))
(set-logic UFNIA)
