;; sequence(s): A78033
;; terms: 1 ~1 ~1 ~1 3 3 ~1 ~9 ~5 11 23 ~1 ~45 ~45 47 135 43 ~229 ~313 143
;; small program: loop(loop2(y + y, y - x, y, 1, 0) - x, x, 1)
;; fast program: 1 + ((loop2((x - y) - y, x, x, 1, 1) div 2) - (x mod 2))
(set-logic UFNIA)
