...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (* (* (div (* 2 (- (* 2 (* x y)) x)) (+ 1 y)) 2) (* 2 y)))))
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* (div (* (v3 x y) x) y) 2))))
...
(assert (forall ((x Int)) (= (fast x) (div (* (v2 x) (w4 x)) (v5 x)))))
