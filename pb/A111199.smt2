;; sequence(s): A111199
;; terms: 1 2 5 7 8 11 13 16 20 22 23 25 26 32 35 37 41 43 46 47
;; small program: (compr(((loop((((2 * (y + y)) - 2) * x) div (1 + y), x, 1) mod (1 + (x + x))) - 2) mod (1 + x), 2 + x) div 2) - 2
;; fast program: (compr((loop(((if (loop(((loop((((2 * (y + y)) - 2) * x) div (1 + y), x, 1) mod (1 + (x + x))) - 2) mod (1 + x), (1 + x) mod 2, x) - 2) <= 0 then 1 else 0) mod (1 + x)) mod 2, 1, x + 2) + 1) mod 2, 1 + x) - 1) div 2
(set-logic UFNIA)
