;; sequence(s): A221454
;; terms: 0 1 2 7 24 88 328 1235 4668 17675 66974 253858 962352 3648397 13831870 52440191 198815196 753764564 2857736696 10834499599
;; small program: (loop2(y, (1 + 2) * (x + y), x, 0, 1) + loop2(x + y, x, x, 0, 1)) div 2
;; fast program: (loop2((1 + 2) * (x + y), x, x - 1, if x <= 0 then 0 else 1, 0) + loop2(x + y, x, x - 2, 1, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (* (+ 1 2) (+ x y)))))
