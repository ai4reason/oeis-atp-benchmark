;; sequence(s): A332158
;; terms: 8 585 55855 5558555 555585555 55555855555 5555558555555 555555585555555 55555555855555555 5555555558555555555 555555555585555555555 55555555555855555555555 5555555555558555555555555 555555555555585555555555555 55555555555555855555555555555 5555555555555558555555555555555
;; small program: ((((loop(2 + (2 * ((2 * (x + x)) + x)), x + x, 2) + loop(2 * ((2 * (x + x)) + x), x, 1)) * (1 + (2 + 2))) + 1) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) div 2
;; fast program: (((((loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2))) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) div (1 + (2 * (2 + 2)))) * (1 + (2 + 2))) + 1) + loop2(x * y, y, x, 1 + 2, 2 + (2 * (2 + 2)))) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (+ (+ (* (+ (v0 x) (v1 x)) (+ 1 (+ 2 2))) 1) (w2 x)) 2))))
...
(assert (forall ((x Int)) (= (fast x) (- (+ (+ (* (div (* (w3 x) (w4 x)) (+ 1 (* 2 (+ 2 2)))) (+ 1 (+ 2 2))) 1) (w5 x)) 1))))
