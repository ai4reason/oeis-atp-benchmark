;; sequence(s): A14143
;; terms: 1 4 12 34 98 294 919 2974 9891 33604 116103 406614 1440025 5147876 18550572 67310938 245716094 901759950 3325066996 12312494462
;; small program: loop(loop(loop((((1 + 2) * (x * y)) div (2 + y)) + x, y, 1) + x, y, x), x, 1) + x
;; fast program: loop(loop(loop((loop(2 * (((x div y) + x) + x), x, 2) div (1 + x)) div (2 + x), 1, y) + x, y, x), x, 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (div (div (v6 x) (+ 1 x)) (+ 2 x)))))
(assert (= g5 1))
