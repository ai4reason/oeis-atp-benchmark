;; sequence(s): A79102
;; terms: 1 2 4 4 16 8 64 16 256 32 1024 64 4096 128 16384 256 65536 512 262144 1024
;; small program: loop(loop2(y + y, x, y, x, 1), x, 1)
;; fast program: loop(x * x, 1 - (x mod 2), loop(x + x, (1 + x) div 2, 1))
(set-logic UFNIA)
