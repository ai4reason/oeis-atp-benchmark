;; sequence(s): A227169
;; terms: 1 6 45 392 3780 39204 429429 4907760 58023108 705264040 8772399636 111263122656 1434941066000 18775651948200 248797110637125 3333772874210400 45115597383228900 615974564891763000 8477309210264363700 117511846058893572000
;; small program: ((loop2((1 + y) * (x * y), 1 + y, x, 1, 2 + x) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + 2)) * (1 + x)
;; fast program: ((loop2(((y * y) + y) * x, 1 + y, x, 1, 2 + x) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + 2)) * (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (div (div (w0 x) (v1 x)) (w2 x)) (+ 1 x)))))
