;; sequence(s): A166808
;; terms: 4 19 54 124 250 460 790 1285 2000 3001 4366 6186 8566 11626 15502 20347 26332 33647 42502 53128
;; small program: loop((((2 * (x + x)) + x) div y) + x, 1 + x, 1) - 2
;; fast program: (loop((loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) div (2 * (2 + (2 + 2)))) * x, 1, 2 + x) div (2 + (2 * (2 + 2)))) - 2
(set-logic UFNIA)
