;; sequence(s): A19041
;; terms: 1 21 313 4125 51601 630741 7630633 91892685 1104403201 13261555461 159183299353 1910426955645 22926277062001 275121159824181 3301483361726473 39617948633641005 475416129363276001
;; small program: loop((loop2(loop((2 + y) * x, 2, x) + (y * y), y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
