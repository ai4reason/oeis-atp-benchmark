;; sequence(s): A191554
;; terms: 2 18 11250 64854011250 2980024297506569894680811250 1319492964487055911863581348741902326769016593763234907139211250
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * (x * x), y - 1, 1 + x, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x * x), y - 1, 1 + x, 1, x)
(set-logic UFNIA)
