;; sequence(s): A176776
;; terms: 1 3 4 5 8 17 40 93 208 449 944 1949 3976 8049 16216 32573 65312 130817 261856 523965
;; small program: ((2 - x) * x) + loop(x + x, x, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + ((2 - x) * x)
(set-logic UFNIA)
