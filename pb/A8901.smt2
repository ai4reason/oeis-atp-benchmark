;; sequence(s): A8901
;; terms: 90 45 134 67 200 100 50 25 74 37 110 55 164 82 41 122 61 182 91 272
;; small program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 2 * loop(((2 + x) * x) * x, 2, 1))
;; fast program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 2 * loop(((2 + x) * x) * x, 1, 1 + 2))
(set-logic UFNIA)
