;; sequence(s): A130243
;; terms: 1 2 4 7 10 13 17 21 25 29 34 39 44 49 54 59 64 70 76 82
;; small program: loop(loop(((1 + y) div loop2(x + y, x, x, 1, 2)) + x, y, 1) + x, x, 1)
;; fast program: loop(loop((y div loop2(x + y, x, x, 1 + 2, 1)) + x, 1 + y, 0) + x, x, 1) + x
(set-logic UFNIA)
