;; sequence(s): A99254
;; terms: 1 2 1 ~2 ~4 ~2 3 6 3 ~4 ~8 ~4 5 10 5 ~6 ~12 ~6 7 14
;; small program: loop(loop2(2 + y, y - x, y, 1, y) - x, x, 1)
;; fast program: loop2(y, y - x, x mod (2 + (2 + 2)), 1, 2) * (1 + (x div (1 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (w2 x) (+ 1 (div x (+ 1 2)))))))
