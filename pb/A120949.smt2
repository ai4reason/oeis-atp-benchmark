;; sequence(s): A120949
;; terms: 2 10 38 158 714 3378 16366 80326 397202 1972826 9824694 49005294 244672090 1222297474 6108298622 30531927062 152630937378 763068593322 3815084686150 19074648589630
;; small program: (loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 2, 2) + x) + x
;; fast program: ((x + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ x (w1 x)) (w3 x)) x))))
