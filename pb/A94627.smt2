;; sequence(s): A94627
;; terms: 1 3 14 34 144 344 1444 3444 14444 34444 144444 344444 1444444 3444444 14444444 34444444 144444444 344444444 1444444444 3444444444
;; small program: loop2(y, 2 * (2 + ((2 * (x + x)) + x)), x, 1, 1 + 2)
;; fast program: loop2(2 * (2 + (x * y)), y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 + 2))
(set-logic UFNIA)
