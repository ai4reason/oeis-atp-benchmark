;; sequence(s): A182467
;; terms: 36 90 198 414 846 1710 3438 6894 13806 27630 55278 110574 221166 442350 884718 1769454 3538926 7077870 14155758 28311534
;; small program: 2 * loop((x + x) + x, 2, loop(1 + (x + x), x, 2))
;; fast program: ((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1 + 2))) - 1) - 2) * (2 + (2 + 2))
(set-logic UFNIA)
