;; sequence(s): A138690
;; terms: 60 65 81 105 177 225 345 417 585 897 1017 1425 1737 1905 2265 2865 3537 3777 4545 5097
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + 1) * x, y, 2, 1, x) + loop((1 + x) * (2 + x), 2, 1)
;; fast program: (loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 1, x) + (2 * loop((x * x) * x, 1, 1 + 2))) + 2
(set-logic UFNIA)
