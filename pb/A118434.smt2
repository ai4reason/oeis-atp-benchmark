;; sequence(s): A118434
;; terms: 1 0 2 4 ~4 0 ~8 ~16 16 0 32 64 ~64 0 ~128 ~256 256 0 512 1024
;; small program: loop2(2 * (y - x), 0 - x, x, 1, x mod 2)
;; fast program: loop2(x + y, y - x, x, loop(0 - x, x mod 2, 1), 1)
(set-logic UFNIA)
