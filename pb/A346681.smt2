;; sequence(s): A346681
;; terms: 1 0 5 30 255 2275 21476 210404 2120041 21830314 228713056 2430255074 26128088701 283703487059 3106713300821 34270543858459 380471319687826 4247891403168599 47665096853113576 537244509843680309
;; small program: loop(loop(loop2((2 + y) * x, 1 + y, x - 1, 1, 2 * (x + x)) div loop(x * y, x, 1), 1, y) - x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + (2 * (x + x))) div loop(x * y, x, 1), 1, y) - x, x, 1)
(set-logic UFNIA)
