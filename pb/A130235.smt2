;; sequence(s): A130235
;; terms: 0 2 5 9 13 18 23 28 34 40 46 52 58 65 72 79 86 93 100 107
;; small program: loop(loop((y div loop2(x + y, x, x, 1, 0)) + x, y, 1) + x, x, 0)
;; fast program: loop(loop((y div loop2(x + y, x, x, 2, 1)) + x, y, 0) + x, x, x) + x
(set-logic UFNIA)
