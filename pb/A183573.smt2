;; sequence(s): A183573
;; terms: 2 4 5 7 8 9 10 12 13 14 15 17 18 19 20 21 22 24 25 26
;; small program: loop(2 + ((x + y) div (1 + x)), x + x, 2) + x
;; fast program: loop(loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x div 2) + x, 2, x) - x, 1, x - (x div 2)) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ 2 (div (+ x y) (+ 1 x))))))
