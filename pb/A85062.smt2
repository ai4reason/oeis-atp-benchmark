;; sequence(s): A85062
;; terms: 0 1 1 4 2 4 3 13 4 7 5 13 6 10 7 40 8 13 9 22
;; small program: loop(loop2(1 + y, x, x, x div 2, x), x, x) div 2
;; fast program: loop((loop(y - (x mod 2), x mod 2, x) div 2) + x, x mod (2 * (2 + 2)), 1 + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (- y (mod x 2)))))
