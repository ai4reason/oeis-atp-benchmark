;; sequence(s): A188662
;; terms: 1 9 225 7056 245025 9018009 344622096 13521038400 540917591841 21966328580625 902702926350225 37456461988358400 1566697064677290000 65973795093338597136 2794203818390077646400 118933541228935777741056 5084343623375056062840609
;; small program: loop2((x * y) * y, 1 + y, x, 1, 1 + (x + x)) div loop((x * y) * y, x, 1)
;; fast program: loop2(loop((loop2(x * y, 1 + y, x - 1, 1, 1 + (x + x)) div loop(x * y, x - 1, 1)) * (if x <= 0 then 1 else (1 + 2)), 1, y) * x, y, 2, 1, x)
(set-logic UFNIA)
