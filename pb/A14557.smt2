;; sequence(s): A14557-A49322
;; terms: 0 0 0 0 0 0 2 4 8 12 20 28 40 52 70 88 112 136 168 200
;; small program: 2 * loop(loop((y div 2) + x, (y - 2) div 2, x), x, 0)
;; fast program: (loop(loop(loop(x * x, 1, x div 2) - x, 1, y) + x, x, 1) + x) div 2
(set-logic UFNIA)
