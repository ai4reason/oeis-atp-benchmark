;; sequence(s): A187093
;; terms: 0 1 1 3 8 13 17 23 32 41 49 59 72 85 97 111 128 145 161 179
;; small program: ((x * x) + loop2(y, 0 - x, x, 1, 2)) div 2
;; fast program: (1 + loop(x - 2, (x mod (2 + 2)) - 1, x * x)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (+ (* x x) (w0 x)) 2))))
