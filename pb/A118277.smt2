;; sequence(s): A118277
;; terms: 0 1 6 9 19 24 39 46 66 75 100 111 141 154 189 204 244 261 306 325
;; small program: loop2(x + y, y - 1, x div 2, x, x + x)
;; fast program: ((loop(((1 + 2) * (x * x)) + x, 1, x div 2) + (x * x)) div 2) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (+ (v1 x) (* x x)) 2) x))))
