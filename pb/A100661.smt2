;; sequence(s): A100661
;; terms: 1 2 1 2 3 2 1 2 3 2 3 4 3 2 1 2 3 2 3 4
;; small program: ((2 * loop((y div loop2(x + y, y div 2, x, 0, x)) + x, x, 1)) - 1) - x
;; fast program: ((2 * loop((y div loop2(x + y, y div 2, 1 + (2 + 2), x, x div 2)) + x, x, 1)) - 1) - x
(set-logic UFNIA)
