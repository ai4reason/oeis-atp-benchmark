;; sequence(s): A159023
;; terms: 41 47 53 60 67 75 83 92 101 111 121 132 143 154 166 178 191 204 218 232
;; small program: loop((loop((y div (x * x)) + x, x, 1) - 1) + x, x, loop((x * x) + x, 2, 2) - 1)
;; fast program: loop((loop((y div (x * x)) + x, x, 1) - 1) + x, x, 1 + (2 * (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
