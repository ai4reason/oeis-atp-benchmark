;; sequence(s): A192474
;; terms: 3 4 8 17 40 98 247 632 1632 4237 11036 28802 75259 196796 514840 1347257 3526176 9230050 24161999 63252752
;; small program: loop2(loop2(x + y, x, y, 1, 0) + x, y + y, 2, 1, x)
;; fast program: loop2(x + y, x, x, 1, loop2(x + y, x, x, 1, 2)) + loop(0, x mod 2, 2)
(set-logic UFNIA)
