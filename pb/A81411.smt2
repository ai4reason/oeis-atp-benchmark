;; sequence(s): A81411
;; terms: 1 2 4 16 32 128 256 1024 6144 12288 73728 294912 589824 2359296 14155776 84934656 169869312 1019215872 4076863488 8153726976
;; small program: loop(loop(loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) - x, 1 + y, 2, 0, x), 1, y) * x, x, 1)
;; fast program: loop(loop(loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) - x, 1 + y, 2, 0, x), 1, y) * x, x, 1)
(set-logic UFNIA)
