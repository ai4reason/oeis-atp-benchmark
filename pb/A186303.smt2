;; sequence(s): A186303
;; terms: 4 12 16 24 36 40 52 64 76 84 96 100 112 120 132 136 156 180 184 192
;; small program: compr(((loop(x + x, x, x mod 2) - 1) mod (1 + (x + x))) mod (1 + x), 1 + x) + 1
;; fast program: compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) + x) mod (1 + (x + x)), x mod 2, x), 1 + x) + 1
(set-logic UFNIA)
