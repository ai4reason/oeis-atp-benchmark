;; sequence(s): A43329
;; terms: 2 5 6 7 11 14 15 16 18 19 21 22 29 32 33 34 38 41 42 43
;; small program: compr(loop2(((y * y) - y) + x, y div (1 + 2), x, 1, x) mod (1 + 2), x)
;; fast program: compr(loop2(((2 + y) * y) + x, y div (1 + 2), 1 + 2, 1, x) mod (1 + 2), x)
(set-logic UFNIA)
