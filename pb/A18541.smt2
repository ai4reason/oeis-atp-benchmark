;; sequence(s): A18541
;; terms: 1 2 3 4 5 6 8 10 12 15 20 24 25 30 40 50 60 75 100 120
;; small program: compr(loop(2 * (((x * x) * y) + x), 2, 2) mod (1 + x), x) + 1
;; fast program: compr(loop((x * x) + x, 1, 2 * (2 * (2 + (2 + 2)))) mod (1 + x), x) + 1
(set-logic UFNIA)
