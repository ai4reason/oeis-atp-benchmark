;; sequence(s): A23542
;; terms: 2 9 23 47 84 136 206 296 409 548 715 913 1145 1413 1720 2068 2460 2899 3387 3927
;; small program: loop(loop((loop(((y * y) div (2 + x)) + y, y, 0) + x) + y, y + 1, x), x, 2)
;; fast program: loop(loop((loop(((y * y) div (2 + x)) + y, y, 0) + x) + y, y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (div (* y y) (+ 2 x)) y))))
