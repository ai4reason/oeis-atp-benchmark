;; sequence(s): A302675
;; terms: 3 3 8 7 11 18 29 47 76 123 199 322 521 843 1364 2207 3571 5778 9349 15127
;; small program: loop2(x + y, x, loop(2 - (x + y), x, 2), 1, 1) * loop2(x + y, x, x, 1, 2)
;; fast program: loop2(x + y, x, (2 - (x mod 2)) - ((1 + x) div 2), 1, 1) * loop2(x + y, x, x, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h3 x) (- (- 2 (mod x 2)) (div (+ 1 x) 2)))))
(assert (= i3 1))
(assert (= j3 1))
