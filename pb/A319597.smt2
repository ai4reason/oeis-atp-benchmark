;; sequence(s): A319597
;; terms: 5 11 29 55 131 181 305 379 551 869 991 1405 1721 1891 2255 2861 3539 3781 4555 5111
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + (x * x), y, 2, 1, x)
