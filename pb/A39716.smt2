;; sequence(s): A39716
;; terms: 2 6 120 5040 39916800 6227020800 355687428096000 121645100408832000 25852016738884976640000 8841761993739701954543616000000 8222838654177922817725562880000000 13763753091226345046315979581580902400000000 33452526613163807108170062053440751665152000000000
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x * y, x, 1), 0, 2, 1, x) div 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x * y, x - 1, 1), y, 2, 0, x)
(set-logic UFNIA)
