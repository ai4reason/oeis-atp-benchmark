;; sequence(s): A37227
;; terms: 1 3 1 5 1 3 1 7 1 3 1 5 1 3 1 9 1 3 1 5
;; small program: loop2((y mod 2) + x, y div (2 - (x mod 2)), 1 + x, 1, x)
;; fast program: ((loop((loop2((y mod 2) + x, y div (2 - (x mod 2)), (2 * (2 + (2 + 2))) - 1, 1, x) div 2) + x, x mod 2, x) - x) * 2) + 1
(set-logic UFNIA)
