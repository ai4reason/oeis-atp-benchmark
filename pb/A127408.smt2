;; sequence(s): A127408
;; terms: 18 144 625 1980 5145 11648 23814 45000 79860 134640 217503 338884 511875 752640 1080860 1520208 2098854 2850000 3812445 5031180
;; small program: loop(loop(loop(x + y, y, x) + y, y, x), 1 + x, 0) * loop(x * x, 1, 1 + (2 + x))
;; fast program: (loop(loop((((2 + y) * y) + x) + y, y, x), 1 + x, 0) * loop(x * x, 1, 1 + (2 + x))) div 2
(set-logic UFNIA)
...
(assert (= g6 1))
(assert (forall ((x Int)) (= (h6 x) (+ 1 (+ 2 x)))))
(assert (forall ((x Int) (y Int)) (= (u6 x y) (ite (<= x 0) y (f6 (u6 (- x 1) y))))))
(assert (forall ((x Int)) (= (v6 x) (u6 g6 (h6 x)))))
(assert (forall ((x Int)) (= (fast x) (div (* (v4 x) (v6 x)) 2))))
