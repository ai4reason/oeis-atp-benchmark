;; sequence(s): A70350
;; terms: 1 2 4 8 16 32 19 38 31 17 34 23 1 2 4 8 16 32 19 38
;; small program: loop(x + x, x, 1) mod loop((2 + (2 + x)) * x, 2, 1)
;; fast program: loop(x + x, x mod (2 * (2 + (2 + 2))), 1) mod loop(((2 + x) * x) * x, 1, 1 + 2)
(set-logic UFNIA)
