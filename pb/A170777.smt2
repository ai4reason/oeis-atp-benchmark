;; sequence(s): A170777
;; terms: 0 1 4224 800442 33587200 610546875 6531186816 48447387604 274886295552 1270954437525 5000050000000 17261463251406 53496817680384 151437961161487 396858124521600 973098815625000 2251801961168896
;; small program: ((loop(x + y, loop(x * x, 2, x) * x, 0) * x) * x) * x
;; fast program: (loop2((x + y) * x, x, 1, loop((x * x) * x, 1, x * x), x) div 2) * x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (w2 x) 2) x))))
