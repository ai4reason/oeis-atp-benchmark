;; sequence(s): A168607
;; terms: 3 5 11 29 83 245 731 2189 6563 19685 59051 177149 531443 1594325 4782971 14348909 43046723 129140165 387420491 1162261469
;; small program: 2 + loop((x + x) + x, x, 1)
;; fast program: 2 + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
