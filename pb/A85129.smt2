;; sequence(s): A85129
;; terms: 6 12 18 24 30 36 42 48 54 60 72 84 90 96 108 120 126 144 150 162
;; small program: ((compr(loop((1 + (2 + y)) * (x * x), 1 + (2 + 2), x) mod (1 + x), x) * 2) + 2) * (1 + 2)
;; fast program: ((compr(loop((1 + (y + y)) * ((x * x) * x), 2 + 2, 2) mod (1 + x), x) * 2) + 2) * (1 + 2)
(set-logic UFNIA)
