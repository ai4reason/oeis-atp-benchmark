;; sequence(s): A113849
;; terms: 16 81 625 1296 2401 10000 14641 28561 38416 50625 83521 130321 194481 234256 279841 456976 707281 810000 923521 1185921
;; small program: loop2((compr(loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x, 1 + y) * x) + x, y, 2 + 2, 1, x)
;; fast program: loop2((compr(loop((if ((y * y) mod (1 + x)) <= 0 then 1 else 0) + x, x, x) - x, 1 + y) + 1) * ((x * x) * x), y, 2, 1, x)
(set-logic UFNIA)
