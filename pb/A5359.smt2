;; sequence(s): A5359
;; terms: 1 0 2 0 24 0 720 0 40320 0 3628800 0 479001600 0 87178291200 0 20922789888000 0 6402373705728000 0
;; small program: loop(x * y, x, 1 - (x mod 2))
;; fast program: loop2(loop(x * y, y, 1), y, 1 - (x mod 2), 0, x)
(set-logic UFNIA)
