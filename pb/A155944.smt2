;; sequence(s): A155944
;; terms: 0 2 1 4 5 12 21 44 85 172 341 684 1365 2732 5461 10924 21845 43692 87381 174764
;; small program: loop2(1 + (y - x), y + y, x, 0, 1)
;; fast program: loop(2 * (2 + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)
(set-logic UFNIA)
