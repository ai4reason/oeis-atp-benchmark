;; sequence(s): A112033
;; terms: 12 3 24 6 48 12 96 24 192 48 384 96 768 192 1536 384 3072 768 6144 1536
;; small program: (1 + 2) * loop2(y, x + x, x, 2 + 2, 1)
;; fast program: (1 + 2) * loop(x + x, x div 2, loop(1, x mod 2, 2 + 2))
(set-logic UFNIA)
