;; sequence(s): A156287
;; terms: 2 3 4 6 7 9 12 13 16 18 19 21 22 27 28 33 34 36 39 42
;; small program: (compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x) div 2) + 2
;; fast program: (compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) div 2) + 2
(set-logic UFNIA)
