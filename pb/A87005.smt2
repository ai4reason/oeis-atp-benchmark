;; sequence(s): A87005
;; terms: 1 2 3 5 6 7 10 11 14 15 21 22 30 33 35 42 55 66 70 77
;; small program: loop(compr((loop(2 * (2 * (2 + (x * x))), 2, 2) - 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 * loop((2 + x) * x, 1, 1 + (2 * (2 * (2 * (2 + 2)))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
