;; sequence(s): A140346
;; terms: 1 45 1125 20625 309375 4021875 46921875 502734375 5027343750 47480468750 427324218750 3690527343750 30754394531250 248400878906250 1951721191406250 14963195800781250 112223968505859375
;; small program: loop(loop2(((2 * (2 * (x + x))) div y) + x, 2, 2, x, y), x, 1)
;; fast program: (loop2(x * y, 1 + y, x, 1, 1 + (2 * (2 + 2))) div loop(x * y, x, 1)) * loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
