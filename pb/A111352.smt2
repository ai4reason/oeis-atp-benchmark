;; sequence(s): A111352
;; terms: 1 ~1 2 0 5 7 22 48 121 287 698 1680 4061 9799 23662 57120 137905 332927 803762 1940448
;; small program: loop(loop2(y, (x + y) + y, y, 1, 0) - x, x, 1)
;; fast program: (((((loop2((x + x) + y, x, x - 2, if x <= 0 then 0 else 1, 1) + 1) div 2) - (x mod 2)) + 1) - (x mod 2)) - (x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (+ (- (div (+ (w2 x) 1) 2) (mod x 2)) 1) (mod x 2)) (mod x 2)))))
