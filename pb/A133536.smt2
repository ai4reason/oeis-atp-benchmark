;; sequence(s): A133536
;; terms: 275 3368 19932 177858 532344 1791150 3895956 8912442 26947492 49140300 97973108 185200158 262864644 376353450 647540500 1133119792 1559520600 2194721408 3154354458 3877300944
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 1 + (2 + 2), 1, x), 1, y) + x, 1 + y, 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (((x * x) * x) * x), y, 2, 1, x), 1, y) + x, 1 + y, 2, 0, x)
(set-logic UFNIA)
