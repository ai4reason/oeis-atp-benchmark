;; sequence(s): A17917
;; terms: 1 19 258 3110 35651 399609 4433668 48962380 539552901 5939935199 65363612678 719121544050 7910946538951 87023461294789 957273325857288 10530082856852120 115831292830529801 1274146128290750379
;; small program: loop(((loop((loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop(((loop(((loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))) - loop2(x * y, y, x, 1 + (2 + 2), 1 + (2 + 2))) div 2) div (1 + 2), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (div (div (- (w6 x) (w7 x)) 2) (+ 1 2)))))
(assert (= g5 1))
