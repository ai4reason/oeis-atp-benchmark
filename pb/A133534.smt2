;; sequence(s): A133534
;; terms: 35 152 468 1674 3528 7110 11772 19026 36556 54180 80444 119574 148428 183330 252700 354256 432360 527744 658674 746928
;; small program: loop2(loop(loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + 2, 1, x), 1, y) + x, 1 + y, 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x * x), y, 2, 1, x), 1, y) + x, 1 + y, 2, 0, x)
(set-logic UFNIA)
