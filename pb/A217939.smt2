;; sequence(s): A217939
;; terms: 5 420 28560 1855040
;; small program: loop2(loop2((((y * y) * y) + x) + x, y + y, y, 1, 2) * x, 1 + y, 2, 1, x) div 2
;; fast program: loop2(loop(1 + (2 * (x + x)), y, 1) * x, 1 + y, 2, 1, x) * loop2(x * y, y, x, 1, 2 + 2)
(set-logic UFNIA)
