;; sequence(s): A230300
;; terms: 1 3 4 6 6 8 9 11 10 12 13 15 15 17 18 20 18 20 21 23
;; small program: 1 + loop2(2 + (x - y), y div 2, x, x, x)
;; fast program: 1 + (loop2(x - y, y div 2, 2 + (2 + 2), x, x div 2) + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ 1 (+ (w1 x) x)))))
