;; sequence(s): A1764
;; terms: 1 1 3 12 55 273 1428 7752 43263 246675 1430715 8414640 50067108 300830572 1822766520 11124755664 68328754959 422030545335 2619631042665 16332922290300
;; small program: loop2((2 + y) * x, 1 + y, x - 1, 1, x + x) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x - 1, 1)) div (if x <= 0 then 1 else x)
(set-logic UFNIA)
