;; sequence(s): A175747
;; terms: 786432 1310720 1835008 2883584 3407872 4456448 4980736 6029312 7602176 8126464 9699328 10747904 11272192 12320768 13893632 15466496 15990784 17563648 18612224 19136512
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) + 1) * loop((x * x) * x, 2, 2 + 2)
;; fast program: (((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 2 + x) * 2) + 2) * loop(x * x, 1 + 2, 2 + 2)) * 2
(set-logic UFNIA)
...
(assert (= v6 (u6 g6 h6)))
(assert (forall ((x Int)) (= (fast x) (* (* (+ (* (v3 x) 2) 2) v6) 2))))
