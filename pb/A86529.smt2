;; sequence(s): A86529
;; terms: 2 4 6 8 14 12 22 16 30 28 34 40 42 44 50 56 62 60 74 68
;; small program: loop(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) * 2) - x, x, 1) + 1
;; fast program: loop(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) - x) + 1, x, 1) * 2
(set-logic UFNIA)
