;; sequence(s): A272123
;; terms: 0 1 5 26 123 555 2440 10569 45381 193834 825275 3506867 14883984 63124593 267596485 1134071130 4805348667 20359308187 86252640920 365396207993
;; small program: loop2(y - x, x, x + x, 0, 1) + loop2(x + y, x, (x + x) + x, 0, 1)
;; fast program: loop2(((x - y) + x) + x, x, x, 0, 1) mod loop2((2 * (x + x)) + y, x, x - 1, 2, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (w2 x) (w3 x)))))
