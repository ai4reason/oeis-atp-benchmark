;; sequence(s): A81251
;; terms: 2 6 20 60 182 546 1640 4920 14762 44286 132860 398580 1195742 3587226 10761680 32285040 96855122 290565366 871696100 2615088300
;; small program: (loop((x + x) + x, 2 + x, 1) div 2) div 2
;; fast program: loop(((x div (2 + 2)) + x) + x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
