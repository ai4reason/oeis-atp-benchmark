;; sequence(s): A21684
;; terms: 1 23 360 4810 59111 690573 7801990 86089520 933531621 9989073523 105774639620 1110701801430 11583617458531 120125571974873 1239860303429250 12746044308940540 130587414625807841
;; small program: loop(((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((((y div 2) + y) * y) + x, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
