;; sequence(s): A231444
;; terms: 2 6 23 102 492 2485 12858 67354 355003 1876862 9937840 52659593 279141170 1479959118 7847200511 41610135894 220644482580 1170015798397 6204298839786 32899919832226
;; small program: loop(loop((loop2(((x + y) + y) + y, x, x, 1, 0) + loop2(x + y, x, x, 1, 0)) div 2, 1, y) + x, x + x, 2)
;; fast program: loop(loop((loop2(((x + y) + y) + y, x, x - 1, 1, 1) + loop2(x + y, x, x - 1, 1, 1)) div 2, 1, y) + x, x + x, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (div (+ (w2 x) (w3 x)) 2))))
(assert (= g1 1))
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (+ (+ x y) y) y))))
...
(assert (forall ((x Int)) (= (f5 x) (div (+ (w6 x) (w7 x)) 2))))
(assert (= g5 1))
