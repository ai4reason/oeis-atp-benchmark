;; sequence(s): A74541
;; terms: 3 15 89 567 3713 24615 164369 1103607 7444673 50431815 342942449 2340125847 16018073633 109949712615 756587253329 5217746527287 36054040542593 249557173563015 1729973554841009 12008254925907927
;; small program: loop((2 * ((x + x) + x)) + x, x, 1) + loop(x + x, x, 1 + loop((x + x) + x, x, 1))
