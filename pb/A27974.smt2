;; sequence(s): A27974-A27983
;; terms: 1 5 14 35 81 180 389 825 1726 3575 7349 15020 30561 61965 125294 252795 509161 1024100 2057549 4130225
;; small program: loop((x + x) + loop2(x + y, x, y, 1, 2), x, 1)
;; fast program: (2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2)))) - loop2(x + y, x, x, 1 + (2 + (2 + 2)), 2 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* 2 (v2 x)) (w5 x)))))
