;; sequence(s): A274332
;; terms: 1 2 3 5 6 8 9 11 14 15 18 20 21 23 26 29 30 33
;; small program: (compr((1 + loop(x + x, x, x)) mod (2 + x), x) div 2) + 1
;; fast program: compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, (x div 2) - 1, 2)))) mod (1 + (x + x))) - 2, 1 + x)
(set-logic UFNIA)
