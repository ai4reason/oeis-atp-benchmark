;; sequence(s): A249993
;; terms: 1 1 11 29 147 525 2227 8653 35123 139469 559923 2235597 8950579 35785933 143176499 572640461 2290692915 9162509517 36650562355 146601200845
;; small program: loop((loop2((y * y) - x, y + y, y, 1, 2) - x) - x, x, 1)
;; fast program: loop(loop(loop(((1 + x) div (1 + 2)) * x, 1, loop(x + x, x, 2)) div 2, 1, y) - x, x, 1)
(set-logic UFNIA)
