;; sequence(s): A2145
;; terms: 3 7 11 19 23 31 43 47 59 67 71 79 83 103 107 127 131 139 151 163
;; small program: compr(loop((1 + loop(x + x, x, x)) mod (1 + x), (x div 2) mod 2, x), 1 + x) + 1
;; fast program: (compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) * 2) + 1
(set-logic UFNIA)
