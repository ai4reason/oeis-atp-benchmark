;; sequence(s): A75510
;; terms: 1 30 560 8400 111216 1360800 15790720 176563200 1922176256 20518417920 215825326080 2244998246400 23153670762496 237224718704640 2418102840688640 24549985173504000 248464183682727936
;; small program: loop(((loop((loop2(((2 * (y * y)) - y) + x, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1) * loop(x + x, x, 1)
;; fast program: loop((loop(((loop((loop((x * x) + x, 1, loop(2 + (x + x), x, 2)) div 2) div (1 + 2), 1, y) + x) + x) + x, y, 1) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
