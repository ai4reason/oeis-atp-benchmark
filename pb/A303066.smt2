;; sequence(s): A303066
;; terms: 0 1 5 60 1560 84240
;; small program: loop2(x * y, ((2 - (x mod 2)) + y) + y, x, 1, 2) div 2
;; fast program: loop2(x * y, (2 + y) + y, x - 1, if x <= 0 then 0 else 1, 1 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (+ (+ (- 2 (mod x 2)) y) y))))
