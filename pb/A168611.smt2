;; sequence(s): A168611
;; terms: ~3 ~1 5 23 77 239 725 2183 6557 19679 59045 177143 531437 1594319 4782965 14348903 43046717 129140159 387420485 1162261463
;; small program: (loop((x + x) + x, x, 1) - 2) - 2
;; fast program: (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - 2) - 2
(set-logic UFNIA)
