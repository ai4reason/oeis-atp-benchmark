;; sequence(s): A203925
;; terms: 1 1 5 665 282412759265 1797010299914431210411850601513820123858571820477570761825
;; small program: loop(((loop(x + x, y - 1, 1) + x) + x) + x, loop(x * y, x, 1), 0)
;; fast program: loop(loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x, 1), 1, loop(x * y, x, 1))
(set-logic UFNIA)
