;; sequence(s): A32169
;; terms: 1 6 26 91 273 728 1768 3978 8398 16796 32065 58786 104006 178296 297160 482885 766935 1193010 1820910 2731365
;; small program: loop(((loop((2 + y) * x, 2, x) - x) div y) + x, x, 1) div (1 + x)
;; fast program: loop(((2 * ((2 * (x + x)) + x)) div y) + x, 1 + x, 1) div (1 + (2 + (2 * (2 + 2))))
(set-logic UFNIA)
