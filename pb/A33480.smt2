;; sequence(s): A33480
;; terms: 15 46 23 70 35 106 53 160 80 40 20 10 5 16 8 4 2 1 4 2
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(x * x, 2, 2) - 1)
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, (2 * (2 * (2 + 2))) - 1)
(set-logic UFNIA)
