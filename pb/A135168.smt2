;; sequence(s): A135168
;; terms: 4 17 87 503 3123 20207 134067 903983 6162243 42326927 292300947 2026334063 14085963363 98111316047 684331387827 4778093469743 33385561572483 233393582711567 1632228682858707 11417969834487023
;; small program: (loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 2, 2) + loop((2 * ((x + x) + x)) + x, x, 1)) + loop(x + x, x, 1)
