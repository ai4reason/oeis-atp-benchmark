;; sequence(s): A28166
;; terms: 1 27 460 6330 76951 863457 9169210 93598560 928041301 9002652087 85889800360 809002365990 7544820424051 69822238375917 642271794705910 5880216219628620 53636500167577201 487828126104034947
;; small program: loop((loop((loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop(loop((((loop2(x * y, y, x, 1, 1 + (2 + 2)) + loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) div 2) - loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) div 2, 1, 2 + x) div 2, 1, y) + (2 * ((x + x) + x)), x, 1)
(set-logic UFNIA)
