;; sequence(s): A208901
;; terms: 0 0 4 8 24 48 112 224 480 960 1984 3968 8064 16128 32512 65024 130560 261120 523264 1046528
;; small program: loop(x + x, x, 2) - loop2(y + y, x, x, 2, 2)
;; fast program: 2 * loop(x + x, x mod 2, loop((x * x) - x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
