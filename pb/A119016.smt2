;; sequence(s): A119016
;; terms: 1 0 1 2 3 4 7 10 17 24 41 58 99 140 239 338 577 816 1393 1970
;; small program: loop2((x + y) + y, x + y, x div 2, 1 - (x mod 2), x mod 2)
;; fast program: loop2(y, (x + y) + y, x div 2, 1 - (x mod 2), 1 + (x mod 2))
(set-logic UFNIA)
