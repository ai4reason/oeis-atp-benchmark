...
(assert (forall ((x Int)) (= (f0 x) (mod (div (- (v1 x) x) 2) (+ 1 x)))))
(assert (forall ((x Int)) (= (g0 x) (+ 1 x))))
(assert (forall ((x Int)) (= (t0 x) (ite (<= (f0 x) 0) x (t0 (+ x 1))))))
(assert (forall ((x Int)) (= (u0 x) (ite (<= x 0) (t0 0) (t0 (+ (u0 (- x 1)) 1))))))
(assert (forall ((x Int)) (= (v0 x) (u0 (g0 x)))))
(assert (forall ((x Int)) (= (small x) (+ (div (- (v0 x) (div x 2)) (+ 1 x)) 1))))
...
(assert (forall ((x Int)) (= (fast x) (div (+ (+ (* (+ (+ (* (v2 x) 2) 1) (ite (<= x 0) 1 0)) 2) 1) x) (* 2 (+ 1 x))))))
