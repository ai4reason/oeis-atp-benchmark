;; sequence(s): A293579
;; terms: 3 16 66 248 892 3136 10888 37536 128880 441472 1510176 5161856 17635264 60233728 205697152 702386688 2398283520 8188622848 27958448640 95457597440
;; small program: loop((loop2(2 * ((x - y) + x), x, y, 2, 1) + x) + x, 1 + x, 0) div 2
;; fast program: loop(loop2(2 * ((x - y) + x), x, x - 1, (if x <= 0 then 0 else 2) + 2, 1) - loop(x + x, x, 2), 1, 2 + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i3 x) (+ (ite (<= x 0) 0 2) 2))))
(assert (= j3 1))
