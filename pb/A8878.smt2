;; sequence(s): A8878
;; terms: 39 118 59 178 89 268 134 67 202 101 304 152 76 38 19 58 29 88 44 22
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, 1 + loop(2 + (x * x), 2, 2))
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, (2 * (2 * (2 + (2 * (2 + 2))))) - 1)
(set-logic UFNIA)
