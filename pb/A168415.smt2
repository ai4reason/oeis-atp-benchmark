;; sequence(s): A168415
;; terms: 8 9 11 15 23 39 71 135 263 519 1031 2055 4103 8199 16391 32775 65543 131079 262151 524295
;; small program: loop(2 + (x + y), 2, loop(x + x, x, 1))
;; fast program: 1 + (2 + (2 + (2 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))))))
(set-logic UFNIA)
