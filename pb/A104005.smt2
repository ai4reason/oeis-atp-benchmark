;; sequence(s): A104005
;; terms: 1 ~1 3 ~2 9 ~3 28 1 91 38 309 241 1092 1197 3991 5398 14977 23189 57324 96937
;; small program: loop((x + loop2(y - x, x, 2 + y, 1, 0)) + x, x, 1)
;; fast program: loop((loop2(x + y, x, y, 2, 1) - x) - x, x, 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
