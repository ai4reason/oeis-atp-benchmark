;; sequence(s): A138617
;; terms: 0 1 4 19 52 40 280 1231 4243 3457 43882 11929 437797 407374 2851618 10395388 1023181 7162267 50135869 738371572
;; small program: loop((2 * ((x + x) + x)) + x, x, 1) mod loop((x + x) + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) mod loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
