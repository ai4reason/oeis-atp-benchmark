;; sequence(s): A127234
;; terms: 1 2 36 17280 435456000 941525544960000 257498348545415577600000 12293098054744302855420641280000000 134988938425519353794787639744975077376000000000 434085115076654530026451920435442716425635693068288000000000000
;; small program: loop((x * y) + x, x, 1) * loop(x * y, loop(x + y, x, 0), 1)
;; fast program: loop(loop(loop2(x * y, y - 1, x, 1 + x, ((x * x) + x) div 2), 1, y) * x, x, 1)
(set-logic UFNIA)
