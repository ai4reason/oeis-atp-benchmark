;; sequence(s): A93121
;; terms: 1 0 4 6 30 80 286 882 2924 9350 30438 98208 318278 1029210 3331820 10780014 34888062 112894960 365344142 1182264930
;; small program: loop(2 - (x + x), x, 1) * loop2(y - x, x, x, 1, 0)
;; fast program: ((2 + loop((x - 2) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) div (1 + 2)) * loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (+ 2 (v2 x)) (+ 1 2)) (w5 x)))))
