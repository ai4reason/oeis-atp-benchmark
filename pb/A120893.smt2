;; sequence(s): A120893
;; terms: 1 1 5 17 65 241 901 3361 12545 46817 174725 652081 2433601 9082321 33895685 126500417 472105985 1761923521 6575588101 24540428881
;; small program: loop(loop2(y, (2 * (y + y)) - x, y, 2, 2) - x, x, 1)
;; fast program: (2 * (loop2((2 * (x + x)) - y, x, x - 1, 2, 1) div (1 + 2))) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* 2 (div (w2 x) (+ 1 2))) 1))))
