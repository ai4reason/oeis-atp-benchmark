;; sequence(s): A94979
;; terms: 1 1 1 1 2 3 3 4 5 7 9 11 14 18 22 28 35 44 55 69
;; small program: loop((x div 2) div 2, x, loop((2 * (x + x)) + x, x, 1))
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) div loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
