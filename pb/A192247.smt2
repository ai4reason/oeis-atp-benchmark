;; sequence(s): A192247
;; terms: 0 4 14 54 159 439 1111 2671 6136 13616 29346 61742 127262 257742 514102 1011862 1968265 3788845 7225565 13664305
;; small program: loop(loop(loop(loop(x + y, 1 + y, x), x, 1) * loop2(x + y, x, x, 0, 1), 1, y) + x, x, 0)
;; fast program: loop(loop(((loop((x * x) * x, 1, 2 + x) - x) div (2 + (2 + 2))) * loop2(x + y, x, x - 2, 1, 1), 1, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f6 x) (* (div (- (v7 x) x) (+ 2 (+ 2 2))) (w8 x)))))
(assert (= g6 1))
