;; sequence(s): A168198-A177898
;; terms: 1 6 4 9 7 12 10 15 13 18 16 21 19 24 22 27 25 30 28 33
;; small program: 1 + loop2(1 + (2 + y), x, x, 0, 2)
;; fast program: 1 + (loop(2 + (2 + x), x mod 2, x div 2) + x)
(set-logic UFNIA)
