;; sequence(s): A192356
;; terms: 0 1 1 15 29 211 561 3095 9829 46971 164921 728575 2707629 11450531 43942081 181348455 708653429 2884834891 11388676041 46006694735
;; small program: ((loop(x * x, 1, loop(x + x, x - 1, 2)) - loop((1 + 2) * (0 - x), x, 1)) div (1 + 2)) div 2
;; fast program: ((loop(x * x, 1, loop(x + x, x, 1)) - loop2(x * y, y, x, 1, 0 - (1 + 2))) div 2) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (* (+ 1 2) (- 0 x)))))
(assert (forall ((x Int)) (= (g2 x) x)))
(assert (= h2 1))
(assert (forall ((x Int) (y Int)) (= (u2 x y) (ite (<= x 0) y (f2 (u2 (- x 1) y))))))
(assert (forall ((x Int)) (= (v2 x) (u2 (g2 x) h2))))
(assert (forall ((x Int)) (= (small x) (div (div (- (v0 x) (v2 x)) (+ 1 2)) 2))))
...
(assert (forall ((x Int)) (= (fast x) (div (div (- (v3 x) (w5 x)) 2) (+ 1 2)))))
