;; sequence(s): A302773
;; terms: 1 5 2 11 7 17 5 23 13 29 8 35 19 41 11 47 25 53 14 59
;; small program: loop(x div (2 - (x mod 2)), 2, 2 + ((x + x) + x))
;; fast program: 1 + loop(loop(x div 2, x mod 2, x), 2, 1 + ((x + x) + x))
(set-logic UFNIA)
