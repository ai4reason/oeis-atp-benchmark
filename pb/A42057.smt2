;; sequence(s): A42057
;; terms: 1 2 93 188 8741 17670 821561 1660792 77217993 156096778 7257669781 14671436340 682143741421 1378958919182 64114254023793 129607466966768 6026057734495121 12181722935957010 566385312788517581 1144952348512992172
;; small program: loop2((loop(loop(x * y, 2 + 2, x) - x, y mod 2, 2) * x) + y, x, x, 1, 0)
...
(assert (forall ((x Int)) (= (f4 x) (- (* 2 (* 2 (* 2 (+ (+ x x) x)))) x))))
