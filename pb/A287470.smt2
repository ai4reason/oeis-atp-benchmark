;; sequence(s): A287470
;; terms: 1 0 6 0 28 0 120 0 496 0 2016 0 8128 0 32640 0 130816 0 523776 0
;; small program: loop((x - 1) + y, loop2(y + y, x, x, 2, 0), 0)
;; fast program: loop(loop(loop((2 * (x * x)) - x, 1, loop(x + x, x div 2, 1)) + x, 1 - (x mod 2), x) - x, 1, x)
(set-logic UFNIA)
