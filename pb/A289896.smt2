;; sequence(s): A289896
;; terms: 0 0 1 8 45 242 1414 9432 72246 628260 6116319 65856928 776628203 9950798214 137612550620 2042588039056 32384583304092 546155914771464 9761655297881037 184309987662192600
;; small program: loop(loop(loop(loop(x + y, y, x) + (x * y), y - 1, 0) + x, y, x), x, 0)
;; fast program: (loop(loop(loop((loop(1 + (x * y), y, 1) - y) + x, x, 1) - x, 1, y) + x, x, 1) - x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (- (v7 x y) y) x))))
...
(assert (forall ((x Int)) (= (fast x) (div (- (v4 x) x) 2))))
