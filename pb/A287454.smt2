;; sequence(s): A287454
;; terms: 3 4 8 11 15 16 19 23 27 28 32 36 39 40 44 47 51 52 56 60
;; small program: loop(compr(loop2(y - x, y div (1 + 2), x, 2, x) mod (1 + 2), y), x, 2) + 1
;; fast program: ((((loop2(y - x, y div (1 + 2), 1 + (2 + 2), 1, x) mod (1 + 2)) + 1) + x) + x) + x
(set-logic UFNIA)
