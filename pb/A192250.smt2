;; sequence(s): A192250
;; terms: 1 1 7 27 167 923 5543 32999 200309 1221329 7503033 46301793 286971677 1784658077 11131825877 69611130917 436270168817 2739539507957 17232530582057 108564692241257
;; small program: loop(loop(loop(2 * ((x - (x div y)) + x), x, 1) * loop2(y, x + y, x, 1, 0), 1, y) + x, x, 1)
;; fast program: loop(loop(loop(2 * ((x - (x div y)) + x), x, loop2(x + y, x, x - 1, 0, 1)), 1, y) + x, x, 1)
(set-logic UFNIA)
