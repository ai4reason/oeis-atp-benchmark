;; sequence(s): A85126
;; terms: 3 6 9 12 15 18 21 24 27 30 36 42 45 48 54 60 63 72 75 81
;; small program: (compr(loop((1 + (2 + y)) * (x * x), 1 + (2 + 2), x) mod (1 + x), x) + 1) * (1 + 2)
;; fast program: (compr(loop((1 + (y + y)) * ((x * x) * x), 2 + 2, 2) mod (1 + x), x) + 1) * (1 + 2)
(set-logic UFNIA)
