;; sequence(s): A263458
;; terms: 4 6 12 22 28 30 36 46 52 60 70 78 100 102 108 126 148 150 156 166
;; small program: compr((1 + loop(0 - (x + x), x div 2, 1)) mod (1 + x), 2 + x)
;; fast program: compr(((1 + loop(x * x, 1, loop(x + x, x div 2, 1))) mod (1 + (x + x))) mod (2 + x), 1 + x) * 2
(set-logic UFNIA)
