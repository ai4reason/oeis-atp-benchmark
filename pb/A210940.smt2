...
(assert (forall ((x Int)) (= (f2 x) (mod (+ (mod (v3 x) (+ 1 x)) 1) 2))))
(assert (= g2 1))
...
(assert (forall ((x Int)) (= (f0 x) (- (mod (- (v1 x) 1) (w4 x)) 2))))
