;; sequence(s): A175660
;; terms: 1 2 7 17 40 89 193 410 859 1781 3664 7493 15253 30938 62575 126281 254392 511745 1028281 2064314
;; small program: loop((x + x) + loop2(y, x + y, y, 1 + 2, 0), x, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - ((1 + 2) * loop2(x + y, x, x, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (v2 x) (* (+ 1 2) (w5 x))))))
