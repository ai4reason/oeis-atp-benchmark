;; sequence(s): A332141
;; terms: 1 414 44144 4441444 444414444 44444144444 4444441444444 444444414444444 44444444144444444 4444444441444444444 444444444414444444444 44444444444144444444444 4444444444441444444444444 444444444444414444444444444 44444444444444144444444444444 4444444444444441444444444444444
;; small program: ((loop(2 + (2 * ((2 * (x + x)) + x)), x + x, 2) - loop(2 * ((2 * (x + x)) + x), x, 1)) * 2) - loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
;; fast program: (((((((loop2(x * y, y, x, 2, 2 + (2 * (2 + 2))) - 1) * (1 + (2 + 2))) - 2) - 2) * loop2(x * y, y, x, 2, 2 + (2 * (2 + 2)))) div (1 + (2 * (2 + 2)))) * 2) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (- (* (- (v0 x) (v1 x)) 2) (w2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (* (div (* (- (- (* (- (w3 x) 1) (+ 1 (+ 2 2))) 2) 2) (w4 x)) (+ 1 (* 2 (+ 2 2)))) 2) (w5 x)))))
