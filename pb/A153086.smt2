;; sequence(s): A153086
;; terms: 2 5 7 8 11 12 14 17 20 21 22 23 26 27 28 29 32 34 35 37
;; small program: (compr(loop(loop(x * y, x - (x div (1 + 2)), 1) mod (1 + (x + x)), x mod 2, x), 1 + x) div 2) - 1
;; fast program: (compr(loop(if (((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2) <= 0 then 2 else 1, x mod 2, x) - 1, 1 + x) div 2) - 1
(set-logic UFNIA)
