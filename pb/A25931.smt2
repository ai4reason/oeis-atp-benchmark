;; sequence(s): A25931
;; terms: 1 17 188 1726 14343 112371 848506 6255392 45386165 325753285 2320698744 16447547298 116147697667 818112983159 5752200695702 40392496919044 283383067688049 1986859807248393 13923911479636180 97546847987676230
;; small program: loop(((loop((loop2(((2 * ((x + x) + x)) + x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop((((loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) div 2) - loop2(x * y, y, x, 1, 1 + (2 + 2))) div 2, 1, 2 + x) div 2, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
