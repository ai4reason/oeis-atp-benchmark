;; sequence(s): A346396
;; terms: 0 1 9 62 390 2384 14680 93680 635824 4697664 38442112 351331584 3582715136 40476303360 501863078912 6767130867712 98464775493632 1536203429306368 25564684461735936 451816479967608832
;; small program: loop(((loop(loop(x + x, y + y, 1) + (x * y), y - 1, 1) + x) + x) * 2, x, 0) div 2
;; fast program: loop((((loop((x * y) + loop(2 * (x + x), y, 1), y - 1, 1) + x) + x) + x) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (* (+ (+ (v1 x y) x) x) 2))))
