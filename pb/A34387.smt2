;; sequence(s): A34387
;; terms: 0 2 5 5 10 10 17 17 17 17 28 28 41 41 41 41 58 58 77 77
;; small program: loop((loop((loop(x * y, x, x) mod (1 + x)) mod 2, 1, y) * (1 + y)) + x, x, 0)
;; fast program: loop(loop(if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 0, 1, y) + x, x, 0)
(set-logic UFNIA)
