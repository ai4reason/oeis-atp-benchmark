;; sequence(s): A1043
;; terms: 5 8 12 18 24 30 36 42 52 60 68 78 84 90 100 112 120 128 138 144
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 2, 2, x)
;; fast program: loop2(compr(loop((1 - loop(x + x, (x div 2) - 1, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 2, 2, x)
(set-logic UFNIA)
