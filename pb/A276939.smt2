;; sequence(s): A276939
;; terms: 3 8 36 240 2520 32340 540540 10210200 232792560 6692786100 207030183360 7621298624940 311671001662020 13387011595197240 627972543920161440 33204048259778536140 1955349508631402683800 119211141709561183622340 7975609932439674026862360 565799151677779228023294480
;; small program: loop2(loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, y, 1) + x, 1 + y, 2, 0, x)
;; fast program: loop2(loop((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) + 1) * x, y, 1) + x, 1 + y, 2, 0, x)
(set-logic UFNIA)
