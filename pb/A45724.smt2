;; sequence(s): A45724
;; terms: 1 15 142 1083 7266 44758 259356 1435347 7663898 39761282 201483204 1001098462 4891910100 23565178380 112118316088 527674017411 2459747256138 11368724035210 52145629874100 237541552456362
;; small program: loop(loop((((loop(((((loop(2 * (((x div y) + x) + x), y, 1) div (1 + y)) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop((((loop((((loop(loop2(x * y, 1 + y, x, 1, 2 + x) div loop(x * y, x, 1), 1, y) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (* 2 (+ (+ (div x y) x) x)))))
(assert (forall ((x Int) (y Int)) (= (g3 x y) y)))
(assert (= h3 1))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y) x)))))
(assert (forall ((x Int) (y Int)) (= (v3 x y) (u3 (g3 x y) h3))))
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (+ (+ (div (v3 x y) (+ 1 y)) x) x) x) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (+ (+ (+ (v6 x y) x) x) x) x))))
