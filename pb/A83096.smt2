;; sequence(s): A83096
;; terms: 0 12 30 36 84 90 108 120 246 252 270 282 324 336 354 360 732 738 756 768
;; small program: ((((compr(loop(if (x mod 2) <= 0 then (x div (1 + 2)) else 1, x, x) mod 2, x + x) div 2) + 1) div 2) * 2) * (2 + 1)
;; fast program: ((((loop((((((loop(((((loop((((((loop(((((loop((((((loop(((((compr(loop(if (x mod 2) <= 0 then (x div (1 + 2)) else 1, (x div 2) div 2, x) mod 2, x) div 2) * (1 + 2)) + 1) - x) - x, 1, x div 2) + x) * (1 + 2)) - 1) - 2) - x) - x, 1, x div 2) + x) * (1 + 2)) + 1) - x) - x, 1, x div 2) + x) * (1 + 2)) - 1) - 2) - x) - x, 1, x div 2) + x) * (1 + 2)) + 1) - x) - x, 1, x div 2) + x) * (1 + 2)) - 1) - 2) - x) - x, 1, x div 2) + x) * (1 + 2)) + 1) div 2) * (2 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (* (div (+ (div (v0 x) 2) 1) 2) 2) (+ 2 1)))))
(assert (forall ((x Int)) (= (f9 x) (ite (<= (mod x 2) 0) (div x (+ 1 2)) 1))))
(assert (forall ((x Int)) (= (g9 x) (div (div x 2) 2))))
(assert (forall ((x Int)) (= (h9 x) x)))
(assert (forall ((x Int) (y Int)) (= (u9 x y) (ite (<= x 0) y (f9 (u9 (- x 1) y))))))
(assert (forall ((x Int)) (= (v9 x) (u9 (g9 x) (h9 x)))))
(assert (forall ((x Int)) (= (f8 x) (mod (v9 x) 2))))
...
(assert (forall ((x Int)) (= (f7 x) (- (- (+ (* (div (v8 x) 2) (+ 1 2)) 1) x) x))))
(assert (= g7 1))
...
(assert (forall ((x Int)) (= (fast x) (* (div (+ (* (+ (v2 x) x) (+ 1 2)) 1) 2) (+ 2 (+ 2 2))))))
