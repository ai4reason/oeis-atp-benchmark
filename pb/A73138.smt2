;; sequence(s): A73138
;; terms: 0 1 2 3 4 6 6 7 8 12 12 14 12 14 14 15 16 24 24 28
;; small program: loop(loop(loop((x - 1) mod y, x, 0), 2, x) + x, x, x)
;; fast program: loop(loop(loop((x - 1) mod y, x, 0), 2, x) + x, 1 + (2 + 2), x)
(set-logic UFNIA)
