;; sequence(s): A18070
;; terms: 1 22 339 4532 56357 672210 7813303 89300464 1009144713 11315328398 126186563867 1401795991596 15529706751469 171706382611786 1895807080277631 20910172869786728 230462261504563025
;; small program: loop(((loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop(((loop((loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))) - loop((x * x) * x, 1, loop(x + x, x, 2))) div (1 + 2), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
