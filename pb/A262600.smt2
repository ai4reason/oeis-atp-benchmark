;; sequence(s): A262600
;; terms: 0 0 0 0 1 7 33 132 484 1684 5661 18579 59917 190696 600744 1877256 5828185 17998783 55342617 169552428
;; small program: loop(((x - 1) + x) + x, x - 1, 1) - loop2(((x - y) + x) + x, x, x, 1, 2)
;; fast program: ((1 + loop2(x * y, y, x - 1, 1, 1 + 2)) div 2) - loop2(((x - y) + x) + x, x, x - 2, if (x - 1) <= 0 then 1 else 2, 1)
(set-logic UFNIA)
