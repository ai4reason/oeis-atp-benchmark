;; sequence(s): A42941
;; terms: 1 13 110 765 4746 27314 149052 781725 3975730 19730150 95973956 459145778 2165937060 10095323460 46566906872 212857023069 965208806082 4345780250270 19442667426420 86489687956518
;; small program: loop(loop((((loop(((((loop(2 * ((x - (x div y)) + x), y, 1) div (1 + y)) + x) + x) + x) + x, y, 1) + x) + x) + x) + x, y, 1) + (2 * (x + x)), x, 1)
