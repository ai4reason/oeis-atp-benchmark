;; sequence(s): A61547
;; terms: 1 0 1 2 6 10 26 42 106 170 426 682 1706 2730 6826 10922 27306 43690 109226 174762
;; small program: loop2(1 + (y + y), x + x, x - 1, 1, 1) div (if x <= 0 then 1 else 2)
;; fast program: loop2(1 + (x * y), y, (x - 1) div 2, loop(1, x mod 2, 1 + 2), if 1 <= 0 then 2 else (2 + 2)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (w0 x) (ite (<= x 0) 1 2)))))
