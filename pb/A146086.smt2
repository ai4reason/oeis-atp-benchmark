;; sequence(s): A146086
;; terms: 3 11 45 197 903 4271 20625 100937 498123 2470931 12295605 61300877 305972943 1528270391 7636568985 38168496017 190799433363 953868026651 4768952712765 23843601302357
;; small program: loop2((((y div 2) + x) + x) + x, (2 * (y + y)) + y, 1 + x, 1, 1)
;; fast program: (loop((loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))) div 2, 1, 1 + x) div 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (div (+ (w2 x) (w4 x)) 2))))
(assert (= g1 1))
