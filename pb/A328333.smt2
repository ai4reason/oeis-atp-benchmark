;; sequence(s): A328333
;; terms: 1 5 9 49 89 489 889 4889 8889 48889 88889 488889 888889 4888889 8888889 48888889 88888889 488888889 888888889 4888888889
;; small program: loop2(1 + (y + y), ((2 * (x + x)) - 1) + x, x, 1, 2)
;; fast program: loop2((x * y) - 1, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), 2 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g0 x) (+ (- (* 2 (+ x x)) 1) x))))
