;; sequence(s): A50404
;; terms: 1 14 77 280 798 1932 4158 8184 15015 26026 43043 68432 105196 157080 228684 325584 454461 623238 841225 1119272
;; small program: loop((((2 * (x + x)) + x) div y) + x, x, loop(1 + (x + x), 2, x)) div (1 + 2)
;; fast program: loop((((2 * (x + x)) + x) div y) + x, x, 1 + (2 + (2 * (x + x)))) div (1 + 2)
(set-logic UFNIA)
