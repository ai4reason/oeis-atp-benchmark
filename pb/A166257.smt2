;; sequence(s): A166257
;; terms: 1 7 11 15 17 19 23 27 29 31 35 39 41 43 47 49 51 53 55 59
;; small program: (loop(compr(loop(x * y, x, 2) mod (2 + x), y) + 1, x, 0) * 2) + 1
;; fast program: (compr(loop((if (loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, x div 2, x) mod (1 + x), x) * 2) + 1
(set-logic UFNIA)
