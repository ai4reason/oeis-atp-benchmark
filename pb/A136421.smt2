;; sequence(s): A136421
;; terms: 1 1 1 2 2 2 3 3 4 5 6 7 8 10 12 14 17 21 25 31
;; small program: ((loop2((x + x) + y, x, x, 2, 0) div loop(x + x, x, 1)) + 1) div 2
;; fast program: ((loop2((2 * x) + y, x, x - 1, if x <= 0 then 1 else 2, 1) div loop(x + x, x - 1, 1)) + 1) div 2
(set-logic UFNIA)
