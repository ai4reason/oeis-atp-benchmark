;; sequence(s): A49068
;; terms: 3 5 7 8 10 11 13 14 15 17 18 19 21 22 23 24 26 27 28 29
;; small program: loop(loop(((y div x) div x) + x, x, 1) + x, 2, x)
;; fast program: loop((loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2, (x div 2) - 1) + 2) + x, 2, x) + 1
(set-logic UFNIA)
