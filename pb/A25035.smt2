;; sequence(s): A25035
;; terms: 1 1 10 280 15400 1401400 190590400 36212176000 9161680528000 2977546171600000 1208883745669600000 599606337852121600000 356765771022012352000000 250806337028474683456000000 205661196363349240433920000000 194555491759728381450488320000000
;; small program: loop(loop((x - 2) + y, (y + y) + y, 1) * x, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) * loop2(x * y, 2 + y, x, 1, 1 + 2)) div loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (w2 x) (w3 x)) (w4 x)))))
