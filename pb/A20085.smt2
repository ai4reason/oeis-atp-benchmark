;; sequence(s): A20085
;; terms: 1 0 0 0 1 7 36 228 1647 13507 124268 1267542 14196477 173197024 2286200718 32464050199 493453563029 7993947721071 137495900802423 2502425394604113
;; small program: loop(((2 * ((y - 2) + y)) + y) * x, x, 1) div loop((2 * (x + x)) + x, x, 1)
;; fast program: loop2(x * y, 1 + (2 + (2 + y)), x - 1, 1, 2 + (2 + 2)) div loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
