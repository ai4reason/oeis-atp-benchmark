;; sequence(s): A287922
;; terms: 8 13 29 53 125 173 293 365 533 845 965 1373 1685 1853 2213 2813 3485 3725 4493 5045
;; small program: (loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 2, y, 2, 1, x) + 1) + 2
;; fast program: (loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 2, y, 2, 1, x) + 1) + 2
(set-logic UFNIA)
