;; sequence(s): A91496
;; terms: 1 16 630 28672 1385670 69206016 3528923580 182536110080 9540949030470 502682972323840 26651569523959380 1420217179365703680 75998432812419471900 4081125953526124511232 219813190240007470094520
;; small program: loop(loop2((2 + y) * x, 2 + (2 + y), x, 1, x) div loop(x * y, x, 1), 1, x + x)
;; fast program: loop(loop2(x * y, 2 + (2 + y), x, 1, 2 + x) div loop(x * y, x, 1), 1, x + x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g4 x y) (+ 2 (+ 2 y)))))
