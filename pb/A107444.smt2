;; sequence(s): A107444
;; terms: 1 28 2925 635376 234531275 131513824548 104200375748469 110859231254749120 152494520486567153895 263409560461970212832400 558225230412816157198777770 1424174931670379304734465767920
;; small program: loop(loop2(x * y, y - 1, x, 1, (x * x) * x) div loop(x * y, x, 1), 1, 1 + x)
;; fast program: loop(loop2(x * y, y - 1, x, 1, (x * x) * x) div loop(x * y, x - 1, x), 1, 1 + x)
(set-logic UFNIA)
