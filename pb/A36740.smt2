;; sequence(s): A36740
;; terms: 1 1 4 216 331776 24883200000 139314069504000000 82606411253903523840000000 6984964247141514123629140377600000000 109110688415571316480344899355894085582848000000000 395940866122425193243875570782668457763038822400000000000000000000
;; small program: loop2(loop(x * y, y, x), y, x, 1, x)
;; fast program: loop2(x * y, y, x - (x div 2), 1, loop(x * y, x - 1, x)) * loop2(x * y, y, x div 2, 1, loop(x * y, x - 1, x))
(set-logic UFNIA)
