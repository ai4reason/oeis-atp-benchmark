;; sequence(s): A73169
;; terms: 3 4 5 5 5 6 7 7 7 8 9 9 9 10 10 10 10 10 11 12
;; small program: compr(loop(x * y, x, 2) mod (1 + x), 2 + x) - x
;; fast program: compr(loop((if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1) - 1, (x - 1) div 2, x), 1 + x) - x
(set-logic UFNIA)
