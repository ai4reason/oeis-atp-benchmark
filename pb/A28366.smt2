;; sequence(s): A28366
;; terms: 1 1 6 5040 1307674368000 8222838654177922817725562880000000 1982608315404440064116146708361898137544773690227268628106279599612729753600000000000000
;; small program: loop(x * y, loop(x + x, x, 1) - 1, 1)
;; fast program: loop2(loop((loop2(x * y, 2 + y, x - 1, 1, 1 + 2) * loop(x + x, x, 1)) div 2, 1, y) * x, y + y, x - 1, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (div (* (w4 x) (v5 x)) 2))))
(assert (= g3 1))
