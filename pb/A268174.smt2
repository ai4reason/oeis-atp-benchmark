;; sequence(s): A268174
;; terms: 1 3 5 9 11 15 17 21 27 29 35 39 41 45 51 57 59 65 69 71
;; small program: compr((loop(loop(2, 2, 2) * x, x, 2) - 1) mod (2 + x), x)
;; fast program: (compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x) * 2) - 1
(set-logic UFNIA)
(declare-fun f2 () Int)
(declare-fun g2 () Int)
(declare-fun h2 () Int)
