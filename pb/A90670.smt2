;; sequence(s): A90670
;; terms: 3 5 7 11 13 17 23 25 31 35 37 41 43 53 55 65 67 71 77 83
;; small program: compr((1 + loop2(x * y, y, x, 1, 0 - (2 + 2))) mod (1 + (x + x)), 1 + x) + 2
;; fast program: compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x) - 1, 1 + x) + 2
(set-logic UFNIA)
