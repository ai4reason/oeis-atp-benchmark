;; sequence(s): A258155
;; terms: 900 11025 148225 1002001 5909761 17631601 55190041 160604929 427538329 1106427169 2211538729 4255083361 6865945321 11473194769 21599886961 36384418009 58145123689 84202691329 120590202121 167655034849
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, 1 + y, 1 + 2, 1, x), 1, y) * x, y, 2, 1, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 1 + 2, 1, x), 1, y) * x, y, 2, 1, x)
(set-logic UFNIA)
