;; sequence(s): A129771
;; terms: 3 5 9 15 17 23 27 29 33 39 43 45 51 53 57 63 65 71 75 77
;; small program: (compr(loop2(loop(0 - x, y, x), y div 2, x, 1, x), x) * 2) + 1
;; fast program: ((((((loop2((y - x) div 2, x, 2 + 2, x div 2, 0) + 1) + x) mod 2) + x) + x) * 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (+ (+ (mod (+ (+ (w3 x) 1) x) 2) x) x) 2) 1))))
