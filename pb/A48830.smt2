;; sequence(s): A48830
;; terms: 0 1 2 12 61440
;; small program: loop2(1 + loop(x + x, x div 2, y), x * y, x, 1, 2) div 2
;; fast program: loop(loop(2 * (2 * ((x * y) + x)), x, 1) div 2, x - 2, 1) * x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (* 2 (* 2 (+ (* x y) x))))))
