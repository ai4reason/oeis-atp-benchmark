;; sequence(s): A98695
;; terms: 1 1 4 96 18432 35389440 815372697600 263006617337856000 1357366631815981301760000 126095668058466123464363212800000 234278891648287676839670388023623680000000
;; small program: loop(loop(2 * (x * y), y, x) div 2, x, 1)
;; fast program: (loop(loop(x * y, y, 1 + y) * x, x - 2, 1) * loop(x * y, x, 1)) * loop2(x * y, y + y, x - 1, 1, 2)
(set-logic UFNIA)
