;; sequence(s): A79285
;; terms: 0 2 1 5 4 13 13 34 39 89 112 233 313 610 859 1597 2328 4181 6253 10946
;; small program: loop2(x + y, x, x, 1, 1) - loop2(y + y, x, x, 1, 0)
;; fast program: loop2(x + y, x, x - 1, 2, 1) - loop(x + x, (x - 1) div 2, loop(0, x mod 2, 2))
(set-logic UFNIA)
