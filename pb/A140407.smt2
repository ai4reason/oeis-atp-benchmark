;; sequence(s): A140407
;; terms: 1 2 3 3 7 5 15 9 31 17 63 33 127 65 255 129 511 257 1023 513
;; small program: loop2(y, x + x, x, 2, 1) - loop(0 - x, x, 1)
;; fast program: loop(2 + (x div 2), x mod 2, loop(x + x, x div 2, 2)) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (+ 2 (div x 2)))))
