;; sequence(s): A79362
;; terms: 1 4 5 14 17 44 53 134 161 404 485 1214 1457 3644 4373 10934 13121 32804 39365 98414
;; small program: loop2(2 + y, (x + x) + x, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 2), 1 + 2) - 1
(set-logic UFNIA)
