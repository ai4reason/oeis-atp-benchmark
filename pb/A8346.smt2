;; sequence(s): A8346
;; terms: 1 0 2 1 4 4 9 12 22 33 56 88 145 232 378 609 988 1596 2585 4180
;; small program: loop(loop2(x + y, x, y, 1, 0) - x, x, 1)
;; fast program: 1 + loop(x - 2, x mod 2, if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
