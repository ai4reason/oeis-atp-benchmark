;; sequence(s): A155616
;; terms: 1 8 40 188 880 4148 19720 94508 456160 2215268 10814200 53022428 260917840 1287811988 6371951080 31591319948 156882857920 780119322308 3883416742360 19348364235068
;; small program: loop2(((2 * (x + x)) - (y * y)) + x, y + y, x, 2, 1) - 1
;; fast program: (loop(x * x, 1, loop(x + x, x, 1)) - 1) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
