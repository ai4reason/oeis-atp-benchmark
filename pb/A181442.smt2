;; sequence(s): A181442
;; terms: 1 2 4 15 35 144 342 1421 3381 14062 33464 139195 331255 1377884 3279082 13639641 32459561 135018522 321316524 1336545575
;; small program: (loop2(((2 - (y mod 2)) * (x + y)) + x, x + y, x, 1, 0) div 2) + 1
;; fast program: (loop2(((2 - (y mod 2)) * (x + y)) + x, x + y, x - 1, (if x <= 0 then 0 else 2) + 1, 1) div 2) + 1
(set-logic UFNIA)
