;; sequence(s): A1655
;; terms: 1 3 15 60 260 1092 4641 19635 83215 352440 1493064 6324552 26791505 113490195 480752895 2036500788 8626757644 36543528780 154800876945 655747029795
;; small program: loop2(loop2(x + y, x, y, x, 0), 1 + y, 1 + 2, 1, x) div 2
;; fast program: ((((loop(x * x, 1, loop2(x + y, x, x, 1, 1)) - (x mod 2)) - (x mod 2)) + 1) * loop2(x + y, x, x, 1, 1)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (+ (- (- (v2 x) (mod x 2)) (mod x 2)) 1) (w4 x)) 2))))
