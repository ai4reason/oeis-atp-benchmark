;; sequence(s): A93434
;; terms: 3 180 30240 9979200 5448643200 4446092851200 5068545850368000 7694052600858624000 15003402571674316800000 36548288664598635724800000 108767707065845539917004800000 388300714225068577503707136000000
;; small program: loop2((2 + y) * x, 1 + y, 2 + (x + x), 1, x) div 2
;; fast program: (loop2((x * y) + x, 1 + y, 1 + x, 1, 2 + (x + x)) * loop2(x * y, 1 + y, x, 1, 1 + x)) * (1 + (x + x))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (w1 x) (w2 x)) (+ 1 (+ x x))))))
