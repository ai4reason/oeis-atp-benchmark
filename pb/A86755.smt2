;; sequence(s): A86755
;; terms: 2 20 92 292 742 1624 3192 5784 9834 15884 24596 36764 53326 75376 104176 141168 187986 246468 318668 406868
;; small program: 2 * loop(loop(((y * y) * y) + x, 1 + y, x), x, 1)
;; fast program: loop(loop(x * x, 1, (y * y) + y) + x, 1 + x, 0) div 2
(set-logic UFNIA)
...
(assert (= g3 1))
(assert (forall ((x Int) (y Int)) (= (h3 x y) (+ (* y y) y))))
