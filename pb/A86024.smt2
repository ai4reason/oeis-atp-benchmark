;; sequence(s): A86024
;; terms: 1 126 3501 46376 389376 2389752 11650752 47587752 168875127 534401002 1537404003 4080706128 10109274128 23590546128 52243162128 110473767504 224205418629 438589465254 830009446129 1524339072504
;; small program: loop(loop((x * x) * x, 1, loop(((2 * (x + x)) div y) + x, y, 1)) + x, x, 1)
;; fast program: loop(loop(loop2(loop(loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) div (2 * (2 * (2 + (2 + 2)))), 1, y) * (x * x), y, 2, 1, x), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f6 x) (div (v7 x) (* 2 (* 2 (+ 2 (+ 2 2))))))))
(assert (= g6 1))
