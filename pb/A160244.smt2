;; sequence(s): A160244
;; terms: 6 8 14 21 34 50 77 116 180 283 442 702 1117 1784 2864 4611 7434 11994 19375 31312
;; small program: (compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + x) + 1) + loop2(x + y, x, x, 2 + 2, 1)
;; fast program: (compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + x) + 1) + loop2(x + y, x, x, 2 + 2, 1)
(set-logic UFNIA)
