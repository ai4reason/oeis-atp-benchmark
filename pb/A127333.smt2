;; sequence(s): A127333
;; terms: 41 56 72 90 112 132 156 180 204 228 252 280 304 330 358 384 410 434 462 492
;; small program: (loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 2 + (2 + 2), 2, x) + 2) + 2
;; fast program: (loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 2 + (2 + 2), 2, x) + 2) + 2
(set-logic UFNIA)
