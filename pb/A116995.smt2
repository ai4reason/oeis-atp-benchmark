;; sequence(s): A116995
;; terms: 5 12 35 70 176 247 425 532 782 1247 1426 2035 2501 2752 3290 4187 5192 5551 6700 7526
;; small program: (loop2(((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + 1) * x) - 1, y, 2, 1 + 2, x) div 2) + 1
;; fast program: (loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x) - 1, y, 2, 1 + 2, x) + 2) div 2
(set-logic UFNIA)
