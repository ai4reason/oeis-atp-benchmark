;; sequence(s): A37166
;; terms: 4 12 30 70 132 208 306 418 644 870 1116 1480 1722 1978 2444 3074 3540 4026 4690 5112
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 1, 1 + y, 2, 1, x) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1, 1 + y, 2, 1, x) - 1
(set-logic UFNIA)
