;; sequence(s): A86910
;; terms: 1 3 3 5 7 7 11 9 15 15 17 21 21 23 25 29 31 31 37 35
;; small program: (loop(compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) - x, x, 0) * 2) + 1
;; fast program: (loop(compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) - x, x, 0) * 2) + 1
(set-logic UFNIA)
