;; sequence(s): A259161
;; terms: 5 48510 465793515 4472549283020 42945417749765025 412361896760694487530 3959498889750770719498535 38019107927025003687930446040 365059470355795195660737423378045 3505300996337237541709397051345542550 33657899801770684519698434826282476187555
;; small program: loop2(loop2((2 * ((2 * (x + x)) + x)) - y, x, y, 1, 0) * x, 1 + y, 2, 1, x + x) div 2
;; fast program: loop(x * x, 1, loop2(((1 + (2 + 2)) * (x + x)) - y, x, x + x, 1 + (2 * (2 + 2)), 1)) div (2 * (2 * (2 + 2)))
(set-logic UFNIA)
