;; sequence(s): A131193
;; terms: 0 1 ~3 3 ~1 0 0 1 ~3 3 ~1 0 0 1 ~3 3 ~1 0 0 1
;; small program: loop(loop2((0 - (x + x)) div y, x, y + y, 1, 1) - x, x, 1) div 2
;; fast program: ((loop(2 + (2 + 2), x mod 2, 1) - (x mod (1 + 2))) div 2) - (x mod (1 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (div (- 0 (+ x x)) y))))
...
(assert (forall ((x Int)) (= (fast x) (- (div (- (v2 x) (mod x (+ 1 2))) 2) (mod x (+ 1 2))))))
