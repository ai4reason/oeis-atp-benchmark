;; sequence(s): A68780
;; terms: 8 9 14 15 20 21 24 25 26 27 32 33 34 35 38 39 44 45 48 49
;; small program: compr((loop(x * y, x, 1) mod ((1 + x) * (2 + x))) - 1, 2 + x) + 1
;; fast program: (loop((((compr(if (((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2) <= 0 then 1 else 0, x) * 2) + 1) - x) - x, 1, x div 2) + x) - 1
(set-logic UFNIA)
