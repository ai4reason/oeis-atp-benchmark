;; sequence(s): A86091
;; terms: 1 6 33 171 849 4083 19161 88203 399777 1789155 7923369 34780155 151526385 655905747 2823355257 12093944427 51582654273 219172472259 928100356425 3918172435419
;; small program: loop2((2 + y) * x, 2, x, x, 1) + loop((1 + 2) * x, x, 1)
;; fast program: ((1 + 2) * (loop(x * x, 1, loop(x + x, x - 1, 1)) * x)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (+ 1 2) (* (v2 x) x)) (w4 x)))))
