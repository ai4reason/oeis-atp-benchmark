;; sequence(s): A98773
;; terms: 9 25 161 897 22529 106497 2228225 9961473 192937985 15569256449 66571993089 5085241278465 90159953477633 378231999954945 6614661952700417 477381560501272577 34011184385901985793
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), y, 2, 0, x) + 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x + x, x, 1), y, 2, 0, x) + 1
(set-logic UFNIA)
