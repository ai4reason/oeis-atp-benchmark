;; sequence(s): A133209
;; terms: 3 2 0 0 8 32 80 160 288 512 960 1920 3968 8192 16640 33280 66048 131072 261120 522240
;; small program: loop(x + x, x, 1) + loop2(x - y, x + y, x, 2, 2)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) + loop2(x - y, x + y, x, 2, 2)
(set-logic UFNIA)
