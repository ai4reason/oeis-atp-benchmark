;; sequence(s): A94978
;; terms: 1 3 13 49 180 662 2430 8910 32671 119796 439252 1610592 5905506 21653524 79396256 291119607 1067438559 3913941385 14351118413 52620767516
;; small program: loop(x div (1 + 2), x, loop(loop((2 + y) * x, 2, x) - x, x, 1))
;; fast program: (loop2(x * y, y, x - 1, 1, 1 + (2 + (2 * (2 + 2)))) * (if x <= 0 then 1 else (1 + (2 + (2 * (2 + 2)))))) div loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
