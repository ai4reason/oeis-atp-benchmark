;; sequence(s): A21448
;; terms: 0 0 2 2 5 2 2 5 2 2 5 2 2 5 2 2 5 2 2 5
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (* (ite (<= (mod y (+ 1 2)) 0) x 1) 2) 2))))
...
(assert (forall ((x Int)) (= (g1 x) (mod (- (- x 1) 1) (+ 1 2)))))
(assert (= h1 1))
(assert (forall ((x Int) (y Int)) (= (u1 x y) (ite (<= x 0) y (f1 (u1 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v1 x) (u1 (g1 x) h1))))
(assert (forall ((x Int)) (= (fast x) (mod (- 1 x) (+ (v1 x) x)))))
