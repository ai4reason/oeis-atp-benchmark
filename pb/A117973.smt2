;; sequence(s): A117973
;; terms: 2 4 4 8 4 8 8 16 4 8 8 16 8 16 16 32 4 8 8 16
;; small program: loop2(((y mod 2) * x) + x, y div 2, x, 2, x)
;; fast program: loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), 2, x div 2) * (1 + (x mod 2))
(set-logic UFNIA)
