;; sequence(s): A55861
;; terms: 0 0 6 48 500 6480 100842 1835008 38263752 900000000 23579476910 681091006464 21505924728444 737020860878848 27246730957031250 1080863910568919040 45798768824157052688 2064472028642102280192
;; small program: 2 * (loop2(x * y, y, x - 1, x, 1 + x) div 2)
;; fast program: loop2(x * y, y, x - 1, loop(0, 2 - x, 1), 1 + x) * x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* 2 (div (w0 x) 2)))))
