;; sequence(s): A141317
;; terms: 0 0 8 24 80 240 728 2184 6560 19680 59048 177144 531440 1594320 4782968 14348904 43046720 129140160 387420488 1162261464
;; small program: loop2(y, (2 * (x + y)) + x, x, 2, 2) - 2
;; fast program: loop(x - 2, x mod 2, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - 1
(set-logic UFNIA)
