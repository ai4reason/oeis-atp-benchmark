;; sequence(s): A143293
;; terms: 1 3 9 39 249 2559 32589 543099 10242789 233335659 6703028889 207263519019 7628001653829 311878265181039 13394639596851069 628284422185342479 33217442899375387209 1955977793053588026279 119244359152460559009549 7977565910232727614888639
;; small program: loop(loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, y, 1) + x, x, 1)
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), (1 + x) mod 2, x) - 2, y) + 1) * x) + 1, y - 1, x, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (* (+ (v5 x y) 1) x) 1))))
