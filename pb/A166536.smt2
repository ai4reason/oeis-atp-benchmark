;; sequence(s): A166536
;; terms: 1 3 6 16 40 105 273 715 1870 4896 12816 33553 87841 229971 602070 1576240 4126648 10803705 28284465 74049691
;; small program: loop(1 + (loop2(x + y, x, y + y, 1, 1) - x), x, 1)
;; fast program: loop2(x + y, x, x, loop2(x + y, x, x, 1, 1), 0) + (x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ 1 (- (w1 x y) x)))))
