;; sequence(s): A104004
;; terms: 1 3 7 16 35 75 158 329 679 1392 2839 5767 11678 23589 47555 95720 192427 386451 775486 1555153
;; small program: loop((x + x) + loop2(x + y, x, y, 0, 1), x, 1)
;; fast program: ((1 + 2) * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - loop2(x + y, x, x, 2, 1)
(set-logic UFNIA)
