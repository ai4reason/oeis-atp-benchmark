;; sequence(s): A167444
;; terms: 1 1 2 3 15 384 135135 13749310575 46620662575398912000 8687364368561751199826958100282265625 352999527454840466971061863960307904899505075341088595453568994140625
;; small program: loop(loop(loop(x * y, y, 1) div x, x, 1), 1, loop2(x + y, x, x, 1, 0))
;; fast program: loop(loop2(x * y, y - 2, x div 2, 1, x), 1, loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
