;; sequence(s): A153480
;; terms: 4 14 46 94 238 334 574 718 1054 1678 1918 2734 3358 3694 4414 5614 6958 7438 8974 10078
;; small program: (loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2, 2, x) - 2) - 2
;; fast program: (loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 2, x) - 2) - 2
(set-logic UFNIA)
