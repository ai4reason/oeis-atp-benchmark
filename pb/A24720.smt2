;; sequence(s): A24720
;; terms: 1 2 9 64 519 4395 38044 334054 2963629 26499449 238414581 2155749364 19572882981 178326272881 1629509263831 14928031562011 137059765831906 1260847661188318 11618870102584178 107234108018545278
;; small program: loop(loop(loop2(x * y, y - 1, x, 1, 2 * (x + x)) div loop(x * y, x, 2), 1, y) + x, x, 2) div 2
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 1 + ((x + x) + x)) div loop(x * y, x - 1, 1), 1, y) + x, x, 1)
(set-logic UFNIA)
