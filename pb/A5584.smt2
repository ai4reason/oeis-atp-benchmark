;; sequence(s): A5584
;; terms: 2 13 49 140 336 714 1386 2508 4290 7007 11011 16744 24752 35700 50388 69768 94962 127281 168245 219604
;; small program: loop(loop(loop(loop(loop(x + y, y, x), y, x) - y, y, x), 2 + y, x), x, 2)
;; fast program: (loop((((2 * (x + x)) + x) div y) + x, x, (2 * (2 + (2 + 2))) + x) div 2) div (1 + 2)
(set-logic UFNIA)
