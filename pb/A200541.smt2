;; sequence(s): A200541
;; terms: 1 1 4 12 35 104 312 924 2754 8195 24386 72576 215991 642785 1912960 5693016 16942573 50421592 150056090 446571180
;; small program: loop2(1 + (((y * y) div (x + y)) + y), x + y, x, 1, 0) * loop2(x + y, x, x, 1, 0)
;; fast program: loop2(((((y * y) + y) div x) + x) + y, x, x - 2, if (x - 1) <= 0 then 1 else 2, 1) * loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (div (+ (* y y) y) x) x) y))))
