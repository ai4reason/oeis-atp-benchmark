;; sequence(s): A131569
;; terms: 1 2 8 24 71 198 541 1452 3862 10208 26885 70644 185369 485982 1273420 3335640 8735707 22875050 59895221 156819960
;; small program: loop(x + y, loop2(x + y, 2 + x, x, 0, 1), 0) + loop2(x + y, x, x, 1, 0)
;; fast program: ((loop((x * x) - x, 1, loop2(x + y, x, x, 2, 1)) div 2) + 1) - loop2(x + y, x, x, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (+ (div (v3 x) 2) 1) (w5 x)))))
