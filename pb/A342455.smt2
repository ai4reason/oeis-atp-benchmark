;; sequence(s): A342455
;; terms: 1 32 7776 24300000 408410100000 65774855015100000 24421743243121524300000 34675383095948798128025100000 85859681408495723096004822084900000 552622359415801587878908964592391520700000 11334919554709059323420895730190266747414284300000 324509123504618420438174660414872405442002404781629300000
;; small program: loop2(loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, y, x), y, 1 + (2 + 2), 1, x)
;; fast program: loop2(loop((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), (1 + x) mod 2, x) - 2, y) + 1) * x, y, 1) * x, y, 1 + (2 + 2), 1, x)
(set-logic UFNIA)
