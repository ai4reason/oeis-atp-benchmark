;; sequence(s): A139730
;; terms: 0 4 6 104 311 2799 191 17344 77971 701739 456276 33403359 202973981 361922079 815892461 19550063399 145432992466 88193807194 1556683717871 10195456195214
;; small program: loop((x + x) + x, x + x, 1) mod loop((2 * (x + x)) + x, x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) mod loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
