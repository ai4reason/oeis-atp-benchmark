;; sequence(s): A14303
;; terms: 2 6 15 35 66 104 153 209 322 435 558 740 861 989 1222 1537 1770 2013 2345 2556
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + 1, 1 + y, 2, 1, x) div 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 1, 1 + y, 2, 1, x) div 2
(set-logic UFNIA)
