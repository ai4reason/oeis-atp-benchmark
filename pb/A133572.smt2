;; sequence(s): A133572
;; terms: 1 4 6 16 24 64 96 256 384 1024 1536 4096 6144 16384 24576 65536 98304 262144 393216 1048576
;; small program: loop(x + x, x, 1 + (2 + (x mod 2))) div 2
;; fast program: loop(loop((x div 2) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))), 1, 1 + x)
(set-logic UFNIA)
