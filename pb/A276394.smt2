...
(assert (forall ((x Int)) (= (f0 x) (mod (+ 1 x) (+ 1 (* 2 (+ 2 2)))))))
(assert (forall ((x Int)) (= (g0 x) (mod x (+ 1 (* 2 (* 2 (+ 2 (+ 2 2)))))))))
(assert (= h0 2))
(assert (forall ((x Int) (y Int)) (= (u0 x y) (ite (<= x 0) y (f0 (u0 (- x 1) y))))))
(assert (forall ((x Int)) (= (v0 x) (u0 (g0 x) h0))))
(assert (forall ((x Int)) (= (small x) (mod (v0 x) 2))))
(assert (forall ((x Int)) (= (f1 x) (+ x x))))
(assert (forall ((x Int)) (= (g1 x) (mod (mod x (+ 1 (* 2 (* 2 (+ 2 (+ 2 2)))))) (+ 1 (* 2 (+ 2 2)))))))
(assert (= h1 1))
...
(assert (= v2 (u2 g2 h2)))
(assert (forall ((x Int)) (= (fast x) (mod (- (mod (v1 x) v2) 1) (+ 1 2)))))
