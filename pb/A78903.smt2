;; sequence(s): A78903
;; terms: 0 0 1 1 2 3 5 5 6 7 9 10 12 14 17 17 18 19 21 22
;; small program: loop(loop(loop2(x - y, y div 2, x, x, x) + x, 1, 1 + y) + x, x, 0) - x
;; fast program: (loop(loop(loop2(x - y, y div 2, 2 + (2 + 2), x, x div 2), 1, 1 + y) + x, x, 1) - x) - 1
(set-logic UFNIA)
