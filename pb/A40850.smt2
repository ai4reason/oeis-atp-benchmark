;; sequence(s): A40850
;; terms: 29 1 1 1 58 1 1 1 58 1 1 1 58 1 1 1 58 1 1 1
;; small program: loop(1, x mod (2 + 2), loop(1 + ((2 + y) * x), 2, 2) * (if x <= 0 then 1 else 2))
;; fast program: loop((2 + loop((x * x) * x, 1, 1 + 2)) * (1 + x), 1 - (x mod (2 + 2)), if x <= 0 then 0 else 1)
(set-logic UFNIA)
(declare-fun f0 () Int)
