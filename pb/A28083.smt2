;; sequence(s): A28083
;; terms: 1 28 505 7480 99181 1226548 14470705 165111760 1838112661 20084217868 216290873305 2302672401640 24288950066941 254275654917988 2645388660962305 27378515971285120 282112466144578021
;; small program: loop(loop(loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1) * loop((x + x) + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop(loop(((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
