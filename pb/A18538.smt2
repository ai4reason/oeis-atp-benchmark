;; sequence(s): A18538
;; terms: 1 5 7 17 35 85 119 595
;; small program: loop(compr((loop(2 * (2 + (x + x)), 2 + 2, 1) + x) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + loop((1 + x) * (2 + (x * x)), 1, 2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
