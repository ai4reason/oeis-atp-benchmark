;; sequence(s): A8882
;; terms: 99 298 149 448 224 112 56 28 14 7 22 11 34 17 52 26 13 40 20 10
;; small program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(1 + ((2 + x) * x), 2, 2) - 1)
;; fast program: loop(loop(2 + (2 * ((x + x) + x)), x mod 2, x) div 2, x, loop(x * x, 1, 2 + (2 * (2 + 2))) - 1)
(set-logic UFNIA)
