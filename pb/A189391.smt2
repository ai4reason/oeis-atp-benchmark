;; sequence(s): A189391
;; terms: 0 1 3 8 19 44 98 216 467 1004 2134 4520 9502 19928 41572 86576 179587 372044 768398 1585416
;; small program: loop((loop((x * y) div (y - (y div 2)), y - 1, 1) + x) + x, x, 0)
;; fast program: loop((loop(loop(2 * ((x - (x div y)) + x), x div 2, 1 + (x mod 2)), 1, y) + x) + x, x, 0) div 2
(set-logic UFNIA)
