;; sequence(s): A175661
;; terms: 1 5 10 23 49 104 217 449 922 1883 3829 7760 15685 31637 63706 128111 257353 516536 1036033 2076857
;; small program: (2 * loop(x + x, x, 2)) - loop2(x + y, x, x, 1 + 2, 0)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - loop2(x + y, x, x, 1 + 2, 0)
(set-logic UFNIA)
