;; sequence(s): A98600-A99926
;; terms: 1 2 2 5 6 12 17 30 46 77 122 200 321 522 842 1365 2206 3572 5777 9350
;; small program: loop(loop2(x + y, x, y, 1, 2) - x, x, 1)
;; fast program: loop(2 + x, x mod 2, loop2(y, x + y, x, 2, 1)) - 1
(set-logic UFNIA)
