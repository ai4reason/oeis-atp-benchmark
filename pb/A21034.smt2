;; sequence(s): A21034
;; terms: 1 13 116 902 6615 47271 333922 2346784 16455989 115278449 807210768 5651264346 39561225523 276935720347 1938571500254 13570064940788 94990648033617 664935116841765 4654547560235980
;; small program: loop(((loop2(((2 * (((x + x) + x) + y)) - 1) + x, y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) + 1) div 2, 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
