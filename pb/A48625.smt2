;; sequence(s): A48625
;; terms: 4 6 9 13 19 28 41 60 88 129 189 277 406 595 872 1278 1873 2745 4023 5896
;; small program: 2 + loop2(2 + (((y * y) div x) + x), x, x, 2, 0)
;; fast program: 2 + loop2(2 + (((y * y) div x) + x), x, x - 1, (if x <= 0 then 0 else 2) + 2, 2)
(set-logic UFNIA)
