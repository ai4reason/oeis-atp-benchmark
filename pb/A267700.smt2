;; sequence(s): A267700
;; terms: 0 1 2 5 6 9 12 19 20 23 26 33 36 43 50 65 66 69 72 79
;; small program: loop(loop(1 + loop((2 + x) mod y, x, 0), x, y) + x, x, 0)
;; fast program: (loop(loop(loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), 1 + (x mod 2), x div 2), 1, y) + x, x, 1) - x) - 1
(set-logic UFNIA)
...
(assert (= h5 (+ 2 (+ 2 2))))
(assert (forall ((x Int)) (= (i5 x) (+ 1 (mod x 2)))))
