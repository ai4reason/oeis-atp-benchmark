;; sequence(s): A50494
;; terms: 1 10 52 192 570 1452 3300 6864 13299 24310 42328 70720 114036 178296 271320 403104 586245 836418 1172908 1619200
;; small program: loop(loop(loop(loop((loop(x + y, y, 0) * y) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop((loop(((loop(((x * x) * x) - x, 1, 2 + x) * x) div (2 * (2 + (2 + 2)))) * x, 1, 2 + x) * (1 + x)) div (2 + (2 * (2 + 2))), 1, y) + x, x, 2) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f7 x) (* (div (* (v8 x) x) (* 2 (+ 2 (+ 2 2)))) x))))
(assert (= g7 1))
(assert (forall ((x Int)) (= (h7 x) (+ 2 x))))
(assert (forall ((x Int) (y Int)) (= (u7 x y) (ite (<= x 0) y (f7 (u7 (- x 1) y))))))
(assert (forall ((x Int)) (= (v7 x) (u7 g7 (h7 x)))))
(assert (forall ((x Int)) (= (f6 x) (div (* (v7 x) (+ 1 x)) (+ 2 (* 2 (+ 2 2)))))))
(assert (= g6 1))
