;; sequence(s): A118255
;; terms: 1 2 4 9 18 37 74 149 299 599 1198 2397 4794 9589 19179 38359 76718 153437 306874 613749
;; small program: loop((loop((2 + loop(x * y, x, 2)) mod (1 + x), 1, y) + x) + x, x, 2) div 2
;; fast program: loop((loop(if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then 0 else 1, 1, y) + x) + x, x, 1)
(set-logic UFNIA)
