;; sequence(s): A7798
;; terms: 0 0 2 18 116 660 3542 18438 94376 478440 2411882 12118458 60769436 304378620 1523487422 7622220078 38125449296 190670293200 953480606162 4767790451298
;; small program: loop2((((y div 2) + x) + x) + x, (2 * (y + y)) + y, x, 0, 1)
;; fast program: (((loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) div 2) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (- (div (w1 x) 2) (w4 x)) 2) 1))))
