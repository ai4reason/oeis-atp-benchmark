;; sequence(s): A210448
;; terms: 0 3 15 57 195 633 1995 6177 18915 57513 174075 525297 1582035 4758393 14299755 42948417 128943555 387027273 1161475035 3485211537
;; small program: loop2((1 + 2) * (x + y), y + y, x, 0, 1)
;; fast program: (1 + 2) * (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (+ 1 2) (- (w1 x) (v3 x))))))
