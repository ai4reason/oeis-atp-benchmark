;; sequence(s): A129972
;; terms: 1 3 3 5 5 5 5 7 7 7 7 7 7 7 7 9 9 9 9 9
;; small program: (loop(loop((x + y) div 2, x, y), x, 0) * 2) + 1
;; fast program: (loop(loop2((if (x * y) <= 0 then y else 1) + x, y div 2, 2 + (2 + 2), 1, x div 2), 1, 1 + x) * 2) - 1
(set-logic UFNIA)
