;; sequence(s): A189819
;; terms: 0 1 2 2 2 2 2 2 2 2 3 4 4 5 6 6 7 8 8 9
;; small program: loop(loop(loop(if (1 - (x mod (1 + 2))) <= 0 then (x div (1 + 2)) else 1, x + x, x), 1, y) + x, x, 0)
;; fast program: loop(loop((loop(if (1 - (x mod (1 + 2))) <= 0 then (x div (1 + 2)) else 1, x, x) + x) mod 2, 1, y) + x, x, 0)
(set-logic UFNIA)
