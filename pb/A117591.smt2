;; sequence(s): A117591
;; terms: 1 3 5 10 19 37 72 141 277 546 1079 2137 4240 8425 16761 33378 66523 132669 264728 528469
;; small program: loop(x + x, x, 1) + loop2(x + y, x, x, 0, 1)
;; fast program: (if x <= 0 then 0 else loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) + loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (ite (<= x 0) 0 (v2 x)) (w5 x)))))
