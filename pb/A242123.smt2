;; sequence(s): A242123
;; terms: 2 3 5 7 11 13 17 19 23 4 6 12 16 18 22 3 9 11 17 21
;; small program: (compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), 1 + x) mod (1 + loop((2 + y) * x, 2, 2))) + 1
;; fast program: (compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), (1 + x) mod 2, x) - 1, 1 + x) + 1) mod loop(2 + x, ((2 + 2) + 2) * 2, 1)
(set-logic UFNIA)
