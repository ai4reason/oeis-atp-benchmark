;; sequence(s): A94971
;; terms: 1 4 20 91 410 1845 8303 37366 168151 756680 3405062 15322783 68952523 310286355 1396288601 6283298708 28274844190 127236798856 572565594852 2576545176835
;; small program: loop(x div 2, x, loop((x + x) + x, x + x, 1))
;; fast program: loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div loop(x + x, x, 1)
(set-logic UFNIA)
