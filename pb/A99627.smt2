;; sequence(s): A99627
;; terms: 1 2 3 4 5 7 8 9 11 15 16 17 19 23 31 32 33 35 39 47
;; small program: loop((loop(loop((x - 1) mod y, x, 0), 2, x) + 1) + x, x, 1)
;; fast program: compr(loop(loop(loop(x div (1 + (x mod 2)), 1 + (2 + 2), x), 2, x) - 1, 2, x), 1 + x)
(set-logic UFNIA)
