;; sequence(s): A25620
;; terms: 1 4 9 16 36 64 81 144 256 324 576 729 1024 1296 2304 2916 4096 5184 6561 9216
;; small program: loop2((compr(loop(2 * (x * x), 2 + 2, 1 + 2) mod (1 + x), y) * x) + x, y, 2, 1, x)
;; fast program: loop2((compr(loop((x * x) * x, 2, 2 + (2 + 2)) mod (1 + x), y) * x) + x, y, 2, 1, x)
(set-logic UFNIA)
