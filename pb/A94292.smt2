;; sequence(s): A94292
;; terms: 0 0 1 3 9 25 68 182 483 1275 3355 8811 23112 60580 158717 415715 1088661 2850645 7463884 19541994
;; small program: loop2(x + loop2(y, x + y, y, 1, 0), 1 + y, x, 0, x) div 2
;; fast program: ((loop2(x + y, x, x - 1, 1, 2) - 1) * loop2(x + y, x, x - 2, 1, 1)) div 2
(set-logic UFNIA)
