;; sequence(s): A48506
;; terms: 1 2 7 25 81 241 673 1793 4609 11521 28161 67585 159745 372737 860161 1966081 4456449 10027009 22413313 49807361
;; small program: (loop2((x * y) + x, 1, x, x, x) div 2) + 1
;; fast program: ((1 + loop(0, 2 - x, x)) * loop(x + x, x - 2, x)) + 1
(set-logic UFNIA)
