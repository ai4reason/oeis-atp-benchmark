;; sequence(s): A262778
;; terms: 12 103 1005 10007 100011 1000013 10000017 100000019 1000000023 10000000029 100000000031 1000000000037 10000000000041 100000000000043 1000000000000047 10000000000000053 100000000000000059 1000000000000000061
;; small program: (compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + x) + 1) + loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2)))
;; fast program: (compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + x) + 1) + loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
