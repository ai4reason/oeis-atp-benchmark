;; sequence(s): A62510
;; terms: 0 3 3 9 15 33 63 129 255 513 1023 2049 4095 8193 16383 32769 65535 131073 262143 524289
;; small program: loop2(1 + (y + y), x + y, x, 0, 1)
;; fast program: loop(2 + (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1
(set-logic UFNIA)
