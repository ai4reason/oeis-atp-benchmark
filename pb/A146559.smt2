;; sequence(s): A146559
;; terms: 1 1 0 ~2 ~4 ~4 0 8 16 16 0 ~32 ~64 ~64 0 128 256 256 0 ~512
;; small program: loop2(x + y, y - x, x, 1, 0)
;; fast program: loop2(0 - y, x, (x div 2) mod (2 + 2), 1, x mod 2) * loop(x + x, x div 2, 1)
(set-logic UFNIA)
