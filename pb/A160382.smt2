;; sequence(s): A160382
;; terms: 0 0 1 0 0 0 1 0 1 1 2 1 0 0 1 0 0 0 1 0
;; small program: loop2(loop(loop((y div 2) + x, x, 0) mod 2, 1, y) + x, (y div 2) div 2, x, 0, x)
;; fast program: loop2(loop((loop((x mod 2) + y, x, 0) div 2) mod 2, 1, y) + x, y div (2 + 2), 1 + 2, 0, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (mod x 2) y))))
(assert (forall ((x Int)) (= (g5 x) x)))
(assert (= h5 0))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v5 x) (u5 (g5 x) h5))))
(assert (forall ((x Int)) (= (f4 x) (mod (div (v5 x) 2) 2))))
(assert (= g4 1))
