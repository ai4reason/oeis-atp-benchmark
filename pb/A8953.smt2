;; sequence(s): A8953
;; terms: 1 3 6 1 1 2 2 3 4 5 6 7 9 1 1 1 1 1 1 2
;; small program: loop(loop(y, (x div 2) div (1 + (2 + 2)), x), x, 1 + loop(x + y, x, x))
;; fast program: loop(loop(y, x div (2 + (2 * (2 + 2))), x), 2 + 2, 1 + loop(x + y, x, x))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h3 x) (+ 1 (v5 x)))))
