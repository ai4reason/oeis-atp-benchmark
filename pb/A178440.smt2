;; sequence(s): A178440
;; terms: 1 2 9 16 44 72 156 240 450 660 1122 1584 2508 3432 5148 6864 9867 12870 17875 22880
;; small program: loop(loop(((2 * ((x + x) + x)) div y) + x, y div 2, 1) + x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x, 1, 1 + (2 + (2 + 2))) div loop(x * y, x, 1), 1, y div 2) + x, x, 1)
(set-logic UFNIA)
