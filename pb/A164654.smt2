;; sequence(s): A164654
;; terms: 3 8 6 16 12 32 24 64 48 128 96 256 192 512 384 1024 768 2048 1536 4096
;; small program: 2 + loop2(2 + (y + y), x, x, 1, 2)
;; fast program: loop(x + x, x div 2, 2 + loop(2 + (2 + 2), x mod 2, 1))
(set-logic UFNIA)
