;; sequence(s): A1392
;; terms: 1 9 54 273 1260 5508 23256 95931 389367 1562275 6216210 24582285 96768360 379629720 1485507600 5801732460 22626756594 88152205554 343176898988 1335293573130
;; small program: (loop2((1 + y) * (x * y), 2 + y, x, 1, 1 + (2 * (2 + 2))) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + (2 * (2 + 2)))
;; fast program: (loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + (2 * (2 + 2))) div loop(x * y, x, 1)) div loop2(x * y, 1 + y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (div (w3 x) (v4 x)) (w5 x)))))
