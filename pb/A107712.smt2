;; sequence(s): A107712
;; terms: 1 3 35 1001 46189 2800733 247110827 25626846353 3359814435017 525737919635921 86239147714071593 16043263382808092801 3203015854291983284351 765364544499964883824067 196164712672886348479652149 51407675872168960728167564239
;; small program: loop2((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, 1 + y, x, 1, x)
;; fast program: loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, 1 + y, x, 1, x)
(set-logic UFNIA)
