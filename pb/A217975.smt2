;; sequence(s): A217975
;; terms: 2 4 8 22 46 128 268 746 1562 4348 9104 25342 53062 147704 309268 860882 1802546 5017588 10506008 29244646
;; small program: loop(loop(loop2(y, (x + y) + y, x, x mod 2, 1), 1, y) + x, x, 1) * 2
;; fast program: loop2((2 * ((x + x) + x)) - y, x, x div 2, 1 + (x mod 2), 2 - (x mod 2)) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i2 x) (mod x 2))))
(assert (= j2 1))
...
(assert (forall ((x Int)) (= (j3 x) (- 2 (mod x 2)))))
