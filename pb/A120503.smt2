;; sequence(s): A120503
;; terms: 1 2 3 3 4 5 6 6 7 8 9 9 9 10 11 12 12 13 14 15
;; small program: loop((y div loop2(x + y, y div (1 + 2), x, 0, x)) + x, x, 1)
;; fast program: loop((y div loop2(x + y, y div (1 + 2), 2 + 2, 0, x)) + x, x, 1)
(set-logic UFNIA)
