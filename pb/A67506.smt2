;; sequence(s): A67506
;; terms: 1 9 81 150094635296999121
;; small program: loop2(loop((x + x) + x, y, 2), x + x, x, 2, 2) div 2
;; fast program: loop2(loop2(x * y, y, y, 1, x), x, x - 1, (if x <= 0 then 0 else (2 * (2 + 2))) + 1, 2)
(set-logic UFNIA)
