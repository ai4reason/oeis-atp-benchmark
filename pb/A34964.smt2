;; sequence(s): A34964
;; terms: 28 39 53 67 83 101 119 139 161 181 199 221 243 263 287 311 331 351 373 395
;; small program: (loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 1 + (2 + 2), 1, x) + 2) + 2
;; fast program: (loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 1 + (2 + 2), 1, x) + 2) + 2
(set-logic UFNIA)
