;; sequence(s): A138654
;; terms: 0 3 1 23 97 423 2961 4343 63169 245575 408305 1809559 84001 50919655 155110993 548906039 2768600449 15085235847 36877174193 258140219351
;; small program: loop((2 * ((x + x) + x)) + x, x, 1) mod loop(x + x, x + x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + (2 + 2)), x mod 2, 1), (2 * (2 * (2 * (2 + (2 + 2))))) + 1) mod loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (w2 x) (v4 x)))))
