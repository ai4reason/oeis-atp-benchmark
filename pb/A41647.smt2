;; sequence(s): A41647
;; terms: 1 2 73 148 5401 10950 399601 810152 29565073 59940298 2187415801 4434771900 161839204201 328113180302 11973913695073 24275940570448 885907774231201 1796091489032850 65545201379413801 132886494247860452
;; small program: loop2((((if (x mod 2) <= 0 then (2 + loop(x * x, 2, 2)) else 1) * 2) * x) + y, x, x, 1, 0)
...
(assert (= v1 (u1 g1 h1)))
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (* (* (ite (<= (mod x 2) 0) (+ 2 v1) 1) 2) x) y))))
