;; sequence(s): A260217
;; terms: 0 0 4 24 100 360 1204 3864 12100 37320 114004 346104 1046500 3155880 9500404 28566744 85831300 257756040 773792404 2322425784
;; small program: 2 - loop2((x - y) + x, (y + y) + y, x, 2, 2)
;; fast program: (loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2)))) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (w1 x) (v3 x)) 2))))
