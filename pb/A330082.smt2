;; sequence(s): A330082
;; terms: 0 5 15 15 25 75 105 70 90 225 275 165 195 455 525 300 340 765 855 475
;; small program: loop(x div (2 - (x mod 2)), 2, (x * x) + x) * (1 + (2 + 2))
;; fast program: loop(loop(x div 2, 1 - (x mod 2), x), 1, ((x * x) + x) div 2) * (1 + (2 + 2))
(set-logic UFNIA)
