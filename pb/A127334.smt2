;; sequence(s): A127334
;; terms: 58 75 95 119 143 169 197 223 251 281 311 341 371 401 431 463 493 523 559 593
;; small program: ((loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 1 + (2 + (2 + 2)), 1, x) + 2) + 2) + 2
;; fast program: ((loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 1 + (2 + (2 + 2)), 1, x) + 2) + 2) + 2
(set-logic UFNIA)
