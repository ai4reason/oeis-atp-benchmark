;; sequence(s): A94723
;; terms: 1 3 8 21 54 137 344 857 2122 5229 12836 31413 76686 186833 454448 1103921 2678674 6494037 15732284 38089677
;; small program: loop2((x + x) + y, x, x, 2, 1) - loop(x + x, x, 1)
;; fast program: loop2((x + x) + y, x, x, 2, 1) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
