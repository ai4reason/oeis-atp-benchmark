;; sequence(s): A201003
;; terms: 0 36 11628 3744216 1205625960 388207814940 125001710784756 40250162664876528 12960427376379457296 4173217365031520372820 1343763031112773180590780 432687522800947932629858376 139324038578874121533633806328 44861907734874666185897455779276
;; small program: loop(loop2(y, (2 * (y + y)) + x, 2 * (y + y), 0, 1) + x, x, 1) div 2
;; fast program: loop(x * x, 1, loop2((2 * ((2 * (2 * (x + x))) + x)) - y, x, x, 1, 1)) div (2 * (2 + 2))
(set-logic UFNIA)
