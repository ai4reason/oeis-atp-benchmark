;; sequence(s): A37114
;; terms: 3 100 50 25 826 413 13630 6815 224896 112448 56224 28112 14056 7028 3514 1757 57982 28991 956704 478352
;; small program: loop(loop(2 + (loop((2 * (x * x)) - x, 2, 2) * x), x mod 2, x) div 2, x, 1 + 2)
;; fast program: loop(loop(2 + ((2 + loop((x * x) * x, 1, 2 + 2)) * x), x mod 2, x) div 2, x, 1 + 2)
(set-logic UFNIA)
