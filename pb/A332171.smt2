;; sequence(s): A332171
;; terms: 1 717 77177 7771777 777717777 77777177777 7777771777777 777777717777777 77777777177777777 7777777771777777777 777777777717777777777 77777777777177777777777 7777777777771777777777777 777777777777717777777777777 77777777777777177777777777777 7777777777777771777777777777777
;; small program: ((loop(1 + (2 * ((2 * (x + x)) + x)), x + x, 1) - loop(2 * ((2 * (x + x)) + x), x, 1)) * (1 + (2 + (2 + 2)))) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
;; fast program: ((((((((((loop2(x * y, y, x, 2, 2 + (2 * (2 + 2))) - 1) * (1 + (2 + 2))) - 2) - 2) * loop2(x * y, y, x, 2, 2 + (2 * (2 + 2)))) div (1 + (2 * (2 + 2)))) * (1 + (2 + (2 + 2)))) div 2) + 1) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (* (- (v0 x) (v1 x)) (+ 1 (+ 2 (+ 2 2)))) (w2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (- (+ (+ (div (* (div (* (- (- (* (- (w3 x) 1) (+ 1 (+ 2 2))) 2) 2) (w4 x)) (+ 1 (* 2 (+ 2 2)))) (+ 1 (+ 2 (+ 2 2)))) 2) 1) (w5 x)) 1))))
