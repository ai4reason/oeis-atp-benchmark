;; sequence(s): A164358
;; terms: 1 3 4 3 2 3 4 3 2 3 4 3 2 3 4 3 2 3 4 3
;; small program: loop2(2 - y, x, x, 0, 1) + (if x <= 0 then 1 else 2)
;; fast program: (if x <= 0 then 0 else loop(y, (1 + x) mod (2 + 2), 2)) + 1
(set-logic UFNIA)
