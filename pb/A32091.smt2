;; sequence(s): A32091
;; terms: 2 6 16 32 60 100 160 240 350 490 672 896 1176 1512 1920 2400 2970 3630 4400 5280
;; small program: loop(loop(loop(x + y, y div 2, x), 2 + y, x), x, 1) * 2
;; fast program: (loop(loop(x + y, 1 + y, x), x div 2, 1) * loop2(1 + y, x, x, 1, 2)) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (v3 x) (w5 x)) 2))))
