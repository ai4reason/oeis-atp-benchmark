;; sequence(s): A60336
;; terms: 3 45 3654 1929501 7355513529 212787633478239 47937678641708357304 85524882506287709213421693 1224201212028616655577478516173315 142132497715474639139076246298436794277130
;; small program: loop(loop2(x * y, 1 + y, x, 1, loop((x + x) + x, x, 1)) div loop(x * y, x, 1), 1, 1 + x)
;; fast program: loop2(x * y, 1 + y, 1 + x, 1, loop2(x * y, y, x, 1 + 2, 1 + 2)) div loop(x * y, x, 1 + x)
(set-logic UFNIA)
