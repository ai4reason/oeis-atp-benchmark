;; sequence(s): A18775
;; terms: 1 2 3 6 13 26 39 78 169 338 507 1014
;; small program: loop(compr(loop((x + x) + y, 2 * (2 + 2), 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((loop((2 * ((x * x) * x)) - x, 1, 2 * (2 + 2)) - 2) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
