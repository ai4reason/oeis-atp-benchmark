;; sequence(s): A50250
;; terms: 9 18 108 198 1098 1998 10998 19998 109998 199998 1099998 1999998 10999998 19999998 109999998 199999998 1099999998 1999999998 10999999998 19999999998
;; small program: loop2(loop((x + x) + x, 2, y) + x, x - y, 1 + x, 2, 1) - 2
;; fast program: loop(loop2(x * y, y, x div 2, loop(1 + (2 + (2 * (2 + 2))), x mod 2, 2), 2 + (2 * (2 + 2))), 1, 1 + x) - 2
(set-logic UFNIA)
