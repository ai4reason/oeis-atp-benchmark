;; sequence(s): A69262
;; terms: 16 36 100 196 484 676 1156 1444 2116 3364 3844 5476 6724 7396 8836 11236 13924 14884 17956 20164
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2, 2, x) * 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, y, 2, 2, x) * 2
(set-logic UFNIA)
