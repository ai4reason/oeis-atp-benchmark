;; sequence(s): A82413
;; terms: 1 7 57 495 4401 39447 354537 3189375 28700001 258286887 2324542617 20920765455 188286534801 1694577750327 15251196564297 137260759512735 1235346806916801 11118121176157767 100063090327139577 900567812169415215
;; small program: loop2((2 * loop((x + x) + x, y, x)) + x, 0, x, 1, x)
;; fast program: loop((2 * (x * x)) + x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div (1 + 2)
(set-logic UFNIA)
