;; sequence(s): A139209
;; terms: ~1 ~1 ~1 0 5 23 80 249 731 2072 5741 15663 42272 113201 301427 799272 2112773 5571815 14668208 38563881
;; small program: loop2(x + y, x, x + x, 0, 1) - loop(x + x, x, 1)
;; fast program: loop2(((x - y) + x) + x, x, x - 2, if (x - 1) <= 0 then x else (1 + 2), 1) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
