;; sequence(s): A139729
;; terms: 0 1 1 25 161 681 3057 15225 55105 233801 269201 3471385 1882337 50495465 186023729 63600825 3793632897 12667859593 28111390417 253002513753
;; small program: loop((x + x) + x, x + x, 1) mod loop(x + x, x + x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) mod loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
