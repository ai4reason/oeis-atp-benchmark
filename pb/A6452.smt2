;; sequence(s): A6452
;; terms: 1 1 2 4 11 23 64 134 373 781 2174 4552 12671 26531 73852 154634 430441 901273 2508794 5253004
;; small program: loop(loop(loop2(y, (x + y) + y, x, x mod 2, 1), 1, y - 1) + x, x, 1)
;; fast program: loop2((2 * ((x + x) + x)) - y, x, x div 2, 1, loop(1, x mod 2, 2) * 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j3 x) (* (v4 x) 2))))
