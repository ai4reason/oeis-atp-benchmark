;; sequence(s): A18069
;; terms: 1 21 307 3873 45235 504633 5465323 58007361 606913219 6283868745 64556638939 659310178449 6703052628403 67910134629657 686138217844555 6917677165178337 69627131588692387 699874195511336169
;; small program: loop(((loop2((2 * ((2 * (x + x)) + x)) + ((y * y) * y), y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop(((loop(loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2))) - loop((x * x) * x, 1, loop(x + x, x, 2)), 1, y) + x) + x) + x, x, 2) div 2
(set-logic UFNIA)
