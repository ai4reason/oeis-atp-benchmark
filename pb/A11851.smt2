;; sequence(s): A11851
;; terms: 0 0 0 0 0 0 1 4 11 25 50 92 158 257 400 600 873 1237 1713 2325
;; small program: loop(loop(loop(loop(x + y, y - 2, x), y, x), y - 2, x), x, 0) div (1 + (2 + 2))
;; fast program: ((loop2(x * y, y - 1, 2 + (1 + 2), 1, x) div loop(x * x, 1, 2 + (2 * (2 + 2)))) div (1 + 2)) div 2
(set-logic UFNIA)
...
(assert (= v5 (u5 g5 h5)))
(assert (forall ((x Int)) (= (fast x) (div (div (div (w4 x) v5) (+ 1 2)) 2))))
