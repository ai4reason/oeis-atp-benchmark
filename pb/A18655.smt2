;; sequence(s): A18655
;; terms: 1 2 3 4 6 12 67 134 201 268 402 804
;; small program: loop(compr(loop(2 * ((x * x) + y), 2, 1 + 2) mod (1 + x), y), x, 0) + 1
;; fast program: (((((compr(loop(2 * ((x * x) + y), 2, 1 + 2) mod (1 + x), x) + 1) + x) - x) + x) - x) div 1
(set-logic UFNIA)
