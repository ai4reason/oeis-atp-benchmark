;; sequence(s): A166027
;; terms: 4 1 24 6 144 36 864 216 5184 1296 31104 7776 186624 46656 1119744 279936 6718464 1679616 40310784 10077696
;; small program: loop2(y, 2 * ((x + x) + x), x, 2 + 2, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1, x mod 2, 2 + 2), 2 + (2 + 2))
(set-logic UFNIA)
