;; sequence(s): A265-A276234
;; terms: 1 1 3 1 5 3 7 1 9 5 11 3 13 7 15 1 17 9 19 5
;; small program: 1 + loop(x div (1 + (x mod 2)), x, x)
;; fast program: (loop(loop(loop(loop(loop(loop(loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, x div 2), x mod 2, x) div 2, x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2) * 2) + 1
(set-logic UFNIA)
