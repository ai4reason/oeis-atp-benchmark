;; sequence(s): A60590
;; terms: 0 2 2 14 10 62 42 254 170 1022 682 4094 2730 16382 10922 65534 43690 262142 174762 1048574
;; small program: (2 * loop2(y + y, x + y, x, 1, x mod 2)) - 2
;; fast program: (loop((2 * ((x + x) + x)) - 1, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)) * 2
(set-logic UFNIA)
