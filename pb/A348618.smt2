;; sequence(s): A348618
;; terms: 1 2 16 140 1280 12012 114688 1108536 10813440 106234700 1049624576 10418726760 103817412608 1037865473400 10404558274560 104557533120240 1052941297385472 10623352887172620 107358720517734400 1086563988284497800
;; small program: loop2(2 * (x * y), 2 + y, x, 1, x) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 2 + y, x - 1, 1, 2 + x) * loop(x + x, x, 1)) div loop(x * y, x - 1, 1)
(set-logic UFNIA)
