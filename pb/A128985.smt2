;; sequence(s): A128985
;; terms: 0 16 144 768 3200 11520 37632 114688 331776 921600 2478080 6488064 16613376 41746432 103219200 251658240 606076928 1443889152 3406823424 7969177600
;; small program: loop(loop(x + x, x, x) * x, 1, 1 + x) * x
;; fast program: 2 * (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1 + x))) * x)
(set-logic UFNIA)
