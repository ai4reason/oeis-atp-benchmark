;; sequence(s): A773
;; terms: 0 0 0 1 1 6 8 29 45 130 220 561 1001 2366 4368 9829 18565 40410 77540 164921
;; small program: (loop2((x + y) + y, x, x, 1, 0) - loop2(y, (x + x) + x, x, 1, 1)) div 2
;; fast program: ((((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)) * 2) + 1) - loop2(x * y, y, x div 2, 1, 1 + 2)) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (- (+ (* (div (v2 x) (+ 1 2)) 2) 1) (w5 x)) 2))))
