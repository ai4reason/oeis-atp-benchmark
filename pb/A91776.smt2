;; sequence(s): A91776
;; terms: 1 1 1 2 30 6678144 14783742920460482277828601638764478251520
;; small program: loop(loop2(x * y, 1 + y, y, 1, x) div y, x, 1)
;; fast program: loop((loop2(x * y, 1 + y, y, 1, 1 + x) * x) div (1 + y), x - 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (div (w1 x y) y))))
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (div (* (w3 x y) x) (+ 1 y)))))
