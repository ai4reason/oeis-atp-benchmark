;; sequence(s): A122746
;; terms: 1 2 6 12 28 56 120 240 496 992 2016 4032 8128 16256 32640 65280 130816 261632 523776 1047552
;; small program: loop(x + x, x, 2) - loop2(y + y, x, x, 1, 1)
;; fast program: loop(x + x, x mod 2, loop((2 * (x * x)) - x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
