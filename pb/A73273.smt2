;; sequence(s): A73273
;; terms: 3 4 7 9 13 15 19 23 26 32 35 39 43 47 52 56 62 65 69 74
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 2 + y, 2, 1, x) div 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 2 + y, 2, 1, x) div 2
(set-logic UFNIA)
