;; sequence(s): A257199
;; terms: 1 5 16 41 91 182 336 582 957 1507 2288 3367 4823 6748 9248 12444 16473 21489 27664 35189
;; small program: 1 + loop(loop(loop(loop(x + y, y, x), y, x) + y, y, x) + y, x, x)
;; fast program: loop(loop(loop((((x * x) - x) div (2 + (2 + 2))) + x, 1, ((x * x) + x) div 2), 1, y) + x, 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f6 x) (+ (div (- (* x x) x) (+ 2 (+ 2 2))) x))))
(assert (= g6 1))
