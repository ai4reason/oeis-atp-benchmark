;; sequence(s): A327704
;; terms: 1 2 3 4 4 5 5 6 6 6 7 7 7 7 8 8 8 8 8 9
;; small program: loop(loop(((x div 2) + x) div 2, x, 1 + y) + x, x, 1)
;; fast program: loop(loop(((x div 2) + x) div 2, x, y) + x, 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (div (+ (div x 2) x) 2))))
...
(assert (forall ((x Int)) (= (f3 x) (div (+ (div x 2) x) 2))))
