;; sequence(s): A186314
;; terms: 0 0 1 6 26 99 352 1200 3977 12918 41338 130779 410048 1276512 3950929 12170598 37343834 114209811 348332320 1059927312
;; small program: loop((x + x) + x, x, 1) - loop2(x + y, x, x + x, 1, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - (if x <= 0 then 1 else loop2(((x - y) + x) + x, x, x - 1, 1 + 2, 1))
(set-logic UFNIA)
