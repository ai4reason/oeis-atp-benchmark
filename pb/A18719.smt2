;; sequence(s): A18719
;; terms: 1 3 5 15 61 183 305 915
;; small program: loop(compr(loop(((x + x) + x) - y, 2 + (2 + 2), 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((2 * (2 * (x * x))) + x, 1, (2 * (2 * (2 + 2))) - 1) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
