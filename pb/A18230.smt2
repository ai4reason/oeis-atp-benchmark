;; sequence(s): A18230
;; terms: 3 12 27 48 108 192 432 1728
;; small program: loop2((compr(loop((2 + y) * x, 2, 2) mod (1 + x), y) * x) + x, y, 2, 1 + 2, x)
;; fast program: loop2((compr((2 * (2 * (2 + (2 + 2)))) mod (1 + x), y) * x) + x, y, 2, 1 + 2, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (mod (* 2 (* 2 (+ 2 (+ 2 2)))) (+ 1 x)))))
