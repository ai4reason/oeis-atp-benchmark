;; sequence(s): A34961
;; terms: 10 15 23 31 41 49 59 71 83 97 109 121 131 143 159 173 187 199 211 223
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 1 + 2, 1, x) + 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 1 + 2, 1, x) + 2
(set-logic UFNIA)
