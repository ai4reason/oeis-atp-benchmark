;; sequence(s): A181639
;; terms: 20 30 200 300 2000 3000 20000 30000 200000 300000 2000000 3000000 20000000 30000000
;; small program: loop2(y, 2 * ((2 * (x + x)) + x), 2 + x, 2, 1 + 2)
;; fast program: loop2(x * y, y, 1 + (x div 2), 2 + (x mod 2), 2 * (1 + (2 + 2)))
(set-logic UFNIA)
