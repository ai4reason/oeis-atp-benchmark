;; sequence(s): A127610
;; terms: 0 0 0 2 15 123 1118 11344 127831 1590245 21700716 322880256 5209007463 90661989607 1694616510154 33876697720832 721588072472639 16321494271570569 390811944752490542 9878354899591168000
;; small program: (loop2((x * y) + x, y, x, 1, x) div loop(x + x, x, 1)) - loop(x * y, x, 1)
;; fast program: ((loop2(x * y, y, x - (x div 2), 1, 1 + x) * loop2(x * y, y, x div 2, 1, 1 + x)) div loop(x + x, x, 1)) - loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (div (* (w3 x) (w4 x)) (v5 x)) (v6 x)))))
