;; sequence(s): A172191
;; terms: 32 162 1250 4802 29282 57122 167042 260642 559682 1414562 1847042 3748322 5651522 6837602 9759362 15780962 24234722 27691682 40302242 50823362
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2 + 2, 2, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (((x * x) * x) * x), 0, 2, 1, x)
(set-logic UFNIA)
