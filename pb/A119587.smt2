;; sequence(s): A119587
;; terms: 0 1 1 3 7 17 39 87 189 403 847 1761 3631 7439 15165 30795 62343 125905 253783 510759
;; small program: 1 + (loop(x + x, x, 1) - loop2(x + y, x, x, 2, 0))
;; fast program: 1 + (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x + y, x, x - 1, 2, 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ 1 (- (v2 x) (w5 x))))))
