;; sequence(s): A161718
;; terms: 1 ~2 6 ~10 14 ~18 22 ~26 30 ~34 38 ~42 46 ~50 54 ~58 62 ~66 70 ~74
;; small program: loop2(y, 0 - y, x, 1, 2) * (1 - (x + x))
;; fast program: if x <= 0 then 1 else (2 * loop(0 - x, x mod 2, (x - 1) + x))
(set-logic UFNIA)
