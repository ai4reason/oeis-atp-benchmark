;; sequence(s): A6645
;; terms: 0 0 1 4 14 44 131 376 1052 2888 7813 20892 55338 145428 379655 985520 2545720 6547792 16777993 42847988
;; small program: (loop2(y, (x + y) + y, x, x, x - 1) div 2) div 2
;; fast program: (1 + loop2((x + x) + y, x, x - 1, x - 1, x)) div (2 + 2)
(set-logic UFNIA)
