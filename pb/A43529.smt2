;; sequence(s): A43529
;; terms: 1 1 2 1 2 2 2 1 2 2 2 2 2 2 2 1 2 2 2 2
;; small program: if loop((x - 1) mod y, x, 0) <= 0 then 1 else 2
;; fast program: if loop(loop((x * x) * x, 1, 2 + 2) mod (1 + x), x mod 2, x) <= 0 then 1 else 2
(set-logic UFNIA)
