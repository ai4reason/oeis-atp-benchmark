;; sequence(s): A131019
;; terms: 13 18 24 30 36 44 51 60 69 76 84 92 101 110 120 129 136 145 153 162
;; small program: (loop2(compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + y) + x, 1 + y, 2 + 2, 0, x) div 2) + 2
;; fast program: loop2(compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, 1 + y) + x, 1 + y, 2 + 2, 0, x) + 2
(set-logic UFNIA)
