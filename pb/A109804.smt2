;; sequence(s): A109804
;; terms: 0 1 3 6 10 15 16 17 18 19 20 21 23 25 27 29 31 33 36 39
;; small program: loop(loop(loop(y, (x div 2) div (1 + 2), x), 2, y) + x, x, 0)
;; fast program: loop(loop(loop(y, x div (2 + (2 + 2)), x), 2, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g2 x) (div (div x 2) (+ 1 2)))))
...
(assert (forall ((x Int)) (= (g5 x) (div x (+ 2 (+ 2 2))))))
