;; sequence(s): A124671
;; terms: 1 3 7 16 37 85 191 418 893 1871 3863 7892 16005 32297 64959 130374 261309 523299 1047415 2095800
;; small program: loop(loop((loop(x + x, y, 1) - y) + x, y, x), x, 1) + x
;; fast program: ((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - 1) - loop(loop(x + y, y, x), x, 2)) - x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (- (v3 x) 1) (v6 x)) x))))
