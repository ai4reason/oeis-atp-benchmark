;; sequence(s): A111254
;; terms: 8 11 17 21 29 33 41 49 55 67 73 81 89 97 107 115 127 133 141 151
;; small program: loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 2 + y, 2, 1, x) + 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 2 + y, 2, 1, x) + 2
(set-logic UFNIA)
