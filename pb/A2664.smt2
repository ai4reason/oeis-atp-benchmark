;; sequence(s): A2664
;; terms: 0 0 0 0 0 1 7 29 93 256 638 1486 3302 7099 14913 30827 63019 127858 258096 519252
;; small program: loop(loop(loop(loop(x + y, (y - 2) - 2, x), y, x), y, x) + x, x, 0)
;; fast program: loop((loop(loop((x * x) - x, 1, ((x * x) - x) div 2) div (2 + (2 + 2)), 1, y) + x) + x, x - 2, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g3 x y) (- (- y 2) 2))))
