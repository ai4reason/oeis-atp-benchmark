;; sequence(s): A30629
;; terms: 1024 59049 9765625 282475249 25937424601 137858491849 2015993900449 6131066257801 41426511213649 420707233300201 819628286980801 4808584372417849 13422659310152401
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2 + (2 * (2 + 2)), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (loop((x * x) * x, 1, (x * x) * x) * x), 0, 2, 1, x) div 2
(set-logic UFNIA)
