;; sequence(s): A112387
;; terms: 1 2 1 4 3 8 5 16 11 32 21 64 43 128 85 256 171 512 341 1024
;; small program: loop2(loop(y, x - y, y + y), x, x, 1, 1)
;; fast program: (loop(x + x, x div 2, loop(2 + (2 + 2), x mod 2, 2)) + 1) div (1 + 2)
(set-logic UFNIA)
