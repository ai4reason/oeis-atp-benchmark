;; sequence(s): A113549
;; terms: 1 2 60 24 15120 720 8648640 40320 8821612800 3628800 14079294028800 479001600 32382376266240000 87178291200 101421602465863680000 20922789888000 415017197290314178560000 6402373705728000 2149789081963827444940800000
;; small program: loop2((x * y) + x, 1 + y, 1 + x, 1, loop(0, x mod 2, x))
;; fast program: loop2(x * y, 1 + y, 1 + x, 1, 1 + loop(0, x mod 2, x))
(set-logic UFNIA)
