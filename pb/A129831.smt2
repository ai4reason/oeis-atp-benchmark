;; sequence(s): A129831
;; terms: 1 1 2 6 9 39 66 318 627 3213 7182 38898 96237 548883 1478142 8843778 25615647 160178913 494550162 3221341038
;; small program: loop(loop(loop((x * y) + x, y, 1) div x, y, 1) - x, x, 1)
;; fast program: loop(loop(loop2(x * y, y - 2, x div 2, 2 + x, x), 1, y) - x, x - 1, 1)
(set-logic UFNIA)
