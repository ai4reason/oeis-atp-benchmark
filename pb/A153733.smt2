;; sequence(s): A153733
;; terms: 0 0 2 0 4 2 6 0 8 4 10 2 12 6 14 0 16 8 18 4
;; small program: loop(x div (1 + (x mod 2)), x, x)
;; fast program: loop(loop(loop(loop(loop(loop(x, (x mod (2 + 2)) - 2, x) div 2, x mod 2, x) div 2, x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2), x mod 2, x div 2) * 2
(set-logic UFNIA)
