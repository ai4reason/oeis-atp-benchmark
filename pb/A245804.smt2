;; sequence(s): A245804
;; terms: ~1 0 6 30 114 390 1266 3990 12354 37830 115026 348150 1050594 3164070 9516786 28599510 85896834 257887110 774054546 2322950070
;; small program: 0 - loop2((x - y) + x, (y + y) + y, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2))) - loop(x + x, x, 1 + 2)
(set-logic UFNIA)
