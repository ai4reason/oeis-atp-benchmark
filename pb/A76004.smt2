;; sequence(s): A76004
;; terms: 1 80 4160 179200 6967296 254607360 8940421120 305659904000 10259284361216 339910422691840 11158051230842880 363834840082022400 11805930580539867136 381715961976738283520 12309283295632755261440
;; small program: loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, y, 1, 2) + x, x, 1) * loop(x + x, (x + x) + x, 1)
;; fast program: loop(loop(((loop(((x - 1) + x) * ((x * x) - x), 1, loop(x + x, x, 2)) div (1 + 2)) + 1) div 2, 1, y) + (((x + x) + x) * 2), x, 1) * loop2(x * y, y, x, 1, 2 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (div (+ (div (v5 x) (+ 1 2)) 1) 2))))
(assert (= g4 1))
(assert (forall ((x Int) (y Int)) (= (h4 x y) y)))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int) (y Int)) (= (v4 x y) (u4 g4 (h4 x y)))))
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (v4 x y) (* (+ (+ x x) x) 2)))))
...
(assert (forall ((x Int)) (= (fast x) (* (v3 x) (w7 x)))))
