;; sequence(s): A135162
;; terms: 0 1 19 199 1711 13471 101359 743359 5367871 38381311 272651599 1928323519 13596619231 95666721151 672114790639 4717029615679 33080299697791 231867445524991 1624598513486479 11379820537307839
;; small program: (loop2(((2 * ((x + x) + x)) + x) + y, (2 * (y + y)) + y, x, 0, 2) - loop((x + x) + x, x, 1)) + loop(x + x, x, 1)
;; fast program: ((loop(x + x, x, 1) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) - loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
