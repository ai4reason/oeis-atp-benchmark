;; sequence(s): A5673
;; terms: 0 0 0 0 1 2 6 11 24 42 81 138 250 419 732 1214 2073 3414 5742 9411
;; small program: loop2(x + y, x, x, 1, 1) - loop2(1 + y, x + x, x, 1, 1)
;; fast program: (1 - loop(x + x, x div 2, 2 + (x mod 2))) + loop2(x + y, x, x, 1, 1)
(set-logic UFNIA)
