;; sequence(s): A214857
;; terms: 1 2 3 4 6 7 9 10 11 13 14 16 17 18 20 21 23 24 25 27
;; small program: loop(loop(x + y, x, y) div x, x * x, 1)
;; fast program: loop2(loop(x + y, x, y) div x, y, 1 + 2, 1 + x, x * x)
(set-logic UFNIA)
