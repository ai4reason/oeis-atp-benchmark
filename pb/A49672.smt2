;; sequence(s): A49672
;; terms: 0 1 10 71 492 3380 23180 158899 1089144 7465159 51167050 350704322 2403763416 16475639933 112925716670 774004377655 5305104928368 36361730123272 249227005938340 1708227311451263
;; small program: loop2(loop2(x + y, x, y, 1, 0) + x, (1 + 2) + y, x, 0, x)
;; fast program: (loop2(((2 * ((x + x) + x)) - y) + x, x, x - 1, if x <= 0 then 0 else (1 + 2), 0) - loop2(x + y, x, x, 0, 1)) div 2
(set-logic UFNIA)
