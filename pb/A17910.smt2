;; sequence(s): A17910
;; terms: 1 1 2 2 4 5 8 11 16 22 32 45 64 90 128 181 256 362 512 724
;; small program: loop2(2 * ((x - y) + x), x, x, 1, 0) div loop2((x + x) + y, x, x, 1, 1)
;; fast program: loop2(2 * ((x - y) + x), x, x - 1, (if x <= 0 then 0 else 2) + 1, 1) div loop2((x + x) + y, x, x, 1, 0)
(set-logic UFNIA)
