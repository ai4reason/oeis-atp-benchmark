;; sequence(s): A251733
;; terms: 0 3 ~18 135 ~972 7047 ~51030 369603 ~2676888 19387755 ~140418522 1017000927 ~7365772260 53347641903 ~386377801758 2798395587675 ~20267773741872 146792202740307 ~1063163180118690 7700108905374903
;; small program: loop((x + x) + x, x, loop2((y - x) - x, x, x, 0, 1))
;; fast program: loop2((y - x) - x, x, x, 0, 1) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
