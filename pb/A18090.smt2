;; sequence(s): A18090
;; terms: 1 22 337 4450 54301 631462 7111417 78287530 847442101 9055541902 95785566097 1004927161810 10472915657101 108541954516342 1119734731454377 11506184005511290 117841370316867301
;; small program: loop(((loop(loop((x + x) + x, y + y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop(((1 + 2) * (x * x)) - x, 1, loop2(x * y, y, x, 1, 1 + 2)) div 2, 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
