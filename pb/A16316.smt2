;; sequence(s): A16316
;; terms: 1 19 255 2975 32231 333759 3353335 32976175 319155111 3051352799 28893830615 271497720975 2535105456391 23548956856639 217804673719095 2007154559579375 18439691005140071 168959618797797279
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (2 * (2 * (x + x))), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop(((x * x) * x) - x, 1, loop(x + x, x, 2)) div (1 + 2), 1, y) + x) + (((x + x) * 2) * 2), x, 2) div 2
(set-logic UFNIA)
