;; sequence(s): A87946
;; terms: 1 3 10 35 126 461 1702 6315 23494 87533 326382 1217483 4542526 16950573 63255670 236063915 880983606 3287837741 12270301822 45793238475
;; small program: loop((x + loop2(y, (2 * (y + y)) - x, y, 0, 1)) + x, x, 1)
;; fast program: (loop2((2 * (x + x)) - y, x, x, 2, 1) + loop(x + x, x - 1, 2)) div (1 + 2)
(set-logic UFNIA)
