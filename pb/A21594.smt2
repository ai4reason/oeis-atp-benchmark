;; sequence(s): A21594
;; terms: 1 20 270 3100 32711 328440 3195340 30437000 285695421 2653625260 24459281210 224170373700 2045792060131 18609941810480 168874176353880 1529560509125200 13833895100278841 124980009723284100
;; small program: loop(((loop((loop(1 + loop((x + x) + x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((((y div 2) + y) * y) + x, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (* (+ (div y 2) y) y) x))))
