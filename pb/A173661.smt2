;; sequence(s): A173661
;; terms: 1 7 16 47 121 322 841 2207 5776 15127 39601 103682 271441 710647 1860496 4870847 12752041 33385282 87403801 228826127
;; small program: loop2(x + y, 2 + x, x + x, 1, 1) + loop2(y, x, x, 0, 2)
;; fast program: loop(x - 2, x mod 2, loop(x * x, 1, loop2(x + y, x, x, 1, 2)))
(set-logic UFNIA)
