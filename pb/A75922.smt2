;; sequence(s): A75922
;; terms: 1 42 1225 30870 722701 16235562 355888225 7683656190 164302593301 3491636199282 73902587019625 1560051480424710 32874455072382301 691950889177526202 14553192008156093425 305928163614832076430
;; small program: loop((2 * ((x + x) + x)) + x, x, loop(((loop(1 + (x + x), y, 1) + x) + x) + x, x, 1))
;; fast program: ((loop2((2 * (x + y)) + x, y + y, x, 1, 2 + 2) div 2) + 1) * loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
