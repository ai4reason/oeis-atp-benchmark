;; sequence(s): A157240
;; terms: 2 ~1 ~7 ~7 17 65 65 ~127 ~511 ~511 1025 4097 4097 ~8191 ~32767 ~32767 65537 262145 262145 ~524287
;; small program: 1 + loop2(2 * ((x - y) - y), x, x, 1, 1)
;; fast program: (loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) * loop2(x - y, x, x mod (2 + (2 + 2)), 1, 2)) + 1
(set-logic UFNIA)
