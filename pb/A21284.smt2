;; sequence(s): A21284
;; terms: 1 22 335 4400 53481 620202 6970675 76624900 828512861 8845504382 93498427815 980374738200 10212261530641 105799242660562 1091082072825755 11208627544304300 114766536787594821
;; small program: loop(loop2((2 * (((2 * (x + x)) + x) + y)) - 1, y + y, y, 1, 2) + loop((x + x) + x, 2, x), x, 1)
