;; sequence(s): A117576
;; terms: 1 0 ~1 ~1 3 1 ~5 ~3 11 5 ~21 ~11 43 21 ~85 ~43 171 85 ~341 ~171
;; small program: 1 - loop2(y, (x - y) + x, x div 2, x mod 2, 2)
;; fast program: (loop2(x * y, y, x div 2, loop(1, x mod 2, 2), 0 - 2) + 1) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (w1 x) 1) (+ 1 2)))))
