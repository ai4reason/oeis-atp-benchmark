;; sequence(s): A81460
;; terms: 1 4 72 23184 2403763488 25840354427429161536 2986152136938872067784669198846010266752 39878504028822311675150039382403961856254569551519724209276629577579916539865344
;; small program: loop2(x + y, x, loop(1 + (x + x), x, 2), 1, 0) div 2
;; fast program: loop2(loop2(x + y, x, y, 1 + 2, 1) * x, (2 + y) + y, x, 1, 1)
(set-logic UFNIA)
