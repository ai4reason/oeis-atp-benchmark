;; sequence(s): A18660
;; terms: 1 2 4 7 14 28 29 58 116 203 406 812
;; small program: (compr(loop(2 * (2 + ((x * x) - x)), 2 + 2, 1) mod (1 + x), x) + 1) div 1
;; fast program: (compr(loop((x * x) - x, 1, 2 + loop((x * x) * x, 1, 1 + 2)) mod (1 + x), x) - 1) + 2
(set-logic UFNIA)
