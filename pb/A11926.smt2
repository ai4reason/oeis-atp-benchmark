;; sequence(s): A11926
;; terms: 0 0 0 0 1 7 22 52 105 189 315 495 742 1072 1501 2047 2730 3570 4590 5814
;; small program: loop(((x * x) - x) div 2, 2, 2 - x) div 2
...
(assert (forall ((x Int)) (= (fast x) (div (* (v1 x) x) (* 2 (* 2 (+ 2 2)))))))
