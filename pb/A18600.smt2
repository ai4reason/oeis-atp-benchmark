;; sequence(s): A18600
;; terms: 1 2 4 8 11 16 22 32 44 64 88 176 352 704
;; small program: compr(loop(loop(x + y, x, 1), 2, 2 * (2 + 2)) mod (1 + x), x) + 1
;; fast program: loop(compr(loop((1 + (2 + x)) * (x * x), 1, 2 * (2 + 2)) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
