;; sequence(s): A226649
;; terms: 0 2 0 3 1 4 2 6 4 9 7 14 12 22 20 35 33 56 54 90
;; small program: loop2(x + y, x, x - (x div 2), 1, 0) - loop(0 - x, x, 1)
;; fast program: loop2(x + y, x, (x - 1) div 2, 1, 1) - loop(0 - 1, x mod 2, 1)
(set-logic UFNIA)
