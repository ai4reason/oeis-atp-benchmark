;; sequence(s): A273045
;; terms: 0 1 1 2 3 5 8 13 34 55 89 144 233 377
;; small program: loop2(y, x + y, x, ((x div 2) div 2) div 2, 1)
;; fast program: loop2(y, x + y, x, x div (2 * (2 + 2)), 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i0 x) (div (div (div x 2) 2) 2))))
(assert (= j0 1))
...
(assert (forall ((x Int)) (= (i1 x) (div x (* 2 (+ 2 2))))))
(assert (= j1 1))
