;; sequence(s): A295729
;; terms: ~1 0 1 1 6 7 21 28 65 93 190 283 537 820 1485 2305 4046 6351 10909 17260
;; small program: loop2(2 + y, x + y, x, 1, 2) - loop2(y + y, x, x, 2, 2)
;; fast program: loop2(x + y, x, x, 1, 1 + 2) - loop(x + x, x - (x div 2), 2)
(set-logic UFNIA)
