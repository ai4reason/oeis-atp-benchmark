;; sequence(s): A166450
;; terms: 1 6 3 18 9 54 27 162 81 486 243 1458 729 4374 2187 13122 6561 39366 19683 118098
;; small program: loop2((y + y) + y, x, x, 1, 2)
;; fast program: loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 1), 1 + 2)
(set-logic UFNIA)
