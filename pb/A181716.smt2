;; sequence(s): A181716
;; terms: 0 1 2 2 5 6 12 17 30 46 77 122 200 321 522 842 1365 2206 3572 5777
;; small program: loop(loop2(y, x + y, y, 2, 1) - x, x, 0)
;; fast program: (1 - loop2(y, x - y, x, 1, 2)) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- 1 (w2 x)) (v3 x)))))
