;; sequence(s): A75528
;; terms: 0 3 105 3570 121278 4119885 139954815 4754343828 161507735340 5486508657735 186379786627653 6331426236682470 215082112260576330 7306460390622912753 248204571168918457275 8431648959352604634600 286427860046819639119128
;; small program: ((loop(x * x, 1, loop2((x + x) + y, x, x + x, 1, 0)) div 2) div 2) div 2
;; fast program: loop(x * x, 1, loop2((2 * ((x + x) + x)) - y, x, x - 1, (if x <= 0 then 0 else (1 + 2)) + 2, 1)) div (2 * (2 + 2))
(set-logic UFNIA)
