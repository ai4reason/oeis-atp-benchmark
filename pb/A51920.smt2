;; sequence(s): A51920
;; terms: 2 2 3 4 7 11 21 36 71 127 253 463 925 1717 3433 6436 12871 24311 48621 92379
;; small program: 1 + loop((x * y) div (y - (y div 2)), x, 1)
;; fast program: (loop(2 * (((x div y) + x) + x), x div 2, 1 + (x mod 2)) div (1 + x)) + 1
(set-logic UFNIA)
