;; sequence(s): A18721
;; terms: 1 2 3 6 9 17 18 27 34 51 54 102 153 306 459 918
;; small program: loop(compr((loop(2 * (((2 + x) * x) + x), 2, 2) - 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(((1 + 2) * loop((x * x) + x, 1, 1 + (2 * (2 * (2 + 2))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
