;; sequence(s): A19752
;; terms: 1 27 505 8115 120241 1695387 23126185 308127555 4034342881 52117311147 666165944665 8442335850195 106239836635921 1329127977509307 16546285315207945 205119670292296035 2533642759410327361 31197987005034321867 383112856942345668025
;; small program: loop((loop2(loop((2 + y) * x, 2, x) + (y * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop((loop2(x * y, y, x, 1 + 2, 1 + 2) div 2) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (* (div (w6 x) 2) (v7 x)))))
(assert (= g5 1))
(assert (forall ((x Int) (y Int)) (= (h5 x y) y)))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int) (y Int)) (= (v5 x y) (u5 g5 (h5 x y)))))
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (v5 x y) x) (* (+ (* (* x 2) 2) x) 2)))))
