;; sequence(s): A88730
;; terms: 3 26 3124 823542 285311670610 302875106592252 827240261886336764176 1978419655660313589123978 20880467999847912034355032910566 2567686153161211134561828214731016126483468
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop2(x * y, y, x - 1, 1, x), y, 2, 1, x) - 1
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop2(x * y, y, x - 2, x, x), y, 2, 1, x) - 1
(set-logic UFNIA)
