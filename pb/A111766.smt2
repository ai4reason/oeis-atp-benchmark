;; sequence(s): A111766
;; terms: 0 5 24 145 840 4901 28560 166465 970224 5654885 32959080 192099601 1119638520 6525731525 38034750624 221682772225 1292061882720 7530688524101 43892069261880 255821727047185
;; small program: loop(loop2((x + x) + y, x, y + y, 1, 0) - x, x, 0)
;; fast program: loop(2 + x, x mod 2, loop(x * x, 1, loop2((x + x) + y, x, x, 1, 0))) - 1
(set-logic UFNIA)
