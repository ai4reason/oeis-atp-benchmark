;; sequence(s): A97339
;; terms: 1 3 12 35 80 157 280 471 768 1241 2024 3379 5824 10389 19128 36143 69632 135985 267976 531147
;; small program: ((x * x) * x) + loop(x + x, x, 1)
;; fast program: ((x * x) * x) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
