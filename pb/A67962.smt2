;; sequence(s): A67962
;; terms: 1 2 12 180 7200 748800 204422400 145957593600 272940700032000 1336044726656640000 17122749216831498240000 574502481723130428948480000 50464872497041500009263431680000 11605406728144633757130311383449600000
;; small program: loop(loop2(x + y, x, y div 2, x, x), x + x, 1)
;; fast program: loop(x * x, 1, loop(loop2(x + y, x, y, 1, 0) * x, x, 1)) * loop2(x + y, x, x, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (v2 x) (w5 x)))))
