;; sequence(s): A282704
;; terms: 1 3 11 59 419 4619 60059 1021019 19399379 446185739 12939386459 401120980259 14841476269619 608500527054419 26165522663340059 1229779565176982819 65178316954380089459 3845520700308425278139 234576762718813941966539
;; small program: loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, x, 2) - 1
;; fast program: (loop(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x - 1, if x <= 0 then 1 else 2) * 2) - 1
(set-logic UFNIA)
