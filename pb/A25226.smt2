;; sequence(s): A25226
;; terms: 3 9 54 405 3402 30618 288684 2814669 28146690 287096238 2975361012 31241290626 331638315876 3553267670100 38375290837080 417331287853245 4566095267100210
;; small program: loop((loop(2 - ((2 + y) * x), 2, y) * x) div (1 + y), x, 1 + 2)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1)) * loop2(x * y, y, x, 1 + 2, 1 + 2)
(set-logic UFNIA)
