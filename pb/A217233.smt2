;; sequence(s): A217233
;; terms: 1 1 7 23 89 329 1231 4591 17137 63953 238679 890759 3324361 12406681 46302367 172802783 644908769 2406832289 8982420391 33522849271
;; small program: loop(loop2(y, (2 * (y + y)) - x, y, 0, 2) - x, x, 1)
;; fast program: ((loop2((2 * (x + x)) - y, x, x - 1, 1 + (2 + 2), 1) div (2 + (2 + 2))) * 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (div (w2 x) (+ 2 (+ 2 2))) 2) 1))))
