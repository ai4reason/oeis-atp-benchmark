;; sequence(s): A11674
;; terms: 0 0 0 0 0 0 1 0 1 1 0 1 1 0 0 0 1 0 1 0
;; small program: loop(((loop2((y - x) div 2, x, 2 + (2 + 2), 0, x) mod 2) + x) + x, x, 2 + (2 + 2)) mod 2
;; fast program: (((((loop(((loop2((y - x) div 2, x, 2 + (2 + 2), 0, x) mod 2) + x) + x, x - 2, 2) div 2) div 2) div 2) div 2) div 2) mod 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (div (div (div (div (div (v2 x) 2) 2) 2) 2) 2) 2))))
