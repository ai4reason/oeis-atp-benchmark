;; sequence(s): A278814
;; terms: 1 2 3 4 4 4 5 5 5 6 6 6 7 7 7 7 7 8 8 8
;; small program: loop(((y div x) div x) + x, x * (1 + 2), 1)
;; fast program: loop((((loop((loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2 + (2 + 2), (x - 2) div 2) + 2) + x, 2, x) - x) + 1) - x) + x, 1, (x + x) + x) div 2
(set-logic UFNIA)
