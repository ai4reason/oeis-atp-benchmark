;; sequence(s): A264153
;; terms: 1 2 144 64800 101606400 411505920000 3585039575040000 59375425441812480000 1710012252724199424000000 80059353648041568632832000000 5780285333388601255290470400000000 616883611349898303167109582028800000000 93983451956379706284115479041251737600000000
;; small program: loop((x * y) * y, x + x, 1) div loop(x + x, x, 1)
;; fast program: (loop2(x * y, 1 + y, x, 1, 1 + x) * loop2(x * y, 2 + y, x - 1, 1, 1 + 2)) * loop(x * x, 1, loop(x * y, x, 1))
(set-logic UFNIA)
