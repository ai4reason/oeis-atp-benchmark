;; sequence(s): A233411
;; terms: 0 0 2 4 12 24 56 112 240 480 992 1984 4032 8064 16256 32512 65280 130560 261632 523264
;; small program: loop(x + x, x, 1) - loop2(y + y, x, x, 1, 1)
;; fast program: loop(x + x, x mod 2, loop((x * x) - x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
