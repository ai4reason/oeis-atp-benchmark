;; sequence(s): A30533
;; terms: 1 1 5 6 15 19 35 44 69 85 121 146 195 231 295 344 425 489 589 670
;; small program: loop(loop(x * x, 1, loop(y - x, y, 1)) + x, x, 1)
;; fast program: loop(loop(loop(x * x, 1, 1 + ((x div 2) - (x mod 2))), 1, y) + x, x, 1)
(set-logic UFNIA)
