;; sequence(s): A187536
;; terms: 1 3 39 1239 60039 3870279 311229639 29993362119 3369233266119 432276047602119 62366420037720519 9994350965362162119 1761334292457572030919 338557476887113316030919 70488382605888266852030919 15802755831536546966525630919
;; small program: loop(loop(loop2((x * y) * y, 1 + y, x, 2, x) div loop(x * y, x, 1), 1, y) + x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x, 1, 1 + x) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, x), 1, y) + x, x, 1)
(set-logic UFNIA)
