;; sequence(s): A78050
;; terms: 1 ~2 0 4 ~4 ~4 12 ~4 ~20 28 12 ~68 44 92 ~180 ~4 364 ~356 ~372 1084
;; small program: loop2(0 - (x + y), x + x, x, 1, 1)
;; fast program: loop2((x - y) - y, x, x - 1, if x <= 0 then 1 else 2, 1) * loop(0 - x, x mod 2, 1)
(set-logic UFNIA)
