;; sequence(s): A299337
;; terms: 1 2 8 14 35 56 112 168 294 420 672 924 1386 1848 2640 3432 4719 6006 8008 10010
;; small program: loop(loop((((2 * (x + x)) + x) div y) + x, y div 2, 1) + x, x, 1)
;; fast program: loop(loop(loop(loop2(x * y, 1 + y, x, 1, 2 + (2 + 2)) div loop(x * y, x, 1), 1, x div 2), 1, y) + x, x, 1)
(set-logic UFNIA)
