;; sequence(s): A7520-A294912
;; terms: 3 11 19 43 59 67 83 107 131 139 163 179 211 227 251 283 307 331 347 379
;; small program: (compr((2 + loop(x * x, 1, loop(x + x, x div 2, 2))) mod (1 + (x + x)), 1 + x) * 2) + 1
;; fast program: (compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x), 1 + x) * 2) + 1
(set-logic UFNIA)
