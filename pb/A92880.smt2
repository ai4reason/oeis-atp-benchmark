;; sequence(s): A92880
;; terms: 1 2 6 26 126 602 2766 12266 52926 223802 932526 3844106 15722526 63936602 258902286 1045109546 4209004926 16921851002 67945160046 272554432586
;; small program: loop2(((((y - 2) * y) + x) + x) + x, y + y, x, 1, 1)
;; fast program: loop((2 + x) * x, 1, loop(x + x, x, 1)) - loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
