;; sequence(s): A232601
;; terms: 0 ~2 14 ~58 198 ~602 1702 ~4570 11814 ~29658 72742 ~175066 414758 ~969690 2241574 ~5131226 11645990 ~26233818 58700838 ~130567130
;; small program: loop((loop(0 - (x + x), y, y) * y) + x, x, 0)
;; fast program: loop(loop(loop(0 - (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, x))), 1, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (- 0 (+ x x)))))
