;; sequence(s): A73188
;; terms: 0 1 2 3 3 4 4 5 5 6 6 6 7 7 7 8 8 8 9 9
;; small program: loop(((y + y) + y) div ((2 + 2) + x), x + x, 0)
;; fast program: loop2(loop(x + y, x, y) div (2 + x), y, 1 + 2, 2 * (2 + 2), (x + x) + x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (div (+ (+ y y) y) (+ (+ 2 2) x)))))
