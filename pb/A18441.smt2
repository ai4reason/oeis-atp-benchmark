;; sequence(s): A18441
;; terms: 1 2 3 6 9 18 23 46 69 138 207 414
;; small program: loop(compr((loop(1 + (loop(x + y, x, 1) * x), 2, 2) + x) mod (1 + x), y), x, 0) + 1
;; fast program: compr((loop((2 + ((2 + x) * x)) * (x * x), 1, 2 + 2) - 2) mod (1 + x), x) + 1
(set-logic UFNIA)
