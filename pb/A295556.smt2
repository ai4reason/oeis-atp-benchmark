;; sequence(s): A295556
;; terms: 0 0 1 2 4 5 7 9 11 13 15 17 20 22 25 27 30 32 35 37
;; small program: loop(loop(((y - 1) div loop2((x + y) + y, x, x, 1, 0)) + x, y, 1) + x, x, 0) div 2
;; fast program: loop(loop((y div loop2((x + y) + y, x, x, 1, 1)) + x, y, 0) + x, x - 1, x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (div (- y 1) (w2 x)) x))))
