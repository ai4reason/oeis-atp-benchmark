;; sequence(s): A90076
;; terms: 10 21 55 91 187 247 391 551 713 1073 1271 1591 1927 2279 2773 3233 3953 4331 4891 5609
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, 2 + y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 2 + y, 2, 1, x)
(set-logic UFNIA)
