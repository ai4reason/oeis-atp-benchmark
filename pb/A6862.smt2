;; sequence(s): A6862
;; terms: 2 3 7 31 211 2311 30031 510511 9699691 223092871 6469693231 200560490131 7420738134811 304250263527211 13082761331670031 614889782588491411 32589158477190044731 1922760350154212639071 117288381359406970983271 7858321551080267055879091
;; small program: loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) * x) + x, x, 1) + 1
;; fast program: loop(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, x - 1, if x <= 0 then 1 else 2) + 1
(set-logic UFNIA)
