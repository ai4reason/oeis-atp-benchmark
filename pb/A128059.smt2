;; sequence(s): A128059
;; terms: 1 1 3 5 7 1 11 13 1 17 19 1 23 1 1 29 31 1 1 37
;; small program: loop(loop(x * y, x, 1) mod (1 + x), 1, (x - 2) + x) + 1
;; fast program: loop(loop(if (loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2) <= 0 then (1 + x) else 1, 1, y), (x - 2) + x, 1)
(set-logic UFNIA)
