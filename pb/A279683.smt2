;; sequence(s): A279683
;; terms: 0 0 1 9 78 750 8220 102900 1463280 23451120 419942880 8331634080 181689298560 4323472433280 111534141438720 3101254066310400 92468631077222400 2943141763622860800 99596858633182310400 3570677764371119001600
;; small program: loop(loop(loop(2 * (x * y), y, 1) + (x * y), y - 1, 0) + (x * y), x, 0) div 2
;; fast program: loop(((loop((x * y) + loop(2 * (x * y), y, 1), y - 1, 1) + x) * y) + x, x - 1, 0)
(set-logic UFNIA)
