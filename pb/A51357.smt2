;; sequence(s): A51357
;; terms: 1 6 180 37800 87318000 2622159540000 1338638666765400000 12984380089637682726000000 2896722619368127899492763620000000 18740906719713843949122453226304292600000000
;; small program: loop(loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y) * x) + x, y, 2) * x, x, 1)
;; fast program: loop(loop(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2) * x, x, 1)
(set-logic UFNIA)
