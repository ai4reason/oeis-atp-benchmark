;; sequence(s): A277431
;; terms: 1 1 4 12 52 260 1568 10976 87824 790416 7904192 86946112 1043353408 13563594304 189890320384 2848354805760 45573676892416 774752507171072 13945545129079808 264965357452516352
;; small program: loop((x * y) + loop2(y + y, x, y, 1, 0), x, 1)
;; fast program: loop(loop(loop(loop(x + x, x div 2, 1) + x, 1 - (x mod 2), x) - x, 1, y) + (x * y), x, 1)
(set-logic UFNIA)
