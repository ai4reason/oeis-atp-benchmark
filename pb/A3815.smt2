;; sequence(s): A3815
;; terms: 0 1 3 0 4 1 7 0 8 1 11 0 12 1 15 0 16 1 19 0
;; small program: loop(loop(0 - x, y, x) + y, x, 0)
;; fast program: loop2(y, 1 + x, (1 + x) mod (2 + 2), 0, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (mod (+ 1 x) (+ 2 2)))))
(assert (= i2 0))
