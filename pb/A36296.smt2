;; sequence(s): A36296
;; terms: 1 2 1 8 8 32 8 128 128 512 256 2048 2048 8192 1024 32768 32768 131072 65536 524288
...
(assert (forall ((x Int)) (= (small x) (div (* (+ 1 (v0 x)) (v1 x)) (+ 2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (div (* (+ 1 (v2 x)) (v4 x)) (+ 2 x)))))
