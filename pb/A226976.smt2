;; sequence(s): A226976
;; terms: 1 9 28 133 539 2322 9773 41501 175636 744273 3152359 13354306 56568617 239630337 1015087436 4299984173 18215017507 77160064914 326855259829 1384581132277
;; small program: loop(loop2(x + y, x, y + y, 2, 0) - x, x, 1) * loop2(x + y, x, x, 1, 2)
;; fast program: (((loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1)) + (x mod 2)) * 2) - 1) * loop2(x + y, x, x, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- (* (+ (v3 x) (mod x 2)) 2) 1) (w5 x)))))
