;; sequence(s): A24678
;; terms: 2 3 5 7 9 11 13 17 20 23 27 29 31 35 40 43 46 50 52 55
;; small program: (loop2(compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + y) + x, 1 + y, 2, 2, x) div 2) - (2 + x)
;; fast program: (loop2(compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, 1 + y) + x, 1 + y, 2, 0, x) - 1) - x
(set-logic UFNIA)
