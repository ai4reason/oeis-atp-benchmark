;; sequence(s): A276805
;; terms: 6 3 20 15 42 7 72 45 110 33 156 91 210 30 272 153 342 95 420 231
;; small program: (1 + loop(loop(x div 2, x mod 2, x), 1 + 2, 2 + x)) * (2 + x)
;; fast program: loop(loop(x div (2 - (x mod 2)), x mod (2 + 2), 1 + x) * x, 1, 2 + x)
(set-logic UFNIA)
