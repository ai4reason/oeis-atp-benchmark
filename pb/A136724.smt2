;; sequence(s): A136724
;; terms: 12 20 24 28 36 40 44 48 52 56 60 68 72 76 80 84 88 92 96 100
;; small program: ((loop(loop(2 + ((x div y) + x), x, y) div x, x, 2) * 2) + 2) * 2
;; fast program: (((loop(2 + ((x div y) + x), 1 + x, x) div (1 + x)) * 2) + 2) * 2
(set-logic UFNIA)
