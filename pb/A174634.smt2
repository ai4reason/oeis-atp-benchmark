;; sequence(s): A174634
;; terms: 1 6 27 135 648 3159 15309 74358 360855 1751787 8503056 41275251 200353257 972537030 4720790403 22915204479 111232727064 539935021503 2620899608085 12722114017782
;; small program: loop((x + x) + x, x, loop2(x + y, x, x, 1, 1))
;; fast program: loop2(x + y, x, x, 1, 1) * loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
