;; sequence(s): A306637
;; terms: 0 1 1 0 ~3 ~5 0 13 21 0 ~55 ~89 0 233 377 0 ~987 ~1597 0 4181
;; small program: loop2(x + y, x, x, 0, loop2(y, y - x, x, 0, 1))
;; fast program: loop2(y - x, x, x, 0, 1) * (((1 + x) mod (1 + 2)) - 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (w2 x) (- (mod (+ 1 x) (+ 1 2)) 1)))))
