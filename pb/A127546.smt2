;; sequence(s): A127546
;; terms: 2 6 14 38 98 258 674 1766 4622 12102 31682 82946 217154 568518 1488398 3896678 10201634 26708226 69923042 183060902
;; small program: 2 * loop(loop2(x + y, x, y + y, 2, 0) - x, x, 1)
;; fast program: loop(x * x, 1, loop2(x + y, x, x, 2, 0)) - loop(0 - x, x mod 2, 2)
(set-logic UFNIA)
