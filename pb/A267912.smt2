;; sequence(s): A267912
;; terms: 1 2 4 11 29 77 201 525 1361 3525 9097 23453 60353 155189 398649 1023501 2626289 6736677 17274601 44286845
;; small program: (loop((loop2(x + y, 2 * (x + x), y - 1, 1, 1) + x) + x, x, 1) + 1) div 2
;; fast program: (((loop2(2 * (x + y), x - y, x, 1 + 2, 1) - loop(x + x, x, 1)) div 2) + 1) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ (div (- (w2 x) (v3 x)) 2) 1) 2))))
