;; sequence(s): A101353
;; terms: 1 4 9 19 38 75 147 288 565 1111 2190 4327 8567 16992 33753 67131 133654 266323 531051 1059520
;; small program: (loop(x + x, x, 2) - 2) + loop2(x + y, x, x, 1, 1)
;; fast program: ((2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - 2) + loop2(x + y, x, x, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (* 2 (v2 x)) 2) (w5 x)))))
