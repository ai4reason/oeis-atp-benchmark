;; sequence(s): A208650
;; terms: 1 2 6 36 480 15000 1134000 211768200 99131719680 117595223746560 356467003200000000 2779532232516963000000 56049508602150185041920000 2935889842347365340037522521600
;; small program: (loop(loop2(x * y, y, y, x, y), x, 1) div loop(loop(x * y, y, x), x, 1)) * (1 + x)
;; fast program: loop((loop(loop2(x * y, y, x, 1, x), 1, y) * x) div loop(x * y, y, 1), x, 1) * (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (div (v0 x) (v2 x)) (+ 1 x)))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (div (* (v5 x y) x) (v7 x y)))))
(assert (forall ((x Int)) (= (g4 x) x)))
(assert (= h4 1))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v4 x) (u4 (g4 x) h4))))
(assert (forall ((x Int)) (= (fast x) (* (v4 x) (+ 1 x)))))
