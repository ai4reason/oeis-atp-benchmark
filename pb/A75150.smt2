;; sequence(s): A75150
;; terms: 4 ~1 9 ~16 49 ~121 324 ~841 2209 ~5776 15129 ~39601 103684 ~271441 710649 ~1860496 4870849 ~12752041 33385284 ~87403801
;; small program: loop2((y - x) - x, x - y, x, 2, 1) + 2
;; fast program: loop(0 - x, x mod 2, loop(x * x, 1, loop2(y - x, x, x, 2, 1)))
(set-logic UFNIA)
