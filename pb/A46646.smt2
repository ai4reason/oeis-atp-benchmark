;; sequence(s): A46646
;; terms: 1 2 6 24 110 546 2856 15504 86526 493350 2861430 16829280 100134216 601661144 3645533040 22249511328 136657509918 844061090670 5239262085330 32665844580600
;; small program: loop2((2 + y) * x, 1 + y, x - 1, if x <= 0 then 1 else 2, x + x) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1)) * (if x <= 0 then 1 else 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (w2 x) (v3 x)) (ite (<= x 0) 1 2)))))
