;; sequence(s): A18585
;; terms: 1 2 3 4 6 7 8 12 14 16 21 24 28 32 42 48 56 84 96 112
;; small program: compr((2 * loop(2 * ((x + y) * x), 2, 2)) mod (1 + x), x) + 1
;; fast program: compr((2 * (2 * loop((2 + x) * x, 1, 2 * (2 + (2 + 2))))) mod (1 + x), x) + 1
(set-logic UFNIA)
