;; sequence(s): A14690
;; terms: 4 7 10 15 18 23 26 31 38 41 48 53 56 61 68 75 78 85 90 93
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 1 + x) + 2) + x
;; fast program: ((compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 1 + x) * 2) + 2) + x
(set-logic UFNIA)
