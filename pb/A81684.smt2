;; sequence(s): A81684
;; terms: 1 ~1 ~1 29 275 1829 10739 59429 318275 1670789 8656979 44454629 226827875 1151991749 5830280819 29429454629 148249811075 745630312709 3745590106259 18797445635429
;; small program: (((loop((2 * (x + x)) + x, x, 1) - loop((x * x) + x, 1, loop(x + x, x, 1))) - loop((x + x) + x, x, 1)) + 1) + 2
;; fast program: (((loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), (2 * (2 * (2 + (2 + 2)))) + 1) - loop((x * x) + x, 1, loop(x + x, x, 1))) - loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) + 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (+ (- (- (v0 x) (v1 x)) (v3 x)) 1) 2))))
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (- (- (w4 x) (v6 x)) (w8 x)) 2) 1))))
