;; sequence(s): A20711
;; terms: 5 7 10 14 20 29 42 61 89 130 190 278 407 596 873 1279 1874 2746 4024 5897
;; small program: 2 + (loop2(2 + (((y * y) div x) + x), x, x, 2, 0) + 1)
;; fast program: (1 + loop2(2 + (((y * y) div x) + x), x, x - 1, (if x <= 0 then 0 else 2) + 2, 2)) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ 1 (w1 x)) 2))))
