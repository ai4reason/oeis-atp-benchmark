;; sequence(s): A8895
;; terms: 63 188 94 47 140 70 35 104 52 26 13 38 19 56 28 14 7 20 10 5
;; small program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, 1 + loop(2 + (x + x), 2 + 2, 2))
;; fast program: loop(loop((2 * ((x + x) + x)) - 1, x mod 2, x) div 2, x, loop((x * x) * x, 1, 2 + 2) - 1)
(set-logic UFNIA)
