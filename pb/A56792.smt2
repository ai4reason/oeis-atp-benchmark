;; sequence(s): A56792
;; terms: 0 1 2 3 3 4 4 5 4 5 5 6 5 6 6 7 5 6 6 7
;; small program: loop2(((if y <= 0 then 0 else 1) + x) - y, y div 2, x, x, x div 2)
;; fast program: loop2(((if y <= 0 then 0 else 1) + x) - y, y div 2, 2 + (2 + 2), x, x div 2)
(set-logic UFNIA)
