;; sequence(s): A264040
;; terms: 1 12 181440 10461394944000 7755605021665492992000000 185996663394950608733999724075417600000000 304140932017133780436126081660647688443776415689605120000000000 63443466092942082051716694667580740401432758087272596099400947187607352115200000000000000
;; small program: loop((2 + y) * x, ((2 + x) * x) - 1, 1)
;; fast program: (loop(loop((loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + (x * x)) * (1 + x)) * (1 + x), 1, y) * x, x, 1) + 1) div 2
(set-logic UFNIA)
