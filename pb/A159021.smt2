;; sequence(s): A159021
;; terms: 19 23 27 32 37 43 49 56 63 70 78 86 95 104 114 124 135 146 158 170
;; small program: loop((loop(((y div x) div x) + x, x, 1) - 1) + x, x, 1 + loop((x + x) + x, 2, 2))
;; fast program: loop((loop((y div (x * x)) + x, x, 1) - 1) + x, x, 1 + (2 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
