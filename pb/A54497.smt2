;; sequence(s): A54497
;; terms: 1 7 31 105 300 756 1732 3676 7330 13870 25102 43714 73612 120340 191620 298012 453739 677677 994565 1436435
;; small program: loop(loop(loop(loop((loop((x + x) + x, 2, x) div y) + x, y, 1) - x, y, 1) - x, y, 1) - x, x, 1)
;; fast program: loop(loop(loop(loop((((2 * (2 * (x + x))) + x) div y) + x, y, 1) - x, y, 1) - x, y, 1) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ (div (+ (* 2 (* 2 (+ x x))) x) y) x))))
