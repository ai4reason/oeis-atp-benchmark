;; sequence(s): A112700
;; terms: 1 7 79 1159 19303 345895 6504487 126597031 2528447911 51526205863 1067116097959 22394503831975 475191351108007 10177980935594407 219758235960500647 4778128782752211367 104526001924311998887
;; small program: loop(loop(((loop(2 - ((2 + y) * x), 2, y) * x) div (1 + y)) * 2, y, 1) + x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x - 1, x)) * loop2(x * y, y, x, 1, 2 + (2 + 2)), 1, y) + x, x, 1)
(set-logic UFNIA)
