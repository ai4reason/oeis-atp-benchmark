;; sequence(s): A277589
;; terms: 2 12 20 22 32 42 52 62 72 82 92 102 112 120 122 132 142 152 162 172
;; small program: compr(((loop(x div loop(1, x mod (2 + (2 * (2 + 2))), 2 + (2 * (2 + 2))), x div 2, x) mod (1 + (2 + 2))) - 1) mod (1 + x), 1 + x) * 2
;; fast program: compr(((loop(x div loop(1, x mod (2 + (2 * (2 + 2))), 2 + (2 * (2 + 2))), x div (2 + (2 * (2 + 2))), x) mod (1 + (2 + 2))) - 1) mod (1 + x), 1 + x) * 2
(set-logic UFNIA)
(declare-fun f2 () Int)
