;; sequence(s): A130103
;; terms: 0 1 1 4 11 26 57 120 247 502 1013 2036 4083 8178 16369 32752 65519 131054 262125 524268
;; small program: loop(loop((x + x) + y, y, 0), x - 1, x)
;; fast program: (loop(loop(2, 2 - x, x) + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) - x
(set-logic UFNIA)
