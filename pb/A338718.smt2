;; sequence(s): A338718
;; terms: 1 2 1 2 1 3 2 3 2 4 2 4 2 4 3 5 3 5 3 5
;; small program: loop(loop((1 + y) * (x * y), y, 1) div (x * y), x, 1) div loop(x * y, x, 1)
;; fast program: (loop(loop((y * y) * x, y - 1, 1) div x, x, 1) * (1 + x)) div loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (v3 x) (+ 1 x)) (v5 x)))))
