;; sequence(s): A18774
;; terms: 1 2 4 11 22 23 44 46 92 253 506 1012
;; small program: loop(compr((2 + loop(((x * x) * x) + x, 2, 2)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 + loop(((x * x) * x) + x, 1, 2 + (2 * (2 + 2)))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
