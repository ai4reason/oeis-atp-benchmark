;; sequence(s): A11373
;; terms: 0 1 1 1 2 2 1 3 3 2 5 4 2 5 6 4 8 7 4 5
;; small program: loop2((y mod 2) + x, y div 2, x, 0, loop2(x + y, x, x, 0, 1))
;; fast program: loop2((y mod 2) + x, y div 2, x, 0, loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
