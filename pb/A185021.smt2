;; sequence(s): A185021
;; terms: 1 1 2 6 12 60 120 840 840 7560 15120 166320 110880 1441440 2882880 43243200 10810800 183783600 367567200 6983776800
;; small program: loop2(loop(loop(x * y, x, 1) div loop((x * y) * y, x div 2, 1), 1, y) * x, y div 2, x, 1, x)
;; fast program: loop2(loop(loop(2 * ((x - (x div y)) + x), x div 2, if (x mod 2) <= 0 then 1 else x), 1, y) * x, y div 2, x, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h6 x) (ite (<= (mod x 2) 0) 1 x))))
