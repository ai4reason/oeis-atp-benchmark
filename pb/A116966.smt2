;; sequence(s): A116966
;; terms: 1 3 2 4 5 7 6 8 9 11 10 12 13 15 14 16 17 19 18 20
;; small program: (x mod 2) + loop((x mod 2) + y, x, 1)
;; fast program: x + loop2(y, 1, (2 - x) mod (2 + 2), 0, 2)
(set-logic UFNIA)
...
(assert (= g1 1))
(assert (forall ((x Int)) (= (h1 x) (mod (- 2 x) (+ 2 2)))))
(assert (= i1 0))
(assert (= j1 2))
