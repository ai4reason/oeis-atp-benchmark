;; sequence(s): A20903
;; terms: 1 2 1 2 1 1 2 1 2 1 2 1 2 1 1 2 1 2 1 1
;; small program: loop(loop(loop(y - 1, x - y, x), x, x), x, x) + 1
;; fast program: loop(loop(loop(y, x - y, x), (1 + x) div 2, 1 + x), 1 + 2, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g4 x) (div (+ 1 x) 2))))
