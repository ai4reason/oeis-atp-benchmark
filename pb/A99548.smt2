;; sequence(s): A99548
;; terms: 1 1 3 1 5 3 0 1 2 5 4 3 6 0 1 1 3 2 5 5
;; small program: (1 + loop(x div (1 + (x mod 2)), x, x)) mod (1 + (2 + (2 + 2)))
;; fast program: ((loop(loop(loop(1 + loop(loop(x div 2, x mod 2, x), loop(2 + 2, x mod 2, 0), x), 1, x div 2), x mod 2, x) div 2, x mod 2, x div 2) * 2) + 1) mod (1 + (2 + (2 + 2)))
(set-logic UFNIA)
