;; sequence(s): A275858
;; terms: 1 1 ~1 ~4 ~4 4 17 17 ~17 ~72 ~72 72 305 305 ~305 ~1292 ~1292 1292 5473 5473
;; small program: loop(loop(loop2(x + y, x, x, 1, 0) * loop2(x - y, x, x, 1, 1), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(y - x, x, x, 1, 0) * loop(x - 1, x mod (1 + 2), 1), 1, y) + x, x, 1)
(set-logic UFNIA)
