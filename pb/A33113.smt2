;; sequence(s): A33113
;; terms: 1 3 10 30 91 273 820 2460 7381 22143 66430 199290 597871 1793613 5380840 16142520 48427561 145282683 435848050 1307544150
;; small program: loop2((2 * (x + y)) + y, x, x, 2, 1) div 2
;; fast program: loop((x div (2 * (2 + 2))) + x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
