;; sequence(s): A215465
;; terms: 0 1 10 76 540 3751 25840 177451 1217160 8344876 57202750 392089501 2687463360 18420257701 126254611990 865362736876 5931286406640 40653646980451 278644255208560 1909856172864751
;; small program: (loop((x * x) - x, 1, loop2(y - x, x, x + x, 2, 1)) div 2) div 2
;; fast program: (loop((x * x) - x, 1, loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2)) div 2) div 2
(set-logic UFNIA)
