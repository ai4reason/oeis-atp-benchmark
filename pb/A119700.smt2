;; sequence(s): A119700
;; terms: 0 2 12 240 2520 31500 354816 4060056 45405360 505842480 5588869000 61464995592 672880545792 7340296254200 79824251379600 865788437880000 9368862119134560 101178055201047660 1090713358902182400 11739380070425284200
;; small program: loop(2 * ((x - (x div y)) + x), x, loop(x * x, 1, loop2(x + y, x, x, 0, 1))) * x
;; fast program: loop(2 * (((x div y) + x) + x), x - 1, if x <= 0 then 0 else 2) * loop(x * x, 1, loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
