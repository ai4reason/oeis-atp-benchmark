;; sequence(s): A167936
;; terms: 0 1 1 5 7 23 37 101 175 431 781 1805 3367 7463 14197 30581 58975 124511 242461 504605
;; small program: loop(x + x, x, 1) - loop((x + x) + x, x div 2, 1)
;; fast program: loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x * y, y, x div 2, 1, 1 + 2)
(set-logic UFNIA)
