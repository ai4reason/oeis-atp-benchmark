;; sequence(s): A74538
;; terms: 3 14 78 476 3042 19964 133338 901796 6155682 42307244 292241898 2026156916 14085431922 98109721724 684326604858 4778079120836 33385518525762 233393453571404 1632228295438218 11417968672225556
;; small program: loop2(((2 * (x + x)) + x) + y, (2 * ((y + y) + y)) + y, x, 2, 2) + loop(x + x, x, 1)
;; fast program: (loop(x + x, x, 1) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (v2 x) (w3 x)) (w6 x)))))
