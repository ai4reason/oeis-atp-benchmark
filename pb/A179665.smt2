;; sequence(s): A179665
;; terms: 512 19683 1953125 40353607 2357947691 10604499373 118587876497 322687697779 1801152661463 14507145975869 26439622160671 129961739795077 327381934393961 502592611936843 1119130473102767
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + (2 * (2 + 2)), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop((x * x) * x, 1, (x * x) * x), 0, 2, 1, x) div 2
(set-logic UFNIA)
