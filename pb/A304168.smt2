;; sequence(s): A304168
;; terms: 5 16 50 154 470 1426 4310 12994 39110 117586 353270 1060834 3184550 9557746 28681430 86060674 258214790 774709906 2324260790 6973044514
;; small program: loop((x + x) + x, 1 + x, 2) - loop(x + x, x, 1)
;; fast program: ((1 + 2) * loop2(x * y, y, x div 2, loop(2 + (2 + 2), x mod 2, 2), 1 + (2 * (2 + 2)))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (+ 1 2) (w2 x)) (v4 x)))))
