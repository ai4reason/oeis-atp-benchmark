;; sequence(s): A139
;; terms: 2 1 2 6 22 91 408 1938 9614 49335 260130 1402440 7702632 42975796 243035536 1390594458 8038677054 46892282815 275750636070 1633292229030
;; small program: loop2((x * y) + x, 1 + y, x + x, 2, x) div loop((2 + y) * x, x + x, 1)
;; fast program: (((loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x - 1, 1)) div (if x <= 0 then 1 else x)) * 2) div (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (div (div (w2 x) (v3 x)) (ite (<= x 0) 1 x)) 2) (+ 1 x)))))
