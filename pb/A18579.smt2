;; sequence(s): A18579
;; terms: 1 3 13 17 39 51 221 663
;; small program: loop(compr((1 + loop(2 * (2 * (2 - x)), 2 + 2, x)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((2 * (2 * (x * x))) - x, 1, 1 + (2 * (2 + (2 + 2)))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
