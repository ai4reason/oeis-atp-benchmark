;; sequence(s): A122880
;; terms: 0 0 0 1 8 43 196 820 3265 12615 47840 179355 667875 2478022 9180616 34011401 126120212 468411235 1743105373 6500874434
;; small program: loop((((1 + 2) * (x * y)) div (2 + y)) + x, x, 1) - loop2(x + y, x, x + x, 1, 0)
;; fast program: ((loop(2 * (((x div y) + x) + x), x, 2) div (1 + x)) div (2 + x)) - loop2(((x - y) + x) + x, x, x - 1, if x <= 0 then 1 else 2, 1)
(set-logic UFNIA)
