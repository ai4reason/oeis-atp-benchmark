;; sequence(s): A139159
;; terms: 3 7 121 5041 39916801 6227020801 355687428096001 121645100408832001 25852016738884976640001 8841761993739701954543616000001 8222838654177922817725562880000001
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x * y, x - 1, 1), y, 2, 1, x) + 1
