;; sequence(s): A248924
;; terms: 2 2 1 7 3 16 12 36 39 85 113 210 310 534 829 1379 2191 3588 5760 9368
;; small program: loop2(y, x + y, x, 2, 1) - loop(0 - x, x, x)
;; fast program: loop2(y, x + y, x, 2, 1) - loop(0 - x, x mod 2, x)
(set-logic UFNIA)
