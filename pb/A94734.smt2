;; sequence(s): A94734
;; terms: 0 1 1 4 19 76 271 904 2899 9076 27991 85504 259579 784876 2366911 7125304 21425059 64373476 193317031 580344304
;; small program: loop(((x - 1) + x) + x, x, 1) - loop(2 + (x + x), x - 1, 1)
;; fast program: ((1 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div 2)) - loop(x + x, x - 1, 1 + 2)) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (+ 1 (div (w2 x) 2)) (v4 x)) 2))))
