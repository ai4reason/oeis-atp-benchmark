;; sequence(s): A167991
;; terms: 2 3 4 4 4 5 6 6 6 6 6 7 8 8 8 8 8 8 8 9
;; small program: loop(((1 + y) div loop((x + y) + y, x div 2, 0)) + x, x, 2)
;; fast program: (loop(((loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x div 2) * 2) - 1) + x, 2, 1 + x) - x) div 2
(set-logic UFNIA)
