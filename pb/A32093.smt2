;; sequence(s): A32093
;; terms: 3 12 40 100 226 452 848 1484 2485 3976 6160 9240 13524 19320 27072 37224 50391 67188 88440 114972
;; small program: loop(loop(loop(loop(loop(x + y, y + y, x), y div 2, x), y, x), y, x), 2 + x, 0)
;; fast program: loop(loop(loop(loop(loop(x + y, y + y, x), y div 2, x), y, x), 2 + y, x), x, 1) + 2
(set-logic UFNIA)
