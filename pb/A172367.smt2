;; sequence(s): A172367
;; terms: 1 3 7 9 13 15 19 25 27 33 37 39 43 49 55 57 63 67 69 75
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + x) - 1) - 2
;; fast program: ((compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 2 + x) - 2) * 2) + 1
(set-logic UFNIA)
