...
(assert (forall ((x Int)) (= (f1 x) (div (- (+ (- (v2 x) (v3 x)) 1) (v4 x)) (v5 x)))))
(assert (= g1 1))
...
(assert (forall ((x Int)) (= (f8 x) (div (- (+ (- (- (* (w9 x) 2) (mod x 2)) (mod x 2)) 1) (v10 x)) (v11 x)))))
(assert (= g8 1))
...
(assert (forall ((x Int)) (= (fast x) (mod (v7 x) (v12 x)))))
