;; sequence(s): A131631
;; terms: 1 2 18 792 209880 389117520 5771780174160 770509566129663360 1028600220910021528728960 15104551945968674840127424147200 2661646219535110627933754465838408595200
;; small program: loop(loop(((2 + y) * x) + loop(0 - x, y, 1), y, 1) * x, x, 1)
;; fast program: loop(loop(loop(loop(1 - (x * y), x, 1) * loop(0 - x, x mod 2, 1), 1, x + 2), 1, y) * x, x, 1)
(set-logic UFNIA)
