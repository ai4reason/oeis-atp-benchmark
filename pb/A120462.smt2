;; sequence(s): A120462
;; terms: 0 6 4 22 20 86 84 342 340 1366 1364 5462 5460 21846 21844 87382 87380 349526 349524 1398102
;; small program: 2 * loop2((x + y) + y, x, x, x mod 2, 1)
;; fast program: (loop(2 * (2 + (x + x)), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2))) - 2) div (1 + 2)
(set-logic UFNIA)
