;; sequence(s): A253
;; terms: 0 1 4 11 27 63 142 312 673 1432 3015 6295 13055 26926 55284 113081 230572 468883 951347 1926527
;; small program: loop((loop2((((y * y) + y) div (x + y)) + x, x + y, y, 1, 0) + x) + x, x, 0)
;; fast program: loop((loop2(1 + (((y * y) div (x + y)) + x), x + y, y - 1, 1, 0) + x) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (div (+ (* y y) y) (+ x y)) x))))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ 1 (+ (div (* y y) (+ x y)) x)))))
