;; sequence(s): A6
;; terms: 1 1 2 2 3 3 4 4 4 5 5 6 6 6 6 7 7 7 8 8
;; small program: loop((((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) div (x * x)) + x, x, 2) - 1
;; fast program: loop((((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) div (x * x)) + x, x, 2) - 1
(set-logic UFNIA)
