;; sequence(s): A120165
;; terms: 7 9 11 14 17 21 27 33 42 52 65 81 102 127 159 199 248 310 388 485
;; small program: (loop(((x div 2) div 2) + x, x, 2 + loop((x * x) + y, 2, 2)) div 2) div 2
;; fast program: loop((x div (2 + 2)) + x, x, 2 + loop((x * x) * x, 1, 1 + 2)) div (2 + 2)
(set-logic UFNIA)
