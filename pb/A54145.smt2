;; sequence(s): A54145
;; terms: 0 2 12 58 256 1072 4336 17112 66304 253280 956608 3579680 13292544 49039360 179912448 656874368 2388205568 8650598912 31231020032 112419973632
;; small program: loop2(((x + x) + x) + y, x + y, x, x, 1) div 2
;; fast program: loop2(2 * ((x - y) + x), x, x - 1, (x * (1 + 2)) + 1, x) div 2
(set-logic UFNIA)
