;; sequence(s): A94374
;; terms: 1 3 8 21 56 153 428 1221 3536 10353 30548 90621 269816 805353 2407868 7207221 21588896 64701153 193972388 581655021
;; small program: loop2(1 + (((x - y) + x) + x), y + y, x, 1, 1)
;; fast program: (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) div 2) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (w1 x) 2) (v3 x)))))
