;; sequence(s): A4649
;; terms: 0 1 1 3 3 5 5 7 2 1 4 5 4 5 8 11 10 13 14 13
;; small program: (compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), 2 + x) + 1) mod (1 + x)
;; fast program: ((compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), 1 - (x mod 2), x) - 1, 2 + x) + 1) mod (1 + x)) div 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (mod (+ (v2 x) 1) (+ 1 x)) 1))))
