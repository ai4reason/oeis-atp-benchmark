;; sequence(s): A72477
;; terms: 18 1800 352800 114307200 55324684800 37399486924800 33659538232320000 38910426196561920000 56186655427835412480000 99113260174701667614720000 209723658529668728672747520000 524309146324171821681868800000000
;; small program: loop2((x * y) * y, 1 + y, 2 + x, 1, 2 + x) div 2
;; fast program: loop(x * x, 1, loop2(x * y, 1 + y, 2 + x, 1, 2 + x)) div 2
(set-logic UFNIA)
