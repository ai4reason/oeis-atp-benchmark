;; sequence(s): A215460
;; terms: 1 1 1 2 4 11 30 96 339 1316 5584 25733 128025 683949 3905083 23731187 152934464 1041782238 7479469995 56448098958
;; small program: loop((1 + y) * (x * y), x, 1) div loop2((x * y) + x, y, x, 1, x)
;; fast program: loop(x * x, 1, loop(x * y, x, 1)) div loop2(x * y, y, x - 1, 1, 1 + x)
(set-logic UFNIA)
