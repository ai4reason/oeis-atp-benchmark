;; sequence(s): A6882
;; terms: 1 1 2 3 8 15 48 105 384 945 3840 10395 46080 135135 645120 2027025 10321920 34459425 185794560 654729075
;; small program: loop(loop(x * y, y, 1) div x, x, 1)
;; fast program: loop2(x * y, y - 2, x div 2, 1, x)
(set-logic UFNIA)
