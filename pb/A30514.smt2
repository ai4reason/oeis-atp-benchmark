;; sequence(s): A30514
;; terms: 16 81 625 2401 14641 28561 83521 130321 279841 707281 923521 1874161 2825761 3418801 4879681 7890481 12117361 13845841 20151121 25411681
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 2 + 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (((x * x) * x) * x), 0, 2, 1, x) div 2
(set-logic UFNIA)
