;; sequence(s): A7068
;; terms: 1 3 4 10 14 34 48 116 164 396 560 1352 1912 4616 6528 15760 22288 53808 76096 183712
;; small program: loop2(x + y, (if (x - y) <= 0 then 0 else x) + x, x, 1, 2)
;; fast program: loop2(2 * ((x - y) + x), x, x div 2, loop(1 + 2, x mod 2, 1), x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (+ (ite (<= (- x y) 0) 0 x) x))))
