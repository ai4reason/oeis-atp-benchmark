;; sequence(s): A134006
;; terms: 4 16 84 496 3108 20176 134004 903856 6161988 42326416 292299924 2026332016 14085959268 98111307856 684331371444 4778093436976 33385561506948 233393582580496 1632228682596564 11417969833962736
;; small program: (loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 2, 2) + loop((2 * ((x + x) + x)) + x, x, 1)) + 1
;; fast program: (1 + (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ 1 (+ (w2 x) (w4 x))) (w5 x)))))
