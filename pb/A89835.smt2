;; sequence(s): A89835
;; terms: 1 2 24 600 23520 1270080 87816960 7420533120 742053312000 85781362867200 11260753452748800 1655330757554073600 269436914075724595200 48113734656379392000000
;; small program: loop2((x * y) * y, 1 + y, x, 1, 1 + x) div loop((x * y) + x, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 1 + x)
(set-logic UFNIA)
