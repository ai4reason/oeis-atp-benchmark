;; sequence(s): A74600
;; terms: 2 7 29 133 641 3157 15689 78253 390881 1953637 9766649 48830173 244144721 1220711317 6103532009 30517610893 152587956161 762939584197 3814697527769 19073486852413
;; small program: loop((2 * (x + x)) + x, x, 1) + loop(x + x, x, 1)
;; fast program: loop(x + x, x, 1) + loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
