;; sequence(s): A83558
;; terms: 6 21 105 301 1221 2041 4641 6517 11661 23577 28861 49321 67281 77701 101661 146121 201957 223321 296341 352941
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) * x) + x, y, 2, 1, x)
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) * x) + x, y, 2, 1, x)
(set-logic UFNIA)
