;; sequence(s): A104126
;; terms: 8 81 15625 5764801 3138428376721 3937376385699289 14063084452067724991009 37589973457545958193355601 480250763996501976790165756943041
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop2(x * y, y, x, 1, x), y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop2(x * y, y, x, 1, x), y, 2, 0, x)
(set-logic UFNIA)
