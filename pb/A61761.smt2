;; sequence(s): A61761
;; terms: 0 3 7 13 23 41 75 141 271 529 1043 2069 4119 8217 16411 32797 65567 131105 262179 524325
;; small program: ((loop(x + x, x, 1) - 1) + x) + x
;; fast program: ((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - 1) + x) + x
(set-logic UFNIA)
