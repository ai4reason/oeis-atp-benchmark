;; sequence(s): A131023
;; terms: 1 2 3 4 5 7 14 37 101 256 593 1267 2534 4825 8921 16384 30581 58975 117950 242461
;; small program: loop2((x - y) + x, x + y, x - 1, 1, 1) + (loop(x + x, x, 1) div 2)
;; fast program: loop2((x - y) + x, x + y, x - 2, if x <= 0 then 0 else 1, 2) + loop(x + x, x - 1, 1)
(set-logic UFNIA)
