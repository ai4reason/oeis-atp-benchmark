;; sequence(s): A214091
;; terms: ~3 ~5 ~7 ~5 17 115 473 1675 5537 17635 54953 168955 515057 1561555 4717433 14217835 42784577 128615875 386371913 1160164315
;; small program: loop((x + x) + x, x, 1) - (2 * loop(x + x, x, 2))
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 2)))
(set-logic UFNIA)
