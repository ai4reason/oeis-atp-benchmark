;; sequence(s): A186297
;; terms: 1 5 9 21 29 33 41 53 65 69 81 89 105 113 125 141 153 165 173 189
;; small program: compr((2 + loop(x * x, 1, loop(x + x, x div 2, 2))) mod (1 + (x + x)), 1 + x)
;; fast program: (compr(loop((loop(x * x, 1, loop(x + x, x div 2, 1)) - x) mod (1 + (x + x)), x mod 2, x), 1 + x) - 2) + 2
(set-logic UFNIA)
