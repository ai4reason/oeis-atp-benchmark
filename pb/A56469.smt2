;; sequence(s): A56469
;; terms: 2 3 4 6 10 18 34 66 130 258 514 1026 2050 4098 8194 16386 32770 65538 131074 262146
;; small program: 2 + (loop(x + x, x, 1) div 2)
;; fast program: 2 + loop(x div 2, 1 - (x mod 2), loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
