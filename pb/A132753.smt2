;; sequence(s): A132753
;; terms: 3 4 7 14 29 60 123 250 505 1016 2039 4086 8181 16372 32755 65522 131057 262128 524271 1048558
;; small program: 1 + (loop(x + x, x, 2) - x)
;; fast program: 1 + ((2 * loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - x)
(set-logic UFNIA)
