;; sequence(s): A74530
;; terms: 3 13 77 547 4193 33043 262937 2099467 16784033 134237923 1073801897 8590113787 68720012273 549757416403 4398051310457 35184386470507 281475019822913 2251799942956483 18014398897164617 144115189238641627
;; small program: loop((x + x) + x, x, 1) + loop(((x * x) * x) + x, 1, loop(x + x, x, 1))
;; fast program: loop(((x * x) * x) + x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
