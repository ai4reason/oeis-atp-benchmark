;; sequence(s): A112704
;; terms: 1 11 211 5211 145211 4345211 136345211 4426345211 147426345211 5009426345211 172969426345211 6051569426345211 214063569426345211 7643063569426345211 275087063569426345211 9969932063569426345211
;; small program: loop((loop(2 * (2 * ((1 + (2 + 2)) * ((x - (x div y)) + x))), y, 1) div (1 + y)) + x, x, 1)
;; fast program: loop(loop((loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x - 1, x)) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (* 2 (* 2 (* (+ 1 (+ 2 2)) (+ (- x (div x y)) x)))))))
