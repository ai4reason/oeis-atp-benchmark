;; sequence(s): A85260
;; terms: 1 12 155 2003 25884 334489 4322473 55857660 721827107 9327894731 120540804396 1557702562417 20129592507025 260127000028908 3361521407868779 43439651302265219 561353945521579068
;; small program: loop2((loop((2 + y) * x, 2, x) - y) + x, x, x, 1, 1)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (- (+ (* (div x y) x) x) y))))
