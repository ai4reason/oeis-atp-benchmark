;; sequence(s): A18609
;; terms: 1 2 3 4 5 6 8 9 10 12 15 16 18 20 24 30 36 40 45 48
;; small program: compr(loop((2 + y) * x, 2 + 2, 2) mod (1 + x), x) + 1
;; fast program: compr(loop(((x * x) * x) - x, 1, 1 + (2 * (2 + 2))) mod (1 + x), x) + 1
(set-logic UFNIA)
