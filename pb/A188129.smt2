;; sequence(s): A188129
;; terms: 8 17 41 113 353 1217 4481 17153 67073 265217 1054721 4206593 16801793 67158017 268533761 1073938433 4295360513 17180655617 68721049601 274881052673
;; small program: 1 + loop((2 + (2 + (2 + x))) * x, 1, loop(x + x, x, 1))
;; fast program: loop((2 + (2 + (2 + x))) * x, 1, loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) + 1
(set-logic UFNIA)
