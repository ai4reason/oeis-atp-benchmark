;; sequence(s): A53113
;; terms: 1 55 2200 71500 2002000 50050000 1144000000 24310000000 486200000000 9237800000000 167960000000000 2939300000000000 49742000000000000 817190000000000000 13075040000000000000 204297500000000000000
;; small program: loop2(loop((loop((x + x) + x, 2, x) div y) + x, y, 1) * x, 1, x, 1, 1 + x)
;; fast program: ((loop2(x * y, 1 + y, x, 1, 1 + (2 + (2 * (2 + 2)))) div loop(x * y, x, 1)) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) div (1 + x)
(set-logic UFNIA)
