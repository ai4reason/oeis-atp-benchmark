;; sequence(s): A186356
;; terms: 3 5 6 8 10 11 13 14 15 17 18 20 21 22 24 25 26 27 29 30
;; small program: loop(loop(x + y, x, y) div x, (1 + 2) * (1 + x), 1) + x
;; fast program: loop2(loop(x + y, x, y) div x, y, 1 + 2, (2 + (x mod 2)) * (2 + (2 + 2)), (1 + 2) * (1 + x)) + x
(set-logic UFNIA)
...
(assert (= h2 (+ 1 2)))
(assert (forall ((x Int)) (= (i2 x) (* (+ 2 (mod x 2)) (+ 2 (+ 2 2))))))
