;; sequence(s): A55938
;; terms: 2 5 6 9 12 13 14 17 20 21 24 27 28 29 30 33 36 37 40 43
;; small program: (2 * loop((y div loop2(x + y, y div 2, x, 0, x)) + x, x, 1)) + x
;; fast program: (2 * loop((y div loop2(x + y, y div 2, 1 + (2 + 2), x, x div 2)) + x, x, 1)) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* 2 (v2 x)) x))))
