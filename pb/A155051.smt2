;; sequence(s): A155051
;; terms: 1 2 3 4 6 8 13 18 32 46 88 130 262 394 823 1252 2682 4112 8974 13836
;; small program: loop(loop((2 * ((2 * (x * y)) - x)) div (1 + y), y div 2, 1) + x, x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + x) div loop(x * y, x, 1), 1, y div 2) + x, x, 1)
(set-logic UFNIA)
