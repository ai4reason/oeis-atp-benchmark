;; sequence(s): A212323
;; terms: 1 2 8 25 78 238 721 2174 6540 19649 58994 177058 531297 1594090 4782592 14348297 43045734 129138566 387417905 1162257286
;; small program: loop((x + x) + x, x, 1) - loop2(x + y, x, x, 0, 1)
;; fast program: (if x <= 0 then 2 else loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (ite (<= x 0) 2 (w2 x)) (w4 x)))))
