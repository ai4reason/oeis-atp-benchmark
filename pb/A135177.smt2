;; sequence(s): A135177
;; terms: 4 18 100 294 1210 2028 4624 6498 11638 23548 28830 49284 67240 77658 101614 146068 201898 223260 296274 352870
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) * x) + 1, y, 2, 1, x) - 1
;; fast program: loop2(((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) * x) + 1, y, 2, 1, x) - 1
(set-logic UFNIA)
