;; sequence(s): A18581
;; terms: 1 5 7 19 35 95 133 665
;; small program: loop(compr(loop(((x + x) + x) + y, 1 + (2 + 2), 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((1 + loop(((2 + ((2 + x) * x)) * x) + x, 1, 2 * (2 + 2))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
