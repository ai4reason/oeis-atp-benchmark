;; sequence(s): A161720
;; terms: ~1 0 2 3 5 6 8 11 12 15 17 18 20 23 26 27 30 32 33 36
;; small program: ((compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + x) div 2) - 1) - 2
;; fast program: (compr((((((2 * loop(x * x, 2, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1) mod (1 + x)) - 1, 2 + x) - 1) - 2
(set-logic UFNIA)
