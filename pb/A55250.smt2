;; sequence(s): A55250
;; terms: 1 9 47 187 630 1898 5282 13866 34831 84575 199977 462973 1053804 2365704 5250660 11543700 25177005 54539205 117456115 251676495
;; small program: loop(loop(loop(loop(loop((x - 1) + x, y, y) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop((loop((loop(loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) div (2 * (2 * (2 + (2 + 2)))), 1, y) + x) + x, y, 1) + x) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (+ (- x 1) x))))
