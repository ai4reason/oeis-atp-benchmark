;; sequence(s): A215458
;; terms: 0 1 4 7 8 11 28 71 144 259 484 991 2072 4187 8236 16247 32544 65587 131572 262543
;; small program: ((loop(x + x, x, 1) - loop2(x - y, x + x, x, 2, 1)) div 2) + 1
;; fast program: ((loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))) - loop2(x - y, x + x, x, 2, 1)) div 2) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (div (- (v2 x) (w5 x)) 2) 1))))
