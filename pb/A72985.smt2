;; sequence(s): A72985
;; terms: 1 2 7 6 21 18 63 54 189 162 567 486 1701 1458 5103 4374 15309 13122 45927 39366
;; small program: loop2(y, (2 * ((2 div (x * x)) + x)) + x, x, 1, 2)
;; fast program: if x <= 0 then 1 else loop2(x * y, y, (x - 1) div 2, loop(2, x mod 2, 1 + (2 + (2 + 2))), 1 + 2)
(set-logic UFNIA)
