;; sequence(s): A47009
;; terms: 1 2 4 14 60 286 1456 7752 42636 240350 1381380 8064030 47682960 284997384 1719031840 10450528048 63967345068 393895175646 2438398706380 15166284983850
;; small program: loop2(x * y, 1 + y, x - 1, if x <= 0 then 1 else 2, x + x) div loop(x * y, x, 1)
;; fast program: (loop2(x * y, 1 + y, x - 1, 1, x + x) div loop(x * y, x, 1)) * (if x <= 0 then 1 else 2)
(set-logic UFNIA)
