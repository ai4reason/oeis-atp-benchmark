;; sequence(s): A133525
;; terms: 503 1826 3996 8784 15300 26136 48328 73206 117000 173754 228872 302904 401128 537586 685060 882000 1091034 1274672 1540730 1811754
;; small program: loop2(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * (x * x), y, 2, 1, y) + x, 1 + y, 2 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x * x), y, 2, 1, x), 1, y) + x, 1 + y, 2 + 2, 0, x)
(set-logic UFNIA)
