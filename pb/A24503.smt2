;; sequence(s): A24503
;; terms: 1 0 0 0 0 1 1 1 1 2 3 3 5 6 8 10 13 18 23 30
;; small program: loop(x div (1 + 2), x, loop(2 * ((x - (x div y)) + x), x, 1))
;; fast program: (loop((((2 * (y + y)) - 2) * x) div (1 + y), x, 1) * (1 + x)) div loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))
(set-logic UFNIA)
