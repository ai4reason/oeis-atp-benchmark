;; sequence(s): A223719
;; terms: 9 81 484 2116 7396 21904 57121 134689 292681 594441 1140624 2085136 3655744 6180196 10118761 16104169 24990001 37908649 56340036 82192356
;; small program: loop(x * x, 1, loop(loop(1 + loop(x + y, y, x), y, x), x + 1, 1))
;; fast program: loop2(loop(loop((loop((x * x) + x, 1, 2 + (((x * x) + x) div 2)) div (2 + (2 + 2))) - x, 1, 2 + x), 1, y) * x, y, 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ 1 (v3 x y)))))
...
(assert (= g7 1))
(assert (forall ((x Int)) (= (h7 x) (+ 2 (div (+ (* x x) x) 2)))))
(assert (forall ((x Int) (y Int)) (= (u7 x y) (ite (<= x 0) y (f7 (u7 (- x 1) y))))))
(assert (forall ((x Int)) (= (v7 x) (u7 g7 (h7 x)))))
(assert (forall ((x Int)) (= (f6 x) (- (div (v7 x) (+ 2 (+ 2 2))) x))))
(assert (= g6 1))
