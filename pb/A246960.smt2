;; sequence(s): A246960
;; terms: 0 1 2 1 2 3 2 1 2 3 0 3 2 3 2 1 2 3 0 3
;; small program: loop(loop(x div (2 - (x mod 2)), x, y) + x, x, 0) mod (2 + 2)
;; fast program: ((loop2(((1 + y) div (2 + 2)) + x, y div 2, 2 + (2 + 2), 0, x) * 2) + x) mod (2 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (+ (* (w2 x) 2) x) (+ 2 2)))))
