;; sequence(s): A192246
;; terms: 1 1 11 31 101 269 689 1649 3794 8414 18138 38158 78653 159293 317733 625365 1216455 2341635 4465645 8445005
;; small program: loop(loop(loop(loop(x + y, 1 + y, x), x, 1) * loop2(y, x + y, x, 1, 0), 1, y) + x, x, 1)
;; fast program: loop(loop(((loop((x * x) * x, 1, 2 + x) - x) div (2 + (2 + 2))) * loop2(y, x + y, x, 1, 0), 1, y) + x, x, 1)
(set-logic UFNIA)
