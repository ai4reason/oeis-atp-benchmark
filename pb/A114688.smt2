;; sequence(s): A114688
;; terms: 1 5 11 30 71 175 421 1020 2461 5945 14351 34650 83651 201955 487561 1177080 2841721 6860525 16562771 39986070
;; small program: loop(loop2(1 + (2 + ((x + x) + y)), x, y, 1, 1) - x, x, 1)
;; fast program: loop(((1 + 2) * (x div 2)) + x, 1, loop2((x + x) + y, x, x, 1, 0))
(set-logic UFNIA)
