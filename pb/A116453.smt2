;; sequence(s): A116453
;; terms: 5 9 18 36 72 144 288 576 1152 2304 4608 9216 18432 36864 73728 147456 294912 589824 1179648 2359296
;; small program: 1 + loop2((x + x) + y, 1, x, 2 + 2, 0)
;; fast program: (1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1 + 2)))) div 2
(set-logic UFNIA)
