;; sequence(s): A46327
;; terms: 223092870 3234846615 33426748355 247357937827 1448810778701 5663533044013 20475850236047 63836474265323 198229051666003 525737919635921 1214635883296783 2781907990776503 5488629279099587
;; small program: loop2((compr((loop(x * x, 1, loop(x + x, x div 2, 1)) + x) mod (1 + x), 1 + y) * x) + x, 1 + y, 1 + (2 * (2 + 2)), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 1 + (2 * (2 + 2)), 1, x)
(set-logic UFNIA)
