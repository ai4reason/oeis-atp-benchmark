;; sequence(s): A61536
;; terms: 1 2 4 6 9 12 16 20 24 28 33 38 44 50 56 62 69 76 84 92
;; small program: loop(loop((loop((y * y) * x, y - 1, 1) mod (1 + y)) + x, y, x), x, 1)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (mod (v2 x y) (+ 1 y)) x))))
