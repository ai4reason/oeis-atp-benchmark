;; sequence(s): A230631
;; terms: 0 2 4 6 5 7 9 11 10 12 14 16 15 17 19 21 17 19 21 23
;; small program: loop2((y mod (2 + 2)) + x, (y div 2) div 2, x, x, x)
;; fast program: ((loop2(x - y, y div (2 + 2), 2 + 2, x, x) * (1 + 2)) + x) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (* (w1 x) (+ 1 2)) x) x))))
