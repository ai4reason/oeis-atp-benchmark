;; sequence(s): A138364
;; terms: 0 1 0 3 0 10 0 35 0 126 0 462 0 1716 0 6435 0 24310 0 92378
;; small program: loop((x * y) div (y - (y div 2)), x, x mod 2)
;; fast program: loop2((loop(2 * ((x - (x div y)) + x), y, 1) div (1 + y)) - x, 1, x mod 2, 0, x div 2) * x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (- (div (v2 x y) (+ 1 y)) x))))
(assert (= g1 1))
