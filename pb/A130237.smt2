;; sequence(s): A130237
;; terms: 0 2 6 12 16 25 30 35 48 54 60 66 72 91 98 105 112 119 126 133
;; small program: loop((y div loop2(x + y, x, x, 1, 0)) + x, x, 1) * x
;; fast program: (loop(loop(x + y, y - loop2(x + y, x, x, 2, 1), x), 1 + x, 0) + 2) * x
(set-logic UFNIA)
