;; sequence(s): A77874
;; terms: 1 2 1 0 3 6 1 ~4 7 18 ~3 ~24 19 62 ~23 ~108 63 234 ~107 ~448
;; small program: loop(loop(1 - (x + x), y div 2, 1) + x, x, 1)
;; fast program: loop2(((y - x) + 2) + y, x, x div 2, 1 + (x mod 2), 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (- y x) 2) y))))
