;; sequence(s): A236332
;; terms: 1 8 14 36 63 112 172 260 365 504 666 868 1099 1376 1688 2052 2457 2920 3430 4004
;; small program: loop(y - x, loop((x * x) * x, 1, 1 + x), 2) + 2
;; fast program: (loop(2 * (2 + 2), x mod 2, 1) + loop((x * x) * x, 1, 1 + x)) div 2
(set-logic UFNIA)
