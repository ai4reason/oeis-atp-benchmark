;; sequence(s): A90244
;; terms: 1 2 3 1 4 3 7 4 11 7 18 11 29 18 47 29 76 47 123 76
;; small program: loop2(y, x + y, loop(y - x, x, 1), 2, 1)
;; fast program: loop2(y, x + y, (x div 2) + (1 - (x mod 2)), 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (+ (div x 2) (- 1 (mod x 2))))))
(assert (= i2 2))
(assert (= j2 1))
