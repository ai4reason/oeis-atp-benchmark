;; sequence(s): A53367
;; terms: 1 11 63 255 825 2277 5577 12441 25740 50050 92378 163098 277134 455430 726750 1129854 1716099 2552517 3725425 5344625
;; small program: loop(loop(loop(loop(loop(((1 + y) * (y * y)) + x, y, x), y, x), y, x), 1 + y, x), x, 2) div 2
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (* (+ 1 y) (* y y)) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (div (+ (* 2 (+ (+ x x) x)) x) y) x))))
(assert (forall ((x Int)) (= (g5 x) x)))
(assert (forall ((x Int)) (= (h5 x) (+ (* 2 (+ 2 (+ 2 x))) x))))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v5 x) (u5 (g5 x) (h5 x)))))
(assert (forall ((x Int)) (= (fast x) (div (div (div (v5 x) 2) 2) 2))))
