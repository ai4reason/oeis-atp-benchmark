;; sequence(s): A139287
;; terms: 7 31 511 8191 2097151 33554431 8589934591 137438953471 35184372088831 144115188075855871 2305843009213693951 9444732965739290427391 2417851639229258349412351 38685626227668133590597631
;; small program: ((loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), 0, 2, 1, x) div 2) - 1) div 2
;; fast program: ((loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop(x + x, x, 1), x, 2, 1, x) div 2) div (1 + 2)) - 1
(set-logic UFNIA)
