;; sequence(s): A18733
;; terms: 1 2 4 5 10 20 47 94 188 235 470 940
;; small program: loop(compr(loop((((2 * (2 + x)) + y) * x) + x, 2, 2) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((2 * (2 + loop(((2 * (x * x)) + x) * x, 1, 2 + (2 + 2)))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
