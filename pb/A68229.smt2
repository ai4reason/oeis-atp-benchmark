;; sequence(s): A68229
;; terms: 7 19 31 43 67 79 103 127 139 151 163 199 211 223 271 283 307 331 367 379
;; small program: (compr(((((if (((1 + (2 * loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2) <= 0 then 1 else 0) * (1 + x)) mod (1 + 2)) - 1) mod (1 + x), 1 + x) * 2) + 1
;; fast program: (((compr(loop((((loop(if (((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2) <= 0 then 1 else 2, 1, (x + x) + x) + 1) mod 2) mod (1 + (x + x))) mod (1 + x), x mod 2, x), 1 + x) * 2) + 1) * (1 + 2)) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f0 x) (mod (- (mod (* (ite (<= (- (mod (+ 1 (* 2 (v1 x))) (+ 1 (+ x x))) 2) 0) 1 0) (+ 1 x)) (+ 1 2)) 1) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (f5 x) (ite (<= (- (mod (+ 1 (v6 x)) (+ 1 (+ x x))) 2) 0) 1 2))))
(assert (= g5 1))
(assert (forall ((x Int)) (= (h5 x) (+ (+ x x) x))))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int)) (= (v5 x) (u5 g5 (h5 x)))))
(assert (forall ((x Int)) (= (f4 x) (mod (mod (mod (+ (v5 x) 1) 2) (+ 1 (+ x x))) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (- (* (+ (* (v3 x) 2) 1) (+ 1 2)) 2))))
