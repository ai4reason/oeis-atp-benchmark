;; sequence(s): A225785
;; terms: 0 12 84 3960 27144 1275204 8740380 410611824 2814375312 132215732220 906220110180 42573055163112 291800061102744 13708391546789940 93958713454973484 4414059505011197664 30254413932440359200 1421313452222058857964
;; small program: loop(x * x, 1, loop2(((x - y) + x) + x, x, (x - (x div 2)) + x, 1, 1)) div 2
;; fast program: loop(x * x, 1, loop2((2 * (x + x)) + y, x, x, 1, 0 - loop(0 - x, x, 1))) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j3 x) (- 0 (v4 x)))))
