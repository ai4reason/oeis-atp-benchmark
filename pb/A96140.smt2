;; sequence(s): A96140
;; terms: 0 1 3 10 29 81 220 589 1563 4126 10857 28513 74792 196041 513619 1345282 3522981 9224881 24153636 63239221
;; small program: loop2(loop2(x + y, x, y, 0, 1) + x, 1 + y, x, 0, x)
;; fast program: ((((loop2(y, x + y, x, 2, 1) - 1) * loop2(x + y, x, x - 1, 1, 1)) - 1) + (x mod 2)) + (x mod 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (- (* (- (w2 x) 1) (w3 x)) 1) (mod x 2)) (mod x 2)))))
