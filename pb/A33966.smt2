;; sequence(s): A33966
;; terms: 1 20 10 5 96 48 24 12 6 3 58 29 552 276 138 69 1312 656 328 164
;; small program: loop(loop(2 + (loop(2 + (x * x), 2, 2) * x), x mod 2, x) div 2, x, 1)
;; fast program: loop(loop(2 + ((2 + loop(x * x, 1, 2 + (2 + 2))) * x), x mod 2, x) div 2, x, 1)
(set-logic UFNIA)
