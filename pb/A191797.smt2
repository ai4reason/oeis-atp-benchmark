;; sequence(s): A191797
;; terms: 0 0 0 1 3 10 28 78 210 561 1485 3916 10296 27028 70876 185745 486591 1274406 3337236 8738290
;; small program: loop((x - 1) + y, loop2(x + y, x, x, 0, 1), 0)
;; fast program: loop((x * x) - x, 1, loop2(x + y, x, x - 2, 1, 1)) div 2
(set-logic UFNIA)
