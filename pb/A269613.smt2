;; sequence(s): A269613
;; terms: 3 9 27 78 222 624 1740 4824 13320 36672 100752 276384 757344 2073600 5674176 15520128 42437760 116014080 317100288 866621952
;; small program: (loop((x + loop2(2 * (x + y), x, y, 1, 0)) + x, x, 2) div 2) * (1 + 2)
;; fast program: ((loop2(2 * (x + y), x, x, 1 + 2, 1) - loop(x + x, x, 1)) div 2) * (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (div (- (w2 x) (v3 x)) 2) (+ 1 2)))))
