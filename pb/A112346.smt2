;; sequence(s): A112346
;; terms: 1 2 5 8 17 26 53 80 161 242 485 728 1457 2186 4373 6560 13121 19682
;; small program: loop2((y + y) + y, x, x, 2, 1) - 1
;; fast program: loop2(x * y, y, x div 2, 2 + (x mod 2), 1 + 2) - 1
(set-logic UFNIA)
