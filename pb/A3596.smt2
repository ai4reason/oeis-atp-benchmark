;; sequence(s): A3596
;; terms: 1 2 4 8 11 16 22 32 44 64 88 121 128 176 242 256 352 484 512 704
;; small program: loop(compr(loop((x * x) * x, 2, 2 + loop((x * x) + x, 2, 2)) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr(loop((x * x) * x, 2, 2 * (2 + (2 * (2 + (2 * (2 + 2)))))) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
