;; sequence(s): A69921
;; terms: 1 5 10 29 73 194 505 1325 3466 9077 23761 62210 162865 426389 1116298 2922509 7651225 20031170 52442281 137295677
;; small program: loop(loop2(x + y, x, y + y, 1 + 2, 0) - x, x, 1)
;; fast program: (2 + ((1 + 2) * loop(x * x, 1, loop2(x + y, x, x, 1, 2)))) div (1 + (2 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (+ 2 (* (+ 1 2) (v2 x))) (+ 1 (+ 2 2))))))
