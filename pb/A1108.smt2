;; sequence(s): A1108
;; terms: 0 1 8 49 288 1681 9800 57121 332928 1940449 11309768 65918161 384199200 2239277041 13051463048 76069501249 443365544448 2584123765441 15061377048200 87784138523761
;; small program: loop2((y - x) - x, x, x + x, 1, 1) div 2
;; fast program: (loop(x * x, 1, loop2((x + x) + y, x, x - 1, 1, 1)) - 1) + (x mod 2)
(set-logic UFNIA)
