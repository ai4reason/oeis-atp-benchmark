;; sequence(s): A140725
;; terms: 0 1 4 10 34 94 298 862 2650 7822 23722 70654 212986 636910 1914826 5736286 17225242 51642958 154994410 464852158
;; small program: loop2(x + y, 2 * ((x + x) + x), x, 1, 1) div 2
;; fast program: loop2(((x + y) + y) + y, x + x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 2)
(set-logic UFNIA)
