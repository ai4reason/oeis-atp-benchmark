;; sequence(s): A105693
;; terms: 0 1 4 13 39 112 313 859 2328 6253 16687 44320 117297 309619 815656 2145541 5637351 14799280 38826025 101809867
;; small program: loop2(x + y, x, x + x, 1, 1) - loop(x + x, x, 1)
;; fast program: (if x <= 0 then 1 else loop2(((x - y) + x) + x, x, x - 1, 1 + 2, 1)) - loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
