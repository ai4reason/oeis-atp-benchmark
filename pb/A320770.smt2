;; sequence(s): A320770
;; terms: 1 1 2 2 ~4 ~4 ~8 ~8 16 16 32 32 ~64 ~64 ~128 ~128 256 256 512 512
;; small program: loop2(x * y, 0 - y, x div 2, 1, 2)
;; fast program: loop(loop2(x * y, y, x div 2, 1 + (x mod 2), 0 - (2 + 2)), 1, x div 2)
(set-logic UFNIA)
