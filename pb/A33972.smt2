;; sequence(s): A33972
;; terms: 1 34 17 562 281 9274 4637 153022 76511 2524864 1262432 631216 315608 157804 78902 39451 1301884 650942 325471 10740544
;; small program: loop(loop(2 + (loop((2 * (x * x)) - x, 2, 2) * x), x mod 2, x) div 2, x, 1)
;; fast program: loop(loop(2 + ((2 + loop((x * x) * x, 1, 2 + 2)) * x), x mod 2, x) div 2, x, 1)
(set-logic UFNIA)
