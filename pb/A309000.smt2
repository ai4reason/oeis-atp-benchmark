;; sequence(s): A309000
;; terms: 3 22 105 416 1491 5034 16365 51892 161799 498686 1524705 4635528 14037627 42391378 127763925 384536924 1156232175 3474201510 10434138825 31326533680
;; small program: ((loop(loop((loop2(((x + x) + x) + y, y + y, y, 2, 1) + x) + x, y, 1) + x, x, 2) * 2) - 1) + x
;; fast program: loop((loop((loop((2 + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) - loop(x + x, x, 1), 1, 2 + x) - 2) - x, 1, y) + x) + x, x, 1) + 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f5 x) (- (+ 2 (w6 x)) (v8 x)))))
(assert (= g5 1))
