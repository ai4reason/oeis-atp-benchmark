;; sequence(s): A21144
;; terms: 1 18 227 2520 26481 271278 2745247 27615060 276964061 2773708938 27757433067 277676053200 2777269152841 27775234648998 277765062125687 2777714199500940 27777459886360821 277776188320627458
;; small program: loop((loop2((2 * (((2 * (x + x)) + x) + y)) - 1, y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1)
;; fast program: (loop((((((((loop(2 * ((2 * (x + x)) + x), x, 1) + loop(x + x, x, 1)) div 2) + loop(x + x, x, 1)) div (1 + 2)) * 2) + 1) - loop2(x * y, y, x, 1, 1 + (2 + 2))) div 2, 1, 2 + x) div 2) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f2 x) (div (- (+ (* (div (+ (div (+ (v3 x) (v4 x)) 2) (v5 x)) (+ 1 2)) 2) 1) (w6 x)) 2))))
(assert (= g2 1))
