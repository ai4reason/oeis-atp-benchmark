;; sequence(s): A79705
;; terms: 12 27 75 147 363 507 867 1083 1587 2523 2883 4107 5043 5547 6627 8427 10443 11163 13467 15123
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + x, y, 2, 1 + 2, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), (((1 + x) * 2) div 2) mod 2, x) - 2, 1 + y) + 1) * (x * x), x, 2, 1, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g5 x) (mod (div (* (+ 1 x) 2) 2) 2))))
