;; sequence(s): A71055
;; terms: 0 0 2 0 2 2 6 0 2 2 6 2 6 6 14 0 2 2 6 2
;; small program: loop(loop((2 + x) mod (1 + y), x, 0), x, x)
;; fast program: loop(loop2(((y mod 2) * x) + x, y div 2, 2 + (2 + 2), 1 + (x mod 2), x div 2), 1, 1 + x) - 2
(set-logic UFNIA)
