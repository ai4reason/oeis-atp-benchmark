;; sequence(s): A87105
;; terms: 12 24 60 96 192 252 396 560 720 1080 1280 1596 1932 2288 2784 3240 3960 4340 4896 5616
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 2, 2 + y, 2, 1, x) - 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + 2, 2 + y, 2, 1, x) - 2
(set-logic UFNIA)
