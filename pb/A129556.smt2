;; sequence(s): A129556
;; terms: 0 2 21 95 816 3626 31005 137711 1177392 5229410 44709909 198579887 1697799168 7540806314 64471658493 286352060063 2448225223584 10873837476098 92968086837717 412919472031679
;; small program: loop2((2 * ((x + x) + x)) + y, x, x, 1, loop(0 - x, x, 1)) div 2
;; fast program: loop2((2 * ((x + x) + x)) + y, x, x, 1, loop(0 - 1, x mod 2, 1)) div 2
(set-logic UFNIA)
