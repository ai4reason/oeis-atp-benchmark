;; sequence(s): A103425
;; terms: 1 3 5 15 41 123 365 1095 3281 9843 29525 88575 265721 797163 2391485 7174455 21523361 64570083 193710245 581130735
;; small program: 1 + loop2(y - x, (y + y) + y, x, 0, 2)
;; fast program: 1 + (2 * ((2 + loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2)))) div (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ 1 (* 2 (div (+ 2 (w1 x)) (+ 2 2)))))))
