;; sequence(s): A305032
;; terms: 0 1 6 22 68 190 500 1260 3080 7350 17220 39732 90552 204204 456456 1012440 2230800 4886310 10647780 23094500
;; small program: loop((loop((loop((x * y) div (y - (y div 2)), y - 1, 2) + x) + x, y - 1, 1) + x) + x, x, 0)
;; fast program: loop((loop((loop(loop(2 * ((x - (x div y)) + x), x div 2, 1 + (x mod 2)), 1, y) + x) + x, y - 1, 1) + x) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h6 x) (+ 1 (mod x 2)))))
