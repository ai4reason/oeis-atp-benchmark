;; sequence(s): A29757
;; terms: 0 1 1 5 1 21 9 45 225 357 761 1757 2641 5013 489 18829 28609 11973 59865 37181
;; small program: loop((2 * (x + x)) + x, x, 1) mod loop(x + x, x, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) mod loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
