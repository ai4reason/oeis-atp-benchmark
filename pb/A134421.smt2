;; sequence(s): A134421
;; terms: 1 2 4 6 8 11 14 17 20 23 26 29 32 35 39 43 47 51 55 59
;; small program: loop(loop(loop((1 + x) div (1 + 2), x, y) + x, y, 1) + x, x, 1)
;; fast program: loop(loop(((y + y) div loop2(x * y, y, x, 1, 1 + 2)) + x, y, 1) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (div (+ y y) (w5 x)) x))))
