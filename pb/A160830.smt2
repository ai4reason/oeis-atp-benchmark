;; sequence(s): A160830
;; terms: 1 1 2 4 5 7 8 10 12 14 16 19 20 22 24 27 29 31 34 35
;; small program: (loop2(compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) + x, 1 + y, 2, 1, x) div 2) div 2
;; fast program: loop2(compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + x, 1 + y, 2, 1, x) div (2 + 2)
(set-logic UFNIA)
