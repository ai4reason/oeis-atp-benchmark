;; sequence(s): A127329
;; terms: 15 21 33 39 51 57 69 87 93 111 123 129 141 159 177 183 201 213 219 237
;; small program: (compr((1 + loop(x + x, x, x)) mod (1 + x), 2 + x) + 1) * (1 + 2)
;; fast program: ((compr((((((1 + (x mod 2)) * loop(x * x, 1, loop(x + x, x div 2, 1))) * loop(x * x, 1, loop(x + x, x div 2, 1))) * (1 + (x mod 2))) mod (1 + (x + x))) - 1, 2 + x) * 2) + 1) * (1 + 2)
(set-logic UFNIA)
