;; sequence(s): A71555
;; terms: 6 36 386 5006 85086 1616616 37182146 1078282206 33426748356 1236789689136 50708377254536 2180460221945006 102481630431415236 5431526412865007456 320460058359035439846 19548063559901161830546
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (2 + x), y) + 2) * x, 1 + x, 1) + 1
;; fast program: loop2(((compr(((1 + loop(x + x, x - 1, 2)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, 1 + y, x, 1 + (2 + 2), 1 + 2) + 1
(set-logic UFNIA)
