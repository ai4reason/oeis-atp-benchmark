;; sequence(s): A76936
;; terms: 1 4 2 32 4 256 8 2048 16 16384 32 131072 64 1048576 128 8388608 256 67108864 512 536870912
;; small program: loop(x + x, loop2(1 + y, x, x, 0, x), 1)
;; fast program: loop((x * x) * x, x mod 2, loop(x + x, x div 2, 2)) div 2
(set-logic UFNIA)
