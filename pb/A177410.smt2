;; sequence(s): A177410
;; terms: 1 2 22 1240 316316 343855008 1551088459936 28684932916796288 2161788213413182113760 661624062463590275090838016 820418024446932078541699530057216
;; small program: loop2(x * y, y - 1, x, 1, loop(x + x, x, 1 + x)) div loop((x * y) + x, x, 1)
;; fast program: loop2(x * y, y - 1, x, 1, loop(x + x, x, 1 + x)) div loop(x * y, x, 1 + x)
(set-logic UFNIA)
