;; sequence(s): A120139
;; terms: 11 17 25 38 57 85 128 192 288 432 648 972 1458 2187 3280 4920 7380 11070 16605 24908
;; small program: loop((x div 2) + x, x, loop((2 + y) * x, 2, 2) - 1) div 2
;; fast program: loop((x div 2) + x, x, (2 * (2 * (2 + (2 + 2)))) - 1) div 2
(set-logic UFNIA)
