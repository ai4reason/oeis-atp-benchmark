;; sequence(s): A246444
;; terms: 2 3 4 8 9 10 15 16 17 21 22 23 27 28 29 33 34 35 36 40
;; small program: loop(compr(((((((((2 * (x + x)) - 1) div loop(1 + (x + x), 2, 2)) + 1) + x) div 2) + 1) + x) mod 2, y), x, 2)
;; fast program: loop(compr(((((((((2 * (x + x)) - 1) div (1 + (2 + (2 * (2 + 2))))) + 1) + x) div 2) + 1) + x) mod 2, y), x, 2)
(set-logic UFNIA)
