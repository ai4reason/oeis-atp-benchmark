;; sequence(s): A24525
;; terms: 1 5 14 39 88 209 378 667 1028 1557 2398 3359 4728 6409 8258 10467 13276 16757 20478 24967
;; small program: loop(loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), y) * x) + x, y, 2, 1, y) + x, x, 1)
;; fast program: loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, y) * x) + x, y, 2, 1, y) + x, x, 1)
(set-logic UFNIA)
