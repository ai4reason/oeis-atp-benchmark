;; sequence(s): A331552
;; terms: 1 2 ~6 ~12 30 60 ~140 ~280 630 1260 ~2772 ~5544 12012 24024 ~51480 ~102960 218790 437580 ~923780 ~1847560
;; small program: loop((x * y) div (y - (y div 2)), x, 1) * loop(0 - x, x div 2, 1 + x)
;; fast program: loop(2 * (((x div y) + x) + x), x div 2, 1 + (x mod 2)) * loop(0 - x, (x div 2) mod 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g3 x) (mod (div x 2) 2))))
(assert (= h3 1))
