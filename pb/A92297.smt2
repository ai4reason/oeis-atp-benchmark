;; sequence(s): A92297
;; terms: 0 6 6 18 30 66 126 258 510 1026 2046 4098 8190 16386 32766 65538 131070 262146 524286 1048578
;; small program: loop2(2 + (y + y), x + y, x, 0, 2)
;; fast program: (2 * loop(2 + (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - 2
(set-logic UFNIA)
