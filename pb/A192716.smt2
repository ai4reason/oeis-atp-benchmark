;; sequence(s): A192716
;; terms: 1 2 4 5 8 10 16 20 25 32 40 50 64 80 100 125 128 160 200 250
;; small program: compr((loop((x * x) * x, 2, 2 + (2 * (2 + 2))) * x) mod (1 + x), x) + 1
;; fast program: loop2((compr(loop((x * x) * x, 2, 2 + (2 * (2 + 2))) mod (1 + x), y) * x) + x, 0, 2 + (2 + 2), 1, x)
(set-logic UFNIA)
