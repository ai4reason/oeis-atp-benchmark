;; sequence(s): A100071
;; terms: 0 1 2 6 12 30 60 140 280 630 1260 2772 5544 12012 24024 51480 102960 218790 437580 923780
;; small program: loop((x * y) div (y - (y div 2)), x - 1, x)
;; fast program: loop(2 * ((x - (x div y)) + x), x div 2, loop(x div 2, 1 - (x mod 2), x))
(set-logic UFNIA)
