;; sequence(s): A86953
;; terms: 1 0 0 2 6 12 22 42 84 170 342 684 1366 2730 5460 10922 21846 43692 87382 174762
;; small program: loop((x - loop2(x - y, x, y, 2, 0)) + x, x, 1)
;; fast program: ((loop2(x - y, x, x mod (2 + (2 + 2)), 1, 2) + loop(x + x, x - 1, 1)) * 2) div (1 + 2)
(set-logic UFNIA)
