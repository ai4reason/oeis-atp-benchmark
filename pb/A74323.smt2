;; sequence(s): A74323
;; terms: 1 1 3 2 6 4 12 8 24 16 48 32 96 64 192 128 384 256 768 512
;; small program: loop2(y + y, x, x, 1 + 2, 1) div 2
;; fast program: if x <= 0 then 1 else loop(x + x, (x - 1) div 2, 1 + loop(0, x mod 2, 2))
(set-logic UFNIA)
