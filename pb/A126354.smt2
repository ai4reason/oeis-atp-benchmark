;; sequence(s): A126354
;; terms: 1 0 3 2 17 12 99 70 577 408 3363 2378 19601 13860 114243 80782 665857 470832 3880899 2744210
;; small program: loop2(x - y, (y - x) - x, x, 1, x mod 2)
;; fast program: loop2((x + x) + y, x, x - 1, 1 - (x mod 2), 1)
(set-logic UFNIA)
