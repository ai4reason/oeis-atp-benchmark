;; sequence(s): A228797
;; terms: 2 2 8 16 42 98 240 576 1394 3362 8120 19600 47322 114242 275808 665856 1607522 3880898 9369320 22619536
;; small program: loop(loop2((x + x) + y, x, y, 2, 0) - x, x, 2)
;; fast program: 1 + loop(x - 2, x mod 2, loop2((x + x) + y, x, x, 1, 1))
(set-logic UFNIA)
