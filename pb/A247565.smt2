;; sequence(s): A247565
;; terms: 2 3 3 1 ~1 9 63 217 527 969 1311 1081 47 ~87 7743 39961 121679 270729 456543 548857
;; small program: loop(x + x, x, 1) + loop2(x - y, 2 * (x + y), x, 1, 0)
;; fast program: loop2(x - y, 2 * (x + y), x - 1, 1, 2) + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))
(set-logic UFNIA)
