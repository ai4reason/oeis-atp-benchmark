;; sequence(s): A101662
;; terms: 0 1 0 2 0 1 2 1 0 1 0 2 2 1 0 2 0 1 0 2
...
(assert (forall ((x Int)) (= (small x) (ite (<= (mod (div (w0 x) 2) 2) 0) (mod x 2) 2))))
...
(assert (forall ((x Int)) (= (fast x) (ite (<= (mod (div (w1 x) 2) 2) 0) (mod x 2) 2))))
