;; sequence(s): A18412
;; terms: 1 2 3 4 5 6 8 9 10 12 15 18 20 24 30 36 40 45 60 72
;; small program: compr(loop((2 + y) * x, 2 + 2, 1) mod (1 + x), x) + 1
;; fast program: compr((2 * loop((1 - x) * (x * x), 1, 2 + (2 + 2))) mod (1 + x), x) + 1
(set-logic UFNIA)
