;; sequence(s): A74552
;; terms: 3 15 83 495 3107 20175 134003 903855 6161987 42326415 292299923 2026332015 14085959267 98111307855 684331371443 4778093436975 33385561506947 233393582580495 1632228682596563 11417969833962735
;; small program: loop2(((x + x) + x) + y, (2 * (y + y)) + y, x, 2, 2) + loop((2 * ((x + x) + x)) + x, x, 1)
;; fast program: (loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (w2 x) (w4 x)) (w5 x)))))
