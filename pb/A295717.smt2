;; sequence(s): A295717
;; terms: 1 3 5 7 14 19 37 52 97 141 254 379 665 1012 1741 2689 4558 7119 11933 18796
;; small program: loop2(2 + y, x + y, x, 1, 2) - loop2(y, x + x, x, 0, 1)
;; fast program: loop2(x + y, x, x, 1, 1 + 2) - loop(x + x, x div 2, x mod 2)
(set-logic UFNIA)
