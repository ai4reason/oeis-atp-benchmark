;; sequence(s): A84920
;; terms: 3 8 24 48 120 168 288 360 528 840 960 1368 1680 1848 2208 2808 3480 3720 4488 5040
;; small program: loop2((compr((2 - loop(x + x, x, 2)) mod (1 + x), 1 + y) * x) + 2, y, 2, 1, x) - 2
;; fast program: (loop2(((compr(((1 + loop(x + x, x, 1)) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, y, 2, 1, x) * loop(1, x, 2 + 2)) - 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (w3 x) (v6 x)) 1))))
