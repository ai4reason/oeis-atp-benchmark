;; sequence(s): A79395
;; terms: 2048 177147 48828125 1977326743 285311670611 1792160394037 34271896307633 116490258898219 952809757913927 12200509765705829 25408476896404831 177917621779460413 550329031716248441
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + (2 + (2 * (2 + 2))), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (loop((x * x) * x, 1, (x * x) * x) * x), y, 2, 1, x)
(set-logic UFNIA)
