;; sequence(s): A110139
;; terms: 1 1 1 1 4 4 27 27 256 256 3125 3125 46656 46656 823543 823543 16777216 16777216 387420489 387420489
;; small program: loop2((y div 2) * x, y, x div 2, 1, x)
;; fast program: loop(loop2(x * y, y, x, 1, x), 1, x div 2)
(set-logic UFNIA)
