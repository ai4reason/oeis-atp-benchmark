;; sequence(s): A89643
;; terms: 0 1 1 1 2 1 1 2 2 1 2 2 2 3 1 1 2 2 1 2
;; small program: loop2(2 + (x - y), y div (1 + 2), x, x, x + x)
;; fast program: loop2(x - y, y div (1 + 2), 2 + 2, 0, (x + x) div (1 + 2)) + x
(set-logic UFNIA)
...
(assert (= h1 (+ 2 2)))
(assert (= i1 0))
(assert (forall ((x Int)) (= (j1 x) (div (+ x x) (+ 1 2)))))
