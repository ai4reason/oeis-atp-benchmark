;; sequence(s): A264038
;; terms: 0 2 3 10 20 47 98 210 435 902 1848 3775 7670 15542 31403 63330 127500 256367 514938 1033450
;; small program: loop2((x + y) + y, x, x, 1, 2) - loop2(x + y, x, x, 1, 2)
;; fast program: ((2 * loop(1 + (x + x), x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) - 1) - loop2(x + y, x, x, 1, 2)
(set-logic UFNIA)
