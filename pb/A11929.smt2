;; sequence(s): A11929
;; terms: 0 0 0 0 1 6 18 44 88 159 265 416 625 903 1264 1724 2298 3006 3865 4896
;; small program: loop((x - y) * x, 2, 2 - x) div (1 + (2 + loop(x * x, 2, 2)))
...
(assert (= v1 (u1 g1 h1)))
(assert (forall ((x Int)) (= (small x) (div (v0 x) (+ 1 (+ 2 v1))))))
