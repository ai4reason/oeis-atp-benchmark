;; sequence(s): A132638
;; terms: 4 46656 8916100448256 104857600000000000000000000
;; small program: loop(loop2(x * y, y, x, 1, x), 1, (1 + x) * (2 + x))
;; fast program: loop(loop2(x * y, y, x - (x div 2), 1, x) * loop2(x * y, y, x div 2, 1, x), 1, (1 + x) * (2 + x))
(set-logic UFNIA)
