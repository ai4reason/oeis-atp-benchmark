;; sequence(s): A139797
;; terms: 0 0 0 0 1 1 3 4 10 18 39 75 153 302 608 1212 2429 4853 9711 19416
;; small program: ((loop(loop2(y + y, x + y, y, 1, 0) - x, x, 0) div 2) + 1) div (1 + 2)
;; fast program: loop(loop(((loop(x + x, x, 2) div (1 + (2 * (2 + 2)))) + 1) div 2, 1, y) - x, x - 1, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (div (+ (div (v4 x) (+ 1 (* 2 (+ 2 2)))) 1) 2))))
(assert (= g3 1))
