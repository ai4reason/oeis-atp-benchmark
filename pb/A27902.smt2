;; sequence(s): A27902
;; terms: 1 2 4 5 7 8 10 13 14 16 20 26 28 32 35 40 41 52 56 65
;; small program: loop(compr((loop((x + x) + x, 2 * (2 * (2 + (2 + 2))), 1) + x) mod (1 + x), y), x, 0) + 1
;; fast program: ((compr((loop((x + x) + x, 2 * (2 * (2 + (2 + 2))), 1) - 1) mod (1 + x), x) * 2) div 2) + 1
(set-logic UFNIA)
