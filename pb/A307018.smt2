;; sequence(s): A307018
;; terms: 0 0 0 1 0 1 2 1 2 4 2 4 6 4 6 9 6 9 12 9
;; small program: loop(0 - loop(x - y, y div (1 + 2), x), x, 0)
;; fast program: loop(loop(loop((x * x) + x, 1, x div (1 + 2)) div 2, 1, y) - x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (- 0 (v1 x y)))))
