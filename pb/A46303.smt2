;; sequence(s): A46303
;; terms: 2310 15015 85085 323323 1062347 2800733 6678671 14535931 31367009 58642669 95041567 162490421 259106347 385499687 600662303 907383479 1249792339 1673450759 2276990377 3024658859
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, 1 + y, 1 + (2 + 2), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) * x) + x, 1 + y, 1 + (2 + 2), 1, x)
(set-logic UFNIA)
