;; sequence(s): A95664
;; terms: 3 25 117 405 1155 2871 6435 13299 25740 47190 82654 139230 226746 358530 552330 831402 1225785 1773783 2523675 3535675
;; small program: ((loop((loop(2 + (x + y), 2, y) * x) div y, x, (2 * (2 * (2 + (2 + 2)))) + x) div 2) div 2) div 2
;; fast program: loop((((2 * ((x + x) + x)) + x) div y) + x, x, (2 * (2 * (2 + (2 + 2)))) + x) div (2 * (2 + 2))
(set-logic UFNIA)
