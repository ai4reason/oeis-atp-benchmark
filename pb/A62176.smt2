;; sequence(s): A62176
;; terms: 0 1 1 1 0 5 1 5 7 5 1 5 1 5 10 13 1 11 1 5
;; small program: loop((2 * (x + x)) + x, x, 1) mod (1 + x)
;; fast program: loop2(x * y, y, x div 2, loop(1 + (2 + 2), x mod 2, 1), loop(x * x, 1, 1 + (2 + 2))) mod (1 + x)
(set-logic UFNIA)
