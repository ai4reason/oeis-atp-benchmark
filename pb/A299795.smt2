;; sequence(s): A299795
;; terms: 4 12 80 448 11264 53248 1114112 4980736 96468992 7784628224 33285996544 2542620639232 45079976738816 189115999977472 3307330976350208 238690780250636288 17005592192950992896 70328211781017665536 4943727411754159833088 83822005070936202543104
;; small program: loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) + 1) * loop(x + x, x, 1), y, 2, 0, x) div 2
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * loop2(x * y, y, x - 2, 1, 2), y, 2, 1, x) * 2
(set-logic UFNIA)
