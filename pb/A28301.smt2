;; sequence(s): A28301
;; terms: 1 3 12 149 22208 493195275 243241579282325638 59166465891759909038312569872107061 3500670686120788688272744016815662448699251721439983660470143846057740
;; small program: loop((compr((1 + loop(x * y, x, 1)) mod (1 + x), y) + 1) + (x * x), x, 1)
;; fast program: loop((compr(loop((1 - loop(x + x, (x div 2) - 1, 2)) mod (1 + x), (1 + x) mod 2, x) - 2, y) + 1) + (x * x), x, 1)
(set-logic UFNIA)
