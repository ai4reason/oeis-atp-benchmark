;; sequence(s): A216096
;; terms: 1 3 9 27 81 243 729 187 561 683 49 147 441 323 969 907 721 163 489 467
;; small program: loop((x + x) + x, x, 1) mod loop(2 * ((2 * (x + x)) + x), 1 + 2, 1)
;; fast program: loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))) mod loop((x * x) * x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
