;; sequence(s): A84847
;; terms: 1 4 18 86 418 2022 9650 45334 209730 956870 4312402 19228662 84948962 372287398 1620178674 7008019670 30150864514 129107299206 550530654866 2338786731958
;; small program: (((x - 2) * loop(x * x, 1, loop(x + x, x, 1))) div 2) + loop((2 * x) + x, x, 2)
;; fast program: (((x - 2) * loop(x * x, 1, loop(x + x, x, 1))) div 2) + loop2(x * y, y, x, 2, 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (div (* (- x 2) (v0 x)) 2) (v2 x)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (div (* (- x 2) (v3 x)) 2) (w5 x)))))
