;; sequence(s): A230269
;; terms: 0 0 2 8 30 108 386 1376 4902 17460 62186 221480 788814 2809404 10005842 35636336 126920694 452034756 1609945658 5733906488
;; small program: loop2(y, (2 * (x + y)) + y, x, 1, 1) div 2
;; fast program: loop2((2 * (x + y)) + x, x, x - 1, 1, 1) div 2
(set-logic UFNIA)
