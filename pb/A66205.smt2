;; sequence(s): A66205
;; terms: 2 10 110 1870 43010 1333310 54665710 2569288370 151588013830 10156396926610 741416975642530 61537608978329990 5969148070898009030 614822251302494930090 67015625391971947379810 8510984424780437317235870 1166004866194919912461314190
;; small program: loop((compr((1 + loop(x + x, x, x)) mod (1 + x), y + y) * x) + x, x, 2)
;; fast program: loop2(((compr(((1 + loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1)))) mod (1 + (x + x))) - 2, y) * 2) + 1) * x, 2 + y, x, 1, 2) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (w3 x) 2))))
