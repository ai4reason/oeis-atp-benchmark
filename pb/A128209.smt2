;; sequence(s): A128209
;; terms: 1 2 2 4 6 12 22 44 86 172 342 684 1366 2732 5462 10924 21846 43692 87382 174764
;; small program: 1 + loop2(x + y, x + x, x, 0, 1)
;; fast program: loop(x + x, x mod 2, 2 + loop(x * x, 1, loop(x + x, x div 2, 1))) div (1 + 2)
(set-logic UFNIA)
