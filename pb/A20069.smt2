;; sequence(s): A20069
;; terms: 1 0 0 0 0 3 17 104 740 6005 54717 553253 6147263 74450193 976124760 13774204958 208143541601 3353423725801 57380805974819 1039230152655057
;; small program: loop(loop(((x - 2) + x) + x, 2, y) * x, x, 1) div loop((x + x) + x, x + x, 1)
;; fast program: loop2(x * y, 1 + ((2 * (2 + 2)) + y), x - 1, 1, 2 + (2 * (2 + 2))) div loop(x * x, 1, loop2(x * y, y, x div 2, loop(1 + 2, x mod 2, 1), 1 + (2 * (2 + 2))))
(set-logic UFNIA)
