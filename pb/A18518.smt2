;; sequence(s): A18518
;; terms: 1 2 3 6 9 18 31 62 93 186 279 558
;; small program: loop(compr((2 + loop(((x * x) + x) + y, 2 + 2, x)) mod (1 + x), y), x, 0) + 1
;; fast program: ((compr((loop((loop(2, 2 - x, 2 * (2 + 2)) + x) * x, 2, 2) - 2) mod (1 + x), x) + 1) * 2) div 2
(set-logic UFNIA)
