;; sequence(s): A133532
;; terms: 3400 20175 180983 549151 1952201 4267249 10332299 29423591 55576643 118484257 213829309 332208601 492209651 794548943 1362464799 1977716093 2909645707 3998950759 5227426051 6954357343
;; small program: loop2(loop(loop2((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x, y, 1 + (2 + 2), 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
;; fast program: loop2(loop(loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (((x * x) * x) * x), y, 2, 1, x), 1, y) + x, 1 + y, 1 + 2, 0, x)
(set-logic UFNIA)
