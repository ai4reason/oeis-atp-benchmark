;; sequence(s): A118640
;; terms: 1 6 16 66 166 666 1666 6666 16666 66666 166666 666666
;; small program: loop2(loop(2 + (x + x), 2, y) + y, x + x, x, 1, 0)
;; fast program: ((1 + (2 + 2)) * loop2(x * y, y, x div 2, loop(2 + 2, x mod 2, 1), 2 + (2 * (2 + 2)))) div (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (div (* (+ 1 (+ 2 2)) (w2 x)) (+ 1 2)))))
