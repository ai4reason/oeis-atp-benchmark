;; sequence(s): A18382
;; terms: 1 2 3 4 5 6 10 12 15 20 25 30 50 60 75 100 150 300
;; small program: compr(loop(((x * y) * x) + x, 2, 1 + 2) mod (1 + x), x) + 1
;; fast program: compr((2 * loop((1 + x) * (x * x), 1, 1 + (2 + 2))) mod (1 + x), x) + 1
(set-logic UFNIA)
