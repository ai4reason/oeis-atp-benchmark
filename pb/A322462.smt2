;; sequence(s): A322462
;; terms: 0 1 12 13 36 37 72 73 120 121 180 181 252 253 336 337 432 433 540 541
;; small program: loop2((y + y) * (x + y), x, 2, x div 2, 1) + x
;; fast program: (2 * loop((2 + ((x + x) + x)) * x, 1, x div 2)) + x
(set-logic UFNIA)
