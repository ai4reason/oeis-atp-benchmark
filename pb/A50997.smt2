;; sequence(s): A50997
;; terms: 32 243 3125 16807 161051 371293 1419857 2476099 6436343 20511149 28629151 69343957 115856201 147008443 229345007 418195493 714924299 844596301 1350125107 1804229351
;; small program: loop2((compr((2 + loop(x * y, x, x)) mod (2 + x), y) + 2) * x, y, 1 + (2 + 2), 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, x div 2, 1)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * ((((x * x) * x) * x) * x), 0, 2, 1, x) div 2
(set-logic UFNIA)
