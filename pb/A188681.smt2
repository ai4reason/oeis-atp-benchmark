;; sequence(s): A188681
;; terms: 1 3 45 1008 27225 819819 26509392 901402560 31818681873 1156122556875 42985853635725 1628541825580800 62667882587091600 2443473892345873968 96351855806554401600 3836565846094702507776 154071018890153214025473
;; small program: (loop2((x * y) * y, 1 + y, x, 1, 1 + (x + x)) div loop((y * x) * y, x, 1)) div (1 + (x + x))
;; fast program: loop2(loop(loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) div loop(x * y, x, 1), 1, y) * x, y, 2, 1 + (x + x), x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (div (div (w0 x) (v1 x)) (+ 1 (+ x x))))))
