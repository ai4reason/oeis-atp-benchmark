;; sequence(s): A245027
;; terms: 1 2 3 4 5 6 8 9 10 12 13 15 16 18 19 20 24 25 26 30
;; small program: loop(compr((loop((2 * ((x + x) + x)) + x, 2 * (2 + (2 + 2)), 1) + x) mod (1 + x), y), x, 0) + 1
;; fast program: loop(compr((loop((x * x) * x, 1, loop(x * x, 2, 1 + (2 + (2 + 2)))) + x) mod (1 + x), y), x, 0) + 1
(set-logic UFNIA)
