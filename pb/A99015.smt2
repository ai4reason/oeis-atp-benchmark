;; sequence(s): A99015
;; terms: 1 2 8 33 140 592 2509 10626 45016 190685 807764 3421728 14494697 61400482 260096680 1101787113 4667245276 19770767984 83750317589 354772037730
;; small program: loop(loop2(y, x + y, y + y, 1 + 2, 0) - x, x, 1) * loop2(x + y, x, x, 1, 0)
;; fast program: ((((((loop2(y - x, x, x + x, 2, 1) - 2) * (1 + 2)) - 1) - 2) div (1 + (2 + 2))) + 2) * loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (+ (div (- (- (* (- (w3 x) 2) (+ 1 2)) 1) 2) (+ 1 (+ 2 2))) 2) (w4 x)))))
