;; sequence(s): A7607
;; terms: 2 3 7 8 9 10 16 17 18 19 20 21 29 30 31 32 33 34 35 36
;; small program: compr(loop(loop(0 + (x + y), x, y) div x, x, 1) mod 2, x) + 1
;; fast program: loop2(loop(loop2(loop(x + y, x, y) div x, y, 1 + 2, 2 + 2, x), 1, y) * x, y, 2, 1, x div 2) + (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ 0 (+ x y)))))
