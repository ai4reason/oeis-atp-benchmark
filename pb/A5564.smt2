;; sequence(s): A5564
;; terms: 6 20 45 84 140 216 315 440 594 780 1001 1260 1560 1904 2295 2736 3230 3780 4389 5060
;; small program: (1 + (2 + x)) * loop(2 + (x + y), x, 2)
;; fast program: loop((2 + x) * ((x * x) - 1), 1, 2 + x) div 2
(set-logic UFNIA)
