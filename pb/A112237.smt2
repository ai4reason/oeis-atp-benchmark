;; sequence(s): A112237
;; terms: 1 2 3 8 144 9969216677189303386214405760200
;; small program: loop(loop(loop2(y, x + y, y, x mod 2, 1), x + y, x), x, 1)
;; fast program: (loop((loop2(y, x + y, x, (x mod (1 + 2)) div (1 + 1), 1) + 1) + y, x, 2) - 1) - x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i4 x) (div (mod x (+ 1 2)) (+ 1 1)))))
(assert (= j4 1))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (+ (w4 x) 1) y))))
