;; sequence(s): A84178
;; terms: 0 1 0 3 ~1 10 ~7 35 ~36 127 ~165 474 ~715 1807 ~3004 6995 ~12393 27370 ~50559 107883
;; small program: loop((loop2(x + y, x, y, 1, 0) - x) - x, x, 0)
;; fast program: loop(2 * (loop2(x + y, x, y - 2, 2, 1) - x), x, 1) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* 2 (- (w3 x y) x)))))
