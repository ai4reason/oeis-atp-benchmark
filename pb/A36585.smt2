;; sequence(s): A36585
;; terms: 3 2 1 3 1 2 3 2 1 2 3 1 3 2 1 3 1 2 3 1
;; small program: loop2(compr(loop2(x + y, y div 2, x, 0, x) mod 2, y) - x, 1 + y, 2, 0, x)
...
(assert (forall ((x Int)) (= (fast x) (+ (mod (+ (div (- (v3 x) x) 2) 2) (+ 1 2)) 1))))
