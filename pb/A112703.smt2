;; sequence(s): A112703
;; terms: 1 10 172 3817 95671 2575729 72725941 2124619642 63681430672 1947319848190 60511350647386 1905278320822060 60654011063307832 1949006134928921932 63131614948174818772 2059214227480322203177
;; small program: loop(loop((((2 * ((2 * (x * y)) - x)) div (1 + y)) * (1 + 2)) * (1 + 2), y, 1) + x, x, 1)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (* (* (div (* 2 (- (* 2 (* x y)) x)) (+ 1 y)) (+ 1 2)) (+ 1 2)))))
