;; sequence(s): A83318
;; terms: 1 3 5 9 17 33 65 129 257 513 1025 2049 4097 8193 16385 32769 65537 131073 262145 524289
;; small program: 1 + loop2(y, y + y, x, 0, 2)
;; fast program: 1 + (if x <= 0 then 0 else loop(x + x, x mod 2, loop(x * x, 1, loop(x + x, x div 2, 1))))
(set-logic UFNIA)
