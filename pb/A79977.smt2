;; sequence(s): A79977
;; terms: 1 0 1 0 2 0 3 0 5 0 8 0 13 0 21 0 34 0 55 0
;; small program: loop2(x + y, x, x div 2, 1 - (x mod 2), 0)
;; fast program: loop(loop2(x + y, x, (x div 2) - 1, 1, 1) + x, 1 - (x mod 2), x) - x
(set-logic UFNIA)
