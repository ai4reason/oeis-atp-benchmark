;; sequence(s): A323467
;; terms: 1 1 3 2 3 3 7 4 5 5 7 6 7 7 15 8 9 9 11 10
;; small program: ((loop(loop((x - 1) mod y, 2 + x, 0) - 1, x, x) + x) div 2) + 1
;; fast program: loop(loop((loop2((((y div x) mod 2) + 1) * x, y, 2 + (2 + 2), 1, x) - 1) + x, x mod 2, x), 2, 1 + x) div 2
(set-logic UFNIA)
