;; sequence(s): A251720
;; terms: 12 45 175 539 1573 2873 5491 8303 15341 26071 35557 56129 72283 86903 117077 165731 212341 249307 318719 367993
;; small program: loop2(((compr((1 + loop(x * y, x, 1)) mod (1 + x), 1 + y) * x) + x) * x, 1 + y, 2, 1, x)
;; fast program: loop2((compr(loop((1 - loop(x + x, (x - 1) div 2, 2)) mod (1 + x), 1 - (x mod 2), x) - 2, 1 + y) + 1) * (x * x), 1 + y, 2, 1, x)
(set-logic UFNIA)
