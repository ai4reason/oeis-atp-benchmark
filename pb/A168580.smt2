;; sequence(s): A168580
;; terms: 2 1 2 1 2 1 2 5 4 7 8 7 8 11 14 13 16 17 16 19
;; small program: (((compr(loop2(1 + (x + y), x, x, 0, 1) mod (1 + x), (1 + 2) + x) - 2) - x) - x) - x
;; fast program: (((loop(compr(loop(loop2(x + y, x, x, 1, 2) mod (1 + x), 1 - (x mod 2), x) - 1, 1 + x), 1, 2 + x) - 2) - x) - x) - x
(set-logic UFNIA)
