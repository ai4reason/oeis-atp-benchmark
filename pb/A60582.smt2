;; sequence(s): A60582
;; terms: 0 2 1 1 0 2 2 1 0 2 1 0 0 2 1 1 0 2 1 0
;; small program: loop2(y - x, y div (1 + 2), x + x, 0, x) mod (1 + 2)
;; fast program: ((loop2(y - x, y div (1 + 2), 2 + 2, 0, x div (1 + 2)) + x) * 2) mod (1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (mod (* (+ (w1 x) x) 2) (+ 1 2)))))
