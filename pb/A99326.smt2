;; sequence(s): A99326
;; terms: 1 4 11 28 67 156 354 792 1747 3820 8278 17832 38174 81368 172644 365104 769411 1617228 3389838 7090440
;; small program: loop((loop((x * y) div (y - (y div 2)), y - 1, 2) + x) + x, x, 2 + x) div 2
;; fast program: loop((loop(loop(2 * ((x - (x div y)) + x), x div 2, 1 + (x mod 2)), 1, y) + x) + x, x, 2 + x) div 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h4 x) (+ 1 (mod x 2)))))
